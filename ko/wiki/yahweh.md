...
see_also = [
    ...
    { title = "영원자들의 의회", path = "wiki/council-of-the-eternals", description = "야훼가 의장으로 주재하는 통치 기구." },
...
- [예수](../jesus/)
- [라엘](../rael/)
- [*설계자들로부터의 메시지*](../message-from-the-designers/)
