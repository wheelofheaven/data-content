+++
title = "비글리노 방법"
description = "비글리노 방법은 이탈리아 번역자 마우로 비글리노의 이름을 딴 것으로, 누적된 신학적 전제를 제거하고 히브리어 성경을 읽음으로써 본문의 문자적·기술적 차원을 복원하는 것을 목적으로 한다. Wheel of Heaven은 자료 재독해의 도구로 이를 폭넓게 참조하지만, 그 모든 주장과 자신을 동일시하지는 않는다."
