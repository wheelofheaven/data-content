...
[extra]
featured_order = 5
redirect_to = { title = "세계의 시대", path = "wiki/world-age" }
...
{{ diagram(name="precession", alt="지구의 기울어진 자전축이 원뿔을 그리므로, 천구의 북극이 항성들을 배경으로 원을 그리며 투반, 폴라리스, 베가를 차례로 지납니다.", caption="지축 세차 운동. 황도면 법선에서 23.4° 기울어진 지구의 자전축은 **대년**(≈ 25,772년)마다 한 번 완전한 원뿔을 그립니다. 천구의 북극은 항성들을 배경으로 느린 원을 그리며 — 투반은 기원전 2800년경 극을 차지했고, 폴라리스는 오늘날 극을 표시하며, 베가는 서기 13,700년경 극을 차지하게 됩니다.") }}
...
- 전 주기당 약 26,000년에 걸쳐 있어, 엘로힘 프로젝트의 주요 사건들(약 13,000년 전, 기원전 약 11,375년의 인류 합성)과 후속하는 지구 역사의 주요 사건들을 포괄하기에 충분함
