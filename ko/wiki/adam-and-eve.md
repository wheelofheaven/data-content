...
footnotes = [
    ...
    { content = "코퍼스가 아담과 하와에게 부여하는 연대 — 사자자리 시대 후반, 사자자리–게자리 경계의 기원전 약 8,850년 — 는 프레임워크 내부적인 것이다. 이는 사자자리 개시기(기원전 약 11,375년)의 최초 아담인 종의 합성 — 요한계시록 13:18에서 읽어낸 20년씩 666세대 계산이 정박시키는 사건 — 과 구별된다. 아담과 하와는 최초의 아담인이 아니라 에덴 단계 후반의 시조 인물이다. 세차 시대들은 실제 천문 현상이지만, 특정 경계 연도들은 프레임워크의 관행이다. 연대기의 도출에 대해서는 창세기, 대홍수 이전 시대, 그리고 사람의 수 항목을 참조하라." },
...
title = "이스라엘 팀 에덴 계통의 시조 인간 한 쌍"
type = "엘로힘 창조자들의 이스라엘 팀이 창조한 합성 인간; 생물학적 한 쌍"
created = "사자자리 시대 후반, 코퍼스의 셈법으로 기원전 약 8,850년(에덴 단계의 종결, 사자자리–게자리 경계); 최초의 아담인 종은 그보다 앞서 사자자리 개시기 기원전 약 11,375년에 합성되었으며, 이는 요한계시록 13:18의 20년씩 666세대 독해에 따른 것이다"
...
라엘 자료에서 발전하여 Wheel of Heaven 코퍼스가 채택한 독해에 따르면, 아담과 하와는 신화적 상징이나 단순한 최초 인간이 아니라 특정한 역사적 인물로 읽힌다. 그들은 **이스라엘 팀의** 특정 에덴 시설에서의 시조 인간 한 쌍이다 — 이는 대홍수 이전 초대륙 전반에 분포된 일곱 창조자-팀 시설 중 하나로, 이스라엘 팀의 시설은 그 후속 역사가 히브리어 성경에 보존될 특정 계통을 산출했다. 그들은 사자자리 시대 후반, 에덴 단계의 종결기인 기원전 약 8,850년에 엘로힘 유전 물질을 주된 원천으로, 지구상의 물질을 기질로 하여 *신생(de novo)* 생물학적 합성을 통해 창조되었다. 팀의 최종 확정된 인간 계통인 최초의 아담인은 그보다 앞서, 사자자리 개시기인 기원전 약 11,375년에 합성되었다.{{ footnote(id="5") }} 그들은 에덴의 통제된 환경에서 반체제 루시퍼 분파를 형성하게 될 인물들을 포함한 이스라엘 팀의 과학자들에게 교육받았다. 그들은 그 분파의 제한된 과학 지식 폭로 — 창세기 3장에서 뱀의 개입으로 서술된 행위 — 를 받았다. 그들은 폭로 이후 시설에서 추방되어 보다 광범위한 에덴 지역에서 여생을 살았으며, 그들의 자손은 초기 대홍수 이전 에덴 문명을 이루었다. 자료는 아담을 최초의 예언자 — 직접적 동맹 통신을 받은 최초의 인간 수신자 — 로 특정하여 동정하며, 아담과 하와 둘 모두를 현재 영원자들의 행성에서 부활하여 물병자리 시대의 대사관에서의 동맹의 공개적 귀환을 기다리는 것으로 동정한다.{{ cite(id="the-book-which-tells-the-truth", text="[2]", title="보릴롱(라엘), *The Book Which Tells the Truth* (1974), 2장 — 이스라엘 팀의 최초 합성 인간으로서의 아담과 하와") }}
