...
title = "쉬우르 코마"
slug = "shiur-qomah"
description = "쉬우르 코마(히브리어 שִׁעוּר קוֹמָה, '신장의 척도')는 카발라 이전 시대의 헤칼로트/메르카바 문헌에 속하는 텍스트로, 천사 Metatron이 신적 육체의 우주적 치수를 사지 하나하나 구술하며 각 부위는 parasang 단위로 측정되고 비밀스러운 이름으로 명명된다. 라엘리안 정전이 '카발라'에 귀속시키는 parasang 수치의 배후에 있는 바로 그 텍스트다."
...
entry_type = "text"
claim_type = "direct"
alternative_names = ["*Shiʿur Qomah* (שִׁעוּר קוֹמָה)", "Sefer Haqqomah ('[신적] 육체의 책')", "신장의 척도", "육체의 척도", "Ma'amar Rabbi Yishmael"]
timeline = ["multi-age"]

[extra.infobox]
type = "헤칼로트/메르카바 신비주의 코퍼스에 속하는 텍스트; 신인동형론적 '신적 육체의 척도'"
literal_meaning = "히브리어 שִׁעוּר(*shiʿur*, '척도, 분량') + קוֹמָה(*qomah*, '신장, 높이'; 아람어로는 '육체'): '신장의 척도'"
corpus = "헤칼로트/메르카바 문헌 (카발라 이전 시대의 유대교 신비주의)"
dating = "논쟁적: Scholem — 서기 2세기; Cohen — 게오님 시대인 6~7세기; Schäfer — 연대를 특정할 수 있는 단일 '텍스트'는 없음 ('그 단일 텍스트는 환상이다')"
attributed_to = "위경적으로 타나임인 R. Ishmael과 R. Akiva에게 귀속되며, 천사 Metatron으로부터 받은 계시를 보고하는 형식"
key_figure = "236 (만의 천 배) parasang — 창조주의 신장으로, 시편 147:5로부터 게마트리아를 통해 도출됨"
printed_in = "*Sefer Raziel ha-Mal'akh* (Amsterdam, 1701, fol. 37b); *Merkavah Shelemah* (Jerusalem, 1921); 비평본: M. S. Cohen (TSAJ 9, 1985)"
wheel_of_heaven_reading = "*parasang*을 광초(光秒)로 간주하면, parasang 수치들은 두 실제 천문학적 거리의 왜곡된 기록으로 읽힌다"
+++
