...
description = "截至 2026 年 6 月 7 日,天輪圖書館中每一本希伯來聖經書卷皆已配備九種語言的文本——英語 ASV 版加上八種匯入的公有領域譯本。"
date = 2026-06-07
...
匯入譯本流程僅是圖書館宗旨的其中一半。另一半是 [天輪翻譯計畫](https://docs.wheelofheaven.world/contributing/content/source-text-translation/),目前正逐章推進《創世記》——一份在本計畫自身之術語紀律下、由希伯來文重新產出的英語讀本,每一章背後皆有 譯者—編者—審校 之流程支持。匯入譯本所負責的是 **廣度**(每一書卷、八種語言、公有領域版本,今日全部上線);而天輪翻譯則提供 **深度**(一個傳統、一次一卷、語文學上有所辯護、目前仍在進行中)。
