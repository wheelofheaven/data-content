+++
title = "外星生物學的軍事隱瞞"
description = "外星生物學的軍事隱瞞指國家(主要為美國)將與地球上非人類存在相關的資料進行機密化處理的一整套機制。Wheel of Heaven 文集將其記錄為阻礙大歸來的制度性障礙之一。"
...
see_also = [
    { title = "PURSUE", path = "wiki/pursue", description = "2026 年的公開釋出計畫,其預設公開的檔案庫從官方一側觸及這項保密之說。" },
]
