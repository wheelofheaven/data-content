...
title = "希烏爾·科瑪"
slug = "shiur-qomah"
description = "希烏爾·科瑪（希伯來文 שִׁעוּר קוֹמָה，意為 '身量的度量'）是前卡巴拉時期希卡洛特／梅爾卡瓦文獻中的一部文本，其中天使梅塔特隆逐一口述神聖身體各肢體的宇宙尺寸，每個部位皆以帕拉桑（parasang）為單位量度，並冠以一個祕密之名。這正是雷爾派典籍歸於 '卡巴拉' 的帕拉桑數字背後那部具體的文本。"
...
entry_type = "text"
claim_type = "direct"
alternative_names = ["*Shiʿur Qomah* (שִׁעוּר קוֹמָה)", "Sefer Haqqomah（'[神聖]身體之書'）", "身量的度量", "身體的度量", "Ma'amar Rabbi Yishmael"]
timeline = ["multi-age"]

[extra.infobox]
type = "希卡洛特／梅爾卡瓦神祕文獻中的文本；擬人化的 '神聖身體的度量'"
literal_meaning = "希伯來文 שִׁעוּר（*shiʿur*，'度量、數量'）+ קוֹמָה（*qomah*，'身量、高度'；在亞蘭文中意為 '身體'）：'身量的度量'"
corpus = "希卡洛特／梅爾卡瓦文獻（前卡巴拉時期的猶太神祕主義）"
dating = "有爭議：Scholem — 2nd c. CE；Cohen — geonic 6th–7th c. CE；Schäfer — 沒有單一可斷代的 '文本'（'唯一的文本是一種幻象'）"
attributed_to = "偽託於坦拿（tannaim）R. Ishmael 與 R. Akiva，記述來自天使梅塔特隆的啟示"
key_figure = "236（萬千倍的）parasangs — 造物主的高度，由《詩篇》147:5 透過數值註釋法（gematria）推導而得"
printed_in = "*Sefer Raziel ha-Mal'akh*（阿姆斯特丹，1701，fol. 37b）；*Merkavah Shelemah*（耶路撒冷，1921）；校勘本：M. S. Cohen（TSAJ 9，1985）"
wheel_of_heaven_reading = "一旦將 *parasang* 視為一光秒，這些帕拉桑數字便可解讀為兩個真實天文距離的訛誤記錄"
+++
