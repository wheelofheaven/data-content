...
title = "希乌尔·科玛"
slug = "shiur-qomah"
description = "希乌尔·科玛（希伯来文 שִׁעוּר קוֹמָה，意为 '身量的度量'）是前卡巴拉时期希卡洛特／梅尔卡瓦文献中的一部文本，其中天使梅塔特隆逐一口述神圣身体各肢体的宇宙尺寸，每个部位皆以帕拉桑（parasang）为单位量度，并冠以一个秘密之名。这正是雷尔派典籍归于 '卡巴拉' 的帕拉桑数字背后那部具体的文本。"
...
entry_type = "text"
claim_type = "direct"
alternative_names = ["*Shiʿur Qomah* (שִׁעוּר קוֹמָה)", "Sefer Haqqomah（'[神圣]身体之书'）", "身量的度量", "身体的度量", "Ma'amar Rabbi Yishmael"]
timeline = ["multi-age"]

[extra.infobox]
type = "希卡洛特／梅尔卡瓦神秘文献中的文本；拟人化的 '神圣身体的度量'"
literal_meaning = "希伯来文 שִׁעוּר（*shiʿur*，'度量、数量'）+ קוֹמָה（*qomah*，'身量、高度'；在亚兰文中意为 '身体'）：'身量的度量'"
corpus = "希卡洛特／梅尔卡瓦文献（前卡巴拉时期的犹太神秘主义）"
dating = "有争议：Scholem — 2nd c. CE；Cohen — geonic 6th–7th c. CE；Schäfer — 没有单一可断代的 '文本'（'唯一的文本是一种幻象'）"
attributed_to = "伪托於坦拿（tannaim）R. Ishmael 与 R. Akiva，记述来自天使梅塔特隆的启示"
key_figure = "236（万千倍的）parasangs — 造物主的高度，由《诗篇》147:5 透过数值注释法（gematria）推导而得"
printed_in = "*Sefer Raziel ha-Mal'akh*（阿姆斯特丹，1701，fol. 37b）；*Merkavah Shelemah*（耶路撒冷，1921）；校勘本：M. S. Cohen（TSAJ 9，1985）"
wheel_of_heaven_reading = "一旦将 *parasang* 视为一光秒，这些帕拉桑数字便可解读为两个真实天文距离的讹误记录"
+++
