+++
title = "UFO学"
description = "UFO学是对不明飞行物及相关接触现象的研究。Wheel of Heaven 文集讨论其档案价值,在可用案例与无定论案例之间作出区分,而不与该领域整体保持一致立场。"
...
see_also = [
    { title = "PURSUE", path = "wiki/pursue", description = "2026年美国政府在 war.gov/UFO 发布 UAP 未决档案的计划——该领域当前的制度性发展。" },
]
