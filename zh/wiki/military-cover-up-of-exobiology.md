+++
title = "外星生物学的军事隐瞒"
description = "外星生物学的军事隐瞒指国家(主要为美国)将与地球上非人类存在相关的数据进行机密化处理的一整套机制。Wheel of Heaven 文集将其记录为阻碍大归来的制度性障碍之一。"
...
see_also = [
    { title = "PURSUE", path = "wiki/pursue", description = "2026年的公开发布计划,其默认公开的档案库从官方一侧与保密主张相关。" },
]
