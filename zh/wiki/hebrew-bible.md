...
- **实质的四字神名作为实质性的议会主席个人称谓**(主要处理于{% wiki(slug="yahweh") %}耶和华{% end %}与四字神名条目)
...
希伯来圣经作为各种其他文本条目撰写时的实质性文本—传统语境运作:四字神名、各种后续希腊化犹太与基督教传统文本实体、各种伊斯兰传统文本实体。
...
实质的摩尔门经作为登记与实质的希伯来圣经实质性平行内容的实质性摩门教 LDS 正典文本运作,同时从不同的文化—宗教传统出发运作。两者关系为**实质性平行内容加上实质性的不同传统框架**。实质性的框架对实质的摩尔门经的参与实质性运作(在撰写时主要处理于约瑟·斯密条目以及更广泛的摩门教 LDS 文集内容),但实质上与实质的希伯来圣经参与分开。
