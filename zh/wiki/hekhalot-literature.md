...
description = "希卡洛特文献（希伯来文 הֵיכָלוֹת，意为 '宫殿'）是古典时代晚期的犹太神秘主义著作总集，描述灵魂穿越七重天上宫殿、上升至神圣宝座战车（merkavah）的历程。它是犹太神秘主义中前卡巴拉时期的一层，也是传承希乌尔·科玛的文献集。"
...
entry_type = "text"
claim_type = "direct"
alternative_names = ["希卡洛特／Heikhalot 文献（הֵיכָלוֹת）", "梅尔卡瓦神秘主义", "Merkabah 神秘主义", "'宫殿' 文献", "*ma'aseh merkavah*（'战车之工'）"]
timeline = ["multi-age"]

[extra.infobox]
type = "古典时代晚期／中世纪早期犹太神秘主义文本的文集（前卡巴拉时期）"
literal_meaning = "希伯来文 הֵיכָלוֹת（*hekhalot*），为 הֵיכָל（*hekhal*）的复数形，意为 '宫殿' 或 '殿堂' — 上升历程中的七重天上宫殿"
also_called = "梅尔卡瓦（战车）神秘主义，得名于以西结的宝座异象（*ma'aseh merkavah*，'战车之工'）"
principal_works = "*Hekhalot Rabbati*（'大宫殿'）、*Hekhalot Zutarti*（'小宫殿'）、*Ma'aseh Merkavah*、*Merkavah Rabbah*、*3 Enoch*（希伯来文《以诺书》）；*Shi'ur Qomah* 嵌于此文集之中"
practitioner = "*yored merkavah*（'下降至战车者'），凭借颂歌、天使之名与封印穿越诸宫殿而上升"
dating = "有争议：撰作／编纂约在公元 3 至 8 世纪之间（Scholem 主张较早，Schäfer 主张较晚且属高昂时期的巴比伦）"
key_figure = "天使梅塔特隆 — '临在之君'、天上的书记，以及（在《3 Enoch》中）变容的先祖以诺"
+++
