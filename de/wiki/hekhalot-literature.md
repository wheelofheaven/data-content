...
entry_type = "text"
claim_type = "direct"
alternative_names = ["Hekhalot-/Heikhalot-Literatur (הֵיכָלוֹת)", "Merkava-Mystik", "Merkaba-Mystik", "die „Palast“-Literatur", "*ma'aseh merkavah* („das Werk des Wagens“)"]
timeline = ["multi-age"]

[extra.infobox]
type = "Korpus spätantiker/frühmittelalterlicher jüdisch-mystischer Texte (vorkabbalistisch)"
literal_meaning = "Hebräisch הֵיכָלוֹת (*hekhalot*), Plural von הֵיכָל (*hekhal*), „Palast“ oder „Halle“ — die sieben himmlischen Paläste des Aufstiegs"
also_called = "Merkava- (Wagen-)Mystik, nach Ezechiels Thronvision (*ma'aseh merkavah*, „das Werk des Wagens“)"
principal_works = "*Hekhalot Rabbati* („die größeren Paläste“), *Hekhalot Zutarti* („die kleineren Paläste“), *Ma'aseh Merkavah*, *Merkavah Rabbah*, *3 Enoch* (das hebräische Henochbuch); der *Shi'ur Qomah* ist in den Korpus eingebettet"
practitioner = "Der *yored merkavah* („Absteiger zum Wagen“), der mit Hymnen, Engelsnamen und Siegeln gerüstet durch die Paläste aufsteigt"
dating = "Umstritten: Abfassung/Redaktion etwa zwischen dem 3. und 8. Jh. n. Chr. (Scholem plädierte für früher, Schäfer für später und gaonäisch-babylonisch)"
key_figure = "Der Engel Metatron — „Fürst des Angesichts“, himmlischer Schreiber und (in 3 Enoch) der verklärte Patriarch Henoch"
+++
