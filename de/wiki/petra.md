...
timeline = ["pisces"]
alternative_names = ["Πέτρα (griechisch „Fels“)", "רקמו (nabatäisch Raqmū)", "רֶקֶם (hebräisch Reqem)", "Rekem", "Raqēmō", "ٱلْبَتْرَاء (arabisch al-Batrāʾ)", "Sela (biblisch „Fels“)", "Mutter der Kolonien", "Reqem der Schluchten"]

[extra.infobox]
type = "In den Fels gehauene nabatäische Karawanen-Hauptstadt; UNESCO-Weltkulturerbe; geografisches Zentrum der Hypothese von Petra als ursprünglichem Mekka"
location = "Wadi Musa, Gouvernement Ma'an, Süden Jordaniens; etwa 1.200 km nördlich des heutigen Mekka"
nabataean_name = "רקמו (Raqmū / Reqem), die Eigenbezeichnung des Königreichs; „Petra“ (πέτρα, „Fels“) ist der griechisch-römische Name"
flourished = "ca. 4. Jh. v. u. Z. – 2. Jh. n. u. Z. als nabatäische Hauptstadt; 106 n. u. Z. von Rom annektiert (Provincia Arabia); Niedergang nach den Erdbeben von 363 n. u. Z. und später"
mainstream_status = "Hauptstadt des nabatäischen Königreichs; bedeutende hellenistisch-römische Karawanenstadt; gemischt heidnisch-christliche Bevölkerung bis in die byzantinische Ära"
hypothesis = "Dan Gibsons Argument (Qur'anic Geography 2011; Let the Stones Speak 2023), dass Petra die ursprüngliche heilige Stadt, Qibla und Pilgerfahrts-Fokus des frühen Islam war, bevor das Heiligtum in den Hedschas verlegt wurde"
principal_evidence = "Qibla-Ausrichtungen früher Moscheen nach Petra (1–ca. 100 AH); Fehlen Mekkas in Ptolemäus' Geographie; al-Azraqīs unregelmäßige Ka'ba-Maße; nabatäisch-aramäisches Substrat des koranischen Arabisch"
principal_critic = "David A. King — die Qibla-Ausrichtungen spiegeln eine nicht-geografische „heilige Richtung“ (volksastronomische) Ausrichtung zur Kaʿba wider, kein Zielen auf Petra"
framework_reading = "Erörtert, nicht übernommen: sofern stichhaltig, verlegt sie die Geografie der Hanafiyya (Religion Abrahams) in die nabatäische Hauptstadt; konvergiert mit der Korpus-Lesart des frühen Islam als abrahamitische Restaurationsbewegung im Zeitalter der Fische"
distinguished_from = "Das hedschasische Mekka der islamischen Mainstream-Tradition; der maximalistische Hagarismus-Revisionismus von Crone und Cook; Kings volksastronomisches Qibla-Modell"
+++

**Petra** (griechisch <span class="arabic">Πέτρα</span> *Pétra*, „Fels“; nabatäisch-aramäisch <span class="arabic">רקמו</span> *Raqmū*; hebräisch <span class="arabic">רֶקֶם</span> *Reqem*; arabisch <span class="arabic">ٱلْبَتْرَاء</span> *al-Batrāʾ*) ist die in den Fels gehauene Hauptstadt des **nabatäischen** Königreichs im heutigen Süden Jordaniens. Im Wheel-of-Heaven-Rahmen wird sie in zwei verschiedenen Registern behandelt, die getrennt gehalten werden müssen. Das erste ist die im Mainstream unstrittige Stadt: die hellenistisch-römische Karawanen-Hauptstadt der Nabatäer, 106 n. u. Z. von Rom annektiert, in der Spätantike als bedeutendes Zentrum aufgegeben und 1812 von Johann Ludwig Burckhardt für die europäische Wissenschaft wiederentdeckt. Das zweite ist Petra als geografisches Zentrum einer **revisionistischen Hypothese** — vor allem mit dem kanadischen Forscher **Dan Gibson** verbunden —, die besagt, dass Petra und nicht die heute **Mekka** genannte Stadt im Hedschas die ursprüngliche heilige Stadt, die *Qibla* (Gebetsrichtung) und der Pilgerfahrts-Fokus des frühen Islam gewesen sei.

Die beiden Register tragen sehr unterschiedliches epistemisches Gewicht, und dieser Eintrag markiert die Grenze durchgehend. Das Material zur nabatäischen Stadt ist `direct`: textlich und archäologisch belegt, im Mainstream unstrittig. Das Material zum ursprünglichen Mekka ist `speculative`: ein umstrittenes archäologisches Argument, das der Mainstream-Historiker der islamischen Astronomie **David A. King** ablehnt, das nicht Teil des raëlianischen Kanons ist und mit dem sich der Korpus als interpretativer Hypothese befasst, statt es als Tatsache zu übernehmen. Der `claim_type` des gesamten Eintrags ist auf `speculative` gesetzt, weil die Seite hauptsächlich existiert, um das zweite Register darzulegen; die Rahmen-Lesart des Eintrags [Mohammed](../muhammad/), die Mohammeds Geburt und erste Offenbarung in den Hedschas verlegt, bleibt daneben bestehen, statt überschrieben zu werden.
...
- **Der Kontext des Zeitalters der Fische.** Mohammeds Wirken fällt in das frühe bis mittlere [Zeitalter der Fische](../timeline/age-of-pisces/), das der Korpus als die Periode der breiten kulturellen Übermittlung der operativen Botschaft über zivilisatorische Regionen hinweg liest. Die Verlegung und Neuformulierung einer Heiligtumstradition im Verlauf des ersten islamischen Jahrhunderts ist mit dem umfassenderen Bild des Korpus vereinbar, wonach Traditionen in der Übermittlung redigiert und verfestigt werden.
...
- **Götzendienst, nicht Polytheismus.** Petra war eine Stadt des Steinkults: Die Nabatäer verehrten ihre Gottheiten in würfelförmigen Standsteinen (*Baityloi*), und die [Hanafiyya](../hanafiyya/)-Tradition stellt die Ablehnung „des Steins, den sie umkreisten“ durch die Suchenden genau diesem Götzendienst entgegen. Der Korpus liest diesen Gegensatz nicht als Monotheismus, der den Polytheismus besiegt — die [Elohim](../elohim/) sind selbst eine [Vielheit](../plurality-of-gods/) verkörperter Schöpfer —, sondern als eine Abkehr von der Verehrung toter Bildnisse hin zum Erkennen der wirklichen Schöpfer, die die Menschheit, wie der [raëlianische Kanon](../../library/the-book-which-tells-the-truth/) sagt, nach dem Zusammenbruch nach Sodom „vergessen“ hatte. Ein Schauplatz Petra macht den Götzendienst wörtlich: Standsteine in genau der Stadt, in der die Religion Abrahams wiedergewonnen wurde. Siehe [Hanafiyya](../hanafiyya/) für die vollständige Entwicklung.
