...
footnotes = [
    ...
    { content = "Das Datum, das der Korpus Adam und Eva zuweist — spätes Zeitalter des Löwen, ca. 8.850 v. Chr., an der Grenze Löwe–Krebs —, ist rahmenintern. Es ist verschieden von der Synthese der ersten adamitischen Spezies zu Beginn des Löwen (ca. 11.375 v. Chr.), die die aus Offenbarung 13,18 herausgelesene Berechnung von 666 Generationen zu je 20 Jahren verankert; Adam und Eva sind Gründungsgestalten spät in der Eden-Phase, nicht die ersten Adamiten. Die präzessionalen Zeitalter sind reale astronomische Phänomene; die spezifischen Grenzjahre sind rahmeninterne Konventionen. Siehe die Einträge zu Genesis, Vorsintflutlich und Zahl des Menschen für die Herleitung der Chronologie." },
...
title = "Das gründende Menschenpaar der Eden-Linie des Israel-Teams"
type = "Vom Israel-Team der Elohim-Schöpfer erschaffene synthetisierte Menschen; biologisches Paar"
created = "Spätes Zeitalter des Löwen, ca. 8.850 v. Chr. nach der Zählung des Korpus (der Abschluss der Eden-Phase, an der Grenze Löwe–Krebs); die erste adamitische Spezies wurde früher synthetisiert, zu Beginn des Löwen ca. 11.375 v. Chr., gemäß der Berechnung von 666 Generationen zu je 20 Jahren aus Offenbarung 13,18"
