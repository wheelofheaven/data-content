...
timeline = ["pisces"]
lead = "In den drei kanonischen Büchern des raëlianischen Korpus baut Claude Vorilhon (Raël) seine Darstellung auf, indem er eine breite Palette bereits existierender Texte, Traditionen und namentlich genannter Persönlichkeiten zitiert, paraphrasiert und auf sie verweist. Dieser Eintrag katalogisiert dieses intertextuelle Feld in zwei Ebenen: einer primären Ebene mit Werken, die der Kanon namentlich nennt oder direkt zitiert, und einer sekundären Ebene mit Traditionen, Sprachen und Motiven, die der Kanon einbezieht, ohne sie förmlich zu zitieren."
reading = "interpretive"

see_also = [
    { title = "Bibel", path = "/wiki/bible/", description = "Die umfassendere Texttradition, in der die Hebräische Bibel und das Neue Testament stehen." },
    { title = "Hebräische Bibel", path = "/wiki/hebrew-bible/", description = "Der größte und am präzisesten zitierte Referenzbestand des Kanons." },
    { title = "Genesis", path = "/wiki/genesis/", description = "Das im Kanon am umfangreichsten zitierte Buch in der Auslegung der Urgeschichte." },
    { title = "Kabbala", path = "/wiki/kabbalah/", description = "In Das Ende der Welt als „das Buch, das der Wahrheit am nächsten kommt“ bezeichnet; die Parasangen-Passage verweist auf das Schi’ur Qoma." },
    { title = "Raëlismus", path = "/wiki/raelism/", description = "Die Bewegung, die durch die drei hier katalogisierten kanonischen Bücher konstituiert wird." },
    { title = "Raël", path = "/wiki/rael/", description = "Claude Vorilhon, Verfasser der drei kanonischen Bücher." },
    { title = "Elohim", path = "/wiki/elohim/", description = "Die zivilisatorische Bezeichnung, die der Kanon aus dem hebräischen Plural entschlüsselt." },
    { title = "Jahwe", path = "/wiki/yahweh/", description = "Der Ratsvorsitzende, den der Kanon im biblischen Text wiederherstellt." },
...
footnotes = [
    ...
    { content = "Die etymologisch-philologische Arbeit des Kanons — *Elohim* als „diejenigen, die vom Himmel kamen“, *angelos* als „Bote“, *apocalypsis* als „Offenbarung“, *diabolos* als „Verleumder“, *euagelion* als „gute Nachricht“ und so weiter — behandelt Wortgeschichten als Zeugnisse eigenen Rechts. Die Genauigkeit jeder einzelnen Etymologie ist uneinheitlich (einige entsprechen dem wissenschaftlichen Konsens, andere sind spekulativ oder umstritten), aber die strukturelle Bewegung ist konsistent: Der Kanon liest Etymologie als Bewahrerin historischen Gehalts, den das konventionelle theologische Vokabular verdeckt hat. Dies ist eine der wiederkehrenden interpretatorischen Operationen des Kanons." },
    { content = "Der Kanon schließt die umfassendere prä-astronautische Auslegungstradition (Sendy, Sitchin, von Däniken, Wallis, Biglino) ausdrücklich aus seinem Geltungsbereich aus, als *vom Leser eingebrachten Kontext* und nicht als eigenen Referenzkorpus. Der raëlianische Kanon beansprucht Offenbarung, nicht Ableitung, und behandelt frühere religiöse Literatur als unvollkommene Aufzeichnungen früheren Elohim-Kontakts und nicht als eigene geistige Quellen. Der Korpusrahmen unterscheidet diese Ebenen sorgfältig: Dieser Eintrag katalogisiert nur das, was der Kanon selbst namentlich nennt und einbezieht." },
]

[[extra.references]]
id = "the-book-which-tells-the-truth"
note = "Vorilhon (Raël, 1974); das grundlegende kanonische Buch und der zentrale Schauplatz der biblischen Exegese des Kanons (Genesis 1–11 Kapitel für Kapitel)."

[[extra.references]]
id = "extraterrestrials-took-me-to-their-planet"
note = "Vorilhon (Raël, 1975); enthält das Kapitel Buddhismus, die direkten Koranzitate und die Lesart der Totengebeine in Ezechiel 37."

[[extra.references]]
id = "lets-welcome-the-extraterrestrials"
note = "Vorilhon (Raël, 1979); enthält das Kapitel Die neuen Offenbarungen zur Apokalypse und den Kommentar Ja... ich bin Raëlianer, der überlebende Spuren auflistet."

[[extra.references]]
id = "intelligent-design-message-from-the-designers"
note = "Die englische Gesamtausgabe von 2005, die alle drei kanonischen Bücher vereint; die zentrale Textgrundlage dieses Katalogs."

[[extra.references]]
id = "dhorme-bible"
note = "Die wichtigste französische Bibel, die Raël während des Kontakts von 1973 verwendete und die in den französischen kanonischen Bänden durchgehend zitiert wird."

[[extra.references]]
id = "rnkjv"
note = "Restored Name King James Version; die wichtigste englischsprachige Bibel der Gesamtausgabe von 2005, die Elohim und Jahwe im Text wiederherstellt."

[[extra.references]]
id = "the-qur-an"
locator = "Sure 21:1-5; 54:1; 56:15-24"
note = "In Außerirdische brachten mich auf ihren Planeten mit kapitel- und versgenauer Präzision direkt zitiert."

[[extra.references]]
id = "book-of-enoch"
note = "Im Kommentar Ja... ich bin Raëlianer als einer der Texte genannt, die der Wahrheit des Kanons näher stehen."

[[extra.references]]
id = "shiur-qomah"
note = "Die frühe jüdische mystische Tradition, deren anthropomorph-kosmisches Körpermaß-Motiv dem Parasangen- / Höhe-des-Schöpfers-Zitat des Kanons zur Kabbala entspricht."

[[extra.references]]
id = "epic-of-gilgamesh"
note = "Im Kommentar Ja... ich bin Raëlianer unter den überlebenden Spuren aufgeführt (als „sumerisch-babylonisch“ gekennzeichnet)."

[[extra.references]]
id = "mahabharata"
note = "Im Kommentar Ja... ich bin Raëlianer namentlich genannt; die Veden und das Rāmāyaṇa sind als Teile des umfassenderen Korpus aufgeführt."

[[extra.references]]
id = "ramayana"
note = "Im Kommentar Ja... ich bin Raëlianer neben dem Mahābhārata aufgeführt."

[[extra.references]]
id = "vedas"
note = "Im Kommentar Ja... ich bin Raëlianer innerhalb des Mahābhārata-Korpus genannt."

[[extra.references]]
id = "kojiki"
note = "Die japanische Chronik aus dem Jahr 712 n. Chr., im Kommentar Ja... ich bin Raëlianer unter den überlebenden Spuren genannt."

[[extra.references]]
id = "popol-vuh"
note = "Das Schöpfungsepos der K’iche’-Maya, im Kommentar Ja... ich bin Raëlianer neben der Chronik von Akakor als lateinamerikanisches Zeugnis genannt."

[[extra.references]]
id = "chronicle-of-akakor"
note = "Brugger (1976); erscheint in der Spurenliste von Ja... ich bin Raëlianer. Die spätere Forschung behandelt Bruggers Werk weithin als literarische Fälschung — eine ungelöste Spannung im Referenzhorizont des Kanons."
+++
...
Die Textgrundlage dieses Katalogs ist die englischsprachige Gesamtausgabe von 2005, *Intelligent Design — Message From the Designers*{{ cite(id="intelligent-design-message-from-the-designers", text="[1]", title="Die englische Gesamtausgabe von 2005, die alle drei kanonischen Bücher vereint") }}{{ footnote(id="1") }}, die alle drei kanonischen Bücher vereint. Wo die ursprünglichen französischen Ausgaben in ihrer Behandlung biblischer Zitate von der englischen Übersetzung abweichen, vermerkt der Kanon selbst die Divergenz: Die französischen Bände stützen sich überwiegend auf die Bibelübersetzung von **Édouard Dhorme**{{ cite(id="dhorme-bible", text="[2]", title="Dhorme (1956–1959); die französische Bibelübersetzung, die Raël zu Rate zog") }}{{ footnote(id="2") }}, während die englische Gesamtausgabe für die meisten Zitate die **Restored Name King James Version** (RNKJV){{ cite(id="rnkjv", text="[3]", title="Restored Name King James Version; stellt Elohim und Jahwe im Text wieder her") }} verwendet, mit gelegentlichem Rückgriff auf die **New King James Version**, die **American Standard Version**, die **Webster Bible**, die **Hebrew Names Version** und die **Darby Translation**. Diese editorischen Entscheidungen sind selbst direkte Verweise auf bestimmte Texttraditionen und werden unten katalogisiert.
...
Die Liste *Ja... ich bin Raëlianer* ist ein Kommentar eines Anhängers und keine Aussage Raëls selbst, erscheint aber innerhalb der kanonischen Gesamtausgabe und artikuliert dieselbe Lesart, die der Kanon in *An der Wurzel aller Religionen* etabliert{{ footnote(id="3") }}.

### Sprachen, die philologisch einbezogen werden

Der Kanon betreibt anhaltende etymologische Lesungen und behandelt Wortgeschichten als Zeugnisse eigenen Rechts{{ footnote(id="5") }}. Zu den ausdrücklich herangezogenen Sprachen gehören:
...
- **Latein** — *senior* (der Älteste / Herr), *pontifex* (Brückenbauer), *cultus* (Tribut), *religio* (das, was verbindet).
