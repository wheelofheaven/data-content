...
entry_type = "figure"
alternative_names = ["der Lichtbringer", "lūcifer", "Helel ben Shahar", "הֵילֵל בֶּן־שַׁחַר", "der Morgenstern", "Phosphoros", "Heosphoros", "der Anführer der Luzifer-Fraktion"]
portrait_id = "lucifer"
...
[[extra.references]]
id = "paradise-lost"
note = "Miltons Epos von 1667 — die einflussreichste nachbiblische literarische Auseinandersetzung mit Luzifer; der charismatische, sympathische Luzifer, den der Korpus als literarischen Vorläufer der moralischen Rehabilitation der Gestalt liest."

[[extra.references]]
id = "marriage-of-heaven-and-hell"
note = "Blakes Lesart von 1790, Milton sei „of the Devil's party without knowing it” gewesen — die grundlegende romantische Umkehrung der Gestalt."

[[extra.references]]
id = "cain-a-mystery"
note = "Byrons sympathischer Luzifer von 1821, der Kain eine kosmologische Vision anbietet, die die orthodoxe Darstellung in Frage stellt."

[[extra.references]]
id = "prometheus-unbound"
note = "Shelleys Ausarbeitung der Luzifer-Prometheus-Parallele von 1820 als moralischer Held des Widerstands gegen willkürliche Autorität."

[[extra.references]]
id = "prometheus-bound"
note = "Aischylos' Tragödie, die Prometheus als zu Unrecht bestraften Wohltäter der Menschheit darstellt — die klassische Primärquelle für die Prometheus-Parallele."

[[extra.references]]
id = "theogony-works-and-days"
note = "Hesiods Dichtungen, die die Erzählung vom Feuerraub des Prometheus und die Tradition des goldenen Geschlechts / der Zeitalter des Niedergangs bewahren."

[[extra.references]]
id = "metamorphoses"
note = "Ovids Kompilation, die unter anderem die Phaethon-Sturz-Erzählung enthält, die der Korpus in die breitere Tradition der stürzenden Gestalt einordnet."

[[extra.references]]
id = "inanna-queen-of-heaven"
note = "Wolksteins und Kramers Übersetzung des sumerischen Inanna-Abstiegszyklus — Vergleichsmaterial für das Muster von Abstieg und Wiederherstellung."

[[extra.references]]
id = "kelly-satan-biography"
note = "Kellys umfassende Darstellung der Entwicklung der Satan-Gestalt — wissenschaftliche Stütze für die Unterscheidung von Luzifer / Satan / Teufel im Korpus."

[[extra.references]]
id = "forsyth-the-old-enemy"
note = "Forsyths Nachzeichnung der Tradition des kosmischen Widersachers und des Kampfmythos von altorientalischen Quellen bis zum christlichen Satan."

[[extra.references]]
id = "pagels-origin-of-satan"
note = "Pagels' Studie über die sozial-politische Konstruktion der christlichen Satan-Gestalt."

[[extra.references]]
id = "russell-lucifer-middle-ages"
note = "Russells Standardwerk über die mittelalterliche Konsolidierung der kosmischen Luzifer-Synthese."

[[extra.references]]
id = "city-of-god"
note = "Augustinus' Konsolidierung der patristischen Lesart vom Sturz Luzifers — eine zentrale Stufe in der Synthese der kosmischen Gestalt, die der Korpus unterscheidet."

[[extra.references]]
id = "de-principiis"
note = "Origenes' frühe Anwendung der Helel-Passage aus Jesaja 14 auf eine kosmische gefallene Gestalt."

[[extra.references]]
id = "summa-theologiae"
note = "Aquins scholastische Ausarbeitung der Lehre vom Sturz Luzifers (Summa Theologiae I, qq. 63–64)."

[[extra.references]]
id = "the-satanic-bible"
note = "LaVeys grundlegender Text des LaVeyanischen Satanismus — eine zeitgenössische symbolische Aneignung des Namens Luzifer, die der Korpus verzeichnet, aber nicht befürwortet."

[extra.infobox]
hebrew_name = "הֵילֵל בֶּן־שַׁחַר (Helel ben Shahar)"
greek_name = "Φωσφόρος (Phosphoros); Ἑωσφόρος (Heosphoros)"
latin_name = "Lūcifer („Lichtbringer”)"
title = "Lichtbringer; Anführer der dissidenten Fraktion innerhalb des Israel-Teams"
born = "Heimatwelt der Eloha; geboren etwa während des späten Zeitalters des Steinbocks oder frühen Zeitalters des Schützen (kein konkretes Datum im Quellenmaterial)"
operational_period = "Spätes Zeitalter des Löwen bis zur Gegenwart (Luzifers fortdauernde Präsenz auf der Erde beginnt mit der Eden-Verbannung, ca. 8.850 v. Chr. nach der Zählung des Korpus, und setzt sich über die vorsintflutliche Periode hinaus fort)"
date_type = "rahmenintern; abgeleitet aus der Eden-Chronologie und der Lesart der fortdauernden Präsenz"
biblical_appearance = "Genesis 3 (die Eden-Episode, in seiner Rolle als Schlange); Jesaja 14,12 (Helel ben Shahar); Hiob 38,7 (die Morgensterne); 2. Petrus 1,19 (der Morgenstern); Offenbarung 22,16 (Jesus als der Morgenstern identifiziert — von Luzifer verschieden)"
faction = "Die dissidente Fraktion innerhalb des Israel-Teams; tritt für die vollständige Enthüllung wissenschaftlichen Wissens gegenüber den synthetisierten Menschen ein"
relationship_to_yahweh = "Untergeordnet innerhalb des Israel-Teams während der Periode vor Eden; politischer Gegner über die Periode nach Eden hinweg; ausgesöhnt im breiteren Allianzprojekt über die nachfolgenden Zeitalter hinweg"
distinguished_from = "Satan (eine eigene Elohim-Gestalt, die die abolitionistische Fraktion der Heimatwelt anführt); die Schlange (Luzifer selbst in seiner spezifischen Rolle bei der Eden-Enthüllung); der Teufel (eine spätere christlich-theologische Synthese, die mehrere unterschiedliche Gestalten zusammenführt)"
current_status = "Fortdauernde Präsenz auf der Erde (gemäß dem Quellenmaterial); ausgesöhnt mit der breiteren Allianz über die nachschöpfungszeitliche Periode hinweg"
principal_text = "Genesis 3 (Rolle als Schlange); Jesaja 14,12 (Helel ben Shahar); die breitere christliche Literatur der Luzifer-Tradition"
principal_framework_source = "*Das Buch, das die Wahrheit sagt* (Vorilhon/Raël, 1974), Kapitel 2"
+++

**Luzifer** (lateinisch: *lūcifer*, „Lichtbringer”, von *lux* „Licht” + *ferre* „tragen, bringen”; hebräisch: <span class="hebrew">הֵילֵל בֶּן־שַׁחַר</span>, *Helel ben Shahar*, „Morgenstern, Sohn der Morgenröte”; griechisch: *Phosphoros* und *Heosphoros*, „Lichtträger” und „Morgenröte-Träger”) ist die in der christlich-theologischen Tradition als Anführer der vom Himmel gefallenen Engel benannte Gestalt, herkömmlich mit Satan, mit der Eden-Schlange und mit der breiteren Gestalt des kosmischen Bösen gleichgesetzt. Der Name Luzifer selbst ist eine Übersetzung der lateinischen Vulgata-Tradition (Hieronymus, ca. 405 n. Chr.) des hebräischen *Helel ben Shahar* aus Jesaja 14,12, in einer Passage, die der hebräische Text selbst an den König von Babylon richtet — eine satirische Klage über den Fall einer überheblichen historisch-politischen Gestalt, die die patristisch-mittelalterliche christliche Tradition als Bezug auf eine kosmische Gestalt umdeutete.{{ footnote(id="1") }} Die Gleichsetzung des Namens Luzifer mit der breiteren Tradition der gefallenen Gestalt hat im Wesentlichen jede nachfolgende westlich-christliche theologische Reflexion über die Gestalt geprägt, mit dem Ergebnis, dass „Luzifer” im populären Sprachgebrauch zu einem Synonym für Satan oder den Teufel geworden ist.
...
- **Origenes** (ca. 185–254 n. Chr.) wendet in *De Principiis* I.5.5 und in den *Homilien zu Hesekiel* 13,1–2 die Jesaja-14-Passage auf die kosmische gefallene Gestalt an und behandelt den König von Babylon als Typus der zugrundeliegenden geistigen Wirklichkeit.{{ cite(id="de-principiis", text="[1]", title="Origenes, *De Principiis* I.5.5 — frühe Anwendung von Jesaja 14 auf eine kosmische gefallene Gestalt") }}
...
- **Augustinus** (354–430 n. Chr.) konsolidiert die patristische Lesart in *City of God* („Vom Gottesstaat”) und andernorts, wobei der Sturz Luzifers als grundlegendes Ereignis der Geschichte des kosmischen Bösen behandelt wird.{{ cite(id="city-of-god", text="[2]", title="Augustinus, *City of God* — Konsolidierung der patristischen Lesart vom Sturz Luzifers") }}
...
- **Die mittelalterliche scholastische Theologie** (Aquin, die breitere mittelalterliche Tradition) arbeitet die entwickelte Luzifer-Lehre innerhalb des dämonologischen Apparats des mittelalterlichen Christentums aus.{{ cite(id="summa-theologiae", text="[3]", title="Aquin, *Summa Theologiae* I, qq. 63–64 — scholastische Ausarbeitung der Lehre vom Sturz Luzifers") }}
...
Das zentrale Material der Hebräischen Bibel, auf dem die Lesart Luzifers durch den Rahmen ruht, ist die Erzählung von der Eden-Schlange in Genesis 3, ausführlich behandelt im Eintrag zur [Serpent](../serpent/). Die Schlange aus Genesis 3 ist auf der Lesart des Korpus Luzifer in seiner spezifischen Rolle bei der Eden-Enthüllung — dieselbe Gestalt, die den spezifischen operativen Akt vollzieht, den der Genesis-Text verzeichnet. Der biographische Bogen des Luzifer-Eintrags, unten behandelt, entfaltet die breitere Laufbahn, von der die Eden-Enthüllung eine Episode ist, mit Querverweis auf den Schlange-Eintrag für die ausführliche Behandlung dieser spezifischen Episode.
...
Luzifers biographischer Bogen, wie der Rahmen ihn liest, spannt sich von seinen vor-irdischen Ursprüngen auf der Heimatwelt der Eloha bis zu seiner fortdauernden Präsenz auf der Erde in der zeitgenössischen Periode.{{ footnote(id="4") }} Der Bogen gliedert sich in sieben Hauptphasen. Die Eden-Enthüllungs-Phase, ausführlich behandelt im Eintrag zur [Serpent](../serpent/), wird hier knapp mit Querverweis verzeichnet und nicht in gleicher Ausführlichkeit erneut entfaltet.
...
Das Eden-Enthüllungs-Ereignis selbst — der in Genesis 3 erzählte Akt — ist ausführlich im Eintrag zur [Serpent](../serpent/) behandelt. Die Schlange aus Genesis 3 ist Luzifer in seiner spezifischen Rolle im Moment der Enthüllung: Er verschafft den ersten Menschen (Adam und Eva) Zugang zu den verbotenen wissenschaftlichen und technologischen Materialien des Gartens und artikuliert öffentlich die Position der dissidenten Fraktion, dass die Menschen Anspruch auf vollständige Information hätten.
...
Über das Zeitalter des Krebses hinweg (ca. 8.850 – 6.690 v. Chr. nach der Chronologie des Korpus) dienten Luzifer und seine verbannte Fraktion als fortdauernde Lehrer der menschlichen Zivilisation der Eden-Linie.{{ cite(id="the-book-which-tells-the-truth", text="[4]", title="Vorilhon (Raël), *Das Buch, das die Wahrheit sagt* (1974), Kap. 2 — die vorsintflutliche Lehrrolle der verbannten Fraktion") }} Dies ist die Periode des umfangreichsten biographischen Materials des Korpus über Luzifers breitere Laufbahn.
...
Die Nephilim-Episode ist einer der zentralen Faktoren, die der Korpus als zur schließlichen Flut-Entscheidung der Heimatwelt beitragend identifiziert.{{ footnote(id="5") }} Die Anhäufung von hybriden Eloha-Mensch-Nachkommen über die vorsintflutliche Zivilisation hinweg brachte eine Population hervor, die aus Sicht der Behörden der Heimatwelt eine inakzeptable Vermischung der Allianz mit der Menschheit war — sowohl im Hinblick auf den genetischen Bestand als auch im Hinblick auf die Führungskapazität. Die Flut-Entscheidung wird vom Korpus so gelesen, dass sie unter anderen Bedenken spezifisch auf die Nephilim-Population zielte.

### Die Flut und der Status nach der Flut

Das Flutereignis des Zeitalters der Zwillinge (ca. 6.690 v. Chr. nach der Chronologie des Korpus) ist ausführlicher im Eintrag zur [Great Flood](../great-flood/) behandelt. Für den biographischen Bogen Luzifers ist die zentrale Frage, was mit Luzifer und seiner Fraktion während und nach der Flut geschah.
...
Der Rahmen unterscheidet sorgfältig zwischen vier Gestalten, deren Beziehungen von der späteren religiösen Tradition verwirrt worden sind: Jahwe (der Anführer des Israel-Teams und gemäßigte Vertreter der Allianz), Luzifer (der Anführer der dissidenten Fraktion), die Schlange (Luzifer in seiner spezifischen Rolle bei der Eden-Enthüllung) und Satan (eine eigene Elohim-Gestalt, die die abolitionistische Fraktion der Heimatwelt anführt).{{ footnote(id="2") }} Die ausführliche Behandlung dieser Taxonomie findet sich im Eintrag zur {% wiki(slug="serpent") %}Schlange{% end %}; für den Luzifer-Eintrag ist der zentrale Punkt, dass Luzifer eine der vier Gestalten ist, von den anderen durch eine spezifische operative Stellung unterschieden.
...
Das Verhältnis zwischen Luzifer und der Schlange ist die Lesart des Rahmens von *demselben Akteur in unterschiedlichen operativen Momenten*. Die Schlange ist Luzifer spezifisch in seiner Rolle bei der Eden-Enthüllung in Genesis 3; Luzifer ist dieselbe Gestalt in seiner breiteren Laufbahn, einschließlich der Eden-Enthüllung, aber erheblich davor und danach ausgreifend. Die ausführliche Behandlung dieser Unterscheidung findet sich im Eintrag zur [Serpent](../serpent/); was hier von Bedeutung ist, ist, dass Luzifer und die Schlange keine verschiedenen Gestalten sind, sondern dieselbe Gestalt in unterschiedlichen Rollen.
...
Die Unterscheidung von Luzifer / Satan ist die folgenreichste einzelne Korrektur, die der Rahmen der konventionellen christlichen Theologie der Gestalt anbietet. Ihre Wiedergewinnung erfordert die Unterscheidung der spezifischen textlichen Quellen der Hebräischen Bibel (Hiob 1–2 und Sacharja 3 für Satan; Genesis 3 für die Schlange / Luzifer; Jesaja 14 für das Helel ben Shahar, das durch die Vulgata-Übersetzung zu Luzifer wurde) und die Erkenntnis, dass die nachbiblische Synthese Quellen zusammenfallen ließ, die sich ursprünglich auf unterschiedliche Gestalten bezogen. Die etablierte Forschung über die Entwicklung der Widersacher-Gestalt — Henry Ansgar Kellys *Satan: A Biography*,{{ cite(id="kelly-satan-biography", text="[5]", title="Kelly, *Satan: A Biography* (2006) — der entwickelte kosmische Satan als nachbiblische Synthese") }} Neil Forsyths *The Old Enemy*,{{ cite(id="forsyth-the-old-enemy", text="[6]", title="Forsyth, *The Old Enemy: Satan and the Combat Myth* (1987)") }} Elaine Pagels' *The Origin of Satan*,{{ cite(id="pagels-origin-of-satan", text="[7]", title="Pagels, *The Origin of Satan* (1995)") }} und Jeffrey Burton Russells *Lucifer: The Devil in the Middle Ages*{{ cite(id="russell-lucifer-middle-ages", text="[8]", title="Russell, *Lucifer: The Devil in the Middle Ages* (1984)") }} — dokumentiert unabhängig, dass die entwickelte Gestalt des kosmischen Widersachers eine nachbiblische Konstruktion und kein einzelner zugrundeliegender Bezug der Hebräischen Bibel ist.
...
**John Milton**s *Paradise Lost* (1667) ist die einflussreichste einzelne nachbiblische literarische Auseinandersetzung mit Luzifer in der westlichen Tradition.{{ cite(id="paradise-lost", text="[9]", title="Milton, *Paradise Lost* (1667)") }} Miltons zwölfbändiges Epos in Blankversen erzählt die kosmische Erzählung von Luzifers Fall, der Versuchung in Eden und der Vertreibung der Menschheit aus dem Garten nach, mit erheblicher Ausarbeitung der kosmisch-politischen Dynamiken hinter den Ereignissen.
...
**Jean Sendy**s Auseinandersetzung mit Luzifer ist über sein Werk hinweg entwickelt, wobei die Gestalt in *Ces dieux qui firent le ciel et la terre* (1969) und in nachfolgenden Werken Behandlung erfährt.{{ cite(id="those-gods-who-made-heaven-and-earth", text="[14]", title="Sendy, *Ces dieux qui firent le ciel et la terre* (1969) — Luzifer als dissidenter Elohim über die Erziehung der Menschen") }} Sendy liest Luzifer als ein Mitglied der Elohim-Pluralität, das in Konflikt mit den Eden-Befehlshabern über die Frage der menschlichen Erziehung geriet, wobei die nachfolgende Rolle der Gestalt die des fortdauernden Lehrers der vorsintflutlichen menschlichen Zivilisation ist.
...
**Mauro Biglino**s Auseinandersetzung mit Luzifer ist in *The Naked Bible* (2022) und über seinen breiteren Korpus hinweg entwickelt.{{ cite(id="the-naked-bible", text="[15]", title="Biglino & Cattaneo, *The Naked Bible* (2022) — Luzifer als physisch verkörpertes Wesen") }} Biglino liest Luzifer als ein Mitglied der Elohim-Pluralität, dessen Rolle in der Eden-Episode und in der nachfolgenden biblischen Erzählung operativ statt kosmisch-allegorisch ist. Biglinos streng übersetzerische Methodik bringt spezifische Lesarten der einschlägigen hebräischen Passagen hervor — das *Helel ben Shahar* aus Jesaja 14, die verschiedenen Morgenstern-Bezüge, das breitere Material der Luzifer-Tradition —, die die zugrundeliegenden Gestalten durchgängig als physisch verkörperte Wesen statt als metaphysisch-kosmische Kategorien behandeln.

Die Überschneidungspunkte zwischen Biglinos Lesart und der Lesart des Korpus sind erheblich. Die Divergenzpunkte umfassen die Hypothese Kain-als-Schlangen-Abstammung (behandelt im Abschnitt zu modernen Neuinterpretationen des Eintrags zur [Serpent](../serpent/)), die der Korpus nicht übernimmt, die aber Biglinos breiteren interpretativen Rahmen erweitert. Speziell für Luzifer sind der Korpus und Biglino in der grundlegenden interpretativen Richtung weitgehend aufeinander abgestimmt.
...
Die Prometheus-Parallele ist der substantiellst ausgearbeitete vergleichende Fall für Luzifer. **Prometheus** ist ein Titan der griechischen Mythologie, dessen zentrale Erzählung — bewahrt in Hesiods *Theogonie* und *Werke und Tage* (ca. 700 v. Chr.){{ cite(id="theogony-works-and-days", text="[17]", title="Hesiod, *Theogonie* und *Werke und Tage* (ca. 700 v. Chr.) — der Feuerraub des Prometheus und das goldene Geschlecht") }} und in Aischylos' *Prometheus Bound* (ca. 5. Jahrhundert v. Chr.){{ cite(id="prometheus-bound", text="[18]", title="Aischylos, *Prometheus Bound* — Prometheus als zu Unrecht bestrafter Wohltäter der Menschheit") }} — direkte strukturelle Parallelen zur Luzifer-Laufbahn auf der Lesart des Rahmens hat.
