...
entry_type = "text"
claim_type = "direct"
alternative_names = ["*Shiʿur Qomah* (שִׁעוּר קוֹמָה)", "Sefer Haqqomah („Buch des [göttlichen] Körpers“)", "das Maß der Gestalt", "das Maß des Körpers", "Ma'amar Rabbi Yishmael"]
timeline = ["multi-age"]

[extra.infobox]
type = "Text des mystischen Hekhalot-/Merkava-Korpus; anthropomorphes „Maß des göttlichen Körpers“"
literal_meaning = "Hebräisch שִׁעוּר (*shiʿur*, „Maß, Menge“) + קוֹמָה (*qomah*, „Gestalt, Höhe“; im Aramäischen „Körper“): „das Maß der Gestalt“"
corpus = "Hekhalot-/Merkava-Literatur (vorkabbalistische jüdische Mystik)"
dating = "Umstritten: Scholem — 2. Jh. n. Chr.; Cohen — gaonäisch, 6.–7. Jh. n. Chr.; Schäfer — kein einzelner datierbarer „Text“ („der eine Text ist eine Illusion“)"
attributed_to = "Pseudepigraphisch den Tannaiten R. Ishmael und R. Akiva zugeschrieben, die eine Offenbarung des Engels Metatron berichten"
key_figure = "236 (Myriaden von Tausenden von) Parasangen — die Höhe des Schöpfers, per Gematrie aus Psalm 147:5 abgeleitet"
printed_in = "*Sefer Raziel ha-Mal'akh* (Amsterdam, 1701, fol. 37b); *Merkavah Shelemah* (Jerusalem, 1921); kritische Edition: M. S. Cohen (TSAJ 9, 1985)"
wheel_of_heaven_reading = "Die Parasangen-Angaben lesen sich als verstümmelte Aufzeichnung zweier realer astronomischer Distanzen, sobald man den *parasang* als Lichtsekunde auffasst"
+++
