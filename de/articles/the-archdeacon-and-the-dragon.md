...
footnotes = [
    ...
    { content = "Akhekh (auch transliteriert *akhekh*, *ꜣḫḫ*) ist eine spärlich bezeugte Gestalt, modernen Lesern vor allem durch die Kompilationen von E. A. Wallis Budge bekannt, die ein fabelhaftes, geflügeltes, greifenähnliches Wüstenwesen beschreiben, das mit Set verbunden ist. ‚Drache' ist eine faire viktorianische Wiedergabe dieser Beschreibung. Keine ägyptologische Quelle stellt Akhekh als einen Nationalgott Ägyptens dar, und der Name kommt nirgends in der Hebräischen Bibel vor." },
    { content = "Der ‚göttliche Rat' ist der eigene Begriff der etablierten Forschung für die Versammlung göttlicher Wesen, die die Hebräische Bibel wiederholt um ihren Gott herum in Szene setzt — Psalm 82 mit ‚El nimmt Stellung in der göttlichen Versammlung, inmitten der Elohim hält er Gericht', 1. Könige 22 mit den beratenden Geistern, Hiob 1 mit den *benei ha-Elohim*. Die ugaritischen Tafeln zeigen dieselbe Institution um El am Berg Ṣaphon. Michael Heiser, der Gelehrte, der am meisten dafür tat, diesen Bestand konservativen Lesern nahezubringen, war zugleich einer der energischsten Widerleger der Prä-Astronautik-Tradition — was seine Daten zum perfekten Kontrollfall macht: Die Vielheit steht bei jeder Lesart im Text; strittig ist allein der Bezug." },
    { content = "Bei Deuteronomium 32,8–9 sagt der masoretische Text, der Höchste habe die Völker ‚nach der Zahl der Söhne Israels' geteilt; das Qumran-Fragment 4QDeut(j) liest ‚Söhne der Elohim' und die Septuaginta ‚Engel Gottes'. Die meisten Gelehrten halten die Qumran-Lesart für ursprünglich: Die Völker wurden göttlichen Wesen zugeteilt, und ‚Yahwehs Anteil ist sein Volk, Jakob sein zugemessenes Erbe'. Der Vers ist tragend für Wallis, für den Kanon und für die etablierte Literatur zum göttlichen Rat gleichermaßen." },
    { content = "Der *neḥushtan* von Numeri 21,8–9: die bronzene Schlange, die Mose in der Wüste aufrichtet, damit die von Schlangen Gebissenen, die auf sie blicken, am Leben bleiben. 2. Könige 18,4 berichtet, dass Hiskia ‚die bronzene Schlange zerschlug, die Mose gemacht hatte, denn bis in jene Tage hatten ihr die Israeliten geopfert'. Ein befohlenes, jahrhundertelang verehrtes und dann als götzendienerisch zerstörtes Bild — sowohl Wallis als auch der Kanon lesen die Episode als ein Datum darüber, was der Kult einst enthielt." },
    { content = "Die sieben *apkallū* der mesopotamischen Tradition: Weise, die vor der Flut gesandt wurden, um die Menschheit die Künste der Zivilisation zu lehren, der erste von ihnen Oannes (Berossos), der aus dem Meer aufstieg und trug, was die Texte als eine Fischhaut beschreiben. Wallis liest sie als wohltätige Besucher in fischschuppigen Anzügen; sie sind das Gegenbild zu seinen Drachen." },
    { content = "Markion von Sinope (gest. um 160 n. Chr.) argumentierte, der Gott der Hebräischen Bibel und der von Jesus verkündete Vater seien zwei verschiedene Wesen, und baute den ersten christlichen Kanon auf dieser Unterscheidung auf. Die Kirche exkommunizierte ihn 144 n. Chr., und die Position gilt bis heute als die Lehrbuch-Häresie. Wallis rehabilitiert Markions *Unterscheidung*, behält aber — anders als Markion — die Hebräische Bibel als wesentliches Beweismaterial bei." }
]
+++

Ein Erzdiakon der Anglikanischen Kirche in Australien zerstörte sich das
...
überhaupt nicht mehr lesen konnte. *„Jedes Mal, wenn ich mich hinsetzte, um
...
nicht weiter. Du hast die Geschichte falsch verstanden!'"*

Paul Wallis hielt tatsächlich an. Das Buch, das er aus jenem
Schiffscontainer heraus schrieb, *Escaping from Eden* (2020), stellte seine
Frage bereits im Untertitel — *does Genesis teach that the human race was
created by God or engineered by ETs?* — und beantwortete sie deutlich genug,
...
*The Scars of Eden* (2021), *Echoes of Eden* (2022), *The Eden Conspiracy*
(2023), *The Invasion of Eden* (2024), *The Eden Enigma* (2025). Unterwegs
wurde er, gemeinsam mit dem italienischen Übersetzer
{% wiki(slug="biglino-method") %}Mauro Biglino{% end %}, zu einer der beiden
folgenreichsten lebenden Stimmen jener neu deutenden Tradition, die dieses
Projekt {% wiki(slug="neo-euhemerism") %}Neo-Euhemerismus{% end %} nennt —
die Lesart der Götter der antiken Erzählung als kulturelle Erinnerung an
reale, technologische Besucher.

Sechsundvierzig Jahre vor der Frisbee-Verletzung berichtete ein
französischer Motorsportjournalist namens Claude Vorilhon —
{% wiki(slug="rael") %}Raël{% end %} —, dass ihm die Bedeutung eben dieser
...
Truth*](/library/the-book-which-tells-the-truth/), ist das Fundament des
...
Wallis' Methode verdient es, vor seinen Schlussfolgerungen dargelegt zu
...
Klassiker wissenschaftlicher Geisteshaltung, angewandt auf die Schrift:

> Der Geschichte der wissenschaftlichen Entdeckung zufolge sollen Anomalien
...
> sie die Pforten zu einer anderen Welt sind.
>
> — *Escaping from Eden*, Kap. 1

Die Anomalien, die er aufzählt, sind jene, die jeder aufmerksame Leser halb
...
verdichtet, ist älter und fremder:

> Was würde geschehen, wenn wir endlich einräumten, dass elohim plurale
...
> und was Menschen sind und woher wir kommen, vollständig um.
>
> — *Escaping from Eden*, Kap. 1

Er wusste, was das Eingeständnis kosten würde, und die Bücher erzählen die
...
> Meine gesamte berufliche Glaubwürdigkeit als hochrangiger Geistlicher von
...
> Ruf war — wohin die Daten führten, dorthin musste ich folgen.
>
> — *The Eden Enigma*, Kap. 5

Die sechs Bücher haben eine lesbare Architektur. *Escaping from Eden*
leistet die Philologie. *The Scars of Eden* nimmt das Ergebnis mit auf eine
...
mit Amnesie". *Echoes of Eden* fragt, welche menschlichen Fähigkeiten
zusammen mit der Erinnerung unterdrückt wurden. *The Eden Conspiracy*
rekonstruiert, wer die Überlieferung redigierte, und wann, und warum. *The
Invasion of Eden* stellt die dunkelste Fassung der Frage — ob einige der
Besucher Ausbeuter waren, und ob das Arrangement je endete. *The Eden
Enigma* geht in der östlichen Türkei in die Tiefe, unter den urartäischen
...
Zeugnis, zur Redaktionsgeschichte, zur Feldarbeit.

## Der Plural, der nicht verschwinden wollte

Das Fundament von allem, was Wallis argumentiert, ist die Grammatik eines
einzigen Wortes. *Elohim* (<span class="hebrew">אֱלֹהִים</span>) trägt die
hebräische maskulin-plurale Endung *-im*, und Wallis' erster Schritt besteht
darin, die Konvention abzulehnen, die es überall dort als singulären „Gott"
liest, wo die Theologie es verlangt:

> Wenden wir uns der Etymologie zu, so ist die Grundbedeutung von elohim
...
Er geht gewissenhaft mit dem Gegenargument um — er zitiert Dom Henry
...
und 35,7 an *elohim* heften. Ist der Plural einmal eingeräumt, argumentiert
Wallis, so hört der hebräische Text auf, eine Polemik gegen die älteren
mesopotamischen Geschichten zu sein, und wird zu deren Zusammenfassung:

> In dem Augenblick, in dem wir elohim als Plural oder als Kollektivum neu
...
> tatsächlich, Geschichte um Geschichte.
>
> — *Escaping from Eden*, Kap. 2

Sein Beleg für das ganze Programm — er nennt ihn „the smoking gun" — ist die
Bundesversammlung zu Sichem, wo Josua den Stämmen die Wahl vorlegt: Legt die
*elohim* ab, denen eure Vorfahren jenseits des Stroms und in Ägypten
dienten, und dient Yahweh
({% libref(book="joshua", chapter=24, verse=14) %}Josua 24,14–15{% end %}).
Hier können *elohim* und Yahweh nicht derselbe Bezug sein; der Vers stellt
...
Geschichten in den Keilschrifttafeln erzählt werden".

Ein Leser dieses Projekts wird jedes Element davon wiedererkennen. Der Kanon
formulierte die plurale Lesart, als empfangene Erklärung und nicht als
Hypothese, bereits 1974 — *„Elohim ist im Hebräischen der Plural von Eloha"*
gehört zu seinen meistwiederholten Beobachtungen, und seine Glosse zum Wort
ist funktional statt etymologisch: *„Elohim, das bedeutet wörtlich «jene, die
vom Himmel kamen»"*
...
Lesarten{% end %} des Projekts trägt den ganzen Apparat. Was Wallis
hinzufügt, ist *Herkunft*: dieselbe Lesart, von innerhalb des Priesterseminars
...
göttliche Rat{{ footnote(id="8") }} — die Versammlung von Elohim in Psalm 82,
die Aufteilung der Völker unter die Söhne der Elohim in Deuteronomium
32,8–9{{ footnote(id="9") }} — ist Lehrbuchstoff. Die Vielheit steht bei
jeder Lesart im Text. Strittig ist allein, was die pluralen Wesen *waren*.

## Ein Drache namens Yahweh

Das Argument, zu dessen Prüfung dieser Artikel in Auftrag gegeben wurde,
tritt in *Echoes of Eden* auf und erreicht seine volle Stärke in *The Eden
Conspiracy*. Es beginnt, für Wallis charakteristisch, mit Jesus — genauer mit
...
speiste. Und dann fällt ihm die Sprache der alten Texte selbst ins Ohr:

> Es mag Sie überraschen zu erfahren, dass die Bibel tatsächlich voll ist von
...
> Kukulkan, Ququmatz und Quetzalcoatl aus Mesoamerika.
>
> — *Echoes of Eden*, Kap. 2

Was er in dieser Liste bemerkt hat, ist ein Klang. Kukulkan, Ququmatz,
...
wiederkehrendes *k-k*-Schlagen, das durch die Drachennamen unverwandter
Sprachen von Mesoamerika bis Japan läuft. Der Name YHWH{{ footnote(id="1") }}
mit seinen zwei fast stummen *h* scheint Welten entfernt, und hier greift
Wallis zur historischen Phonologie. Laute erweichen mit der Zeit; harte
Verschlusslaute lenieren zu Reibelauten{{ footnote(id="3") }}; und in der
älteren semitischen Lautwelt, argumentiert er, war das *h* kein Flüstern:

> Dieser Vorgang der Lauterweichung heißt Affrikation. Dasselbe ist mit dem
...
> ist der hebräische Name.
>
> — *Echoes of Eden*, Kap. 2

*The Eden Conspiracy* baut das Argument mit mehr Gerüst neu auf. Dort ist die
...
Schluss ist, dass der Name ein Lehnwort{{ footnote(id="2") }} ist — und dann
etwas Selteneres als ein Lehnwort:
...
Die Möglichkeit ist die Onomatopöie: das *ch-ch* als „ein Echo des scharfen
...
> Mit all seiner rhetorischen Kraft ruft Josua die versammelte Menge auf,
...
> zu wählen, ob es ACH ECH von Ägypten oder yACHwECH von Israel dienen wird.
>
> Haben Sie das gesehen? Die Ähnlichkeit der beiden Namen ist frappierend.
...
> Ägypten (wie er heute geschrieben wird) war ein Drache.
>
> — *The Eden Conspiracy*, Kap. 6

Von dort aus breitet sich die Identifikation durch den Kanon der Yahweh-Texte
aus. Die Seraphim werden zu „fliegenden Schlangen, bekannt für ihr Feuer".
Die bronzene Schlange{{ footnote(id="10") }}, die Mose auf Yahwehs Befehl
...
Yahwehs *ap* — Nüstern, Schnauze — und das Feuer aus seinem Mund in Psalm 18
...
Menschen fordern, und neben die Satire *Bel und der Drache* der Septuaginta,
...
siebten Kapitel von *The Eden Conspiracy* hat Wallis für den vorreformerischen
...
tatsächlich einen velaren Reibelaut — den deutschen *ach*-Laut, den Wallis
anführt — neben einem pharyngalen und einem einfachen glottalen
*h*.{{ footnote(id="4") }} Aber das Hebräische ordnete jene drei Laute zwei
Buchstaben zu und führte die Buchhaltung genau: Der velare und der pharyngale
verschmolzen zu *ḥet* (ח); das glottale *h* blieb *he* (ה). Der Name יהוה
wird mit *he* geschrieben, zweimal. Ein hebräischer Name, dessen ältere Form
den *ach*-Laut getragen hätte, würde mit *ḥet* geschrieben — wie
...
früheren *k-k* aus einem späteren *h-h* positive Belege verlangt — ältere
Schreibungen, Kognaten in verwandten Sprachen —, und keiner wird geboten. Die
Vergleichsfälle haben ihre eigenen Schwierigkeiten: Die *k-k*-Drachenliste
...
Normalfall als ein Signal ist; und Akhekh selbst{{ footnote(id="7") }} ist im
...
funktionierende Ableitung von YHWH aus dem Verb „sein"{{ footnote(id="5") }}
und eine Spur harter Belege — die Schasu von YHW in ägyptischen Listen des
14. Jahrhunderts v. Chr.{{ footnote(id="6") }} —, die genau auf die Region,
Midian, weist, wo Wallis' eigene Nacherzählung das erste Auftreten des Namens
ansiedelt. Es ist eine echte Kuriosität von *The Eden Conspiracy*, dass er
vor der Tür der midianitischen Hypothese steht, ihre Kulisse beschreibt und an
ihr vorbeigeht.

Die Etymologie scheitert also. Was nicht scheitert — und dies ist der Grund,
...
Phonologie, so sagt Wallis' Josua-24-Argument dies: *Yahweh wird vom Text als
dieselbe Art von Entität dargestellt wie die anderen regionalen Mächte,
unterschieden durch Zuständigkeit statt durch Art.* Diese Behauptung steht
ganz unabhängig von Akhekh auf eigenen Beinen:

> Die New Jerusalem Bible legt nahe, dass uns von einer regionalen Macht
...
> musste in die Schlacht mit dem Mächtigen von Persien ziehen."
>
...
({% libref(book="2-kings", chapter=1, verse=3) %}2. Könige 1{% end %});
...
betrieblichen Detailpunkt, für den die Theologie nie eine Verwendung hatte.

**Das Verbot als Politik.** Für Wallis ist das Verbot des Baumes der
...
ein bestimmter Befehl mit bestimmtem Geltungsbereich:

{% library(book="the-book-which-tells-the-truth", chapter=2, verse=30) %}
Das heißt: Ihr dürft alles lernen, was ihr wollt, alle Bücher lesen, die wir
hier zu eurer Verfügung haben, aber rührt die wissenschaftlichen Bücher nicht
an, oder ihr werdet sterben.
{% end %}

**Die Schlange als abtrünnige Macher.** Dies ist die tiefste der
...
Unter all den Wissenschaftlern dieses Teams wollten einige wenige, die ihre
...
Die „Schlange" — jene kleine Gruppe von Schöpfern, die Adam und Eva die
...
Schöpfer ihre Experimente einstellen und die Erde verlassen mussten.
{% end %}

In *The Invasion of Eden* greift Wallis zu einer chinesischen Geschichte, um
...
Laufbahn der {% wiki(slug="lucifer") %}Luzifer{% end %}-Fraktion — der
{% wiki(slug="serpent") %}Schlange{% end %} von Genesis 3 —, wie der Korpus
sie seit fünfzig Jahren artikuliert.

**Die Flut als Ratsbeschluss, mit einem abweichenden Wohltäter.** Wallis:
...
Fluthelden gegen Enlils Erlass warnt. Der Kanon:

{% library(book="the-book-which-tells-the-truth", chapter=2, verse=58) %}
Also beschlossen sie, von ihrem fernen Planeten aus, alles Leben auf der Erde
...
**Babel als die Zerstörung einer raumfahrenden Zivilisation.** Wallis liest
*bab-el* als „Tor für die Mächtigen", verweist auf die dreihundert
...
{% wiki(slug="tower-of-babel") %}Babel{% end %}-Ereignis als die Zerstreuung
...
**Der Rat der Fraktionen.** Wallis' spätere Bücher setzen das *El-Ba'adat*
der Bibel zusammen — in seiner Wiedergabe „der Rat der Macht" — und lesen die
Politik in seinem Innern:
...
> mit weniger Mitgefühl für die Menschheit, die nichts von alldem wollten.
>
...
und {% wiki(slug="yahweh") %}Yahweh{% end %}, der zwischen ihnen präsidiert.
Es ist erwähnenswert, dass der eigene Satan-Eintrag des Korpus *The Eden
Conspiracy* bereits „substanzielle Inhalte zur Satan-Luzifer-Entflechtung"
...
**Die Redaktion.** Wallis' *Eden Conspiracy* rekonstruiert eine
...
{% wiki(slug="plurality-of-gods") %}Vielheit der Götter{% end %} dargelegt
...
Yahweh ist ausdrücklich kein Ungeheuer; er ist ein Mensch — *„Wir sind
...
Wirkliche Drachen existieren im Kanon, aber als *Schöpfungen*: der
...
Aber andere Wissenschaftlerteams schufen schauerliche Tiere, Ungeheuer, die
...
Dinosaurier oder Brontosaurier und so weiter genannt habt.
{% end %}

— während die *figurative* Schlangen- und Drachensprache der Bibel sich, in
der Lesart des Kanons, an die verbannte Luzifer-Fraktion heftet. Die Einträge
zu {% wiki(slug="dragons") %}Drachen{% end %} und
{% wiki(slug="serpent") %}Schlange{% end %} des Korpus ordnen die
Schlangenüberlieferung der Welt in zwei Gruppen — Chaos-Schlangen (Tiamat,
Apophis, {% wiki(slug="leviathan") %}Leviathan{% end %}), die die Erinnerung
...
Am schärfsten lässt sich die Divergenz an einem Vers sehen, den beide
...
versprach, das Werk zu vollenden —

{% library(book="the-book-which-tells-the-truth", chapter=3, verse=271) %}
Um von den Menschen nicht gestört zu werden, hatten die Schöpfer Stützpunkte
...
Schöpfer versteckten sich unter den Ozeanen.
{% end %}

Beide Rahmen lesen die Drachensprache als Verweis auf reale Akteure der
...
Wendung, die es zu bewahren lohnt: In *Echoes of Eden* sind Wallis'
Schlangengestalten die *Herabstufer* der Menschheit — Ququmatz, der den
ersten Menschen die Sicht trübt —, während die wohltätigen Lehrer als Fische
verkleidet eintreffen, die apkallū{{ footnote(id="11") }} der mesopotamischen
Erinnerung. Im Kanon *sind* die Schlangen-Fraktion die Lehrer. Dasselbe
...
der Korpus unter {% wiki(slug="theomachy") %}Theomachie{% end %} behandelt.

**Was Jesus zu tun kam.** Für Wallis inszenieren die Evangelien eine
...
Markions{{ footnote(id="12") }} — der Offenbarer eines Vaters, der nicht das
...
diesen Unterschied; er ist die tiefste Weggabelung.

**Was über den Elohim bleibt.** Wallis bleibt Theist — ein christlicher
...
Elohim findet er mehr elohim-artige Endlichkeit den ganzen Weg hinauf — [das
...
es keine Spitze gibt. Beide Rahmen sind sich einig, dass Yahweh *als* das
...
**Invasion oder Projekt.** Die spätere Eden Series verdüstert sich. *The
Invasion of Eden* liest große Teile der Überlieferung durch Robert Kirks
...
zutiefst liebten"; seine {% wiki(slug="great-flood") %}Flut{% end %} ist [ein
Reset, keine Strafe](/articles/the-flood-was-a-reset-not-a-punishment/); sein
Ende ist keine Besatzung, der zu widerstehen wäre, sondern eine
{% wiki(slug="great-return") %}Rückkehr{% end %}, die willkommen zu heißen
ist, mit einer {% wiki(slug="embassy") %}Botschaft{% end %}, die dafür zu
...
sein Akhekh-Argument ist, gerade *weil* seine Phonologie scheitert, während
...
durch die der Dingir eines Tages zurückzukehren erwartet wurde:

> Unsere Vorfahren waren die Erinnernden. Wir sind diejenigen, die
...
- Die Einträge {% wiki(slug="serpent") %}Schlange{% end %},
  {% wiki(slug="lucifer") %}Luzifer{% end %},
  {% wiki(slug="satan") %}Satan{% end %} und
  {% wiki(slug="yahweh") %}Yahweh{% end %}, für die vierteilige politische
  Figurentaxonomie, mit der dieser Artikel Wallis' Ensemble vergleicht.
- Der Eintrag {% wiki(slug="theomachy") %}Theomachie{% end %}, für den Krieg,
  dessen Drachenverse beide Lesarten beanspruchen.
- Die Einträge {% wiki(slug="biglino-method") %}Biglino-Methode{% end %} und
  {% wiki(slug="neo-euhemerism") %}Neo-Euhemerismus{% end %}, für die
  Tradition, die Wallis in die anglophone Welt ausdehnt.
- [*The Book Which Tells the
  Truth*](/library/the-book-which-tells-the-truth/), Kapitel 2 und 3, für die
  durchgehend zitierten Kanon-Passagen.
