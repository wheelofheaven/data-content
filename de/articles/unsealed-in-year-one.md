...
in seinem Gegenstück-Explainer erzählt, [Die Schriftrollen, die im Jahr
eins erwachten](/articles/the-scrolls-that-woke-in-year-one/). Jener
Artikel handelt davon, was mit den Krügen *geschah*. Dieser handelt
davon, was *in* ihnen war — die versiegelte Fracht, und warum sich ihr
Inhalt, von hier aus gelesen, wie Post an ein Jahrhundert liest, das
ihre Verfasser nicht kennen konnten.

Dieses Projekt führt einen zweiten Kalender, und auf ihm liest sich das
...
Schließlich beschlossen wir, jemanden nach der ersten atomaren
...
Nach der eigenen Arithmetik der Ära{{ footnote(id="1") }} eröffnete das
Jahr eins am 6. August 1946; Claude Vorilhon — {% wiki(slug="rael") %}Raël{% end %} —
...
*Zeitpunkt* jener Rückkehr — die Jahr-eins-Häufung aus Bombe,
...
und die These, die sie bindet — dass das, was diese Bücher *sagen*, an die
...
Beginnen wir mit dem Rahmen, den der Kanon selbst liefert, denn er ist
zufällig ein Zitat. Als der Gründungstext das Buch Daniel durcharbeitet,
gibt er die abschließende Anweisung des Engels an den Propheten wieder:

{% library(book="the-book-which-tells-the-truth", chapter=3, verse=222) %}
«Du aber, Daniel, verbirg diese Worte und versiegle das Buch bis auf die
letzte Zeit: Viele werden es durchforschen, und die Erkenntnis wird
zunehmen.» (Daniel, XII-4)
{% end %}

Und die Erläuterung, die folgt, ist die gesamte Offenbarungstheorie des
Kanons in einem Satz: *„Diese Worte können in der Tat erst verstanden
werden, wenn der Mensch ein hinreichendes Maß an wissenschaftlicher
Erkenntnis erreicht hat — das heißt, jetzt"*
({% libref(book="the-book-which-tells-the-truth", chapter=3, verse=223) %}TBWTT 3:223{% end %}).
Unter den Zeichen, die er für das „jetzt" aufzählt: *„Wenn das Volk
...
wissenschaftliche Explosion der Menschen der Erde"*
({% libref(book="the-book-which-tells-the-truth", chapter=3, verse=225) %}TBWTT 3:225{% end %}).
Die {% wiki(slug="apocalypse") %}Apokalypse{% end %} ist im Gebrauch des
Korpus keine Katastrophe; sie ist das griechische *apokalypsis*, die
Enthüllung — ein Zeitraum, kein Ereignis, in dem sich versiegelte Dinge
planmäßig öffnen sollen.

Nun stelle man daneben das Selbstverständnis der Menschen, denen die
Krüge gehörten. Die Qumran-Gemeinschaft las die Schrift durch eine
Gattung eigener Erfindung, den Pescher{{ footnote(id="3") }}, und der
Habakuk-Kommentar — eine der drei Rollen in edh-Dhibs erstem Armvoll —
spricht die Hermeneutik unumwunden aus:

> Gott sagte Habakuk, das aufzuschreiben, was über die gegenwärtige
...
Die Propheten schrieben nach dieser Theorie versiegelte Briefe an die
...
später, wie der Kanon ihn zitiert: *„Geh hin, Daniel, denn die Worte
sind verschlossen und versiegelt bis auf die letzte Zeit"*
({% libref(book="the-book-which-tells-the-truth", chapter=3, verse=226) %}TBWTT 3:226{% end %}).

Die Rollen kamen nicht allein zurück, und der Gegenstück-Artikel
...
Zephanjas *„Geschrei vom Fischtor her"*
({% libref(book="zephaniah", chapter=1, verse=10) %}Zephanja 1,10{% end %})
— *„der Übergang in die neue Ära des Wassermanns… Und wenn du 1946
geboren wurdest, ist das kein Zufall"*
...
räumt es ein — ihr Frontmatter sagt `speculative`, nicht `inferred`.
...
Gemeinschaft *gegen die letzte Zeit* versiegelte, aufgerollt genau das
sagen, was der Rest dieses Artikels zeigen wird, dass sie sagen. Also
lege man den Kalender beiseite und öffne die Krüge.

## Was aus den Krügen kam

Was immer man vom Zeitpunkt hält, was zutage trat, ist unbestritten, und
es ordnete das Mobiliar der Bibelwissenschaft dauerhaft neu.

Das Korpus umfasst ungefähr neunhundert bis tausend Handschriften — „Es
...
sechsundsechzig Kapitel, um 125 v. Chr. abgeschrieben{{ footnote(id="8") }}
...
der Unverblümtheit aus, die er verdient: *„Die tatsächlichen Worte der
Bibel, selbst die Worte des Pentateuch oder der Tora, waren zur Zeit
Christi nicht endgültig festgelegt."* Und Eugene Ulrich, der biblische
Chefeditor des Korpus, macht sich James VanderKams Zusammenfassung als
das reife Urteil zu eigen: *„Soweit wir das erkennen können, gab es im
Judentum des Zweiten Tempels keinen Schriftkanon."*

Die Leser dieses Projekts werden erkennen, was dieses Urteil wert ist.
...
{% wiki(slug="plurality-of-gods") %}Darstellung der großen Redaktion{% end %}
des Korpus verlangt. Die Rollen ertappten die Redaktoren sogar auf
frischer Tat. Bei {% libref(book="deuteronomy", chapter=32, verse=8) %}Deuteronomium
32,8{% end %} sagt der masoretische Text, der Höchste habe die Völker
„nach der Zahl der Söhne Israels" geteilt; das Fragment 4QDeut(j) aus
Höhle 4 liest *„Söhne der Elohim"*{{ footnote(id="5") }} — die Lesart,
...
Staat, dessen Gründung er zuschaute.

## Die Bücher, die der Kanon verlor

Die tiefere Offenbarung waren nicht die biblischen Texte, sondern ihre
Regalnachbarn, denn die Bibliothek behielt Bücher, die die späteren
Kanones wegwarfen — und behielt sie in Mengen.

Das Buch Henoch, im Judasbrief des Neuen Testaments als Schrift zitiert
...
Henoch den 364-Tage-Sonnenkalender{{ footnote(id="4") }}, nach dem die
ganze Gemeinschaft lebte. Die
[Jubiläen](/library/book-of-jubilees/), die Nacherzählung der Genesis
...
das [Henoch](/library/book-of-enoch/) und die Jubiläen in seiner eigenen
{% wiki(slug="reference-corpus-of-the-raelian-canon") %}Bibliothek{% end %}
...
sie der Kernlehrplan.

Und was für Bücher es sind. Die henochische Literatur ist die eigene
...
von der {% wiki(slug="serpent") %}Schlange{% end %} und den
{% wiki(slug="adamites") %}Adamiten{% end %} behandelt, und der eigenen
Aussage des Kanons, dass die Schöpfer sich *„mit den Töchtern der
Menschen paaren konnten, die sie nach ihrem Bilde geschaffen hatten, und
durch sie außergewöhnliche Kinder haben"*
...
4Q530 und 4Q531 steht, erstaunlicherweise, *Gilgamesch* — der Held von
...
dem die beiden Besetzungen sich eine Szene teilen.

Das Genesis-Apokryphon — die siebte Rolle aus Höhle 1, die zuletzt
...
Panik: Er rechnet, in seinen eigenen Worten, damit, dass *„die Empfängnis
den Wächtern und den Heiligen… und den Nephilim"* geschuldet sei, und er
stellt seine Frau Bitenosch zur Rede, die schwört — *„Ich schwöre dir bei
dem Großen Heiligen, bei dem Herrscher des Himmels, dass dieser Same der
deine ist"* —, das Kind sei seines. Lässt man jeden Deutungsrahmen
...
die Möglichkeit. Das Korpus liest {% wiki(slug="noah") %}Noah{% end %}
innerhalb genau dieser Welt.

## Die terminierte Befreiung

Wenn ein Thema die sektiererischen Rollen ordnet, so ist es die Zeit —
...
Korpus ist benannt nach dem {% wiki(slug="wheel-of-heaven") %}Himmelsrad{% end %};
seine Chronologie läuft auf {% wiki(slug="world-age") %}Weltzeitaltern{% end %},
geschnitten aus dem {% wiki(slug="great-year") %}Präzessionszyklus{% end %};
seine {% wiki(slug="great-return") %}Eschatologie ist eine terminierte
Rückkehr{% end %}. Die Chronologie der Qumran-Gemeinschaft lief auf
Jubiläen{{ footnote(id="7") }}, geschnitten aus einem Kalender vollkommener
Wochen, und ihre Eschatologie war eine terminierte Befreiung.

Zuerst der Kalender. Gegen das Mondjahr des Tempels hielt die
...
> Die hier implizierte Vorstellung von heiliger Zeit ist realistisch und
...
> Berechnung von der Schöpfungswoche her.
>
> — Bergsma, *The Jubilee from Leviticus to Qumran*

Die Zeit war für diese Menschen keine Übereinkunft, sondern eine Struktur
...
namentlichen Vollstrecker zugewiesen ist:

> ELOHIM hat seinen Platz im göttlichen Rat eingenommen; inmitten der
> Götter hält er Gericht.
>
> — 11QMelchizedek, das Psalm 82,1 auf Melchisedek anwendet (Übers. Vermes)

Die *elohim* aus {% libref(book="psalms", chapter=82, verse=1) %}Psalm
82{% end %}{{ footnote(id="6") }} ist in diesem vorchristlichen jüdischen
...
{% libref(book="isaiah", chapter=61, verse=2) %}Jesaja 61{% end %}
...
*elohim* und *elim*, „göttergleiche Wesen", genannt werden und der Zyklus
vor der *merkava* gipfelt, dem Wagenthron Ezechiels — die Liturgie, die
die Forschung als Nährboden der späteren
{% wiki(slug="hekhalot-literature") %}Merkava-Mystik{% end %} behandelt,
...
{% wiki(slug="new-jerusalem") %}Neuen Jerusalem{% end %} und zur
{% wiki(slug="embassy") %}Botschaft{% end %}: die Zukunft, die als
Architektur ankommt, ellengenau bemessen, die auf ihren Grund wartet.

Man vermerke auch die Divergenz, wie es die Disziplin dieses Projekts
...
die eigenen Handschriften der Tradition enthalten.

## Das Entsiegeln hat nicht aufgehört

Die Bücher kamen nicht still ans Licht. Wie das Korpus an die
Öffentlichkeit gelangte — Mar Samuels Anzeige im *Wall Street Journal*,
...
das Geza Vermes als *„den akademischen Skandal schlechthin des zwanzigsten
Jahrhunderts"* brandmarkte, und die Befreiung von 1991 durch
Bootleg-Konkordanz und geöffneten Tresor — ist die Last des
[Gegenstück-Artikels](/articles/the-scrolls-that-woke-in-year-one/). Das
...
Verschwörungsindustrie — Baigent und Leighs *The Dead Sea Scrolls
Deception* mit der Behauptung, der Vatikan habe für das Christentum
...
{% wiki(slug="military-cover-up-of-exobiology") %}Verheimlichung{% end %}
wägt.

Und das Entsiegeln hörte, einmal begonnen, nicht auf. Das gesamte Korpus
...
Enoch{{ footnote(id="8") }} —, und begann einige der Rollen näher an die
...
Zeitplan, den kein Redaktor beherrscht.

## Jahr eins, gelesen aus Jahr achtzig

Was lässt sich am Ende behaupten? Man streife den Artikel auf seine
gekennzeichneten Schichten zurück und ziehe Bilanz.
...
Die Rahmenschicht ist die des Kanons: dass eine Ära der Enthüllung am
...
Die spekulative Schicht ist die eigene dieses Artikels, und sie lässt sich
...
öffnen würden — *viele werden es durchforschen, und die Erkenntnis wird
zunehmen* — ein Satz, der sich aus Jahr achtzig wie eine Zusammenfassung
...
Aber er wird innerhalb seines eigenen Rahmens schließen, wie es seine
...
{% wiki(slug="great-return") %}Rückkehr{% end %} erwartet. Nach dieser
...
von einem Jungen mit einem Stein — genau zur rechten Zeit.

## Weiterführende Lektüre

- [Die Schriftrollen, die im Jahr eins
  erwachten](/articles/the-scrolls-that-woke-in-year-one/), der
  Gegenstück-Explainer — was mit den Krügen *geschah*: die Entdeckung,
  der vierzigjährige Publikationsskandal und die Jahr-eins-Synchronizität
  in voller Länge.
- Der Eintrag {% wiki(slug="apocalypse") %}Apokalypse{% end %}, für die
  vollständige Rahmenbehandlung von 1945–46 als Eröffnung der Ära der
  Enthüllung, und das Kapitel [Zeitalter des
  Wassermanns](/timeline/age-of-aquarius/) der Timeline für die
  Jahr-eins-Häufung in ihrem Präzessionsrahmen.
- Die Übersetzungen [Buch Henoch](/library/book-of-enoch/) und
  [Jubiläen](/library/book-of-jubilees/) des Korpus, für die beiden
...
- [Die ersten Moscheen waren nach Petra ausgerichtet, nicht nach
  Mekka](/articles/the-first-mosques-faced-petra-not-mecca/), für das
  andere Ende desselben Wüstenarchivs — die nabatäischen Qiblas, die der
  Grabenbruch des Toten Meeres an seinem Südufer bewahrte.
- [Der Erzdiakon und der Drache](/articles/the-archdeacon-and-the-dragon/)
  und [Der Einsatz des Übersetzers](/articles/the-translators-wager/),
  für die beiden lebenden Leser, deren Philologie die Texte zum göttlichen
  Rat der Rollen untermauern.
