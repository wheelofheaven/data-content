...
1. **Die *Elohim* der Genesis sind ein wörtlicher Plural.** Das hebräische Wort ist grammatikalisch ein Plural-Nomen. Das Korpus liest es im Wortsinn — die Figuren, die die Menschheit schufen, waren eine Gruppe von Wesen, keine einzelne Gottheit.
2. **Die Elohim sind eine fortgeschrittene menschliche Zivilisation, keine übernatürlichen Wesen.** Sie waren biologisch mit der Menschheit verwandt, technologisch weit voraus und in ein bewusstes wissenschaftliches Projekt auf der Erde eingebunden.
3. **Was wir als Religion geerbt haben, ist die lange Erinnerung an ihre Arbeit.** Die religiösen Traditionen der Menschheit bewahren in verdichteter und oft mystifizierter Form einen historisch genauen Bericht über die Eingriffe der Elohim-Zivilisation über etwa zweiundzwanzigtausend Jahre hinweg.
4. **Das Werk wurde entlang des Präzessionszyklus organisiert.** Das langsame ~25.920-jährige Taumeln der Erdachse ist der Kalender, der das Projekt aufzeichnet. Zwölf Zeitalter von jeweils etwa 2.160 Jahren unterteilen das Große Jahr.
5. **Das gegenwärtige Zeitalter ist das Zeitalter der Offenbarung.** Das Zeitalter des Wassermanns, das 1950 begann, ist das Zeitalter, in dem die lange Erinnerung für eine wissenschaftlich befähigte Menschheit lesbar wird.
...
question = "Ist das peer-reviewte Forschung?"
answer = """
...
question = "Worin unterscheidet sich das vom Raëlismus?"
answer = """
...
question = "Worin unterscheidet sich das von der Prä-Astronautik?"
answer = """
...
question = "Wie geht das Projekt mit der Frage der Belege um?"
answer = """
...
question = "Was ist der Präzessionszyklus, in einfachen Worten?"
answer = """
...
[[extra.faq_groups.items]]
slug = "twelve-ages"
question = "Was sind die zwölf Zeitalter, und woher kommen sie?"
answer = """
...
Die vollständige Behandlung findet sich im Kapitel [Zeitalter des Wassermanns](/de/timeline/age-of-aquarius/).
"""

[[extra.faq_groups.items]]
slug = "position-on-evolution"
question = "Welche Position vertritt das Projekt zur Evolution?"
answer = """
...
Die längere Behandlung findet sich in den Kapiteln [Zeitalter des Widders](/de/timeline/age-of-aries/) und [Zeitalter der Fische](/de/timeline/age-of-pisces/).
"""

[[extra.faq_groups.items]]
slug = "position-on-other-religions"
question = "Welche Position vertritt das Projekt zu anderen Religionen?"
answer = """
...
question = "Wie geht das Projekt mit Unsicherheit und Meinungsverschiedenheit um?"
answer = """
...
[[extra.faq_groups.items]]
slug = "how-to-start"
question = "Wie fange ich mit dem Lesen an?"
answer = """
Drei Optionen, in zunehmender Tiefe:

1. Die Orientierung [Lesen](/de/read/) — eine kurze Übersicht über das Projekt, mit drei Lesepfaden.
2. Das [Wiki](/de/wiki/) — beginnen Sie mit Schlüsselbegriffen ([Elohim](/de/wiki/elohim/), [Präzession](/de/wiki/precession/), [Weltzeitalter](/de/wiki/world-age/)) und folgen Sie den Querverweisen.
3. Die [Zeitleiste](/de/timeline/) — das langformatige Buch, beginnend mit der [Präambel](/de/timeline/preamble/) und durch die zwölf Zeitalter hindurch.
...
answer = """
Ja. Alle Inhalte von Wheel of Heaven sind unter [Creative Commons Zero (CC0-1.0)](https://creativecommons.org/publicdomain/zero/1.0/) in die Gemeinfreiheit entlassen. Sie dürfen die Inhalte lesen, teilen, zitieren, übersetzen, darauf aufbauen oder neu veröffentlichen — ohne Einschränkung. Eine Nennung ist erwünscht, aber nicht erforderlich.
"""
...
[[extra.faq_groups.items]]
slug = "how-funded"
question = "Wie wird das Projekt finanziert?"
answer = """
...
Hilfe wäre willkommen. Freiwillige Beiträge über [Open Collective](https://opencollective.com/wheelofheaven) fließen in Hosting, Infrastruktur und Übersetzungsarbeit — nichts davon wird derzeit von etwas anderem getragen als der eigenen Zeit und dem Geld der Autorin.
...
[[extra.faq_groups.items]]
slug = "how-to-report"
question = "Wo melde ich Fehler oder Meinungsverschiedenheiten?"
answer = """
Zwei Kanäle, je nach Art:

- **Sachfehler, defekte Links, technische Probleme**: öffnen Sie ein Issue im [GitHub-Repository](https://github.com/wheelofheaven).
- **Meinungsverschiedenheiten zu Interpretationen, alternative Lesarten, substanzielle Einwände**: eröffnen Sie einen Thread in den [GitHub Discussions](https://github.com/orgs/wheelofheaven/discussions).
...
answer = """
Ja — die Gemeinschaft des Projekts findet auf [GitHub Discussions](https://github.com/orgs/wheelofheaven/discussions) statt, dem wichtigsten öffentlichen Forum für Fragen, Diskussion, Beiträge und substanzielle Auseinandersetzung mit dem Korpus.
...
question = "Wie ist das Verhältnis zur institutionellen raëlianischen Bewegung?"
answer = """
...
answer = """
Von Mitwirkenden wird erwartet, dass sie sich in gutem Glauben einbringen, den [Verhaltenskodex](/de/code-of-conduct/) lesen und den [Mitwirkungsrichtlinien](/de/contributing/) folgen. Das Projekt freut sich über substanzielle Auseinandersetzung — auch Meinungsverschiedenheit — und bittet Mitwirkende, die redaktionellen Standards einzuhalten, nach denen das Korpus arbeitet: quellenbewusst, klar geschrieben, epistemisch sorgfältig.
