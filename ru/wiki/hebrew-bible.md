...
- **Тетраграмматон как личное обозначение президента Совета** (рассматривается главным образом в статьях {% wiki(slug="yahweh") %}Яхве{% end %} и Тетраграмматон)
...
Еврейская Библия действует как контекст текстовой традиции для различных иных статей о текстах, когда они будут написаны: Тетраграмматон, различные последующие эллинистико-иудейские и христианско-традиционные текстовые сущности, различные исламско-традиционные текстовые сущности.
