...
description = "Терраформирование — совокупность методов преобразования биосферы планеты с целью сделать её обитаемой. Корпус Wheel of Heaven прочитывает его как одну из ключевых компетенций, мобилизуемых Элохимами при предварительном обустройстве Земли."
