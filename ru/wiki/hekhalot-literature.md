+++
title = "Литература Hekhalot"
slug = "hekhalot-literature"
description = "Литература Hekhalot (ивр. הֵיכָלוֹת, 'дворцы') — свод позднеантичных еврейских мистических сочинений, описывающих восхождение души через семь небесных дворцов к божественному престолу-колеснице (merkavah). Это докаббалистический пласт еврейской мистики и корпус, в котором передаётся Shi'ur Qomah."
...
entry_type = "text"
claim_type = "direct"
alternative_names = ["литература Hekhalot / Heikhalot (הֵיכָלוֹת)", "мистика Merkavah", "мистика Merkabah", "литература 'дворцов'", "*ma'aseh merkavah* ('деяние колесницы')"]
timeline = ["multi-age"]

[extra.infobox]
type = "Корпус позднеантичных / раннесредневековых еврейских мистических текстов (докаббалистический)"
literal_meaning = "ивр. הֵיכָלוֹת (*hekhalot*), мн. ч. от הֵיכָל (*hekhal*), 'дворец' или 'чертог' — семь небесных дворцов восхождения"
also_called = "Мистика Merkavah (колесницы), по престольному видению Ezekiel (*ma'aseh merkavah*, 'деяние колесницы')"
principal_works = "*Hekhalot Rabbati* ('Большие дворцы'), *Hekhalot Zutarti* ('Малые дворцы'), *Ma'aseh Merkavah*, *Merkavah Rabbah*, *3 Enoch* (еврейская Книга Enoch); *Shi'ur Qomah* включён в корпус"
practitioner = "*yored merkavah* ('нисходящий к колеснице'), который восходит через дворцы, вооружённый гимнами, ангельскими именами и печатями"
dating = "Спорна: составление / редактура примерно между III и VIII вв. н. э. (Scholem — раньше, Schäfer — позже, гаонско-вавилонская)"
key_figure = "Ангел Metatron — 'Князь Лика', небесный писец и (в *3 Enoch*) преображённый патриарх Enoch"
+++
