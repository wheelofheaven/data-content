+++
title = "Генетическая инженерия"
description = "Генетическая инженерия — совокупность методов целенаправленного изменения генетического материала организма. Корпус Wheel of Heaven прочитывает её одновременно как путь синтеза, принятый Элохимами для создания земной жизни, и как технологический горизонт, к которому в свою очередь сходится человечество."
