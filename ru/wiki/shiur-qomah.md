...
title = "Shi'ur Qomah"
slug = "shiur-qomah"
description = "Shi'ur Qomah (ивр. שִׁעוּר קוֹמָה, 'мера стана') — текст докаббалистической литературы Hekhalot / Merkavah, в котором ангел Metatron диктует космические размеры божественного тела, часть за частью, причём каждая измеряется в parasang и наделяется тайным именем. Это тот самый текст, что стоит за числами в parasang, которые раэлианский канон приписывает 'Каббале'."
...
entry_type = "text"
claim_type = "direct"
alternative_names = ["*Shiʿur Qomah* (שִׁעוּר קוֹמָה)", "Sefer Haqqomah ('Книга [божественного] тела')", "Мера стана", "Мера тела", "Ma'amar Rabbi Yishmael"]
timeline = ["multi-age"]

[extra.infobox]
type = "Текст мистического корпуса Hekhalot / Merkavah; антропоморфная 'мера божественного тела'"
literal_meaning = "ивр. שִׁעוּר (*shiʿur*, 'мера, количество') + קוֹמָה (*qomah*, 'стан, высота'; в арамейском 'тело'): 'мера стана'"
corpus = "литература Hekhalot / Merkavah (докаббалистическая еврейская мистика)"
dating = "Спорна: Scholem — II в. н. э.; Cohen — гаонский период, VI–VII вв. н. э.; Schäfer — единого датируемого 'текста' нет ('единый текст — это иллюзия')"
attributed_to = "Псевдоэпиграфически — таннаям р. Ishmael и р. Akiva, передающим откровение ангела Metatron"
key_figure = "236 (мириад тысяч) parasang — рост Творца, выведенный гематрией из Псалма 147:5"
printed_in = "*Sefer Raziel ha-Mal'akh* (Amsterdam, 1701, fol. 37b); *Merkavah Shelemah* (Jerusalem, 1921); критическое издание: M. S. Cohen (TSAJ 9, 1985)"
wheel_of_heaven_reading = "Числа в parasang читаются как искажённая запись двух реальных астрономических расстояний, если *parasang* понимать как световую секунду"
+++
