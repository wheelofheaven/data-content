+++
title = "Военное сокрытие экзобиологии"
description = "Военное сокрытие экзобиологии — совокупность государственных, преимущественно американских, механизмов засекречивания данных о присутствии нечеловеческих сущностей на Земле. Корпус Wheel of Heaven документирует это явление как одно из институциональных препятствий Великому возвращению."
...
see_also = [
    { title = "PURSUE", path = "wiki/pursue", description = "Программа публичного раскрытия 2026 года, чей открытый по умолчанию архив касается тезиса о секретности с официальной стороны." },
]
