...
description = "С 7 июня 2026 года каждая книга Еврейской Библии в библиотеке Wheel of Heaven содержит текст на девяти языках — английский ASV и восемь импортированных переводов PD."
date = 2026-06-07
...
sources = [
    { title = "Импортированные переводы: программа источников по языкам", url = "https://docs.wheelofheaven.world/contributing/content/imported-translations/", outlet = "Документация Wheel of Heaven", date = "2026-06-07" },
    { title = "Каталог data-library и файлы глав", url = "https://github.com/wheelofheaven/data-library", outlet = "Wheel of Heaven data-library", date = "2026-06-07" }
]
+++

## Что было выпущено

По состоянию на 7 июня 2026 года библиотека Wheel of Heaven содержит полную Еврейскую Библию — от Бытия до Софонии, тридцать шесть книг — на девяти языках. Каждая глава отображает базовое английское прочтение ASV 1901 года вместе с импортированными изданиями, находящимися в общественном достоянии, на немецком, испанском, французском, японском, корейском, русском, упрощённом китайском и традиционном китайском языках. Читатели, обращающиеся к библиотеке на любом из девяти языков сайта, теперь видят текст на своём языке чтения, не будучи вынуждены проходить через английский.
...
*— Записано 7 июня 2026 года, редакция Wheel of Heaven.*
