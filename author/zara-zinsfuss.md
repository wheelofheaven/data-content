+++
title = "Zara Zinsfuss"
description = "An author's account of the path to Wheel of Heaven — the formative reading, the night of recognition with The Book Which Tells the Truth, the fifteen years of private notebooks, and the promise made on a Jerusalem rooftop in 2026 that turned the notebooks into a public corpus."
...
languages_read = ["English", "German", "French", "some Hebrew"]
on_the_corpus = "Wheel of Heaven (2026–present)"
signature_location = "Switzerland"
signature_year = "80 AH"
signature_year_alt = "2026 in the Gregorian calendar"
...
In my early twenties I received the [Raëlian baptism](/wiki/cellular-plan-transmission/), the cellular plan transmission that the tradition treats as the formal registration of an individual's genetic identity in the alliance's records. I have been a Raëlian, in my own particular way, ever since.
