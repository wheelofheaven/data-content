...
{{ figure(src="wiki/saurian-experiments", caption="Ill. 1 - Genetic lab experiment gone wrong") }}
...
{{ figure(src="wiki/archaic-blue-planet", caption="Ill. 2 - Archaic blue planet") }}
...
{{ figure(src="wiki/futuristic-city-with-tower", caption="Ill. 3 - Advanced civilizatory urban landscape") }}
