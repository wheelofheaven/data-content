...
footnotes = [
    { content = "Le surnom moderne — forgé par l'assyriologue Thorkild Jacobsen — de la composition sumérienne fragmentaire du déluge cataloguée sous la cote ETCSL 1.7.4. C'est le plus ancien récit de déluge conservé, bien qu'environ un tiers seulement de son texte soit préservé." },
    { content = "Lacunes dans un texte là où la tablette d'argile est brisée ou ses signes illisibles (au singulier *lacuna*). La *Légende du déluge* survit sous forme de quelques blocs préservés séparés par de longues lacunes, de sorte qu'il faut lire le récit par-dessus les trous." },
    { content = "Le *puḫru ilāni*, le conseil assemblé des dieux, est l'instance décisionnelle standard de la religion mésopotamienne, calquée sur l'assemblée civique d'une cité sumérienne. Les actes majeurs — la royauté, le jugement, le déluge — y sont ratifiés. La Bible hébraïque conserve une version atténuée du motif sous la forme du *sod YHWH*, le « conseil de YHWH »." },
    { content = "Littéralement « avant le déluge » (du latin *ante* + *diluvium*). Dans les listes royales mésopotamiennes, le terme désigne les dynasties auxquelles le déluge met un terme." },
    { content = "Le survivant du déluge de l'épopée babylonienne de *Gilgamesh*, et le même personnage que le héros de l'*Atraḫasīs* et le Ziusudra sumérien — l'équivalent mésopotamien de Noé. Dans la Tablette XI, il raconte le déluge à la première personne, et il est le seul mortel à qui soit accordée une vie sans fin." },
    { content = "Un calque : une expression empruntée en traduisant ses éléments un à un plutôt qu'en important le mot étranger lui-même. L'hébreu *l-ḥayyot zeraʿ* reproduit le sens de l'akkadien *zēr napšāti* membre par membre." },
    { content = "L'épopée paléo-babylonienne de l'*Atraḫasīs* (vers 1700 av. J.-C.) inscrit le déluge dans une histoire plus longue : les dieux font les humains pour porter leur labeur, s'inquiètent de la croissance de la population humaine, et essaient la peste, la sécheresse et la famine avant de recourir au déluge. Le nom du survivant signifie « Suprêmement Sage »." },
    { content = "La branche de la théologie qui défend la justice de Dieu face au mal et à la souffrance. Le point ici est que la scène babylonienne ne fait *pas* de théodicée — elle ne justifie pas le déluge, elle le remet en question comme politique." },
    { content = "Dans le *Livre des Veilleurs* (1 Hénoch 1–36, vers le IIIᵉ siècle av. J.-C.), les *Veilleurs* sont les « fils de Dieu » de la Genèse 6 — deux cents êtres célestes qui descendent, prennent des femmes humaines et enseignent des arts interdits. Le texte développe les trois versets cryptiques de la Genèse en un récit complet de la corruption que le déluge est envoyé défaire." },
    { content = "Des mots ou expressions issus d'un ancêtre commun, ou assez proches par la forme et le sens pour trahir un emprunt. L'akkadien *erīšu ṭābu* et l'hébreu *reaḥ ha-nîḥoaḥ* sont assez proches pour que l'hébreu soit généralement tenu pour dépendant de l'expression mésopotamienne." },
    { content = "En littérature comparée, la diffusion d'un récit par contact culturel et copie plutôt que par invention indépendante. La tradition cunéiforme du déluge a circulé pendant quelque deux mille ans ; un fragment du *Gilgamesh* akkadien a même été exhumé à Megiddo, à l'intérieur de l'Israël postérieur." },
    { content = "Un terme collectif akkadien désignant une classe de hauts dieux (du sumérien *a-nun-na*, « ceux de semence princière »). Il est devenu un aimant pour la littérature marginale des « anciens astronautes », au premier chef celle de Zecharia Sitchin ; l'appareil savant sur lequel s'appuie cet essai rejette explicitement cette lecture — le mot ne porte aucun sens technologique caché." }
]
+++

Un déluge est une arme stupide. Il ne peut pas viser. Il noie le coupable et
l'innocent, le violent et le nouveau-né, l'espèce ciblée et toutes les espèces
qui se trouvaient partager la plaine inondable. Si l'on voulait *réduire* une
...
seule chose qu'il ne sache pas faire, c'est discriminer.

Le plus ancien récit de déluge que nous puissions encore lire dit exactement
...
{% wiki(slug="great-flood") %}déluge{% end %} : tu aurais dû employer un lion. Un loup. Une famine. Une peste. N'importe quoi
qui prenne les uns et laisse les autres. *Fais peser la faute sur le fautif.* Il
...
une cargaison définie comme *la semence de tous les êtres vivants* ; et, autour
...
{% libref(book="flood-story-woh") %}*Légende du déluge*{% end %} (la « Genèse
d'Eridu », ETCSL c.1.7.4){{ footnote(id="1") }} ne survit que dans des lacunes{{ footnote(id="2") }} — environ cent
...
sont fondées et *attribuées par mesure jaugée*, chacune confiée à un
surveillant nommé ; des canaux d'irrigation sont tracés. Puis un déluge est
décidé, et le texte recourt au vocabulaire d'un verdict plutôt que de la colère.
...
C'est un verdict conclu ; la parole de l'assemblée ne peut être révoquée.
{% end %}

Le sumérien est ici un vocabulaire de prétoire : 𒁲𒌀𒆷 (*di-til-la*), une *affaire
de justice close* ; *puḫrum*{{ footnote(id="3") }}, l'*assemblée* ; *šu gi₄-gi₄ nu-ĝal₂*, « il n'y a pas de
...
La ligne compagne (C:23) énonce le contenu de la décision comme un *destin
décrété* — le sumérien *nam tar*, « trancher un destin » — sur « la semence du
...
antédiluvien{{ footnote(id="4") }}, institué *par mesure jaugée* quelques segments plus tôt, est
formellement liquidé.
...
quand les cœurs des grands dieux furent émus à déchaîner un déluge.
Leur père Anu les lia par serment,
leur conseiller — le guerrier Enlil,
leur porteur de trône Ninurta,
leur inspecteur des canaux Ennugi —
le prince Ea était avec eux, lié par le même serment.
{% end %}
...
anciennes s'accordent à faire du déluge quelque chose qu'un *corps* décide,
...
Un châtiment qui se contenterait d'épargner un seul homme juste lui rendrait sa
...
l'eau ; on lui dit, en détail, comment construire l'engin qui l'y fera passer.

Dans Gilgamesh, le dieu Ea est lié par le serment de l'assemblée et ne peut
...
> « Hutte de roseaux, hutte de roseaux ! Paroi, paroi !
...
> Embarque à bord la semence de tous les êtres vivants. »

Le procédé du « parler à travers la paroi » est davantage qu'une fioriture de
...
plutôt que sur l'affection : l'akkadien *zēr napšāti kalāma*, « la semence de
...
instructions babyloniennes se lisent comme un cahier des charges d'ingénierie :

> « La barque que tu construiras —
> que ses dimensions soient mesurées avec précision ;
> que sa largeur et sa longueur soient égales.
> Comme l'apsû, rends sa toiture complète. »

La narration d'Utnapishtim{{ footnote(id="5") }} qui suit est l'un des passages les plus
...
Fais-toi une arche de bois de gopher. Fais l'arche avec des compartiments, et enduis-la de poix au-dedans et au-dehors. Voici comment tu la feras : la longueur de l'arche trois cents coudées, sa largeur cinquante coudées, et sa hauteur trente coudées.
{% end %}

Même coque enduite, même précision dimensionnelle, même intérieur ponté et
compartimenté (« ponts inférieur, deuxième et troisième », {% libref(book="genesis-woh", chapter=6, verse=16) %}Genèse 6:16{% end %}). Et la même cargaison définitoire, énoncée deux fois et avec le
...
pour conserver une semence en vie sur la face de toute la terre.
{% end %}

Cette expression — l'hébreu לְחַיּוֹת זֶרַע (*l-ḥayyot zeraʿ*), « conserver une
semence en vie » — se lit comme un calque{{ footnote(id="6") }} de l'akkadien *zēr napšāti*. À travers les trois traditions, la vertu du
...
Aucun passage ne résiste plus obstinément à la lecture du châtiment-juste que
...
prend à la politique :

{% library(book="gilgamesh-woh", chapter=11, verse=179, verse_end=187, interlinear=true) %}
« Toi, sage des dieux, guerrier —
comment, oh comment, sans prendre conseil, as-tu déchaîné un déluge ?!
Fais peser la faute sur le fautif ;
fais peser la transgression sur le transgresseur.
Cède — qu'il ne soit pas retranché ; retiens-toi — qu'il ne soit pas ébranlé !
Au lieu de déchaîner un déluge, qu'un lion se lève et diminue le peuple !
Au lieu de déchaîner un déluge, qu'un loup se lève et diminue le peuple !
Au lieu de déchaîner un déluge, qu'une famine s'installe et ravage le pays !
Au lieu de déchaîner un déluge, qu'Erra se lève et ravage le pays ! »
{% end %}

Suivons l'argument réel. *Fais peser la faute sur le fautif* — l'akkadien *bēl
ḫīṭīti emid ḫīṭa-šu* — est, comme le note le commentaire interne, l'une des plus
anciennes formulations d'une justice *proportionnée, individualisée* dans la
littérature proche-orientale — le principe même qu'Ézéchiel énoncera plus tard :
« l'âme qui pèche, c'est elle qui mourra »
({% libref(book="ezekiel", chapter=18, verse=20) %}Ézéchiel 18:20{% end %}).
...
tradition de l'Atraḫasīs{{ footnote(id="7") }} rend le point plus net encore : ces quatre
solutions de rechange sont précisément les méthodes de contrôle de population
que les dieux déploient *avant* de recourir au déluge dans l'épopée plus
...
ils reculèrent, ils s'enfuirent vers le ciel d'Anu.
Les dieux se tapirent comme des chiens, blottis contre le mur extérieur.
{% end %}

La déesse Ishtar — qui avait parlé *en faveur* du déluge à l'assemblée —
...
qu'elle se déroulait encore.

## Ce à quoi servait la purification : la terre corrompue d'Hénoch

Une réinitialisation suppose quelque chose à réinitialiser. Les textes
mésopotamiens sont avares de motif — l'*Atraḫasīs* babylonien invoque la
surpopulation et le *bruit* ; le sumérien est trop brisé pour en être sûr. La
tradition hébraïque fournit un motif mais l'énonce abstraitement : la terre
était « remplie de violence ». C'est la tradition
{% wiki(slug="elohim") %}hénochienne{% end %} — le *Livre des Veilleurs*{{ footnote(id="9") }},
1 Hénoch 6–11 — qui conserve le récit le plus mécaniquement précis de *ce qui a
mal tourné*, et qui se lit moins comme un conte moral que comme un rapport
d'incident.

Le déclencheur est le même événement que la Genèse nomme en trois versets
cryptiques avant de l'abandonner : un groupe des
{% wiki(slug="elohim") %}fils des Élohim{% end %} prend des femmes humaines.
Hénoch les nomme — deux cents d'entre eux, avec un registre de leurs chefs — et
date et localise la descente :

{% library(book="book-of-enoch-woh", chapter=6, verse=6, interlinear=true) %}
Et ils étaient en tout deux cents, qui descendirent aux jours de Yared sur le sommet du mont Hermon.
{% end %}

Ce qui suit n'est pas seulement la convoitise. Les Veilleurs enseignent, et le
programme se lit comme un transfert non autorisé de technologie :

{% library(book="book-of-enoch-woh", chapter=8, verse=1, interlinear=true) %}
Et Asaël enseigna aux hommes à fabriquer des épées et des couteaux et des boucliers et des cuirasses ; et il leur montra les métaux de la terre et leur travail, et les bracelets et les ornements, et l'usage de l'antimoine, et l'embellissement des paupières, et toutes sortes de pierres précieuses, et toutes les teintures — et le monde fut changé.
{% end %}

La métallurgie, l'armurerie, l'extraction minière, les cosmétiques, et puis — au
...
*le monde fut changé*. La conséquence s'amplifie à travers leur progéniture
...
({% libref(book="book-of-enoch-woh", chapter=7, verse=6) %}1 Hénoch 7:6{% end %}).

Le déluge arrive alors, et Hénoch le cadre avec un vocabulaire qu'aucun autre
témoin ne rend aussi explicite. C'est une *remédiation*. La commission donnée à
{% wiki(slug="noah") %}Noé{% end %} et la commission de nettoyer sont données dans
le même souffle :

{% library(book="book-of-enoch-woh", chapter=10, verse=2, interlinear=true) %}
Va vers Noé, et dis-lui en mon nom : Cache-toi. Et révèle-lui la fin qui vient, car toute la terre périra, et l'eau du déluge va venir sur toute la terre, et elle détruira tout ce qui est sur elle. Et maintenant enseigne-le, afin qu'il échappe, et que sa semence subsiste à travers toutes les générations de l'âge.
{% end %}

Les deux mêmes notes résonnent de nouveau : *enseigne-le* — le survivant est
instruit, non simplement épargné — et *que sa semence subsiste*, le but étant la
survie d'une lignée. Le propre dessein du déluge, quand Hénoch l'énonce, est la
décontamination plutôt que la peine :

{% library(book="book-of-enoch-woh", chapter=10, verse=7, interlinear=true) %}
Et guéris la terre, que les Veilleurs ont corrompue ; et proclame la guérison de la terre, afin qu'ils guérissent le fléau, et que tous les fils des hommes ne périssent pas par tout le mystère que les Veilleurs ont transmis et enseigné à leurs fils.
{% end %}

*Guéris la terre, que les Veilleurs ont corrompue.* Le déluge est apparié à une
...
({% libref(book="book-of-enoch-woh", chapter=10, verse=16) %}1 Hénoch 10:16{% end %}).
...
une {% wiki(slug="noahic-covenant") %}alliance{% end %}.

## L'hébreu conserve la mécanique et réécrit la théologie

Si la procédure est si constante à travers le matériau sumérien, babylonien et
hénochien, la question naturelle est de savoir ce que la Genèse *fait* de cet
...
à la traversée ; la structure de gestion et la leçon tirée à la fin, non.

Ce qui survit, point par point : l'avertissement divin ; le vaisseau enduit,
...
le dieu *humant* cette offrande.

{% library(book="genesis-woh", chapter=8, verse=21, interlinear=true) %}
YHWH huma l'agréable odeur, et YHWH dit en son cœur : « Je ne maudirai plus le sol à cause de l'homme, car l'inclination du cœur de l'homme est mauvaise dès sa jeunesse ; et je ne frapperai plus tout être vivant comme je l'ai fait. »
{% end %}

L'hébreu רֵיחַ הַנִּיחֹחַ (*reaḥ ha-nîḥoaḥ*), « l'agréable odeur », est le
quasi-cognat{{ footnote(id="10") }} lexical de l'akkadien *erīšu ṭābu*, « la douce senteur », que les
...
le même moment se lit :

{% library(book="gilgamesh-woh", chapter=11, verse=159, interlinear=true) %}
Les dieux s'attroupèrent comme des mouches autour du maître du sacrifice.
{% end %}

Les dieux mésopotamiens *se pressent autour de l'autel comme des mouches* parce
...
La divinité hébraïque est *touchée* par l'arôme mais n'en a pas *besoin* ; le
motif de la faim divine et l'image des mouches sont supprimés. La même chirurgie
est pratiquée sur les dieux qui *se tapissaient comme des chiens* : la Genèse n'a
...
existe *parce qu'il y a plusieurs décideurs* — est comprimée en une seule
volonté. Il n'y a pas de débat Ea-contre-Enlil dans la Genèse parce qu'il n'y a
pas d'Enlil ni d'Ea, seulement {% wiki(slug="yahweh") %}YHWH{% end %}.

Le changement hébraïque le plus tranchant, cependant, est quelque chose
d'ajouté plutôt que de retranché : la *conclusion que le dieu du survivant tire*
ensuite. Mettons la raison déclarée du déluge à côté de la raison déclarée de ne
jamais le répéter. Avant :
{% libref(book="genesis-woh", chapter=6, verse=5) %}Genèse 6:5{% end %} — « toute
l'inclination des pensées de son cœur n'était que mal à longueur de journée » —
*donc détruire*. Après : {% libref(book="genesis-woh", chapter=8, verse=21) %}Genèse
8:21{% end %} — « l'inclination du cœur de l'homme est mauvaise dès sa
jeunesse » — *donc ne plus jamais détruire de cette manière*. Le diagnostic
...
récit : le mal humain se révèle *constitutionnel* — מִנְּעֻרָיו (*mi-nəʿurav*),
présent dès la jeunesse, structurel plutôt qu'acquis — et donc la
destruction-comme-politique est *vaine*, parce que le problème réside dans la
...
en retirant la méthode pour de bon et en scellant ce retrait dans une alliance :

{% library(book="genesis-woh", chapter=9, verse=11, interlinear=true) %}
J'établirai mon alliance avec vous : plus jamais toute chair ne sera retranchée par les eaux d'un déluge ; plus jamais il n'y aura de déluge pour ravager la terre.
{% end %}

Une alliance de ne plus jamais employer l'instrument se lit moins comme la
...
lexicales ne sont pas de vagues « rimes » thématiques — *zēr napšāti* /
לְחַיּוֹת זֶרַע (*l-ḥayyot zeraʿ*), *erīšu ṭābu* /
...
qu'ils partagent une ascendance.
...
d'inférence. Dans
{% libref(book="the-book-which-tells-the-truth", chapter=2, verse=58) %}*Le Livre
qui dit la vérité*{% end %}, le déluge est l'aboutissement d'une scission
politique au sein de la civilisation des fabricants. Une faction — l'autorité de
tutelle sur la {% wiki(slug="elohim-home-planet") %}« planète lointaine »{% end %} —
se résout à détruire la vie sur Terre, et le fait au moyen d'un armement
nucléaire ; le déluge est l'*effet secondaire* de cette frappe, le raz-de-marée
...
ce que le canon glose aussitôt en termes modernes :

{% library(book="the-book-which-tells-the-truth", chapter=2, verse=58) %}
En réalité — et vos connaissances scientifiques vous permettront bientôt de le comprendre — il suffit d'avoir une cellule vivante de chaque espèce, mâle et femelle, pour reconstituer ensuite l'être tout entier.
{% end %}

La barque devient un vaisseau à étages renfermant une bibliothèque génétique ;
...
conservatrice, Ea oppose manifestement le déluge à des solutions *ciblées* qu'il
...
quelle que soit la lecture de la formule du blâme.

Une troisième objection vient de l'autre côté, de l'intérieur de la tradition
...
auteurs hébraïques ont clairement *bel et bien* re-théologisé la procédure
...
la *strate la plus ancienne et sa forme*, non sur l'exigence que le sens propre
de la tradition hébraïque soit écarté.
...
répondent de manière constante.
