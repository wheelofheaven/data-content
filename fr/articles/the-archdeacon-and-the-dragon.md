...
Un archidiacre de l'Église anglicane d'Australie s'est esquinté la jambe
...
il s'aperçut qu'il ne pouvait plus le lire du tout. *« Chaque fois que je
...
"Paul ! Arrête ! Ne lis pas plus loin. Tu as mal compris l'histoire !" »*

Paul Wallis s'arrêta bel et bien. Le livre qu'il écrivit depuis ce
conteneur, *Escaping from Eden* (2020), posait sa question dans son
sous-titre — *la Genèse enseigne-t-elle que la race humaine a été créée
par Dieu ou fabriquée par des ET ?* — et y répondait assez clairement pour
...
d'Éden : *The Scars of Eden* (2021), *Echoes of Eden* (2022), *The Eden
Conspiracy* (2023), *The Invasion of Eden* (2024), *The Eden Enigma*
(2025). Chemin faisant, il devint, avec le traducteur italien
{% wiki(slug="biglino-method") %}Mauro Biglino{% end %}, l'une des deux
voix vivantes les plus décisives de la tradition réinterprétative que ce
projet nomme {% wiki(slug="neo-euhemerism") %}néo-évhémérisme{% end %} —
la lecture des dieux du récit antique comme mémoire culturelle de
visiteurs réels et technologiques.

Quarante-six ans avant la blessure au frisbee, un journaliste français de
sport automobile nommé Claude Vorilhon — {% wiki(slug="rael") %}Raël{% end %} —
...
livre qu'il publia en 1974, [*Le Livre qui dit la
vérité*](/library/the-book-which-tells-the-truth/), est le fondement du
...
La méthode de Wallis mérite d'être exposée avant ses conclusions, car la
...
classique de la tempérance scientifique appliquée à l'Écriture :

> Selon l'histoire de la découverte scientifique, les anomalies sont
...
Les anomalies qu'il énumère sont celles que tout lecteur attentif remarque
...
plus ancien et plus étrange :

> Que se passerait-il si nous concédions enfin qu'elohim implique des êtres
...
> de ce que sont les êtres humains et d'où nous venons.
>
> — *Escaping from Eden*, chap. 1

Il savait ce que l'aveu coûterait, et les livres racontent ce coût sans
...
tard, est ce qui se rapproche le plus d'un credo dans la série :

> Toute ma crédibilité professionnelle d'homme d'Église chevronné de
...
> réputation, là où les données menaient, je devais suivre.
>
> — *The Eden Enigma*, chap. 5

Les six livres ont une architecture lisible. *Escaping from Eden* fait la
philologie. *The Scars of Eden* emmène le résultat en tour du monde — le
...
patient amnésique ». *Echoes of Eden* demande quelles capacités humaines
furent supprimées en même temps que la mémoire. *The Eden Conspiracy*
reconstitue qui a édité le dossier, quand et pourquoi. *The Invasion of
Eden* pose la version la plus sombre de la question — si certains des
visiteurs étaient des exploiteurs, et si l'arrangement a jamais pris fin.
*The Eden Enigma* se met en quête sur le terrain dans l'est de la Türkiye,
...
au témoignage, à l'histoire de la rédaction, au travail de terrain.

## Le pluriel qui ne voulait pas disparaître

Le fondement de tout ce que soutient Wallis est la grammaire d'un seul
mot. *Elohim* (<span class="hebrew">אֱלֹהִים</span>) porte la désinence
hébraïque du masculin pluriel *-im*, et le premier geste de Wallis est de
refuser la convention qui le lit comme un « Dieu » singulier partout où la
théologie l'exige :

> Si l'on se tourne vers l'étymologie, le sens premier d'elohim est soit
...
> non les diverses qualités superlatives de la gent chérubique.
>
> — *Escaping from Eden*, chap. 1

Il est scrupuleux quant à la contre-argumentation — il cite Dom Henry
Wansbrough, éditeur superviseur de la *New Jerusalem Bible*, sur les
...
les verbes pluriels qui s'attachent à *elohim* en Genèse 20:13 et 35:7.
...
> À l'instant où nous retraduisons elohim comme un pluriel, ou comme un nom
...
Son texte-preuve pour tout le programme — il l'appelle « the smoking gun »,
la preuve accablante — est l'assemblée d'alliance à Sichem, où Josué place
le choix devant les tribus : rejetez les *elohim* que vos ancêtres ont
servis au-delà du Fleuve et en Égypte, et servez Yahvé
({% libref(book="joshua", chapter=24, verse=14) %}Josué 24:14-15{% end %}).
Ici, *elohim* et Yahvé ne peuvent avoir le même référent ; le verset
...
histoires sont racontées dans les tablettes cunéiformes ».

Un lecteur de ce projet reconnaîtra chacun de ces éléments. Le canon a
énoncé la lecture plurielle, comme explication reçue plutôt que comme
hypothèse, dès 1974 — *« Elohim en hébreu est le pluriel d'Eloha »* figure
parmi ses observations les plus répétées, et sa glose du mot est
fonctionnelle plutôt qu'étymologique : *« Elohim, cela signifie
littéralement « ceux qui vinrent du ciel » »*
({% libref(book="the-book-which-tells-the-truth", chapter=3, verse=251) %}LLQDV 3:251{% end %}).
...
{% wiki(slug="list-of-etymological-readings") %}catalogue de lectures
étymologiques{% end %} du projet porte tout l'appareil. Ce que Wallis
ajoute, c'est la *provenance* : la même lecture, atteinte de l'intérieur du
...
lecteurs occasionnels : le conseil divin{{ footnote(id="8") }} — l'assemblée
des elohim du Psaume 82, la division des nations entre les fils des
elohim en Deutéronome 32:8–9{{ footnote(id="9") }} — est matière de manuel.
La pluralité est dans le texte quelle que soit la lecture. Ce qui est en
litige, c'est seulement ce que les êtres pluriels *étaient*.

## Un dragon nommé Yahvé

L'argument que cet article a été chargé d'examiner apparaît dans *Echoes
of Eden* et atteint sa pleine force dans *The Eden Conspiracy*. Il
...
anciens eux-mêmes retient son oreille :

> Vous serez peut-être surpris d'apprendre que la Bible est en fait pleine
...
> Géorgie, Kukulkan, Ququmatz et Quetzalcoatl de Méso-Amérique.
>
> — *Echoes of Eden*, chap. 2

Ce qu'il a remarqué dans cette liste, c'est un son. Kukulkan, Ququmatz,
...
percussion récurrente en *k-k* qui court à travers les noms de dragons de
langues sans parenté, de la Méso-Amérique au Japon. Le nom
YHWH{{ footnote(id="1") }}, avec ses deux *h* presque muets, semble à des
...
lénifient en fricatives{{ footnote(id="3") }} ; et dans l'univers sonore
sémitique plus ancien, soutient-il, le *h* n'était pas un murmure :

> Ce processus d'adoucissement des sons s'appelle l'affrication. La même
...
> Yakhwekh est le nom hébreu.
>
> — *Echoes of Eden*, chap. 2

*The Eden Conspiracy* rebâtit l'argument avec davantage d'échafaudage. Là,
...
conclusion de Wallis est que le nom est un emprunt{{ footnote(id="2") }} —
et ensuite quelque chose de plus rare qu'un emprunt :

> C'est exactement ainsi que le mot Yahweh fait son apparition dans le
...
> comportement du personnage de Yahweh.
>
> — *The Eden Conspiracy*, chap. 6

La possibilité est l'onomatopée : le *ch-ch* comme « un écho du son abrasif
...
> Déployant toute sa puissance rhétorique, Josué appelle la foule
...
> l'Égypte ou yACHwECH d'Israël.
>
> Avez-vous vu cela ? La similitude des deux noms est frappante. Ils sont
...
> l'Égypte (tel qu'on l'orthographie aujourd'hui) était un dragon.
>
> — *The Eden Conspiracy*, chap. 6

De là, l'identification se propage à travers le corpus des textes de
Yahvé. Les séraphins deviennent des « serpents volants connus pour leur
feu ». Le serpent d'airain{{ footnote(id="10") }} que Moïse dresse sur
...
l'*ap* de Yahvé — narines, museau — et le feu de sa bouche dans le Psaume
...
humains, et à côté de la satire de la Septante *Bel et le Dragon*, où une
nation rivale entretient une tente enfumée approvisionnée en nourriture et
en or pour son monstre résident. Au chapitre sept de *The Eden
...
l'allemand *ach* que Wallis invoque — aux côtés d'un *h* pharyngal et d'un
*h* glottal simple.{{ footnote(id="4") }} Mais l'hébreu a réparti ces trois
sons entre deux lettres, et il en a tenu la comptabilité : la vélaire et la
pharyngale ont fusionné en *ḥet* (ח) ; le *h* glottal est resté *he* (ה).
Le nom יהוה s'écrit avec *he*, deux fois. Un nom hébreu dont la forme
ancestrale aurait porté le son *ach* s'écrirait avec *ḥet* — comme, par
...
sons doux au fil du temps, de sorte que tirer un *k-k* antérieur d'un *h-h*
...
leurs propres ennuis : la liste des dragons en *k-k* mêle des langues sans
...
et Akhekh lui-même{{ footnote(id="7") }} n'est qu'un figurant dans le
...
dérivation opérante de YHWH à partir du verbe « être »{{ footnote(id="5") }}
et d'une piste de preuves tangibles — les Shasou de YHW dans des listes
égyptiennes du XIVᵉ siècle av. J.-C.{{ footnote(id="6") }} — pointant
précisément vers la région, Madian, où le propre récit de Wallis met en
scène la première apparition du nom. C'est une véritable curiosité de *The
Eden Conspiracy* qu'il se tienne à la porte de l'hypothèse madianite, en
décrive le décor, et passe son chemin.

Ainsi l'étymologie échoue. Ce qui n'échoue pas — et c'est la raison pour
...
la phonologie et l'argument de Wallis sur Josué 24 dit ceci : *Yahvé est
présenté par le texte comme le même genre d'entité que les autres
puissances régionales, différant en juridiction plutôt qu'en nature.*
Cette prétention tient parfaitement debout, tout indépendamment d'Akhekh :

> La *New Jerusalem Bible* suggère qu'on nous parle d'une puissance
...
> jusqu'ici car j'ai dû livrer bataille à l'Être puissant de la Perse ».
>
> — *The Eden Conspiracy*, chap. 10

Écartez le nom d'Akhekh et chaque autre élément de cette liste est solide :
...
({% libref(book="2-kings", chapter=1, verse=3) %}2 Rois 1{% end %}) ; le
...
({% libref(book="the-book-which-tells-the-truth", chapter=2, verse=28) %}LLQDV 2:28{% end %}).
Les deux lectures prennent le relevé minier de la Genèse 2 pour un détail
opérationnel dont la théologie n'a jamais su que faire.

**L'interdiction comme politique.** Pour Wallis, l'interdit de l'arbre de
...
du canon est un ordre précis, à la portée précise :

{% library(book="the-book-which-tells-the-truth", chapter=2, verse=30) %}
Ce qui signifie : vous pouvez apprendre tout ce que vous voulez, lire tous
les livres que nous tenons ici à votre disposition, mais ne touchez pas aux
livres scientifiques, ou vous mourrez.
{% end %}

**Le Serpent comme fabricants dissidents.** C'est la plus profonde des
...
récit du canon, livré comme narration plutôt que comme inférence :

{% library(book="the-book-which-tells-the-truth", chapter=2, verse=35) %}
Parmi tous les savants de cette équipe, quelques-uns qui aimaient
...
forts que leurs créateurs.
{% end %}

{% library(book="the-book-which-tells-the-truth", chapter=2, verse=39) %}
Le « serpent » — ce petit groupe de créateurs qui avaient voulu enseigner
...
cesser leurs expériences et quitter la Terre.
{% end %}

Dans *The Invasion of Eden*, Wallis a recours à une histoire chinoise pour
...
c'est la carrière de la faction {% wiki(slug="lucifer") %}Lucifer{% end %} —
le {% wiki(slug="serpent") %}Serpent{% end %} de la Genèse 3 — telle que le
corpus l'articule depuis cinquante ans.

**Le Déluge comme décision de conseil, avec un bienfaiteur dissident.**
...
Ils décidèrent donc, depuis leur planète lointaine, de détruire toute vie
...
espèce à sauvegarder.
{% end %}

**Babel comme destruction d'une civilisation spatiale.** Wallis lit
*bab-el* comme « porte des Êtres puissants », renvoie aux trois cents
...
{% wiki(slug="tower-of-babel") %}Babel{% end %} comme la dispersion du
...
**Le conseil des factions.** Les livres plus tardifs de Wallis assemblent
l'*El-Ba'adat* de la Bible — sa traduction, « le Conseil du Pouvoir » — et
lisent la politique qui s'y joue :

> Au sein de ce Conseil, que nous lisions ses récits bibliques,
...
> qui ne voulaient rien de tout cela.
>
...
{% wiki(slug="yahweh") %}Yahvé{% end %} présidant entre elles. Il vaut la
peine de noter que la propre entrée Satan du corpus crédite déjà *The Eden
Conspiracy* d'un « contenu substantiel de démêlage Satan–Lucifer » :
...
**La rédaction.** L'*Eden Conspiracy* de Wallis reconstitue une édition
...
{% wiki(slug="plurality-of-gods") %}pluralité des dieux{% end %}. Deux
...
Yahvé n'est catégoriquement pas un monstre ; c'est un homme — *« Nous
...
De vrais dragons existent dans le canon, mais comme *créations* : la
production extravagante d'équipes d'ingénierie rivales lors de
l'ensemencement de la Terre —

{% library(book="the-book-which-tells-the-truth", chapter=2, verse=22) %}
Mais d'autres équipes de savants créèrent des animaux épouvantables, des
...
que vous avez nommé Dinosaures ou Brontosaures, et ainsi de suite.
{% end %}

— tandis que le langage *figuré* de la Bible sur le serpent et le dragon
se rattache, dans la lecture du canon, à la faction Lucifer exilée. Les
entrées {% wiki(slug="dragons") %}dragons{% end %} et
{% wiki(slug="serpent") %}serpent{% end %} du corpus rangent le folklore
serpentin du monde en deux ensembles — les serpents-du-chaos (Tiamat,
Apophis, {% wiki(slug="leviathan") %}Léviathan{% end %}), conservant la
...
La façon la plus tranchante de voir la divergence est un verset que les
...
Afin de ne pas être dérangés par les hommes, les créateurs avaient des
...
créateurs bannis au commencement se cachèrent sous les océans.
{% end %}

Les deux cadres lisent le langage du dragon comme renvoyant à des acteurs
...
torsion supplémentaire qui mérite d'être conservée : dans *Echoes of Eden*,
les figures serpentines de Wallis sont les *dégradeurs* de l'humanité —
Ququmatz amoindrissant la vue des premiers hommes — tandis que les
bienfaiteurs-enseignants arrivent vêtus en poissons, les
apkallū{{ footnote(id="11") }} de la mémoire mésopotamienne. Dans le canon,
la faction serpentine *est* l'enseignante. Le même dossier comparatif,
...
{% wiki(slug="theomachy") %}Théomachie{% end %}.

**Ce que Jésus est venu faire.** Pour Wallis, les Évangiles mettent en
...
justification de Marcion{{ footnote(id="12") }} — le révélateur d'un Père
...
({% libref(book="the-book-which-tells-the-truth", chapter=4, verse=20) %}LLQDV 4:20{% end %}),
...
profonde bifurcation du chemin.

**Ce qui demeure au-dessus des Élohim.** Wallis demeure théiste — un
...
finitude encore semblable aux Élohim, jusqu'en haut — [l'infini dans les
deux directions](/articles/the-infinite-in-both-directions/), matière
infinie et temps infini, sans Personne au sommet parce qu'il n'y a pas de
sommet. Les deux cadres s'accordent à dire qu'adorer Yahvé *comme* l'Absolu
est une erreur de catégorie ; ils divergent sur la question de savoir si un
Absolu est là, à trouver. Wallis répond en prêtre, le canon en ingénieur.

**Invasion ou projet.** La Série d'Éden s'assombrit vers la fin. *The
Invasion of Eden* lit une grande part du dossier à travers la suggestion,
...
hommes » ; son {% wiki(slug="great-flood") %}Déluge{% end %} est [une
réinitialisation, non un
châtiment](/articles/the-flood-was-a-reset-not-a-punishment/) ; sa fin
n'est pas une occupation à laquelle résister mais un
{% wiki(slug="great-return") %}retour{% end %} à accueillir, avec une
{% wiki(slug="embassy") %}ambassade{% end %} à bâtir pour lui. Wallis
scrute le ciel avec la prudence d'un juriste à l'égard des traités conclus
au nom de l'humanité ; le canon dresse une table.
...
désaccord. Et son argument sur Akhekh, précisément *parce que* sa
...
> Nos ancêtres étaient ceux qui se souvenaient. Nous sommes ceux qui ont
> mal compris.
>
...
- Les entrées {% wiki(slug="serpent") %}Serpent{% end %},
  {% wiki(slug="lucifer") %}Lucifer{% end %},
  {% wiki(slug="satan") %}Satan{% end %} et
  {% wiki(slug="yahweh") %}Yahvé{% end %}, pour la taxinomie politique à
  quatre figures que cet article compare à la distribution de Wallis.
- L'entrée {% wiki(slug="theomachy") %}Théomachie{% end %}, pour la guerre
  dont les deux lectures revendiquent les versets de dragon.
- Les entrées {% wiki(slug="biglino-method") %}méthode Biglino{% end %} et
  {% wiki(slug="neo-euhemerism") %}néo-évhémérisme{% end %}, pour la
  tradition que Wallis étend au monde anglophone.
- [*Le Livre qui dit la
  vérité*](/library/the-book-which-tells-the-truth/), chapitres 2 et 3,
  pour les passages du canon cités tout au long.
