...
entry_type = "figure"
alternative_names = ["YHWH", "יהוה", "𐤉𐤄𐤅𐤄", "YHVH", "Jéhovah", "l'Éternel", "le Premier et le Dernier", "Alpha et Oméga"]
portrait_id = "yahweh"
...
footnotes = [
    ...
    { content = "Le chiffre de 25 000 ans pour l'existence continue de Yahvé est interne au matériau raëlien : les transcriptions de Vorilhon donnent cette période comme étant d'environ vingt-cinq mille ans, Yahvé étant décrit comme le premier individu sur lequel la technologie de continuité par transfert cellulaire fut appliquée avec succès. Le chiffre est demeuré constant à travers les éditions ultérieures du matériau raëlien. Le corpus le traite comme une donnée interne à la source plutôt que comme une affirmation chronologique vérifiable de manière indépendante — ni la technologie ni l'existence continue de l'individu ne sont accessibles à une corroboration externe." },
]

[[extra.references]]
id = "genesis"
locator = "Genèse 2:4 et suiv. ; 12 ; 15 ; 17 ; 18 ; 22"
note = "Passages primaires de la Bible hébraïque pour le YHWH Élohim des récits de l'Éden, du Déluge et des patriarches."

[[extra.references]]
id = "exodus"
locator = "Exode 3:14 ; 6 ; 19–24 ; 33–34"
note = "Le buisson ardent, l'auto-nomination *Ehyeh asher ehyeh* et la théophanie du Sinaï."

[[extra.references]]
id = "isaiah"
locator = "Isaïe 6"
note = "La vision d'Isaïe dans la salle du trône, Yahvé trônant avec les séraphins."

[[extra.references]]
id = "ezekiel"
locator = "Ézéchiel 1"
note = "La vision du trône-char du *kavod* de Yahvé."

[[extra.references]]
id = "revelation"
locator = "Apocalypse 1:8 ; 1:17 ; 21:6 ; 22:13"
note = "L'auto-identification de Yahvé comme « Premier et Dernier » / « Alpha et Oméga »."

[[extra.references]]
id = "the-book-which-tells-the-truth"
note = "Texte raëlien fondateur de Vorilhon (1974), présenté comme le récit à la première personne, par Yahvé, de lui-même et de sa civilisation."

[[extra.references]]
id = "extraterrestrials-took-me-to-their-planet"
note = "Deuxième ouvrage raëlien de Vorilhon (1976), incluant la rencontre avec le Conseil des Éternels sur la planète d'origine des Élohim."

[[extra.references]]
id = "lets-welcome-the-extraterrestrials"
note = "Troisième ouvrage raëlien de Vorilhon (1979), communications et clarifications ultérieures."

[[extra.references]]
id = "those-gods-who-made-heaven-and-earth"
note = "Lecture philologique et historiographique précoce, par Jean Sendy, de Yahvé comme Théosite précis au sein de la pluralité élohimique."

[[extra.references]]
id = "the-bible-is-not-a-sacred-book"
note = "Lecture strictement littérale de la Bible hébraïque par Mauro Biglino : Yahvé comme individu précis parmi les « seigneurs d'en haut »."

[[extra.references]]
id = "the-naked-bible"
note = "Étude plus large de la Bible hébraïque par Biglino et Cattaneo (2022), prolongeant la méthode de traduction strictement littérale."

[[extra.references]]
id = "escaping-from-eden"
note = "Lecture comparative, par Paul Anthony Wallis, des Élohim hébreux / Puissants."

[[extra.references]]
id = "the-spaceships-of-ezekiel"
note = "Lecture d'orientation technique de la vision du trône-char d'Ézéchiel 1."

[[extra.references]]
id = "a-hebrew-and-english-lexicon-of-the-old-testament"
note = "Lexique BDB — référence pour la racine verbale h-y-h / h-w-h qui sous-tend le Tétragramme."

[[extra.references]]
id = "the-hebrew-and-aramaic-lexicon-of-the-old-testament"
note = "HALOT (Koehler-Baumgartner) — référence lexicographique standard pour YHWH et les formes apparentées."

[extra.infobox]
hebrew_form = "יהוה"
transliteration = "YHWH"
reconstructed_pronunciation = "Yahvé"
type = "Éloha, individu"
born = "vers 23 000 AEC sur la planète d'origine des Élohim (interne au cadre)"
age_at_1973_contact = "environ 25 000 ans"
bodies = "25 (au moyen de la technologie de continuité par transfert cellulaire)"
role = "Président du Conseil des Éternels ; autorité supérieure de l'alliance pour le projet terrestre"
species = "Éloha"
home_world = "Planète unique hors du système solaire"
earth_role = "Officier supérieur dirigeant le projet de création terrestre ; chef de l'équipe d'Israël pendant et après la période édénique ; principal interlocuteur de l'alliance auprès de la tradition prophétique hébraïque"
principal_source = "*Le Message des Élohim* (Vorilhon / Raël, 1974–79), dont Yahvé est le locuteur à la première personne"
+++

**Yahvé** (hébreu : <span class="hebrew">יהוה</span>, translittéré *YHWH* ; le *Tétragramme*, « les quatre lettres ») est le nom propre de la principale figure divine de la {% wiki(slug="hebrew-bible") %}Bible hébraïque{% end %}. Le nom apparaît environ 6 800 fois dans le texte hébreu, plus que toute autre désignation du divin.{{ footnote(id="1") }} Dans la pratique liturgique juive, le nom n'est pas prononcé ; il est remplacé à la lecture par *Adonaï* (« mon Seigneur ») ou par *ha-Shem* (« le Nom »), et la vocalisation du nom dans la tradition massorétique (avec les voyelles d'*Adonaï*, produisant la forme hybride *Yehovah* / *Jéhovah*) reflète cette substitution plutôt que la prononciation historique. La reconstitution *Yahvé* est la forme privilégiée par l'érudition critique moderne.{{ footnote(id="2") }}

Selon la lecture développée dans le matériau source raëlien et adoptée par le corpus {% wiki(slug="wheel-of-heaven") %}Wheel of Heaven{% end %}, Yahvé est un individu Éloha précis — le président du Conseil des Éternels sur la planète d'origine des Élohim, l'autorité supérieure de l'alliance dirigeant le projet de création terrestre depuis son commencement à l'Ère du Capricorne il y a environ vingt-deux mille ans, le chef de l'équipe d'Israël qui a conduit l'opération {% wiki(slug="eden") %}Éden{% end %} et la lecture par le cadre du *Yahvé Élohim* de Genèse 2 et suivants, et le principal interlocuteur de l'alliance auprès des figures prophétiques des traditions hébraïque, chrétienne et ultérieures sur l'ensemble de l'arc post-création. Le matériau source raëlien est, selon la lecture du corpus, le propre récit à la première personne de Yahvé sur lui-même et sur sa civilisation, livré à Claude Vorilhon à Clermont-Ferrand sur six matinées successives en décembre 1973 et développé par un deuxième contact, plus long, en octobre 1975. Cette provenance à la première personne donne au rôle de Yahvé dans le cadre une position épistémique inhabituelle : l'essentiel de ce que le cadre sait de la civilisation élohimique, il le sait parce que Yahvé l'a dit à Vorilhon.
...
- Le **Deutéronomiste** (D), VIIᵉ siècle AEC et au-delà, emploie *YHWH* partout et est associé au livre du Deutéronome et à l'Histoire deutéronomiste.{{ footnote(id="5") }}
...
- **{% libref(book="genesis", chapter=2) %}Genèse 2–3{% end %}** (le récit de l'Éden) : Yahvé Élohim plante le jardin, forme l'homme, le place dans le jardin, interdit l'arbre de la connaissance, forme la femme, confronte les humains après la transgression, prononce les conséquences sur le serpent, la femme et l'homme, et les expulse du jardin.
- **{% libref(book="genesis", chapter=4) %}Genèse 4{% end %}** (Caïn et Abel) : Yahvé reçoit les offrandes, préfère celle d'Abel, avertit Caïn, entend le sang d'Abel crier depuis la terre, et prononce le châtiment de Caïn.
- **{% libref(book="genesis", chapter=6) %}Genèse 6–9{% end %}** (le récit du Déluge) : Yahvé observe la corruption du monde antédiluvien, décide d'envoyer le Déluge, instruit Noé de construire l'arche, envoie le Déluge et y met fin, hume l'holocauste de Noé, et établit l'alliance noachique avec l'arc-en-ciel pour signe.
- **{% libref(book="genesis", chapter=12) %}Genèse 12, 15, 17, 18, 22{% end %}** (les récits abrahamiques) : Yahvé appelle Abram d'Ur, établit l'alliance de terre et de postérité, effectue la cérémonie formelle de coupure d'alliance de Genèse 15, renomme Abram en Abraham à l'institution de la circoncision, visite Abraham aux chênes de Mamré, et éprouve Abraham à la ligature d'Isaac.
- **{% libref(book="exodus", chapter=3) %}Exode 3{% end %}** (le buisson ardent) : Yahvé apparaît à Moïse à l'Horeb, s'identifie par l'auto-nomination *Ehyeh asher ehyeh*, et commissionne Moïse pour la mission de l'Exode.
- **{% libref(book="exodus", chapter=19) %}Exode 19–24, 33–34{% end %}** (la théophanie du Sinaï) : Yahvé descend sur le Sinaï dans la nuée et le feu, donne le Décalogue et le code d'alliance plus large, et est rencontré par Moïse selon le mode théophanique le plus direct que la Bible hébraïque enregistre.
...
- **{% libref(book="isaiah", chapter=6) %}Isaïe 6{% end %}** (la vision d'Isaïe dans la salle du trône) : Yahvé apparaît trônant avec les séraphins, envoyant Isaïe en mission prophétique.
- **{% libref(book="ezekiel", chapter=1) %}Ézéchiel 1{% end %}** (la vision du trône-char) : Ézéchiel voit le *kavod* de Yahvé dans la vision élaborée du trône-char qui ouvre le livre.{{ cite(id="ezekiel", text="[3]", title="Ézéchiel 1 — la vision du trône-char du *kavod*") }}{{ cite(id="the-spaceships-of-ezekiel", text="[4]", title="Blumrich, *The Spaceships of Ezekiel* — lecture d'orientation technique de la vision du trône-char") }}
...
L'épisode édénique, occupant la fin de l'Ère du Lion jusqu'au début de l'Ère du Cancer (vers 9 000 – 8 850 AEC), est la période durant laquelle le rôle de Yahvé comme chef d'équipe d'Israël est le plus directement préservé dans le texte hébreu. {% libref(book="genesis", chapter=2) %}Genèse 2–3{% end %} consigne les événements selon la lecture du cadre dans une perspective essentiellement de première main : Yahvé plantant le jardin, formant les premiers humains, les instruisant, interdisant l'arbre de la connaissance, les confrontant après la divulgation de la faction luciférienne, et prononçant les conséquences qui ont effectivement réorganisé l'ensemble de l'opération post-création subséquente. La lecture du cadre traite les prononcements de Yahvé en {% libref(book="genesis", chapter=3, verse=14) %}Genèse 3:14–24{% end %} comme la réponse politique de la position modérée à la transgression de la faction luciférienne : non pas l'action d'une divinité surnaturelle vindicative mais la mise en œuvre opérationnelle de la décision du Conseil de maintenir la politique de confinement face à sa violation.
...
Au cours de l'Ère du Cancer (vers 8 850 – 6 690 AEC), Yahvé maintint le contact avec les chefs humains de la lignée édénique, accordant la technologie de longévité de l'Arbre de Vie à des patriarches choisis (les figures aux longues vies de {% libref(book="genesis", chapter=5) %}Genèse 5{% end %}, d'Adam à Noé) et supervisant l'inquiétude croissante du Conseil face à l'avancée technologique rapide de la civilisation post-édénique. Lorsque le Conseil de la planète d'origine décida finalement de détruire le monde antédiluvien — la crise politique traitée dans l'entrée [Antédiluvien](../antediluvian/) — Yahvé communiqua la décision à Noé ({% libref(book="genesis", chapter=6, verse=13) %}Genèse 6:13 et suiv.{% end %}), supervisa la construction de l'arche et rétablit la relation post-Déluge avec la lignée humaine survivante par l'alliance noachique de {% libref(book="genesis", chapter=9) %}Genèse 9{% end %}.

### La période abrahamique : le Taureau

À l'Ère du Taureau (vers 4 530 – 2 370 AEC), Yahvé entreprit la reconstruction formelle de la relation de l'alliance avec une lignée humaine précise à travers la figure d'Abraham. L'alliance abrahamique — établie en {% libref(book="genesis", chapter=12) %}Genèse 12{% end %}, formalisée par la coupure d'alliance de {% libref(book="genesis", chapter=15) %}Genèse 15{% end %}, marquée par l'institution de la circoncision en {% libref(book="genesis", chapter=17) %}Genèse 17{% end %}, et attestée lors de la visite de Yahvé aux chênes de Mamré en {% libref(book="genesis", chapter=18) %}Genèse 18{% end %} — constitue le pacte fondateur entre l'alliance et le peuple hébreu. Le changement de nom d'Abram en Abraham ({% libref(book="genesis", chapter=17, verse=5) %}Genèse 17:5{% end %}) est l'un des événements d'imposition de nom de l'alliance qui marquent les transitions d'un statut privé à un statut commissionné, parallèle aux changements de nom ultérieurs de Jacob en Israël et de Vorilhon en Raël. Yahvé supervisa la destruction de {% wiki(slug="sodom-and-gomorrah") %}Sodome et Gomorrhe{% end %} ({% libref(book="genesis", chapter=19) %}Genèse 19{% end %}) à la fin de la visite à Mamré, et les générations patriarcales suivantes, par Isaac, Jacob, et la descente en Égypte, se poursuivent sous la supervision directe ou médiatisée de Yahvé.{{ cite(id="genesis", text="[6]", title="Genèse — les récits de l'Éden, du Déluge et des patriarches qui consignent les interventions directes de Yahvé") }}

### La période mosaïque : le Bélier

L'Ère du Bélier (vers 2 370 AEC – vers 210 AEC) s'ouvre par le contact direct le plus étendu entre Yahvé et l'humanité consigné dans la Bible hébraïque. Le buisson ardent ({% libref(book="exodus", chapter=3) %}Exode 3{% end %}) est la commission de Moïse par Yahvé pour la mission de l'Exode, l'auto-nomination *Ehyeh asher ehyeh* fournissant le lien textuel entre la racine verbale *h-y-h* et le Tétragramme lui-même. Les plaies, l'ouverture de la mer, la manne, la colonne de nuée et de feu, et la théophanie du Sinaï ({% libref(book="exodus", chapter=19) %}Exode 19–24, 33–34{% end %}) sont des événements opérationnels que le corpus lit comme des déploiements de technologie de l'alliance sous le commandement direct de Yahvé.{{ cite(id="exodus", text="[7]", title="Exode — le buisson ardent, l'auto-nomination *Ehyeh asher ehyeh* et la théophanie du Sinaï") }} L'alliance au Sinaï, la remise du Décalogue et l'établissement du système sacerdotal sont la structuration institutionnelle, par l'alliance, de la lignée hébraïque pour la longue mission de transmission du message à travers les siècles qui suivirent. Les formes théophaniques précises de Yahvé en cette période — le buisson ardent, la nuée, le feu, le *kavod* (gloire manifestée) — sont lues par le cadre comme des descriptions de vaisseaux de l'alliance et d'installations protectrices.

### La période prophétique et le revirement politique

La période prophétique qui suit Moïse s'étend à travers la monarchie divisée, l'exil et la restauration post-exilique. Le contact de Yahvé avec les figures prophétiques de cette période — Samuel, Nathan, Élie, Élisée, Isaïe, Jérémie, Ézéchiel, Daniel et les Douze Petits Prophètes — procède selon des formes de plus en plus médiatisées au fil des siècles.{{ cite(id="isaiah", text="[8]", title="Isaïe 6 — la vision dans la salle du trône, Yahvé trônant avec les séraphins") }} La rencontre d'Élie à l'Horeb (1 Rois 19:11–13) est structurellement significative : Yahvé n'est explicitement *pas* dans le vent, ni dans le tremblement de terre, ni dans le feu, mais dans la *qol demamah daqqah*, la « voix d'un fin silence » — lue par le corpus comme une communication télépathique ou technologiquement médiatisée précise, distincte des théophanies plus visibles des périodes antérieures. Le passage du contact direct au contact indirect à travers la période du Bélier est l'expression opérationnelle de la découverte de la chaîne cosmique (traitée plus complètement dans l'entrée [Élohim](../elohim/)) : Yahvé, en tant que président du Conseil, mettant en œuvre le revirement politique que sa civilisation a adopté à la lumière de sa propre compréhension transformée.

### La période piscéenne

L'Ère des Poissons (vers 210 AEC – 1950 EC) est l'ère du retrait délibéré de la visibilité opérationnelle pendant que les missions chrétienne et islamique ont livré le contenu du cadre dans un vocabulaire religieux. Le rôle de Yahvé à travers cette période de deux mille ans est la supervision au niveau de l'alliance des interventions de l'Ère des Poissons : la conception délibérée de Jésus par insémination de Marie médiée par l'alliance, la protection de l'enfant durant la période hérodienne, la supervision continue du ministère de Jésus, et la supervision parallèle ultérieure de la mission de {% wiki(slug="muhammad") %}Mahomet{% end %} dans l'Arabie du VIIᵉ siècle. Les visions de l'Apocalypse à Jean de Patmos à la fin du Iᵉʳ siècle EC sont lues par le cadre comme la communication par Yahvé à Jean des événements qui se dérouleraient au cours des siècles de clôture des Poissons et de la transition vers le Verseau. L'auto-identification « le Premier et le Dernier » / « Alpha et Oméga » en {% libref(book="revelation", chapter=1, verse=8) %}Apocalypse 1:8{% end %}, {% libref(book="revelation", chapter=1, verse=17) %}1:17{% end %}, {% libref(book="revelation", chapter=21, verse=6) %}21:6{% end %} et {% libref(book="revelation", chapter=22, verse=13) %}22:13{% end %} est l'attribution propre de Yahvé et est traitée plus bas sous *Identifications et confusions*.{{ cite(id="revelation", text="[9]", title="Apocalypse 1:8 ; 1:17 ; 21:6 ; 22:13 — l'auto-identification « Premier et Dernier » / « Alpha et Oméga »") }}
...
Le troisième rôle précis que Yahvé occupe dans le cadre — et le plus conséquent épistémiquement pour le corpus — est celui de locuteur à la première personne du matériau source raëlien. *Le Livre qui dit la vérité* (1974),{{ cite(id="the-book-which-tells-the-truth", text="[10]", title="Vorilhon (Raël), *Le Livre qui dit la vérité* / *The Book Which Tells the Truth* (1974) — Yahvé comme locuteur à la première personne") }} *Les extraterrestres m'ont emmené sur leur planète* (1976),{{ cite(id="extraterrestrials-took-me-to-their-planet", text="[11]", title="Vorilhon (Raël), *Les extraterrestres m'ont emmené sur leur planète* / *Extraterrestrials Took Me to Their Planet* (1976) — rencontre avec le Conseil des Éternels") }} et *Accueillir les extra-terrestres* (1979){{ cite(id="lets-welcome-the-extraterrestrials", text="[12]", title="Vorilhon (Raël), *Accueillir les extra-terrestres* / *Let's Welcome the Extraterrestrials* (1979) — communications et clarifications ultérieures") }} sont présentés comme le récit propre, par Yahvé, de lui-même et de sa civilisation, livré à Vorilhon au cours des contacts de 1973 et 1975. L'essentiel de ce que le cadre sait de la civilisation élohimique, de l'arc biographique propre à Yahvé, de la structure politique interne du Conseil sur la planète d'origine, de la technologie de continuité par transfert cellulaire, de la découverte de la chaîne cosmique, et des plans de l'alliance pour le retour ouvert de l'Ère du Verseau — le cadre le sait parce que Yahvé l'a dit à Vorilhon.
...
Dans le Livre de l'Apocalypse et dans *Le Livre qui dit la vérité*, Yahvé s'identifie comme **le Premier et le Dernier** ({% libref(book="revelation", chapter=1, verse=17) %}Apocalypse 1:17{% end %} ; {% libref(book="revelation", chapter=22, verse=13) %}22:13{% end %}) et comme l'**Alpha et l'Oméga** ({% libref(book="revelation", chapter=1, verse=8) %}Apocalypse 1:8{% end %} ; {% libref(book="revelation", chapter=21, verse=6) %}21:6{% end %} ; {% libref(book="revelation", chapter=22, verse=13) %}22:13{% end %}). La théologie chrétienne conventionnelle a lu ces titres comme l'expression de la pré-existence et de la post-existence éternelles de Dieu — Dieu comme commencement et fin métaphysiques de toutes choses, englobant l'ensemble du temps sans y être lui-même assujetti.
...
Le travail strictement traductionnel de **Mauro Biglino** traite Yahvé en continuité avec son traitement d'*Élohim* en général — comme un individu précis au sein de la pluralité des *seigneurs d'en haut*, le texte hébreu décrivant ses actions en termes opérationnels concrets.{{ cite(id="the-bible-is-not-a-sacred-book", text="[14]", title="Biglino, série strictement littérale sur la Bible hébraïque (à partir de 2010) — Yahvé comme individu parmi les « seigneurs d'en haut »") }}{{ cite(id="the-naked-bible", text="[15]", title="Biglino & Cattaneo, *The Naked Bible* (2022) — étude plus large de la Bible hébraïque selon la même méthode strictement littérale") }} La lecture par Biglino de passages précis (la visite de Genèse 18 à Mamré, les théophanies de l'Exode, les récits de destruction) développe l'approche générale du corpus dans des cas textuels particuliers.
...
- [Genèse](../genesis/)
- [Bible](../bible/)
- [Livre de l'Apocalypse](../book-of-revelation/)
- [Allah](../allah/)
- [El](../el/)
