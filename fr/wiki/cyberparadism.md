...
see_also = [
    ...
    { title = "Ère du Verseau", path = "timeline/age-of-aquarius", description = "L'ère du seuil d'héritage au sein de laquelle le cyberparadisme émerge comme articulation culturelle de l'ère du Verseau." },
    { title = "Ère du Cancer", path = "timeline/age-of-cancer", description = "L'ère originaire du projet de l'alliance, au sein de laquelle Éden comme cyberparadisme se situe." },
...
Le cadre lit donc Éden non pas principalement comme lieu mytho-surnaturel (le cadrage théologique courant) mais comme le cyberparadisme historique effectif — le laboratoire originaire de l'alliance opérant substantiellement comme première réalisation des principes que l'esthétique cyberparadiste contemporaine articule comme vision d'avenir. Le traitement détaillé d'Éden vit dans l'entrée {% wiki(slug="eden") %}Éden{% end %} lorsqu'elle sera rédigée ; le traitement plus large du projet originaire de l'alliance vit dans l'entrée [Ère du Cancer](/fr/timeline/age-of-cancer/) lorsqu'elle sera rédigée.
