+++
title = "Littérature des Hekhalot"
slug = "hekhalot-literature"
description = "La littérature des Hekhalot (hébreu הֵיכָלוֹת, « palais ») est l'ensemble des écrits mystiques juifs de l'Antiquité tardive décrivant l'ascension de l'âme à travers sept palais célestes jusqu'au char-trône divin (merkavah). C'est la strate pré-kabbalistique de la mystique juive, et le corpus dans lequel le Shi'ur Qomah est transmis."
...
entry_type = "text"
claim_type = "direct"
alternative_names = ["Littérature des Hekhalot / Heikhalot (הֵיכָלוֹת)", "Mystique de la Merkavah", "Mystique de la Merkabah", "la littérature des « palais »", "*ma'aseh merkavah* ('l'œuvre du char')"]
timeline = ["multi-age"]

[extra.infobox]
type = "Corpus de textes mystiques juifs de l'Antiquité tardive / du haut Moyen Âge (pré-kabbalistiques)"
literal_meaning = "Hébreu הֵיכָלוֹת (*hekhalot*), pluriel de הֵיכָל (*hekhal*), « palais » ou « salle » — les sept palais célestes de l'ascension"
also_called = "Mystique de la Merkavah (char), d'après la vision du trône d'Ézéchiel (*ma'aseh merkavah*, « l'œuvre du char »)"
principal_works = "*Hekhalot Rabbati* (« les Grands Palais »), *Hekhalot Zutarti* (« les Petits Palais »), *Ma'aseh Merkavah*, *Merkavah Rabbah*, *3 Hénoch* (le Livre hébreu d'Hénoch) ; le *Shi'ur Qomah* est enchâssé dans le corpus"
practitioner = "Le *yored merkavah* (« celui qui descend vers le char »), qui monte à travers les palais muni d'hymnes, de noms angéliques et de sceaux"
dating = "Contestée : composition / rédaction entre environ le IIIe et le VIIIe siècle apr. J.-C. (Scholem la situait plus tôt, Schäfer plus tard et en Babylonie gaonique)"
key_figure = "L'ange Metatron — « Prince de la Présence », scribe céleste, et (dans 3 Hénoch) le patriarche Hénoch transfiguré"
+++

The **Hekhalot literature** (Hebrew הֵיכָלוֹת, *hekhalot*, "palaces" or "halls") is the corpus of late-antique Jewish mystical writings that describes the ascent of the initiate through **seven concentric heavenly palaces** to the throne-room of God — the מֶרְכָּבָה (*merkavah*), the wheeled chariot-throne the prophet Ezekiel saw by the river Chebar. It is the **pre-Kabbalistic stratum** of Jewish mysticism: older than the [Zohar](../kabbalah/) and the classical [Kabbalah](../kabbalah/) by centuries, and the corpus within which the [**Shi'ur Qomah**](../shiur-qomah/) — the text behind the Raëlian canon's parasang figures — is transmitted.
...
The Hekhalot literature is the ancestor of the classical Kabbalah, though scholars debate how direct the line is. Its throne-visions, its structured hierarchy of divine names and powers, and its *Shi'ur Qomah* speculation on the divine body all feed forward into the medieval *[sephirotic](../tree-of-life/)* cosmology — where the measured limbs of the divine body are reconceived as the ten emanations of the [Tree of Life](../tree-of-life/). The [Kabbalah](../kabbalah/) entry treats that later development; this entry covers the earlier stratum from which it grew.

## In the Wheel of Heaven framework

The framework reads the Hekhalot / Merkavah tradition as a **late-antique preservation of structured-plurality content** — the throne surrounded by named angelic powers, the ascent to a governing celestial court — consonant with the corpus's broader [Plurality of Gods](../plurality-of-gods/) reading of the "divine" as an organized civilization of many beings rather than a monad. Its most concrete contribution is the [Shi'ur Qomah](../shiur-qomah/): embedded in this literature, quoted by it, and carried into print through the *Sefer Raziel ha-Mal'akh*, it supplies the two parasang measurements that [Yahweh](../yahweh/) attributes to "the Kabbalah" and that the framework reads as the [Elohim Home Planet](../elohim-home-planet/)'s astronomical distances. Correctly locating that passage in the Hekhalot stratum — not in the *Zohar* — is what resolves the canon's apparent category error, since a passage from an esoteric Hebrew corpus genuinely did become a "book" one could procure.

The full argument is set out in the Explainer [**The Book Closest to the Truth**](/articles/the-book-closest-to-the-truth/), which reads the embedded text through the [*Shi'ur Qomah* — Wheel of Heaven Translation](/library/shiur-qomah-woh/).
