...
description = "Un catalogue des textes, traditions et figures que les trois livres canoniques du corpus raélien — Le Livre qui dit la Vérité (1974), Les Extra-terrestres m'ont emmené sur leur planète (1975) et Accueillir les Extra-terrestres (1979) — citent directement ou auxquels ils font allusion indirectement, organisé en un premier niveau de sources nommées et un second niveau de sources suggérées."
...
alternative_names = ["Carte intertextuelle du canon raélien", "Textes et traditions cités dans le canon raélien", "Champ intertextuel du canon raélien", "L'horizon de sources du canon"]
timeline = ["pisces"]
lead = "À travers les trois livres canoniques du corpus raélien, Claude Vorilhon (Raël) construit son exposé en citant, paraphrasant et évoquant une vaste gamme de textes, traditions et figures préexistants. Cette entrée catalogue ce champ intertextuel en deux niveaux : un premier niveau d'œuvres que le canon nomme ou cite ouvertement, et un second niveau de traditions, langues et motifs que le canon engage sans les citer formellement."
reading = "interpretive"

see_also = [
    { title = "Bible", path = "/wiki/bible/", description = "La tradition textuelle plus large dans laquelle s'inscrivent la Bible hébraïque et le Nouveau Testament." },
    { title = "Bible hébraïque", path = "/wiki/hebrew-bible/", description = "Le corpus de référence le plus vaste et le plus précisément cité du canon." },
    { title = "Genèse", path = "/wiki/genesis/", description = "Le livre le plus largement cité dans l'exégèse de l'histoire primordiale du canon." },
    { title = "Kabbale", path = "/wiki/kabbalah/", description = "Nommée dans La Fin du Monde comme « le livre le plus proche de la vérité » ; le passage sur les parasanges renvoie au Shi'ur Qomah." },
    { title = "Raëlisme", path = "/wiki/raelism/", description = "Le mouvement constitué par les trois livres canoniques catalogués ici." },
    { title = "Raël", path = "/wiki/rael/", description = "Claude Vorilhon, auteur des trois livres canoniques." },
    { title = "Élohim", path = "/wiki/elohim/", description = "La désignation civilisationnelle que le canon décode à partir du pluriel hébreu." },
    { title = "Yahvé", path = "/wiki/yahweh/", description = "Le chef du Conseil que le canon restaure dans le texte biblique." },
...
footnotes = [
    ...
    { content = "Le canon exclut explicitement de son champ la tradition interprétative plus large des anciens astronautes (Sendy, Sitchin, von Däniken, Wallis, Biglino) en tant que *contexte importé par le lecteur* plutôt que comme corpus de référence propre au canon. Le canon raélien revendique la révélation, non la dérivation, et traite la littérature religieuse antérieure comme des comptes rendus imparfaits de contacts élohimiens antérieurs plutôt que comme ses propres sources intellectuelles. Le cadre du corpus distingue soigneusement ces strates : cette entrée ne catalogue que ce que le canon lui-même nomme et engage." },
]

[[extra.references]]
id = "the-book-which-tells-the-truth"
note = "Vorilhon (Raël, 1974) ; le livre canonique fondateur et le principal lieu de l'exégèse biblique du canon (Genèse 1-11 chapitre par chapitre)."

[[extra.references]]
id = "extraterrestrials-took-me-to-their-planet"
note = "Vorilhon (Raël, 1975) ; contient le chapitre Bouddhisme, les citations directes du Coran et la lecture des ossements desséchés d'Ézéchiel 37."

[[extra.references]]
id = "lets-welcome-the-extraterrestrials"
note = "Vorilhon (Raël, 1979) ; contient le chapitre Les Nouvelles Révélations sur l'Apocalypse et le commentaire Oui... je suis raélien énumérant les traces survivantes."

[[extra.references]]
id = "intelligent-design-message-from-the-designers"
note = "L'omnibus anglais de 2005 réunissant les trois livres canoniques ; le texte de base principal de ce catalogue."

[[extra.references]]
id = "dhorme-bible"
note = "La principale Bible française utilisée par Raël lors du contact de 1973 et citée dans les volumes canoniques français."

[[extra.references]]
id = "rnkjv"
note = "Restored Name King James Version ; la principale Bible anglophone utilisée dans l'omnibus de 2005, restaurant Élohim et Yahvé dans le texte."

[[extra.references]]
id = "the-qur-an"
locator = "Sourate 21:1-5 ; 54:1 ; 56:15-24"
note = "Directement cité dans Les Extra-terrestres m'ont emmené sur leur planète avec précision chapitre-et-verset."

[[extra.references]]
id = "book-of-enoch"
note = "Nommé dans le commentaire Oui... je suis raélien comme l'un des textes les plus proches de la vérité du canon."

[[extra.references]]
id = "shiur-qomah"
note = "La tradition mystique juive ancienne dont le motif anthropomorphique-cosmique de mesure du corps correspond à la citation kabbalistique des parasanges / hauteur du créateur dans le canon."

[[extra.references]]
id = "epic-of-gilgamesh"
note = "Énumérée dans le commentaire Oui... je suis raélien parmi les traces survivantes (identifiée comme « sumérienne-babylonienne »)."

[[extra.references]]
id = "mahabharata"
note = "Nommé dans le commentaire Oui... je suis raélien ; les Védas et le Rāmāyaṇa sont énumérés comme parties du corpus plus large."

[[extra.references]]
id = "ramayana"
note = "Énuméré aux côtés du Mahābhārata dans le commentaire Oui... je suis raélien."

[[extra.references]]
id = "vedas"
note = "Nommé au sein du corpus du Mahābhārata dans le commentaire Oui... je suis raélien."

[[extra.references]]
id = "kojiki"
note = "La chronique japonaise de 712 ap. J.-C. nommée dans le commentaire Oui... je suis raélien parmi les traces survivantes."

[[extra.references]]
id = "popol-vuh"
note = "L'épopée maya k'iche' de la création nommée dans le commentaire Oui... je suis raélien, aux côtés de la Chronique d'Akakor comme témoignage latino-américain."

[[extra.references]]
id = "chronicle-of-akakor"
note = "Brugger (1976) ; apparaît dans la liste des traces de Oui... je suis raélien. La critique ultérieure traite largement l'œuvre de Brugger comme une supercherie littéraire — une tension non résolue dans l'horizon de référence du canon."
+++
...
1. **Référence directe.** Un texte, une figure ou une tradition que le canon nomme explicitement, dont il cite des extraits, ou auquel il attribue un chapitre-et-verset numéroté.
2. **Référence indirecte.** Un texte, une figure, une tradition, une langue ou un motif que le canon engage sans citation formelle — par paraphrase, lecture étymologique, mention dans des listes, ou allusion à un contenu caractéristique.
3. **Contexte importé par le lecteur.** Matériau qu'un lecteur ou commentateur peut apporter au canon depuis l'extérieur (Sendy, Sitchin, Biglino, la littérature des anciens astronautes en général). Cette troisième catégorie est **hors du champ** de cet article{{ footnote(id="6") }}. Elle est cataloguée ailleurs dans la taxonomie des sources du projet.
...
Le texte de base de ce catalogue est l'édition omnibus anglophone de 2005 *Intelligent Design — Message From the Designers*{{ cite(id="intelligent-design-message-from-the-designers", text="[1]", title="L'omnibus anglais de 2005 réunissant les trois livres canoniques") }}{{ footnote(id="1") }}, qui réunit les trois livres canoniques. Lorsque les éditions françaises originales diffèrent de la traduction anglaise dans leur traitement des citations bibliques, le canon lui-même note la divergence : les volumes français s'appuient principalement sur la traduction de la Bible d'**Édouard Dhorme**{{ cite(id="dhorme-bible", text="[2]", title="Dhorme (1956-1959) ; la traduction française de la Bible consultée par Raël") }}{{ footnote(id="2") }}, tandis que l'omnibus anglais utilise la **Restored Name King James Version** (RNKJV){{ cite(id="rnkjv", text="[3]", title="Restored Name King James Version ; restaure Élohim et Yahvé dans le texte") }} pour la plupart des citations, avec un usage occasionnel de la **New King James Version**, de l'**American Standard Version**, de la **Webster Bible**, de la **Hebrew Names Version** et de la **Darby Translation**. Ces choix éditoriaux sont eux-mêmes des références directes à des traditions textuelles spécifiques et sont catalogués ci-dessous.
...
La liste *Oui... je suis raélien* est un commentaire d'un disciple plutôt qu'une déclaration de Raël, mais elle apparaît dans l'omnibus canonique et articule la même lecture que le canon établit dans *À la Racine de Toutes les Religions*{{ footnote(id="3") }}.

### Langues engagées philologiquement

Le canon mène des lectures étymologiques soutenues, traitant les histoires des mots comme des témoignages à part entière{{ footnote(id="5") }}. Les langues explicitement mobilisées comprennent :
