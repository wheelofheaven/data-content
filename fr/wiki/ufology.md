+++
title = "Ufologie"
description = "L'ufologie est l'étude des objets volants non identifiés et des phénomènes de rencontres associés. Le corpus Wheel of Heaven en discute la valeur documentaire en distinguant les cas exploitables des cas non concluants, sans s'aligner sur l'ensemble du champ."
...
see_also = [
    { title = "PURSUE", path = "wiki/pursue", description = "Le programme du gouvernement des États-Unis de 2026 publiant les dossiers UAP non résolus sur war.gov/UFO — le développement institutionnel actuel du champ." },
]
