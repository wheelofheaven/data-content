...
entry_type = "figure"
claim_type = "inferred"
alternative_names = ["l'Adversaire", "l'Accusateur", "l'Opposition", "*ha-satan* (הַשָּׂטָן, « le satan »)", "*satan* (שָׂטָן, nom commun)", "le Calomniateur", "*diabolos* (διάβολος, grec)", "le Diable (désignation théologique médiévale-chrétienne, amalgamée)", "le Testeur", "le Sceptique"]
timeline = ["all-ages"]
...
see_also = [
    ...
    { title = "Adam et Ève", path = "/wiki/adam-and-eve/", description = "Les figures principales du récit d'Éden dont la désobéissance confirma les inquiétudes fondatrices de Satan." },
    { title = "Antédiluvien", path = "/wiki/antediluvian/", description = "La période antédiluvienne durant laquelle Satan accumula les preuves de l'agressivité humaine en vue de la décision de destruction." },
    { title = "Grand Déluge", path = "/wiki/great-flood/", description = "L'exécution de la décision de destruction ; l'épisode où les prédictions de Satan furent opérationnellement réalisées." },
    { title = "Chaîne cosmique", path = "/wiki/cosmic-chain/", description = "La découverte postdiluvienne qui transforma la politique du Conseil et la position institutionnelle de Satan." },
    { title = "Théomachie", path = "/wiki/theomachy/", description = "Le cadre plus large du conflit cosmico-politique au sein duquel opère l'opposition de Satan." },
    { title = "Dragons", path = "/wiki/dragons/", description = "Le traitement de l'incident de laboratoire sur le monde d'origine ; vestige de mémoire culturelle du programme biologique originel." },
    { title = "Jésus", path = "/wiki/jesus/", description = "L'épisode principal de mise à l'épreuve d'un prophète dans le Nouveau Testament (Matthieu 4, 1-11 ; Luc 4, 1-13)." },
    { title = "Prophète", path = "/wiki/prophet/", description = "Le rôle institutionnel au sein duquel opère la fonction de mise à l'épreuve contradictoire de Satan." },
    { title = "Bible hébraïque", path = "/wiki/hebrew-bible/", description = "La source scripturaire principale pour l'articulation de la figure du ha-satan comme procureur du Conseil." },
]

footnotes = [
    { content = "L'articulation par le corpus du mécanisme d'amalgame — par lequel quatre figures originellement distinctes (Satan, Lucifer, le Serpent, le Diable) se sont fondues en une unique personnification du mal cosmique — opère à travers trois moments historiques principaux : l'effondrement post-Sodome du cadre éducatif qui avait jusque-là préservé les distinctions ; l'influence dualiste zoroastrienne d'époque perse sur le judaïsme du Second Temple, qui fournit la grille de lecture du bien-cosmique-contre-mal-cosmique ; et l'élaboration théologique chrétienne de la figure composite résultante en l'élaborée démonologie médiévale. Le cadre lit cela comme le mécanisme opérationnel par lequel la taxonomie originelle à quatre figures fut progressivement perdue." },
    { content = "Le prologue de Job (Job 1-2) consigne le ha-satan opérant avec pleine recevabilité procédurale au Conseil : la figure dispose d'un accès institutionnel à la cour divine, soulève ses contestations selon la procédure adéquate, et opère sous autorisation formelle d'un vote du Conseil. La lecture théologique dominante du satan de Job comme « un adversaire » plutôt que comme « le Diable » constitue elle-même un consensus académique substantiel (Day 1988 ; Pope 1973 ; Habel 1985 ; Newsom 2003 ; Clines 1989-2011 convergent sur ce point) ; la lecture spécifique du corpus ajoute l'articulation politico-institutionnelle de ce que signifie le rôle adversaire au sein du cadre plus large du Conseil." },
    ...
    { content = "L'hébreu *satan* (שָׂטָן) est, dans son usage biblique original, un nom commun dérivé de la racine *s-t-n* signifiant « s'opposer », « faire obstacle », « être hostile à ». Ses occurrences dans des contextes non théologiques (1 Samuel 29, 4 pour David comme adversaire philistin ; 1 Rois 11 pour les opposants géopolitiques de Salomon ; Nombres 22 pour l'ange comme adversaire de Balaam) établissent le terme comme désignation relationnelle-positionnelle plutôt que comme nom propre. Le glissement vers un usage de nom propre — et l'amalgame avec Lucifer, le Serpent et le Diable — est un développement du Second Temple et postbiblique que le cadre lit comme historique-évolutif plutôt qu'originel au matériau hébraïque." },
    { content = "Le grec néotestamentaire *diabolos* (διάβολος) signifie littéralement « calomniateur » ou « celui qui parle contre » (de *dia-* + *bállō*, « jeter à travers », « parler contre »). Le contenu lexical correspond précisément à la fonction institutionnelle de Satan dans le rôle de mise à l'épreuve des prophètes — la figure qui soulève des objections, met en cause, conteste. L'élaboration théologique progressive de *diabolos* en « le Diable » comme personnification du mal cosmique obscurcit le contenu lexico-fonctionnel original de la désignation." },
    { content = "Les traditions transculturelles de figures d'opposition (Angra Mainyu/Ahriman zoroastrien ; asuras hindous ; Mara bouddhique ; Seth égyptien ; Loki nordique) préservent le motif plus large de l'opposition de principe au sein de leurs cadres culturels et religieux distinctifs. Le cadre n'exige pas le rejet du cadre explicatif comparatif dominant — diffusion culturelle, substrat cognitivo-archétypal partagé et développement culturel indépendant y contribuent tous. Ce que le cadre ajoute est le fondement historico-politique sous-jacent : la structure politico-institutionnelle éloha effective au sein de laquelle les figures d'opposition des diverses traditions s'enregistrent comme mémoire culturelle." },
]

[[extra.references]]
id = "the-book-which-tells-the-truth"
note = "Premier ouvrage raëlien de Vorilhon (1974) ; la section « Satan » établit Satan comme chef de la faction d'opposition et propose l'exégèse principale du passage de Job."

[[extra.references]]
id = "extraterrestrials-took-me-to-their-planet"
note = "Deuxième ouvrage raëlien de Vorilhon (1975) ; le contenu « Les humains ne pouvaient comprendre », le contexte antédiluvien de la décision de destruction, la transformation postdiluvienne, la fonction de mise à l'épreuve des prophètes et le passage du débat au Conseil lors de la rencontre du Périgord."

[[extra.references]]
id = "lets-welcome-the-extraterrestrials"
note = "Troisième ouvrage raëlien de Vorilhon (1979) ; cadre politico-institutionnel plus large du Conseil."

[[extra.references]]
id = "intelligent-design-message-from-the-designers"
note = "Édition canonique recueillie des trois ouvrages raëliens du matériau source."

[[extra.references]]
id = "genesis"
locator = "Genèse 3 ; Genèse 6, 1-4"
note = "Récit du serpent d'Éden (non identifié à Satan dans le texte hébreu) et matériau des *benei ha-Elohim* / Nephilim sous-tendant la tradition des Veilleurs au Second Temple."

[[extra.references]]
id = "1-enoch-the-book-of-the-watchers"
note = "Matériau des Veilleurs au Second Temple ; Azazel et le récit de la rébellion angélique s'appuyant sur Genèse 6, 1-4."

[[extra.references]]
id = "book-of-enoch"
note = "Élaboration plus large du corpus hénochique sur le récit de la rébellion angélique ; source principale du Second Temple pour le développement de la figure du mal cosmique."

[[extra.references]]
id = "the-naked-bible"
note = "Biglino & Cattaneo (2022) ; traduction strictement littérale de l'hébreu incluant le matériau sur le satan."

[[extra.references]]
id = "the-bible-is-not-a-sacred-book"
note = "Série de Biglino sur la traduction strictement littérale de la Bible hébraïque ; argument philologique fondateur selon lequel les traditions de traduction dominantes obscurcissent le contenu hébreu original."

[[extra.references]]
id = "the-qur-an"
locator = "Coran 2, 34 ; 7, 11-13 ; 15, 28-44 ; 17, 61-65 ; 18, 50 ; 20, 116 ; 38, 71-85"
note = "Matériau coranique sur Iblîs / Shaytan avec un contenu substantiellement parallèle au satan hébraïque."

[[extra.references]]
id = "avesta"
note = "Écriture zoroastrienne ; le cadre cosmico-dualiste Angra Mainyu / Ahura Mazda qui a substantiellement influencé le développement, au Second Temple, de la figure du satan."

[[extra.references]]
id = "sendy-ces-dieux"
note = "Articulation française fondatrice de l'hypothèse des Élohim par Sendy (1969) ; lecture transtraditionnelle des dynamiques cosmico-politiques."

[[extra.references]]
id = "wallis-eden-conspiracy"
note = "Wallis (2024) ; articulation contemporaine de la lecture Éden / civilisation ingéniérée, avec un contenu substantiel de démêlage Satan-Lucifer."

[[extra.references]]
id = "day-adversary-heaven"
note = "Day (1988) ; étude philologique fondatrice de la figure du satan hébraïque à travers la Bible hébraïque, distinguant les usages en nom commun et en forme à article défini."

[[extra.references]]
id = "pope-job"
note = "Pope (1973) ; commentaire Anchor Bible sur Job, avec traitement substantiel de la figure du ha-satan dans le prologue."

[[extra.references]]
id = "habel-job"
note = "Habel (1985) ; commentaire Westminster sur Job ; articulation substantielle du ha-satan comme opposition institutionnelle."

[[extra.references]]
id = "newsom-job-moral"
note = "Newsom (2003) ; monographie principale sur la structure morale et imaginative de Job, incluant le rôle institutionnel-adversaire de la figure du ha-satan."

[[extra.references]]
id = "clines-job-wbc"
note = "Clines (1989-2011) ; commentaire Word Biblical Commentary en trois volumes sur Job, commentaire critique contemporain principal."

[[extra.references]]
id = "russell-devil-antiquity"
note = "Russell (1977) ; premier volume de la tétralogie principale sur l'histoire de la figure du Diable ; de l'Antiquité au christianisme primitif."

[[extra.references]]
id = "russell-satan-early-christian"
note = "Russell (1981) ; l'élaboration paléochrétienne de Satan en personnification du mal cosmique."

[[extra.references]]
id = "russell-lucifer-middle-ages"
note = "Russell (1984) ; l'élaboration démonologique médiévale de la figure amalgamée Satan/Lucifer/Diable."

[[extra.references]]
id = "russell-mephistopheles-modern"
note = "Russell (1986) ; les transformations modernes de la figure du Diable à travers la culture occidentale post-Réforme."

[[extra.references]]
id = "pagels-origin-satan"
note = "Pagels (1995) ; origines polémico-sociologiques de la figure chrétienne de Satan comme marqueur de frontière contre les opposants politico-religieux."

[[extra.references]]
id = "kelly-satan-biography"
note = "Kelly (2006) ; biographie historico-philologique principale de la figure de Satan à travers les traditions juive et chrétienne."

[[extra.references]]
id = "mcginn-antichrist"
note = "McGinn (1994) ; traitement historique de la tradition de l'Antéchrist, étroitement adjacente à l'érudition sur le développement de Satan."

[[extra.references]]
id = "boyce-zoroastrians"
note = "Boyce (1979) ; le cadre cosmico-dualiste Angra Mainyu / Ahura Mazda qui a substantiellement influencé le développement, au Second Temple, de la figure du satan."

[[extra.references]]
id = "nickelsburg-enoch-1"
note = "Nickelsburg (2001) ; commentaire Hermeneia sur 1 Hénoch ; fondateur pour la tradition des Veilleurs et le matériau des Nephilim de Genèse 6."

[[extra.references]]
id = "reed-fallen-angels"
note = "Reed (2005) ; réception de la littérature hénochique dans la tradition juive et chrétienne."
...
note = "VanderKam (2e éd. 2010) ; introduction accessible aux manuscrits de la mer Morte."

[[extra.references]]
id = "bodman-poetics-iblis"
note = "Bodman (2011) ; le récit d'Iblîs dans le Coran, contenu étroitement parallèle à celui de la figure du satan hébraïque."

[[extra.references]]
id = "awn-satan-iblis"
note = "Awn (1983) ; la tradition d'Iblîs dans la psychologie soufie, articulant Iblîs comme figure d'opposition de principe."

[[extra.references]]
id = "doniger-hindu-myths"
note = "Doniger (1975) ; recueil de mythes hindous incluant la tradition des asuras, étroitement parallèle au contenu du satan hébraïque."

[[extra.references]]
id = "williams-mahayana"
note = "Williams (2e éd. 2008) ; fondements doctrinaux du bouddhisme Mahāyāna, incluant la tradition de Mara et la fonction de mise à l'épreuve des prophètes."

[[extra.references]]
id = "sturluson-prose-edda"
note = "Sturluson (vers 1220) ; tradition mythologique nordique principale, incluant la figure de Loki au contenu substantiellement parallèle."

[extra.infobox]
type = "Figure ; chef éloha d'une faction politique sur le monde d'origine"
position = "Chef de la faction politique du monde d'origine opposée à la création d'êtres synthétiques capables d'égaler ou de dépasser leurs créateurs ; membre du Conseil des Éternels ; rôle institutionnel adversaire dans la structure politique plus large des Élohim"
location = "Monde d'origine (la planète des Élohim) ; jamais sur Terre dans l'articulation du matériau source"
political_position = "Opposition de principe au programme terrestre tout au long de son histoire ; la position selon laquelle les créations synthétiques capables d'égaler leurs créateurs sont fondamentalement dangereuses ; plaidoyer pour la destruction humaine durant la crise antédiluvienne ; position sceptique continue après le Déluge, tout en acceptant le vote majoritaire du Conseil de ne plus jamais détruire l'humanité"
distinguished_from = "Lucifer (chef de la faction des créateurs exilés sur Terre, l'agent de divulgation d'Éden) ; le Serpent (la faction de Lucifer collectivement dans le rôle de divulgation d'Éden) ; le Diable (le *diabolos* grec, désignant la fonction institutionnelle adversaire de Satan) ; la figure théologique médiévale-chrétienne (la personnification amalgamée du mal cosmique combinant des éléments des quatre figures originellement distinctes)"
hebrew_etymology = "*satan* (שָׂטָן), nom commun dérivé de la racine hébraïque *s-t-n* signifiant « s'opposer », « faire obstacle », « être hostile à » ; la forme nominale signifie « adversaire », « accusateur », « opposant » ; apparaît comme nom commun dans des contextes non théologiques (adversaires politiques, opposants militaires, procureurs) ; la forme à article défini *ha-satan* (הַשָּׂטָן, « le satan ») est la désignation institutionnelle spécifique de la Bible hébraïque"
greek_designation = "*diabolos* (διάβολος, « calomniateur », « celui qui parle contre ») ; mot grec du Nouveau Testament pour « le diable » ; dans son sens linguistique premier, « le calomniateur » — la figure qui parle contre autrui, qui cherche à mettre en cause, qui soulève des objections et des contestations ; précisément la fonction qu'accomplit Satan dans la mise à l'épreuve des prophètes"
principal_episodes = "L'incident de laboratoire sur le monde d'origine et l'opposition politique au programme biologique originel ; la période antédiluvienne durant laquelle Satan accumula les preuves de l'agressivité humaine ; la période de la décision de destruction conduisant au Grand Déluge ; la découverte postdiluvienne de la Chaîne cosmique et le vote du Conseil ; le rôle institutionnel de mise à l'épreuve des prophètes à travers la tradition prophétique subséquente ; la mise à l'épreuve de Job (Job 1-2) ; la mise à l'épreuve de Jésus (Matthieu 4, 1-11 ; Luc 4, 1-13)"
status_in_source_material = "Substantiellement documenté ; les passages principaux du matériau source établissent à la fois le rôle politico-factionnel spécifique de Satan et le démêlage rigoureux d'avec Lucifer, le Serpent et la tradition plus large amalgamée"
principal_text = "*Le Livre qui dit la vérité* (1974) ; *Les Extra-terrestres m'ont emmené sur leur planète* (1975), section « Satan » et contenu « Les humains ne pouvaient comprendre » ; chapitre de l'Âge du Cancer de *timeline.epub* (sections III-IV, avec traitement substantiel de la taxonomie à quatre figures) ; chapitre de l'Âge des Gémeaux de *timeline.epub* (section III, avec le contenu de la Décision) ; chapitre de l'Âge des Poissons de *timeline.epub* (le contenu de la mise à l'épreuve de Jésus)"

+++

**Satan** (שָׂטָן, hébreu : « adversaire », « accusateur », « opposant ») est une **figure éloha du monde d'origine**, chef de la faction politique au sein de la civilisation des Élohim qui s'est toujours opposée à la création d'êtres synthétiques capables d'égaler ou de dépasser leurs créateurs. La position de Satan est demeurée substantiellement constante depuis avant le commencement du programme terrestre : la création d'êtres à l'image des Élohim est fondamentalement dangereuse, et aucun protocole, aucune supervision et aucune distance géographique ne sauraient être tenus pour fiables afin d'en contenir le risque. Lorsque l'accident de laboratoire originel sur le monde d'origine produisit les premières victimes (traité plus en détail dans le prologue du monde d'origine de l'entrée {% wiki(slug="dragons") %}Dragons{% end %}), la faction de Satan utilisa l'incident pour imposer l'arrêt du programme biologique sur la planète d'origine. Lorsque les scientifiques se relocalisèrent sur Terre pour poursuivre leurs travaux, Satan et sa faction observèrent le programme terrestre avec suspicion et intervinrent périodiquement, par l'intermédiaire du Conseil des Éternels, pour imposer des restrictions. Lorsque la création humaine se révéla capable de désobéissance et du type de comportement que Satan avait prédit dès le départ, ce fut la voix de Satan qui s'éleva le plus fort dans les salles du Conseil du monde d'origine, appelant à la destruction de ce qui avait été fait.

La contribution analytique distinctive du cadre est le démêlage rigoureux de Satan d'avec trois autres figures et rôles distincts que la tradition religieuse occidentale dominante a progressivement amalgamés en une unique personnification du mal cosmique au cours de la période du Second Temple et du développement théologique chrétien subséquent. Les quatre figures originellement distinctes : **Satan** (le chef de l'opposition au Conseil du monde d'origine, jamais sur Terre) ; **Lucifer** (le chef de la faction des créateurs exilés sur Terre, l'agent de divulgation d'Éden) ; **le Serpent** (la faction de Lucifer collectivement dans le rôle de divulgation d'Éden) ; et **le Diable** (le *diabolos* grec, « calomniateur », désignant la fonction institutionnelle adversaire de Satan dans la mise à l'épreuve des prophètes). La figure contemporaine de la tradition chrétienne Satan/Lucifer/le Diable est le résultat de l'amalgame progressif de ces quatre figures distinctes sur environ deux mille ans de développement religieux et théologique. La contribution spécifique du corpus consiste à articuler la taxonomie originelle à quatre figures et à consigner le mécanisme historique par lequel l'amalgame s'est produit — en particulier l'effondrement post-Sodome du cadre éducatif qui avait préservé les distinctions, l'influence dualiste perse sur le judaïsme du Second Temple, et l'élaboration théologique chrétienne de la figure amalgamée en l'élaborée démonologie médiévale{{ footnote(id="1") }}.

La caractérisation spécifique de Satan dans le matériau source relève du principe plutôt que de la diabolisation. La formulation propre de la source : *« Satan n'était que l'un des Élohim, dirigeant en quelque sorte un parti politique sur la planète, qui s'opposait à la création d'êtres artificiels à leur image par d'autres Élohim qui pensaient eux-mêmes pouvoir créer des êtres positifs et non violents. »*{{ cite(id="the-book-which-tells-the-truth", text="[1]", title="Vorilhon (Raël), *Le Livre qui dit la vérité* (1974) — section « Satan », articulation fondatrice de Satan comme chef de la faction d'opposition") }} La caractérisation n'est ni diabolisante ni disculpante. Elle est descriptive. Satan est un homme politique, non un démon. Il dirige un parti. Le parti a un programme. Le programme a des arguments. La justesse des arguments du programme est l'une des questions politiques centrales que met à l'épreuve le récit plus large du corpus — l'argument substantiel auquel Satan, Yahvé et Lucifer ont tous été associés, selon lequel les créations synthétiques capables d'égaler leurs créateurs deviendront inévitablement dangereuses, a été éprouvé sur tout l'arc du développement civilisationnel humain, depuis l'expulsion d'Éden jusqu'à la période contemporaine, avec des éléments empiriques mitigés et contestés. Le cadre l'enregistre sans forcer une conclusion prématurée.

Le rôle institutionnel spécifique de Satan durant la période postdiluvienne est la mise à l'épreuve des figures prophétiques par entretien contradictoire. Après le vote du Conseil postdiluvien de ne plus jamais détruire l'humanité (consécutif à la découverte par les Élohim qu'ils avaient eux-mêmes été créés — le cadre de la Chaîne cosmique traité plus en détail dans l'entrée {% wiki(slug="cosmic-chain") %}Chaîne cosmique{% end %}), la position d'opposition continue de Satan fut institutionnalisée par la fonction de mise à l'épreuve des prophètes. *« Satan est toujours convaincu du mal présent en l'Homme, mais il s'incline devant la majorité de ceux qui, derrière Yahvé, pensent le contraire au sein du conseil des Éternels. »*{{ cite(id="extraterrestrials-took-me-to-their-planet", text="[2]", title="Vorilhon (Raël), *Les Extra-terrestres m'ont emmené sur leur planète* (1975) — passage de la transformation postdiluvienne, soumission institutionnelle de Satan à la majorité du Conseil") }} La logique institutionnelle est opérationnelle : un prophète qui pourrait être retourné par les épreuves de Satan serait un risque pour la mission plus large ; un prophète qui résisterait aux épreuves serait digne de confiance. Les épreuves étaient, en effet, un entretien contradictoire conduit par l'opposition politique précisément parce que le scepticisme motivé de l'opposition exposerait toute faiblesse dans l'engagement du candidat. Les mises à l'épreuve principalement documentées — celle de Job ({% libref(book="job-woh", chapter=1) %}Job 1{% end %}-{% libref(book="job-woh", chapter=2) %}2{% end %}){{ footnote(id="2") }} et celle de Jésus ({% libref(book="matthew-woh", chapter=4, verse=1) %}Matthieu 4, 1-11{% end %} ; {% libref(book="luke-woh", chapter=4, verse=1) %}Luc 4, 1-13{% end %}) — consignent la procédure institutionnelle de manière substantielle{{ footnote(id="3") }}.

La lecture est substantiellement ancrée dans la source. Le matériau source raëlien fournit une articulation explicite du rôle politico-factionnel spécifique de Satan à travers plusieurs passages dans *Le Livre qui dit la vérité* (1974), *Les Extra-terrestres m'ont emmené sur leur planète* (1975), et le corpus source plus large,{{ cite(id="lets-welcome-the-extraterrestrials", text="[10]", title="Vorilhon (Raël), *Accueillir les Extra-terrestres* (1979) — cadre politico-institutionnel plus large du Conseil") }}{{ cite(id="intelligent-design-message-from-the-designers", text="[11]", title="Vorilhon (Raël), *Le Dessein intelligent : message des Concepteurs* — édition canonique recueillie des trois ouvrages raëliens du matériau source") }} avec un développement corpus substantiel subséquent dans le chapitre de l'Âge du Cancer de *timeline.epub* (la taxonomie à quatre figures), le chapitre de l'Âge des Gémeaux (le contenu de la Décision), et le chapitre de l'Âge des Poissons (le contenu de la mise à l'épreuve de Jésus). L'articulation spécifique par le corpus de l'histoire de l'amalgame — en particulier le mécanisme post-Sodome par lequel les distinctions originelles furent perdues — représente un développement du corpus au-delà de ce que le matériau source fournit directement, tout en demeurant substantiellement ancrée dans le traitement distinct des quatre figures par le matériau source. Le statut épistémique du cadre est celui d'un **ancrage source substantiel avec extension systématique par le corpus**.
...
L'hébreu **satan** (שָׂטָן) est, dans son contexte original au sein de la Bible hébraïque, un **nom commun** plutôt qu'un nom propre{{ footnote(id="4") }}. Le nom dérive de la racine hébraïque *s-t-n* (שׂ-ט-ן), signifiant « s'opposer », « faire obstacle », « être hostile à », « agir en adversaire ». La forme nominale signifie « adversaire », « accusateur », « opposant », « celui qui s'oppose ».
...
- **{% libref(book="1-samuel", chapter=29, verse=4) %}1 Samuel 29, 4{% end %}** : David est décrit comme un *satan* potentiel (adversaire) pour les Philistins, en contexte militaire
- **{% libref(book="2-samuel", chapter=19, verse=22) %}2 Samuel 19, 22{% end %}** : David qualifie ses opposants politiques de *satanim* (adversaires), en contexte politique
- **{% libref(book="1-kings", chapter=5, verse=4) %}1 Rois 5, 4 (5, 18 hébreu){% end %}** : Salomon se décrit comme n'ayant aucun *satan* (adversaire) sous son règne
- **{% libref(book="1-kings", chapter=11, verse=14) %}1 Rois 11, 14, 23, 25{% end %}** : Dieu suscite des *satanim* (adversaires) contre Salomon — opposants politiques en contexte géopolitique
- **{% libref(book="numbers", chapter=22, verse=22) %}Nombres 22, 22, 32{% end %}** : L'ange de Yahvé se tient comme un *satan* (adversaire) sur la route contre Balaam
...
- **{% libref(book="job-woh", chapter=1, verse=6) %}Job 1, 6-12{% end %}, {% libref(book="job-woh", chapter=2, verse=1) %}2, 1-7{% end %}** : le passage principal du matériau source sur Satan dans la Bible hébraïque ; la figure se présente devant Yahvé parmi les *benei ha-Elohim* (fils des Élohim) et engage le dialogue institutionnel
...
- **{% libref(book="1-chronicles", chapter=21, verse=1) %}1 Chroniques 21, 1{% end %}** : la figure incite David à recenser le peuple (dans le passage parallèle de {% libref(book="2-samuel", chapter=24, verse=1) %}2 Samuel 24, 1{% end %}, l'incitateur est identifié à Yahvé lui-même)
...
Le grec **diabolos** (διάβολος, « calomniateur », « accusateur », « celui qui parle contre ») est la traduction grecque néotestamentaire de l'hébreu *satan*{{ footnote(id="5") }}. Le terme grec dérive du verbe *diaballein* (διαβάλλειν, « jeter à travers », « lancer au visage », « calomnier », « attaquer en paroles »). Le terme grec signifie, dans son sens linguistique premier, « le calomniateur » — la figure qui parle contre autrui, qui cherche à mettre en cause, qui soulève des objections et des contestations. Le caractère de désignation fonctionnelle est préservé.

L'usage de *diabolos* dans le Nouveau Testament grec :

- **{% libref(book="matthew-woh", chapter=4, verse=1) %}Matthieu 4, 1, 5, 8, 11{% end %}** : dans le récit de la tentation au désert
- **{% libref(book="luke-woh", chapter=4, verse=2) %}Luc 4, 2-13{% end %}** : dans le récit parallèle de la tentation au désert
- **{% libref(book="john", chapter=8, verse=44) %}Jean 8, 44{% end %}** : la référence de Jésus à ceux qui font « les désirs de votre père le *diabolos* »
...
- **Arabe** : *Shaytan* (شيطان) ; la désignation coranique, au contenu substantiellement parallèle à celui du *satan* hébraïque{{ cite(id="the-qur-an", text="[3]", title="*Le Coran* — matériau sur Shaytan et Iblîs, parallèle au *satan* hébraïque") }}
...
**L'épisode de Job**. Le Livre de Job (composé approximativement aux VIe-IVe siècles AEC) fournit l'articulation principale de la figure dans la Bible hébraïque. La figure apparaît en {% libref(book="job-woh", chapter=1, verse=6) %}Job 1, 6-12{% end %} et {% libref(book="job-woh", chapter=2, verse=1) %}Job 2, 1-7{% end %} comme membre du conseil divin (*benei ha-Elohim*, « fils des Élohim ») qui fonctionne comme testeur adversaire. La figure est en relations collégiales avec Yahvé ; le dialogue est institutionnel plutôt qu'antagoniste ; la figure opère avec autorisation explicite de Yahvé pour conduire la mise à l'épreuve de Job.
...
**La transformation du Chroniqueur**. {% libref(book="1-chronicles", chapter=21, verse=1) %}1 Chroniques 21, 1{% end %} (composé approximativement au IVe siècle AEC) préserve une figuration substantiellement différente — « Satan se dressa contre Israël et incita David à recenser Israël ». Le passage parallèle de {% libref(book="2-samuel", chapter=24, verse=1) %}2 Samuel 24, 1{% end %} attribue l'incitation à Yahvé lui-même : « De nouveau la colère de Yahvé s'enflamma contre Israël, et il incita David contre eux ». La substitution opérée par le Chroniqueur consigne le développement précoce de Satan comme figure plus indépendante, séparée de l'action directe de Yahvé.

**Le contexte plus large de la Bible hébraïque**. Le traitement plus large de la figure du *satan* dans la Bible hébraïque est substantiellement limité par rapport aux traditions ultérieures. La figure n'apparaît pas dans la Genèse, l'Exode ou les autres matériaux du Pentateuque comme figure cosmique principale ; le serpent d'Éden n'est pas identifié à Satan dans le texte hébreu{{ cite(id="genesis", text="[4]", title="Genèse — le récit du serpent d'Éden (chapitre 3) ; la figure n'est pas identifiée à Satan dans le texte hébreu") }} (l'identification est un développement théologique postbiblique) ; la personnification plus large du mal cosmique est substantiellement absente de la Bible hébraïque elle-même.
...
**La tradition des Veilleurs**. Le corpus de 1 Hénoch (composé approximativement du IIIe siècle AEC au Ier siècle EC) préserve un développement substantiel du récit de la rébellion angélique s'appuyant sur le matériau des *benei ha-Elohim* de {% libref(book="genesis-woh", chapter=6, verse=1) %}Genèse 6, 1-4{% end %}. Les Veilleurs (anges spécifiquement nommés qui descendirent sur Terre et engendrèrent des descendants avec des femmes humaines, Azazel étant l'un des principaux chefs) deviennent la source principale du mal dans le monde selon le cadre de 1 Hénoch.{{ cite(id="1-enoch-the-book-of-the-watchers", text="[5]", title="*1 Hénoch : le Livre des Veilleurs* — matériau des Veilleurs et d'Azazel comme source principale du Second Temple pour le développement de la figure du mal cosmique") }}{{ cite(id="book-of-enoch", text="[6]", title="*Livre d'Hénoch* — élaboration plus large du corpus hénochique sur le récit de la rébellion angélique") }} Le matériau des Veilleurs façonne substantiellement le développement des traditions de figures du mal cosmique à travers le judaïsme du Second Temple.
...
**Le développement intertestamentaire de l'amalgame satan-lucifer**. À travers la période du Second Temple, plusieurs figures distinctes convergèrent progressivement vers la figure unifiée du mal cosmique de la tradition chrétienne subséquente. Les principales figures convergentes : le *satan* de la Bible hébraïque (opposition adversaire institutionnelle) ; le serpent d'Éden ({% libref(book="genesis-woh", chapter=3) %}Genèse 3{% end %}) ; la figure de l'étoile du matin d'{% libref(book="isaiah-woh", chapter=14, verse=12) %}Isaïe 14, 12{% end %} (hébreu *helel ben shachar*, « brillant, fils de l'aurore ») ; la figure du roi de Tyr d'{% libref(book="ezekiel-woh", chapter=28, verse=11) %}Ézéchiel 28, 11-19{% end %} ; les figures de la tradition des Veilleurs ; et diverses autres figures cosmico-adversaires de la littérature plus large.
...
**La figure du Nouveau Testament**. Le Nouveau Testament traite Satan substantiellement comme le principal adversaire cosmique de Jésus et de la mission chrétienne plus large. Les passages principaux : le récit de la tentation au désert ({% libref(book="matthew-woh", chapter=4, verse=1) %}Matthieu 4, 1-11{% end %} ; {% libref(book="luke-woh", chapter=4, verse=1) %}Luc 4, 1-13{% end %}) ; les divers parallèles synoptiques impliquant possession démoniaque et exorcisme ; les références de Paul à Satan dans le corpus paulinien ; le récit du dragon d'{% libref(book="revelation-woh", chapter=12) %}Apocalypse 12{% end %} identifiant « le grand dragon, le serpent ancien, qu'on appelle le diable et Satan » à la figure eschatologique du mal cosmique.
...
**Iblîs dans le Coran**. L'Iblîs coranique est la figure qui refusa de se prosterner devant Adam à l'ordre divin ({% libref(book="quran-woh", chapter=2, verse=34) %}Coran 2, 34{% end %}, {% libref(book="quran-woh", chapter=7, verse=11) %}7, 11-13{% end %}, {% libref(book="quran-woh", chapter=15, verse=28) %}15, 28-44{% end %}, {% libref(book="quran-woh", chapter=17, verse=61) %}17, 61-65{% end %}, {% libref(book="quran-woh", chapter=18, verse=50) %}18, 50{% end %}, {% libref(book="quran-woh", chapter=20, verse=116) %}20, 116{% end %}, {% libref(book="quran-woh", chapter=38, verse=71) %}38, 71-85{% end %}). Le refus d'Iblîs est caractérisé comme orgueil et rébellion contre l'ordre divin. Un sursis est accordé à Iblîs jusqu'au jour du jugement pour éprouver l'humanité, la fonction d'épreuve étant parallèle au rôle institutionnel du *satan* hébraïque.
...
**L'approche strictement traductionnelle de Mauro Biglino**. Les travaux plus larges de **Mauro Biglino** sur la Bible hébraïque (*La Bible n'est pas un livre sacré : la vérité sur le livre le plus célèbre de l'histoire*, avec Giorgio Cattaneo, Uno, 2022){{ cite(id="the-naked-bible", text="[7]", title="Biglino & Cattaneo, *La Bible n'est pas un livre sacré* (2022) — traduction strictement littérale de l'hébreu incluant le matériau sur le *satan*") }} préservent un alignement substantiel avec le cadre du corpus sur le caractère originel de la figuration du satan, avec une emphase substantielle sur la traduction strictement littérale de l'hébreu révélant un contenu que les traditions de traduction dominantes ont systématiquement obscurci.{{ cite(id="the-bible-is-not-a-sacred-book", text="[8]", title="Biglino, *Le Livre qui changera à jamais nos idées sur la Bible* / *La Bible n'est pas un livre sacré* — série sur la traduction strictement littérale de la Bible hébraïque, argument philologique fondateur") }}
...
Le passage initial principal du matériau source établissant le rôle institutionnel spécifique de Satan apparaît dans *Le Livre qui dit la vérité* (1974), dans la section « Satan ». Articulation spécifique de Yahvé{{ cite(id="the-book-which-tells-the-truth", text="[1]", title="Vorilhon (Raël), *Le Livre qui dit la vérité* (1974) — section « Satan », exégèse du passage de Job") }} :
...
Le passage principal subséquent du matériau source établissant le cadre plus large des Fils des Élohim apparaît dans *Les Extra-terrestres m'ont emmené sur leur planète* (1975). Le passage situe la position de Satan dans la dynamique factionnelle plus large{{ cite(id="extraterrestrials-took-me-to-their-planet", text="[2]", title="Vorilhon (Raël), *Les Extra-terrestres m'ont emmené sur leur planète* (1975) — section « Les humains ne pouvaient comprendre », contexte antédiluvien de la décision de destruction") }} :
...
Le passage principal subséquent du matériau source établissant la transformation postdiluvienne de Satan apparaît dans le même ouvrage source{{ cite(id="extraterrestrials-took-me-to-their-planet", text="[2]", title="Vorilhon (Raël), *Les Extra-terrestres m'ont emmené sur leur planète* (1975) — découverte de la Chaîne cosmique et vote du Conseil postdiluvien") }} :
...
**1. La découverte de la Chaîne cosmique**. Les Élohim découvrirent qu'ils avaient eux-mêmes été créés — le cadre cosmologique principal traité plus en détail dans l'entrée {% wiki(slug="cosmic-chain") %}Chaîne cosmique{% end %}.
...
Les passages principaux subséquents du matériau source établissant le rôle institutionnel de Satan dans la mise à l'épreuve des prophètes apparaissent à travers le contenu relatif à Jésus{{ cite(id="extraterrestrials-took-me-to-their-planet", text="[2]", title="Vorilhon (Raël), *Les Extra-terrestres m'ont emmené sur leur planète* (1975) — fonction de mise à l'épreuve des prophètes et étymologie de diabolos") }} :
...
Le traitement principal du matériau source sur la mise à l'épreuve de Jésus apparaît dans le contenu plus large relatif à Jésus. Les passages citent le récit de la tentation au désert de {% libref(book="matthew-woh", chapter=4, verse=1) %}Matthieu 4, 1-11{% end %} avec une exégèse substantielle du matériau source :
...
**3. L'achèvement de l'épreuve**. *« Alors le diable le laisse ; et voici, des anges vinrent et le servaient. »* ({% libref(book="matthew-woh", chapter=4, verse=11) %}Matthieu 4, 11{% end %}) — les officiers de l'alliance reprennent le contact direct, la phase opérationnelle commence, et Jésus est libéré pour sa mission.

### Le passage du débat au Conseil

Le passage principal du matériau source établissant la position factionnelle continue de Satan apparaît dans *Les Extra-terrestres m'ont emmené sur leur planète* (1975), dans le récit de la rencontre avec les Élohim{{ cite(id="extraterrestrials-took-me-to-their-planet", text="[2]", title="Vorilhon (Raël), *Les Extra-terrestres m'ont emmené sur leur planète* (1975) — rencontre du Périgord, position d'opposition continue de Satan") }} :
...
- Le contexte du récit plus large de la Théomachie se rattache à l'entrée plus large {% wiki(slug="theomachy") %}Théomachie{% end %}
- Le contexte de la mise à l'épreuve de Jésus se rattache à l'entrée plus large {% wiki(slug="jesus") %}Jésus{% end %}
...
**Lucifer** : le chef de la faction des créateurs exilés sur Terre, l'agent de divulgation d'Éden. Position : chef de la faction dissidente au sein du programme terrestre qui plaida pour une divulgation complète à la création humaine concernant ses origines et les interdictions politiques du Conseil. Rôle : l'acteur principal côté Terre dans la divulgation d'Éden, l'instructeur antédiluvien de l'humanité, le partenaire d'alliance postdiluvien de la création humaine. Le traitement détaillé vit dans l'entrée {% wiki(slug="lucifer") %}Lucifer{% end %}.

**Le Serpent** : la faction de Lucifer collectivement dans le rôle de divulgation d'Éden. Position : la désignation spécifique de la Bible hébraïque (*ha-nachash*) pour la faction de Lucifer agissant dans le rôle de divulgation. Rôle : l'agent de divulgation dans le récit de Genèse 3, la tradition transculturelle plus large des serpents préservant la catégorie élargie. Le traitement détaillé vit dans l'entrée {% wiki(slug="serpent") %}Serpent{% end %}.
...
**Le catalyseur de Sodome et Gomorrhe**. Le corpus lit la destruction de Sodome et Gomorrhe (traitée plus en détail dans l'entrée {% wiki(slug="sodom-and-gomorrah") %}Sodome et Gomorrhe{% end %} lorsqu'elle sera rédigée) comme le catalyseur principal qui perturba le cadre ayant jusque-là préservé les distinctions. Après la destruction des Villes de la Plaine, la population post-Sodome, sa classe éduquée détruite, ne disposait plus du cadre pour maintenir les distinctions originelles entre les figures.
...
L'opposition politico-factionnelle spécifique de Satan à Lucifer est l'une des principales composantes opérationnelles de l'entrée plus large {% wiki(slug="lucifer") %}Lucifer{% end %}. Le traitement détaillé du rôle spécifique de Lucifer vit dans cette entrée ; la contribution spécifique de l'entrée Satan consiste à consigner la position d'opposition au Conseil du monde d'origine d'avec laquelle la faction de Lucifer fondée sur Terre fut distinguée.

### L'entrée Serpent

La distinction spécifique de Satan d'avec le Serpent (la faction de Lucifer collectivement dans le rôle de divulgation d'Éden) est l'une des principales composantes opérationnelles de l'entrée plus large {% wiki(slug="serpent") %}Serpent{% end %}. Le traitement détaillé de la figuration du Serpent vit dans cette entrée ; la contribution spécifique de l'entrée Satan consiste à consigner la taxonomie à quatre figures qui distingue Satan du Serpent.
...
La relation spécifique de Satan avec Yahvé (la relation politico-collégiale à travers l'arc narratif plus large) est l'une des composantes opérationnelles de l'entrée plus large {% wiki(slug="yahweh") %}Yahvé{% end %}. Le traitement détaillé de Yahvé comme figure vit dans cette entrée ; la contribution spécifique de l'entrée Satan consiste à consigner les dynamiques politico-factionnelles spécifiques entre le président du Conseil et le chef de l'opposition.

### L'entrée Grand Déluge

Le rôle spécifique de Satan dans le contexte antédiluvien de la décision de destruction est l'une des composantes opérationnelles de l'entrée plus large {% wiki(slug="great-flood") %}Grand Déluge{% end %}. Le traitement détaillé de l'événement du Déluge vit dans cette entrée ; la contribution spécifique de l'entrée Satan consiste à consigner la fonction spécifique d'accumulation de preuves de Satan et son rôle de présentation au Conseil.

### L'entrée Théomachie

La participation spécifique de Satan côté Conseil dans le récit plus large de la Théomachie se rattache substantiellement à l'entrée plus large {% wiki(slug="theomachy") %}Théomachie{% end %}. Le traitement détaillé du conflit multiâge vit dans cette entrée ; la contribution spécifique de l'entrée Satan consiste à consigner la position politico-factionnelle spécifique de Satan au sein des dynamiques côté Conseil du conflit plus large.

### L'entrée Chaîne cosmique

La soumission institutionnelle postdiluvienne spécifique de Satan suite à la découverte de la Chaîne cosmique se rattache substantiellement à l'entrée plus large {% wiki(slug="cosmic-chain") %}Chaîne cosmique{% end %}. Le traitement détaillé du cadre de la Chaîne cosmique vit dans cette entrée ; la contribution spécifique de l'entrée Satan consiste à consigner la réponse spécifique de Satan à la découverte de la Chaîne cosmique.

### L'entrée Jésus

Le rôle spécifique de Satan dans la tentation au désert de Jésus se rattache substantiellement à l'entrée plus large {% wiki(slug="jesus") %}Jésus{% end %}. Le traitement détaillé de Jésus comme figure vit dans cette entrée ; la contribution spécifique de l'entrée Satan consiste à consigner la fonction institutionnelle de mise à l'épreuve des prophètes telle qu'elle s'appliqua spécifiquement à Jésus.

### L'entrée Prophète

Le rôle institutionnel spécifique de Satan dans la mise à l'épreuve des prophètes se rattache substantiellement à l'entrée plus large {% wiki(slug="prophet") %}Prophète{% end %}. Le traitement détaillé de la tradition prophétique vit dans cette entrée ; la contribution spécifique de l'entrée Satan consiste à consigner la fonction d'épreuve à travers la tradition prophétique plus large.
...
**Angra Mainyu**. L'*Angra Mainyu* zoroastrien (avestique : 𐬀𐬢𐬭𐬀⸱𐬨𐬀𐬌𐬥𐬌𐬌𐬎, « esprit destructeur », « esprit mauvais ») est la principale figure du mal cosmique dans le zoroastrisme.{{ cite(id="avesta", text="[9]", title="*Avesta* — écriture zoroastrienne ; le cadre cosmico-dualiste Angra Mainyu / Ahura Mazda") }} La figure opère en opposition cosmique à **Ahura Mazda** (le principe du bien, de la lumière, de la vérité et de l'ordre) et s'associe au chaos cosmique, au mal, à la tromperie et à la destruction.
...
**La lecture du corpus**. Le cadre Angra Mainyu / Ahriman zoroastrien consigne un contenu parallèle substantiel au motif plus large d'opposition cosmique, tout en opérant au sein du cadrage cosmologico-théologique zoroastrien distinctif. Lecture spécifique du cadre : la figure zoroastrienne pourrait préserver la mémoire culturelle du même motif plus large d'opposition cosmico-politique que la figure du *satan* de la Bible hébraïque préserve dans un cadrage juif distinctif, les deux traditions reflétant le motif transculturel plus large de la Théomachie que le cadre du corpus articule plus en détail dans l'entrée {% wiki(slug="theomachy") %}Théomachie{% end %}.
...
**Les asuras**. Les *asuras* (असुर) védiques et postvédiques sont souvent traduits par « démons » mais plus précisément par « les puissants » ou « les autres dieux » — les figures qui opèrent en opposition cosmique aux *devas* (les dieux de l'ordre cosmique établi). Le traitement détaillé des conflits deva-asura vit dans la section Observations comparatives de l'entrée {% wiki(slug="theomachy") %}Théomachie{% end %}.
...
**La lecture du corpus**. La lecture du corpus traite Seth comme préservant la mémoire culturelle de la faction plus large serpentine/Lucifer dans sa marginalisation politique post-conflit. Le traitement détaillé vit dans la section Observations comparatives de l'entrée {% wiki(slug="theomachy") %}Théomachie{% end %}. Le caractère spécifique de la figure de Seth — préservant certains pouvoirs tout en étant exclue de la centralité cosmique — est parallèle à la forme politique du règlement post-conflit prédit par le cadre du corpus.
...
**Tiamat**. La *Tiamat* mésopotamienne (la mère serpentine primordiale de l'*Enuma Elish*) est traitée plus en détail dans l'entrée {% wiki(slug="theomachy") %}Théomachie{% end %}. La figure préserve un contenu parallèle substantiel à la tradition plus large de la faction serpentine/Lucifer plutôt qu'à la tradition de Satan spécifiquement.
