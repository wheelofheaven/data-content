...
entry_type = "text"
claim_type = "direct"
alternative_names = ["*Shiʿur Qomah* (שִׁעוּר קוֹמָה)", "Sefer Haqqomah ('Livre du corps [divin]')", "la Mesure de la Stature", "la Mesure du Corps", "Ma'amar Rabbi Yishmael"]
timeline = ["multi-age"]

[extra.infobox]
type = "Texte du corpus mystique des Hekhalot / de la Merkavah ; « mesure du corps divin » anthropomorphique"
literal_meaning = "Hébreu שִׁעוּר (*shiʿur*, « mesure, quantité ») + קוֹמָה (*qomah*, « stature, hauteur » ; en araméen « corps ») : « la Mesure de la Stature »"
corpus = "Littérature des Hekhalot / de la Merkavah (mystique juive pré-kabbalistique)"
dating = "Contestée : Scholem — IIe s. apr. J.-C. ; Cohen — gaonique, VIe–VIIe s. apr. J.-C. ; Schäfer — aucun « texte » unique datable (« le texte unique est une illusion »)"
attributed_to = "Pseudépigraphiquement aux tannaïm R. Ishmael et R. Akiva, rapportant une révélation de l'ange Metatron"
key_figure = "236 (myriades de milliers de) parasangs — la hauteur du Créateur, dérivée par guématrie du Psaume 147:5"
printed_in = "*Sefer Raziel ha-Mal'akh* (Amsterdam, 1701, fol. 37b) ; *Merkavah Shelemah* (Jérusalem, 1921) ; édition critique : M. S. Cohen (TSAJ 9, 1985)"
wheel_of_heaven_reading = "Les chiffres en parasangs se lisent comme le relevé brouillé de deux distances astronomiques réelles dès lors que le *parasang* est pris pour une seconde-lumière"
+++
