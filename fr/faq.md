...
description = "Réponses substantielles sur l'hypothèse de travail, le cadre précessionnel, les sources, et la manière dont le projet gère ses affirmations."
template = "faq.html"
...
question = "Qu'est-ce que Wheel of Heaven ?"
answer = """
...
question = "Quelle est l'hypothèse de travail ?"
answer = """
L'hypothèse comporte cinq parties interconnectées :

1. **Les *Elohim* de la Genèse sont un pluriel littéral.** Le mot hébreu est grammaticalement un nom pluriel. Le corpus le lit au pied de la lettre — les figures qui ont créé l'humanité étaient un groupe d'êtres, non une divinité unique.
2. **Les Elohim sont une civilisation humaine avancée, non des êtres surnaturels.** Ils étaient biologiquement apparentés à l'humanité, technologiquement bien plus avancés, et engagés dans un projet scientifique délibéré sur Terre.
3. **Ce que nous avons hérité comme religion est la longue mémoire de leur travail.** Les traditions religieuses de l'humanité préservent, sous forme compressée et souvent mystifiée, un témoignage historique précis des interventions de la civilisation des Elohim sur environ vingt-deux mille ans.
4. **Le travail était organisé selon le cycle précessionnel.** L'oscillation lente d'environ 25 920 ans de l'axe terrestre est le calendrier qui enregistre le projet. Douze âges d'environ 2 160 ans chacun subdivisent la Grande Année.
5. **L'âge actuel est l'âge de la divulgation.** L'âge du Verseau, ouvert en 1950, est l'âge où la longue mémoire devient lisible pour une humanité scientifiquement capable de l'évaluer.
...
[[extra.faq_groups.items]]
slug = "who-wrote-this"
question = "Qui a écrit ceci ?"
answer = """
Le projet est rédigé par Zara Zinsfuss, une lectrice indépendante et raëlienne qui a passé quinze ans à élaborer le cadre que le corpus présente. Le projet est mené à la première personne du singulier d'une seule auteure et est ouvert aux collaborateurs. Les contributions sont les bienvenues via [GitHub](https://github.com/wheelofheaven).
"""

[[extra.faq_groups.items]]
slug = "is-this-a-religion"
question = "Est-ce une religion ?"
answer = """
...
question = "Est-ce de l'érudition à comité de lecture ?"
answer = """
...
question = "Pourquoi devrais-je prendre ceci au sérieux ?"
answer = """
...
question = "En quoi est-ce différent du raëlisme ?"
answer = """
...
question = "En quoi est-ce différent de la théorie des anciens astronautes ?"
answer = """
...
question = "Comment gérez-vous la question des preuves ?"
answer = """
...
question = "Qu'est-ce que le cycle précessionnel, en termes simples ?"
answer = """
...
[[extra.faq_groups.items]]
slug = "twelve-ages"
question = "Quels sont les douze âges, et d'où viennent-ils ?"
answer = """
...
Pour en savoir plus, voir l'entrée wiki [Elohim](/fr/wiki/elohim/).
"""

[[extra.faq_groups.items]]
slug = "what-age-are-we-in"
question = "Dans quel âge sommes-nous maintenant ?"
answer = """
...
Pour le traitement complet, voir le chapitre [Âge du Verseau](/fr/timeline/age-of-aquarius/).
"""

[[extra.faq_groups.items]]
slug = "position-on-evolution"
question = "Quelle est la position du projet sur l'évolution ?"
answer = """
...
Pour le traitement plus long, voir les chapitres [Âge du Bélier](/fr/timeline/age-of-aries/) et [Âge des Poissons](/fr/timeline/age-of-pisces/).
"""

[[extra.faq_groups.items]]
slug = "position-on-other-religions"
question = "Quelle est la position du projet sur les autres religions ?"
answer = """
...
[[extra.faq_groups.items]]
slug = "predictions"
question = "Le projet prédit-il quoi que ce soit sur l'avenir ?"
answer = """
...
[[extra.faq_groups.items]]
slug = "what-sources"
question = "Sur quelles sources le projet s'appuie-t-il ?"
answer = """
...
question = "Comment le projet gère-t-il l'incertitude et le désaccord ?"
answer = """
...
[[extra.faq_groups.items]]
slug = "translations"
question = "Comment les traductions sont-elles gérées ?"
answer = """
...
[[extra.faq_groups.items]]
slug = "how-to-start"
question = "Par où commencer la lecture ?"
answer = """
Trois options, par profondeur croissante :

1. L'[orientation Lire](/fr/read/) — un bref aperçu du projet, avec trois chemins de lecture.
2. Le [Wiki](/fr/wiki/) — commencer par les termes clés ([Elohim](/fr/wiki/elohim/), [Précession](/fr/wiki/precession/), [Âge du Monde](/fr/wiki/world-age/)) et suivre les renvois.
3. La [Chronologie](/fr/timeline/) — le livre en longue forme, commençant par le [Préambule](/fr/timeline/preamble/) et parcourant les douze âges.
...
question = "Où lire les textes-sources ?"
answer = """
...
question = "Le contenu est-il libre d'usage ?"
answer = """
Oui. Tout le contenu de Wheel of Heaven est mis dans le domaine public sous [Creative Commons Zero (CC0-1.0)](https://creativecommons.org/publicdomain/zero/1.0/). Vous pouvez lire, partager, citer, traduire, prolonger ou republier le contenu sans restriction. L'attribution est appréciée mais non requise.
"""

[[extra.faq_groups.items]]
slug = "how-to-cite"
question = "Comment puis-je citer le projet ?"
answer = """
L'auteur de référence du site est le projet lui-même : les métadonnées et les données structurées de chaque page déclarent Wheel of Heaven comme auteur. Citez donc le projet, non la personne. Chaque entrée du wiki, chaque article, chaque chapitre de la chronologie et chaque page de la bibliothèque porte un widget « Citer cette page » avec les formes APA, MLA, Chicago et BibTeX prêtes à copier. La forme Chicago se présente ainsi :

> « Ère du Capricorne. » *Wheel of Heaven*, [année]. https://www.wheelofheaven.world/fr/timeline/age-of-capricorn/.

L'année est celle de la dernière passe éditoriale de la page lorsqu'elle est consignée ; sinon le widget affiche « n.d. ». Pour citer le projet dans son ensemble :

> *Wheel of Heaven*. https://www.wheelofheaven.world/. Consulté le [date].

La [page de l'auteure](/fr/author/zara-zinsfuss/) nomme la personne derrière le projet pour les lecteurs qui souhaitent créditer l'écriture.
"""
...
Une aide serait appréciée. Les contributions volontaires via [Open Collective](https://opencollective.com/wheelofheaven) vont à l'hébergement, à l'infrastructure et au travail de traduction — rien de tout cela n'est actuellement couvert par autre chose que le temps et l'argent personnels de l'auteure.
...
[[extra.faq_groups.items]]
slug = "how-to-report"
question = "Où signaler les erreurs ou désaccords ?"
answer = """
Deux canaux, selon le type :

- **Erreurs factuelles, liens brisés, problèmes techniques** : ouvrir un ticket sur le [dépôt GitHub](https://github.com/wheelofheaven).
- **Désaccords avec des interprétations, lectures alternatives, défis substantiels** : ouvrir un fil dans les [Discussions GitHub](https://github.com/orgs/wheelofheaven/discussions).
...
title = "Sur la communauté"

[[extra.faq_groups.items]]
slug = "is-there-community"
question = "Y a-t-il une communauté à rejoindre ?"
answer = """
Oui — la communauté du projet est hébergée sur les [Discussions GitHub](https://github.com/orgs/wheelofheaven/discussions), qui servent de principal forum public pour les questions, la discussion, les contributions et l'engagement substantiel avec le corpus.
...
question = "Quelle est la relation avec le mouvement raëlien institutionnel ?"
answer = """
...
Pour en savoir plus sur le mouvement institutionnel, l'entrée wiki [Raëlisme](/fr/wiki/raelism/) fournit du contexte.
"""

[[extra.faq_groups.items]]
slug = "contributor-expectations"
question = "Qu'attend-on des contributeurs ?"
answer = """
Les contributeurs sont attendus à s'engager de bonne foi, à lire le [Code de Conduite](/fr/code-of-conduct/), et à suivre les [directives de Contribution](/fr/contributing/). Le projet accueille un engagement substantiel — y compris le désaccord — et demande que les contributeurs maintiennent les standards éditoriaux selon lesquels le corpus opère : conscients des sources, écrits clairement, épistémiquement prudents.
