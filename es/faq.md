...
description = "Respuestas sustantivas sobre la hipótesis de trabajo, el marco precesional, las fuentes y cómo gestiona el proyecto sus afirmaciones."
template = "faq.html"
...
question = "¿Es esto una investigación revisada por pares?"
answer = """
...
question = "¿En qué se diferencia esto del raelismo?"
answer = """
...
question = "¿En qué se diferencia esto de la teoría de los antiguos astronautas?"
answer = """
...
question = "¿Cómo aborda la cuestión de la evidencia?"
answer = """
...
question = "¿Qué es el ciclo precesional, en lenguaje sencillo?"
answer = """
...
[[extra.faq_groups.items]]
slug = "twelve-ages"
question = "¿Cuáles son las doce edades, y de dónde proceden?"
answer = """
...
question = "¿En qué edad nos encontramos ahora?"
answer = """
...
[[extra.faq_groups.items]]
slug = "predictions"
question = "¿Predice el proyecto algo sobre el futuro?"
answer = """
...
[[extra.faq_groups.items]]
slug = "what-sources"
question = "¿En qué fuentes se basa el proyecto?"
answer = """
...
question = "¿Cómo gestiona el proyecto la incertidumbre y el desacuerdo?"
answer = """
...
[[extra.faq_groups.items]]
slug = "translations"
question = "¿Cómo se gestionan las traducciones?"
answer = """
...
question = "¿Es libre el uso del contenido?"
answer = """
Sí. Todo el contenido de Wheel of Heaven se libera al dominio público bajo [Creative Commons Zero (CC0-1.0)](https://creativecommons.org/publicdomain/zero/1.0/). Puede leer, compartir, citar, traducir, ampliar o republicar el contenido sin restricciones. La atribución es bienvenida pero no obligatoria.
"""
...
La ayuda sería bienvenida. Las contribuciones voluntarias a través de [Open Collective](https://opencollective.com/wheelofheaven) se destinan a alojamiento, infraestructura y trabajo de traducción — nada de lo cual está cubierto actualmente por otra cosa que el tiempo y el dinero de la propia autora.
...
[[extra.faq_groups.items]]
slug = "how-to-report"
question = "¿Dónde puedo informar de errores o desacuerdos?"
answer = """
Dos canales, según el tipo:

- **Errores fácticos, enlaces rotos, problemas técnicos**: abra una incidencia en el [repositorio de GitHub](https://github.com/wheelofheaven).
- **Desacuerdos con las interpretaciones, lecturas alternativas, objeciones sustantivas**: abra un hilo en las [Discusiones de GitHub](https://github.com/orgs/wheelofheaven/discussions).
...
answer = """
Sí — la comunidad del proyecto se aloja en las [Discusiones de GitHub](https://github.com/orgs/wheelofheaven/discussions), que sirven de foro público principal para preguntas, debate, contribuciones y compromiso sustantivo con el corpus.
...
question = "¿Cuál es la relación con el movimiento raeliano institucional?"
answer = """
