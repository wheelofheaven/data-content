...
ya no podía leerlo en absoluto. *«Cada vez que me sentaba a leer el libro
...
¡Has entendido mal la historia!"»*

Paul Wallis se detuvo, en efecto. El libro que escribió desde aquel
contenedor de carga, *Escaping from Eden* (2020), planteaba su pregunta en
el subtítulo —*¿enseña el Génesis que la raza humana fue creada por Dios o
diseñada por extraterrestres?*— y la respondía con la suficiente claridad
...
(2023), *The Invasion of Eden* (2024), *The Eden Enigma* (2025). Por el
camino se convirtió, junto con el traductor italiano
{% wiki(slug="biglino-method") %}Mauro Biglino{% end %}, en una de las dos
voces vivas más influyentes de la tradición reinterpretativa que este
proyecto llama {% wiki(slug="neo-euhemerism") %}neoevemerismo{% end %} —la
lectura de los dioses de la narrativa antigua como memoria cultural de
visitantes reales y tecnológicos—.

Cuarenta y seis años antes de la lesión de frisbee, un periodista francés de
automovilismo llamado Claude Vorilhon —{% wiki(slug="rael") %}Raël{% end %}—
...
describen. El libro que publicó en 1974, [*El Libro que dice la
Verdad*](/library/the-book-which-tells-the-truth/), es el fundamento del
...
El método de Wallis merece enunciarse antes que sus conclusiones, porque el
...
> Según la historia del descubrimiento científico, se supone que las
...
Las anomalías que enumera son las que todo lector atento entrevé a medias y
...
condensa en su lugar es más antiguo y más extraño:

> ¿Qué ocurriría si por fin concediéramos que elohim implica seres plurales?
...
> comprensión de quiénes y qué son los seres humanos y de dónde venimos.
>
> — *Escaping from Eden*, cap. 1

Sabía lo que la confesión iba a costarle, y los libros narran el coste sin
...
parecido a un credo que tiene la serie:

> Toda mi credibilidad profesional como eclesiástico veterano de treinta y
...
> reputación, adonde llevaban los datos, yo tenía que seguir.
>
> — *The Eden Enigma*, cap. 5

Los seis libros tienen una arquitectura legible. *Escaping from Eden* hace
la filología. *The Scars of Eden* lleva el resultado de gira por el mundo
...
súbitos de un paciente con amnesia». *Echoes of Eden* pregunta qué
capacidades humanas fueron suprimidas junto con la memoria. *The Eden
Conspiracy* reconstruye quién editó el registro, cuándo y por qué. *The
Invasion of Eden* plantea la versión más sombría de la pregunta —si algunos
de los visitantes fueron explotadores, y si el arreglo llegó a terminar
alguna vez—. *The Eden Enigma* se adentra en el este de Turquía, entre los
...
testimonio, a la historia de la redacción, al trabajo de campo.

## El plural que no quería desaparecer

El fundamento de todo lo que Wallis argumenta es la gramática de una sola
palabra. *Elohim* (<span class="hebrew">אֱלֹהִים</span>) porta la
terminación hebrea de masculino plural *-im*, y el primer movimiento de
Wallis es rechazar la convención que la lee como un «Dios» singular allí
donde la teología lo exige:

> Volviendo a la etimología, el significado de raíz de elohim es «poderes» o
...
> superlativas de la especie querúbica.
>
> — *Escaping from Eden*, cap. 1

Es escrupuloso con el contraargumento —cita a Dom Henry Wansbrough, editor
...
plurales que se adhieren a *elohim* en Génesis 20:13 y 35:7. Una vez
...
> En el momento en que retraducimos elohim como un plural, o como un
...
> realidad lo confirma, historia tras historia.
>
> — *Escaping from Eden*, cap. 2

Su texto probatorio para todo el programa —lo llama «la prueba
irrefutable»— es la asamblea del pacto en Siquem, donde Josué plantea la
elección ante las tribus: apartad a los *elohim* que vuestros antepasados
sirvieron al otro lado del Río y en Egipto, y servid a Yahvé
({% libref(book="joshua", chapter=24, verse=14) %}Josué 24:14–15{% end %}).
Aquí *elohim* y Yahvé no pueden ser el mismo referente; el versículo
...
cuentan en las tablillas cuneiformes»—.

Un lector de este proyecto reconocerá cada elemento de esto. El canon
enunció la lectura plural, como explicación recibida antes que como
hipótesis, en 1974 —*«Elohim, en hebreo, es el plural de Eloha»* figura
entre sus observaciones más repetidas, y su glosa de la palabra es funcional
antes que etimológica: *«Elohim, que significa literalmente "aquellos que
vinieron del cielo"»*
...
{% wiki(slug="list-of-etymological-readings") %}catálogo de lecturas
etimológicas{% end %} del proyecto lleva todo el aparato. Lo que Wallis
añade es *procedencia*: la misma lectura, alcanzada desde dentro del
...
los lectores ocasionales suponen: el consejo divino{{ footnote(id="8") }}
—la asamblea de elohim del Salmo 82, el reparto de las naciones entre los
hijos de elohim{{ footnote(id="9") }} de Deuteronomio 32:8–9— es materia de
manual. La pluralidad está en el texto en cualquier lectura. Lo único que
está en disputa es qué *eran* los seres plurales.

## Un dragón llamado Yahvé

El argumento que este artículo recibió el encargo de examinar llega en
*Echoes of Eden* y alcanza toda su fuerza en *The Eden Conspiracy*.
...
textos antiguos le llama la atención:

> Puede que te sorprenda saber que la Biblia está de hecho llena de historias
...
> Georgia, a Kukulkán, Ququmatz y Quetzalcóatl de Mesoamérica.
>
> — *Echoes of Eden*, cap. 2

Lo que ha advertido en esa lista es un sonido. Kukulkán, Ququmatz,
Quetzalcóatl; la Coca ibérica; los japoneses Kuraokami e Ikuchi; la Kucedra
albanesa; el Kholkhis georgiano; el Akhekh egipcio —una percusión *k-k*
recurrente que atraviesa los nombres de dragones de lenguas sin parentesco,
desde Mesoamérica hasta Japón—. El nombre YHWH{{ footnote(id="1") }}, con
sus dos *h* casi mudas, parece hallarse a un mundo de distancia, y es aquí
...
fricativas{{ footnote(id="3") }}; y en el mundo sonoro semítico más antiguo,
sostiene, la *h* no era ningún susurro:

> Este proceso de ablandamiento del sonido se llama africación. Lo mismo le
...
*The Eden Conspiracy* reconstruye el argumento con más andamiaje. Allí la
...
de Wallis es que el nombre es un préstamo{{ footnote(id="2") }} —y luego
algo más raro que un préstamo—:

> Así es exactamente como la palabra Yahvé hace su aparición en el Canon
...
> comportamiento del personaje de Yahvé.
>
> — *The Eden Conspiracy*, cap. 6

La posibilidad es la onomatopeya: el *ch-ch* como «un eco del sonido
...
libros antes —ahora con el nombre egipcio puesto junto al hebreo—:

> Recurriendo a todo su poder retórico, Josué exhorta a la multitud reunida a
...
> si servirá a ACH ECH de Egipto o a yACHwECH de Israel.
>
> ¿Lo has visto? La semejanza de los dos nombres es asombrosa. Son casi
...
> Akhekh de Egipto (tal como se escribe hoy) era un dragón.
>
> — *The Eden Conspiracy*, cap. 6

A partir de ahí la identificación se propaga por el canon de textos de
Yahvé. Los serafines se convierten en «serpientes voladoras conocidas por su
fuego». La serpiente de bronce{{ footnote(id="10") }} que Moisés levanta por
...
*ap* de Yahvé —fosas nasales, hocico— y el fuego de su boca en el Salmo 18
...
y junto a la sátira de la Septuaginta *Bel y el Dragón*, en la que una
nación rival mantiene una tienda llena de humo abastecida de comida y oro
para su monstruo residente. Para el capítulo siete de *The Eden Conspiracy*,
...
velar —el sonido *ach* del alemán que Wallis invoca— junto a una faríngea y
una *h* glotal simple.{{ footnote(id="4") }} Pero el hebreo ordenó esos tres
sonidos en dos letras, y llevó la contabilidad: la velar y la faríngea se
fundieron en *ḥet* (ח); la *h* glotal siguió siendo *he* (ה). El nombre
יהוה se escribe con *he*, dos veces. Un nombre hebreo cuya forma ancestral
hubiera portado el sonido *ach* se escribiría con *ḥet* —como, por ejemplo,
...
de modo que derivar un *k-k* anterior a partir de un *h-h* posterior exige
...
lista de dragones *k-k* mezcla lenguas sin parentesco genético (maya,
...
Akhekh{{ footnote(id="7") }} es un figurante en el registro egiptológico
...
partir del verbo «ser»{{ footnote(id="5") }} y de un rastro de evidencia
sólida —los Shasu de YHW en las listas egipcias del siglo XIV a.
C.{{ footnote(id="6") }}— que apunta exactamente hacia la región, Madián,
donde el propio relato de Wallis escenifica la primera aparición del nombre.
Es una genuina curiosidad de *The Eden Conspiracy* que se plante ante la
puerta de la hipótesis madianita, describa su decorado y pase de largo.

Así que la etimología fracasa. Lo que no fracasa —y esta es la razón de que
...
fonología y el argumento de Wallis sobre Josué 24 dice esto: *el texto
...
naturaleza.* Esa afirmación se sostiene por sí sola, con total independencia
de Akhekh:

> La Nueva Biblia de Jerusalén sugiere que se nos está hablando de un poder
...
Deja a un lado el nombre de Akhekh y todos los demás elementos de esa lista
...
({% libref(book="2-kings", chapter=1, verse=3) %}2 Reyes 1{% end %}); al
...
operativo al que la teología nunca dio uso alguno.

**La prohibición como política.** Para Wallis, el veto sobre el árbol del
...
del canon es una orden específica con un alcance específico:

{% library(book="the-book-which-tells-the-truth", chapter=2, verse=30) %}
Lo que significa: podéis aprender todo lo que queráis, leer todos los libros
que tenemos aquí a vuestra disposición, pero no toquéis los libros
científicos o moriréis.
{% end %}

**La Serpiente como artífices disidentes.** Esta es la más honda de las
...
canon, entregado como narración antes que como inferencia:

{% library(book="the-book-which-tells-the-truth", chapter=2, verse=35) %}
Entre todos los científicos de este equipo, unos pocos que amaban
...
estudios científicos y que serían tan fuertes como sus creadores.
{% end %}

{% library(book="the-book-which-tells-the-truth", chapter=2, verse=39) %}
La «serpiente» —ese pequeño grupo de creadores que había querido enseñar a
...
que detener sus experimentos y abandonar la Tierra.
{% end %}

En *The Invasion of Eden*, Wallis echa mano de una historia china para hacer
...
{% wiki(slug="lucifer") %}Lucifer{% end %} —la
{% wiki(slug="serpent") %}Serpiente{% end %} del Génesis 3— tal como el
corpus la ha articulado durante cincuenta años.

**El Diluvio como decisión del consejo, con un benefactor disidente.**
...
Enki avisa al héroe del diluvio en contra del decreto de Enlil—. El canon:

{% library(book="the-book-which-tells-the-truth", chapter=2, verse=58) %}
Así que decidieron, desde su planeta lejano, destruir toda la vida en la
...
Wallis lee *bab-el* como «puerta para los Poderosos», remite a los
...
{% wiki(slug="tower-of-babel") %}Babel{% end %} como la dispersión del
...
**El consejo de facciones.** Los libros posteriores de Wallis ensamblan el
*El-Ba'adat* de la Biblia —en su versión, «el Consejo del Poder»— y leen la
...
{% wiki(slug="yahweh") %}Yahvé{% end %} presidiendo entre ambas. Conviene
consignar que la propia entrada del corpus sobre Satán ya atribuye a *The
Eden Conspiracy* un «contenido sustancial de desenredo entre Satán y
...
la casualidad, con ambos—.

**La redacción.** El *Eden Conspiracy* de Wallis reconstruye una edición
...
postura expuesta en la entrada {% wiki(slug="plurality-of-gods") %}pluralidad
de dioses{% end %}—. Dos ediciones, dos épocas, un mecanismo: una pluralidad
...
—*«Somos hombres como vosotros, y vivimos en un planeta bastante parecido a
la Tierra»*
...
En el canon existen dragones reales, pero como *creaciones*: el extravagante
producto de equipos de ingeniería rivales durante la siembra de la Tierra —

{% library(book="the-book-which-tells-the-truth", chapter=2, verse=22) %}
Pero otros equipos de científicos crearon animales espantosos, monstruos que
...
Dinosaurios o Brontosaurios, y demás.
{% end %}

—mientras que el lenguaje *figurado* de serpientes y dragones de la Biblia
se adhiere, en la lectura del canon, a la facción Lucifer exiliada. Las
entradas del corpus sobre {% wiki(slug="dragons") %}dragones{% end %} y
{% wiki(slug="serpent") %}serpiente{% end %} clasifican el saber serpentino
del mundo en dos grupos —serpientes-caos (Tiamat, Apofis,
{% wiki(slug="leviathan") %}Leviatán{% end %}) que preservan la memoria de
...
El modo más nítido de ver la divergencia es un versículo que ambas lecturas
...
el gobierno que la exilió prometió terminar el trabajo —

{% library(book="the-book-which-tells-the-truth", chapter=3, verse=271) %}
Para no ser molestados por los hombres, los creadores tenían bases en las
...
principio se ocultaron bajo los océanos.
{% end %}

Ambos marcos leen el lenguaje de los dragones como referido a actores reales
...
vale la pena conservar: en *Echoes of Eden*, las figuras serpentinas de
Wallis son quienes *degradan* a la humanidad —Ququmatz atenuando la vista de
los primeros hombres—, mientras que los maestros benefactores llegan
vestidos de peces, los apkallū{{ footnote(id="11") }} de la memoria
mesopotámica. En el canon la facción-serpiente *son* los maestros. El mismo
...
trata bajo {% wiki(slug="theomachy") %}Teomaquia{% end %}—.

**Qué vino a hacer Jesús.** Para Wallis, los Evangelios escenifican un
...
Marción{{ footnote(id="12") }} —el revelador de un Padre que no es, y nunca
...
la bifurcación más honda del camino.

**Qué queda por encima de los Elohim.** Wallis sigue siendo teísta —un
...
—[el infinito en ambas
direcciones](/articles/the-infinite-in-both-directions/), materia infinita y
tiempo infinito, sin Persona alguna en la cúspide porque no hay cúspide—.
Ambos marcos coinciden en que adorar a Yahvé *como* el Absoluto es un error
de categoría; discrepan sobre si hay un Absoluto que encontrar. Wallis
responde como sacerdote, el canon como ingeniero.

**Invasión o proyecto.** La Serie del Edén se ensombrece en sus entregas
posteriores. *The Invasion of Eden* lee buena parte del registro a través de
...
a sus hombrecillos»; su {% wiki(slug="great-flood") %}Diluvio{% end %} es
[un reinicio, no un
castigo](/articles/the-flood-was-a-reset-not-a-punishment/); su desenlace no
es una ocupación que resistir sino un
{% wiki(slug="great-return") %}retorno{% end %} que acoger, con una
{% wiki(slug="embassy") %}embajada{% end %} que construir para él. Wallis
escruta el cielo con la cautela de un abogado ante tratados hechos en nombre
de la humanidad; el canon pone la mesa.

**Cómo sabe cada uno lo que afirma.** La última divergencia es la que este
...
filológico; por eso precisamente este proyecto las etiqueta como `framework`
antes que como `direct`, y por eso este artículo lleva la etiqueta
`inferred`. Las dos epistemologías se encuentran en el extraño terreno
...
que el Dingir regresara un día—:

> Nuestros antepasados eran los que recordaban. Nosotros somos los que hemos
> entendido mal.
>
...
- Las entradas {% wiki(slug="serpent") %}Serpiente{% end %},
  {% wiki(slug="lucifer") %}Lucifer{% end %},
  {% wiki(slug="satan") %}Satán{% end %} y
  {% wiki(slug="yahweh") %}Yahvé{% end %}, para la taxonomía política de
  cuatro figuras que este artículo compara con el reparto de Wallis.
- La entrada {% wiki(slug="theomachy") %}Teomaquia{% end %}, para la guerra
  cuyos versículos de dragones ambas lecturas reclaman.
- Las entradas {% wiki(slug="biglino-method") %}método Biglino{% end %} y
  {% wiki(slug="neo-euhemerism") %}neoevemerismo{% end %}, para la tradición
  que Wallis extiende al mundo anglófono.
- [*El Libro que dice la
  Verdad*](/library/the-book-which-tells-the-truth/), capítulos 2 y 3, para
  los pasajes del canon citados a lo largo del texto.
