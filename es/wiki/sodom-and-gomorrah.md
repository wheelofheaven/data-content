...
description = "Sodoma y Gomorra (hebreo <span class=\"hebrew\">סְדוֹם וַעֲמוֹרָה</span> *Sedom we-ʿAmōrāh*) son las ciudades de la cuenca meridional del Jordán destruidas, según la narrativa bíblica (Génesis 18–19), por intervención directa Elohim-yahvista, cuya destrucción mediante \"azufre y fuego del cielo\" sobrevivieron Lot y su familia, mientras la mujer de Lot, al mirar atrás, se transformó en columna de sal. La narrativa está estrechamente ligada al ciclo de Abraham (la negociación entre Abraham y Yahvé sobre el número mínimo de justos en Génesis 18:23–33) y conserva un episodio operativo sustancial de intervención de la Alianza. El marco Wheel of Heaven lee la destrucción de Sodoma y Gomorra como intervención operativa de la Alianza en la era de Aries media (aproximadamente s. XIX a. e. c.) — efecto sustancialmente destructivo, posiblemente nuclear o energéticamente sustancial, de los vehículos Elohim, cuya configuración operativa se conserva en la narrativa bíblica con marcadores tecnológicos sustanciales (descripción de azufre y fuego, implicación de destello luminoso atómico en la transformación en columna de sal, formación de cráter geográficamente específica en la cuenca meridional del Mar Muerto)."
...
chronology = "Late Age of Taurus (conventionally placed approximately 2,000-1,800 BCE on the conventional Abrahamic chronology); approximately 2,500-3,000 years after the Babel intervention; during Abraham's lifetime"
location = "The Cities of the Plain — Sodom (סְדֹם), Gomorrah (עֲמֹרָה), and the additional cities Admah, Zeboiim, and Zoar — situated in the lower Jordan Valley of the southern Levant; the principal site corresponds to the modern Dead Sea basin"
participants_council_side = "The home-world Council of the Eternals (the intervening party, monitoring the situation through remote observation); two Council scouts (the 'two angels' of Genesis 19:1) sent for verification reconnaissance; the broader Council military operations responsible for the atomic strike"
participants_human_side = "The Sodom and Gomorrah rebel population (the descendants of post-Babel scattered scientific elite who had reaccumulated knowledge during the long quiet); Lot and his immediate family (Abraham's nephew, identified by the scouts as not part of the vengeance movement and worth preserving); the broader population of the Cities of the Plain"
abraham_role = "Witness and intercessor; the Mamre conversation between Abraham and the Yahweh-figure (Genesis 18) preserves the substantial negotiation over the threshold of righteous people; the verification confirmed that the threshold could not be met; the strike was authorized; Abraham's nephew Lot was extracted before the strike"
purpose_of_the_rebellion = "Organized vengeance / military retaliation: the human-led conspiracy to reverse, by force, the Council's policy of containment, with substantial weapons-program development drawing on scientific knowledge salvaged and reaccumulated during the long quiet between Babel and Sodom"
council_intervention = "Multi-component intervention: (1) reconnaissance verification by two Council scouts equipped with personal hardware (the 'pocket atomic weapon' of the source's account); (2) extraction of the small population worth preserving (Lot and his immediate family); (3) targeted atomic strike against the Cities of the Plain; (4) substantial geological and ecological transformation of the broader Dead Sea basin"
physical_signature = "The Dead Sea basin: hypersaline terminal lake approximately 430 meters below sea level, with water ten times saltier than ordinary seawater, dead to all normal aquatic life, sitting in a landscape of sterile salt flats and barren marl; magnesium-chloride dominance; heavy-metal concentrations; surrounding sterilized salt flats extending well beyond ordinary lakeshore evaporation patterns"
operational_consequence = "The substantial reduction of the Eden lineage to 'a very primitive state' through the elimination of the educated class; the substantial shift from the post-Babel slow-knowledge-reaccumulation phase to the post-Sodom semi-primitive phase; the substantial Serpent-symbolism transformation from positive to negative valence; the broader cultural-symbolic conditions that produced the subsequent Christian-tradition Devil/Lucifer/Serpent conflation"
distinguished_from = "The Babel intervention (the chronologically earlier Gemini-age dispersion event with substantively different operational character — peace-offering reconciliation attempt vs. organized vengeance movement); the Great Flood (the chronologically much earlier Gemini-age planetary-scale destruction event); the broader Theomachy multi-age narrative (within which Sodom operates as one specific late-Taurus phase); the conventional 'sin of Sodom' theological reading (the framework's specific contribution is the political-military-rebellion reading rather than the conventional sexual-deviance reading)"
status_in_source_material = "Substantially documented; the principal Yahweh passage in 'The Truth' chapter, 'Sodom and Gomorrah' section, of *The Book Which Tells the Truth* establishes the framework's specific content with explicit articulation"
principal_text = "*The Book Which Tells the Truth* (1974), 'Sodom and Gomorrah' section (the principal Yahweh passage); *timeline.epub* Age of Taurus chapter, Section VI ('The Two Scouts, the Strike, and the Dead Sea') and Section VII ('The Forgetting and the Transformation of the Serpent') — the substantial subsequent corpus articulation"
+++
...
- The Babel framework (treated in the [Babel](../babel/) entry) provides the chronologically earlier substantial dispersion event whose consequences operate as substrate for the Sodom rebellion
- The Theomachy framework (treated in the [Theomachy](../theomachy/) entry) provides the broader multi-age narrative context within which Sodom operates as one specific late-Taurus phase
- The Great Flood framework (treated in the [Great Flood](../great-flood/) entry) provides the substantially earlier Council destruction event that produced the substantial human grievance underlying the Sodom rebellion
- The Alliance framework (treated in the [The Alliance](../the-alliance/) entry) provides the substantial covenant-political context within which the Sodom event operated as substantial corruption of the original alliance project
- The Abraham framework (treated in the [Abraham](../abraham/) entry when written) provides the substantial witness-and-recovery-figure context within which the Sodom event operates
- The post-pardon framework (registered in the principal source passage and treated more fully in the [Theomachy](../theomachy/) entry) provides the substantial post-conflict political settlement context
...
The Sodom framework operates substantively after Babel within the broader Theomachy narrative arc. The detailed treatment of Babel lives in the [Babel](../babel/) entry; the Sodom entry's specific contribution is registering the substantial chronological-distinction (the long quiet between Babel and Sodom) and the operational-distinction (peace-offering reconciliation vs. military rebellion).

### The Theomachy entry

The Sodom event operates as one specific phase within the broader Theomachy multi-age narrative. The detailed treatment of the broader Theomachy framework lives in the [Theomachy](../theomachy/) entry; the Sodom entry's specific contribution is registering the late-Taurus event as substantively distinct from the earlier Gemini-age conflict-and-pardon phases.

### The Satan entry

The Sodom event operates as the substantial trigger-event that produced the broader Serpent-symbolism transformation. The detailed treatment of the four-figure-conflation history (Satan/Lucifer/Serpent/Devil) lives in the [Satan](../satan/) entry; the Sodom entry's specific contribution is registering the substantial trigger-event content.

### The Lucifer entry

The Sodom rebels claimed legitimate inheritance from the Lucifer faction while substantively betraying the original alliance project. The detailed treatment of the Lucifer faction lives in the [Lucifer](../lucifer/) entry; the Sodom entry's specific contribution is registering the substantial corruption-of-inheritance content.

### The Great Flood entry

The Sodom event operates substantively long after the Great Flood within the broader narrative arc. The detailed treatment of the Great Flood lives in the [Great Flood](../great-flood/) entry; the Sodom entry's specific contribution is registering the substantial human-grievance content that the Flood produced and that operated as substrate for the Sodom rebellion.

### The Abraham entry

Abraham operates as substantial witness-and-recovery figure within the Sodom narrative. The detailed treatment of Abraham lives in the [Abraham](../abraham/) entry when written; the Sodom entry's specific contribution is registering Abraham's specific role in the Mamre threshold negotiation and the post-Sodom recovery.
...
The Sodom intervention operates substantively within the broader Yahweh narrative. The detailed treatment of Yahweh as figure lives in the [Yahweh](../yahweh/) entry; the Sodom entry's specific contribution is registering Yahweh's specific role in the Mamre conversation and the strike authorization.

### The Hebrew Bible entry

The Sodom narrative operates as one specific narrative event within the broader Hebrew Bible canonical literature. The detailed treatment of the Hebrew Bible lives in the [Hebrew Bible](../hebrew-bible/) entry when written.
...
The relationship is one of **planetary-scale-vs-tactical-scale-distinction-within-broader-Council-intervention-pattern**. The detailed treatment of the Great Flood lives in the [Great Flood](../great-flood/) entry.
...
The relationship is one of **specific-late-phase-within-broader-multi-age-narrative**. The detailed treatment of Theomachy lives in the [Theomachy](../theomachy/) entry.
