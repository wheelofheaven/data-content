+++
title = "Competencia cósmica"
description = "Competencia cósmica es el modelo del corpus Wheel of Heaven sobre la relación dinámica entre civilizaciones biológicas en la galaxia — la tesis de que la creación de nuevos mundos biológicos por civilizaciones avanzadas no se da en un vacío ético-neutral sino en una competencia continua entre civilizaciones creadoras por la configuración del espacio biológico galáctico. El modelo enmarca la escala galáctica como un espacio donde varias civilizaciones avanzadas operan competitivamente: el mundo natal de los Elohim, los miembros de la Alianza, las civilizaciones competidoras secretas de la fuente de Vorilhon (\"los otros\", que operan en paralelo a la tradición Elohim), y la humanidad futura que entra en el juego como actor propio. La competencia cósmica se entiende en el corpus como una configuración positiva — su carácter no problemático contrasta con las narrativas distópicas del primer contacto, y el corpus lee la configuración de Alianza de la tradición Elohim como respuesta metodológica-éticamente reflexiva a las condiciones competitivas de escala galáctica."
...
basic_premise = "Multiple humanities created by the Elohim alliance on multiple worlds; each evaluated against the standard required for inheritance (moral and scientific maturity)"
character = "Non-adversarial; evaluation rather than zero-sum conflict; multiple humanities can potentially qualify simultaneously"
known_creations = "Three surviving humanities (per the parable-of-the-sower reading); Earth is one; two others on planets 'relatively near'; one previous attempt failed and produced a plant-only world that still exists"
qualification_categories = "Moral maturity; scientific maturity; political maturity"
operational_origin = "The Aries-age discovery (c. 2,160–1,200 BCE) that the Elohim themselves had been created, producing the policy shift from direct to indirect contact"
explicit_articulation = "Jesus's parable of the sower (Matthew 13:3-9, c. 30 CE); March 14, 1978 telepathic message to Raël"
current_phase = "Aquarian-age operational evaluation; the inheritance-threshold becoming determinable across the present decades"
distinguished_from = "The Cosmic Chain (the broader recurring pattern); the Earth project specifically (the alliance's specific Earth-side operations); the Aquarian-age opening (the specific present phase); the Apocalypse (the broader unveiling event)"
principal_text = "Matthew 13:3-9 (parable of the sower); Matthew 13:18-30 (Jesus's interpretation); Matthew 6:10 (the Lord's Prayer's central petition)"
principal_framework_source = "*The Book Which Tells the Truth* (Vorilhon/Raël, 1974), 'Parallel Humanities'; *Message of the Elohim* (March 14, 1978), preserved in *Extra-Terrestrials Took Me to Their Planet*"
+++
...
**The Apocalypse and embassy material** (treated more fully in the [Apocalypse](../apocalypse/) and [Embassy](../embassy/) entries): The source's account of the projected open return at the embassy provides the principal source material for the framework's account of the inheritance event itself.
...
The Cosmic Competition framework as the alliance's operational policy emerged from the Aries-age discovery (c. 2,160–1,200 BCE) that the Elohim themselves had been created by a prior civilization. The detailed treatment of this discovery lives in the [Cosmic Chain](../cosmic-chain/) entry; the Cosmic Competition entry's specific point is that the discovery produced the policy shift that constitutes the framework's operational origin.
...
**First attempt (the path / the birds)**: A creation attempt on a planet too close to the home world. The Satan-faction abolitionists (treated more fully in the [Satan](../satan/) entry) opposed the broader Earth-and-parallel-humanity project and were able to physically intervene against the first attempt because of the geographic proximity. The "birds" who came and ate the seeds are read as the abolitionist-faction operatives who eliminated the developing creation before it could reach viability.
...
The Cosmic Competition framework is most centrally invoked in the [Jesus](../jesus/) entry, where the parable-of-the-sower exegesis is the principal evidence for the framework's operational reality. The detailed treatment of Jesus's specific teaching on the cosmic-competition framework lives in the Jesus entry; the Cosmic Competition entry's specific contribution is establishing the framework's broader analytical content.

### The Aquarian-age entries

The framework operates as the broader cosmological context within which the Aquarian-age developments unfold. The detailed treatment of the Aquarian-age inheritance-threshold material lives in the [Apocalypse](../apocalypse/), [Embassy](../embassy/), and [Age of Aquarius](../timeline/age-of-aquarius/) entries; the Cosmic Competition entry's specific contribution is establishing the broader cosmological framework.

### The Aries-age entries

The framework's operational origin in the Aries-age discovery is treated more fully in the [Cosmic Chain](../cosmic-chain/) and [Age of Aries](../timeline/age-of-aries/) entries. The Cosmic Competition entry's specific contribution is establishing the discovery's specific implications for the alliance's policy toward the multiple humanities.
...
The detailed treatment of the Apocalypse lives in the [Apocalypse](../apocalypse/) entry.
...
**The Kabbalistic four worlds** (Atzilut, Beriah, Yetzirah, Asiyah) preserve substantial multiple-worlds material within the distinctive Kabbalistic cosmological framework. The detailed treatment lives in the [Tree of Life](../tree-of-life/) entry's Kabbalistic Sephirot section.
...
**Mesoamerican multiple-suns traditions**. The Aztec tradition preserves the specific doctrine of the **five suns** — five successive cosmic ages, each ending in catastrophic destruction, with the present age (the Fifth Sun) being the current cosmic order. Each previous sun was inhabited by different categories of beings (giants, monkey-people, bird-people, fish-people in various traditions), with the catastrophic transitions producing the present cosmic order. The detailed treatment lives in the [Antediluvian](../antediluvian/) entry's comparative observations.

**Hopi multiple-worlds tradition**. The Hopi tradition preserves substantial material on the four (or in some traditions, five) successive worlds, with humans emerging through the *sipapu* into each successive world after the destruction of the previous one. The detailed treatment lives in the [Great Flood](../great-flood/) entry's comparative observations.
...
Jeremias, Joachim. *The Parables of Jesus*. SCM Press, 1972 (revised English edition).

Dodd, C. H. *The Parables of the Kingdom*. Nisbet, 1935.

Crossan, John Dominic. *In Parables: The Challenge of the Historical Jesus*. Harper & Row, 1973.

Funk, Robert W. *Parables and Presence*. Fortress, 1982.

Snodgrass, Klyne. *Stories with Intent: A Comprehensive Guide to the Parables of Jesus*. Eerdmans, 2008.

Drake, Frank. "Project Ozma." *Physics Today* 14, no. 4 (1961): 40–46.

Drake, Frank, and Dava Sobel. *Is Anyone Out There? The Scientific Search for Extraterrestrial Intelligence*. Delacorte, 1992.

Webb, Stephen. *If the Universe Is Teeming with Aliens... Where Is Everybody? Seventy-Five Solutions to the Fermi Paradox and the Problem of Extraterrestrial Life*. Springer, 2nd ed., 2015.

NASA Exoplanet Archive. <https://exoplanetarchive.ipac.caltech.edu/>

Borucki, William J., et al. "Kepler Planet-Detection Mission: Introduction and First Results." *Science* 327, no. 5968 (2010): 977–980.

Gillon, Michaël, et al. "Seven temperate terrestrial planets around the nearby ultracool dwarf star TRAPPIST-1." *Nature* 542 (2017): 456–460.

Anglada-Escudé, Guillem, et al. "A terrestrial planet candidate in a temperate orbit around Proxima Centauri." *Nature* 536 (2016): 437–440.
...
The Pearl of Great Price. The Church of Jesus Christ of Latter-day Saints, 1851 (canonical scripture; current edition).

Givens, Terryl L. *Wrestling the Angel: The Foundations of Mormon Thought*. Oxford University Press, 2014.

*Genesis Rabbah*. Soncino Press translation.

Talmud Bavli. Various tractates, principally Avodah Zarah 3b.

Scholem, Gershom. *Major Trends in Jewish Mysticism*. Schocken, 1941.

Diels, Hermann, and Walther Kranz. *Die Fragmente der Vorsokratiker*. Weidmann, 6th ed., 1951.

Kirk, G. S., J. E. Raven, and M. Schofield. *The Presocratic Philosophers*. Cambridge University Press, 2nd ed., 1983.
...
Carrasco, Davíd. *Quetzalcoatl and the Irony of Empire*. University of Chicago Press, 1982.
...
"Exoplanet." *Encyclopaedia Britannica*. <https://www.britannica.com/science/extrasolar-planet>

"Parable of the Sower." *Encyclopaedia Britannica*. <https://www.britannica.com/topic/Parable-of-the-Sower>

"Drake equation." *Encyclopaedia Britannica*. <https://www.britannica.com/science/Drake-equation>
