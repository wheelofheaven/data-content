+++
title = "Esvástica"
description = "La esvástica (sánscrito <span class=\"sanskrit\">स्वस्तिक</span> *svastika*, \"que trae fortuna\") es el símbolo principal pancultural antiguo de la tradición hindú-budista-jainista, las tradiciones eslava, báltica y nórdica europea, la tradición finlandesa-siberiana, la tradición indígena norteamericana (hopi, navajo) y la tradición euroasiática de símbolos asociada más amplia. La configuración giratoria de cuatro radios porta significado cosmológico-religioso sustancial como símbolo solar, símbolo del movimiento cíclico eterno y configuración traefortuna. La contaminación histórica del símbolo por su uso como emblema estatal nazi-alemán (años 20–1945) afectó sustancialmente a la tradición occidental contemporánea, con estigmatización sustancial del símbolo en los ordenamientos democrático-occidentales. El marco Wheel of Heaven lee la esvástica principalmente en su tradición pancultural antigua: la configuración giratoria de cuatro radios simboliza la infinitud del tiempo (una de las dos doctrinas cosmológicas centrales del corpus). La tradición raeliana contemporánea ha contribuido sustancialmente a la restauración del significado simbólico prenazi original, con la clarificación de que la tradición simbólica antigua es metodológicamente independiente del mal uso nazi del siglo XX."
...
principal_traditional_meanings = "Auspiciousness, good fortune, well-being (Hindu); cyclic cosmic time (Buddhist, Jain); eternity, infinity in time (Raëlian framework); the cycle, the choice between progress and regression (Raëlian-specific framework content)"
...
position_in_raelian_framework = "Central element of the original Raëlian Symbol of Infinity (1973-present, in use in Asian Raëlian movement branches); modified to galaxy-spiral in Western Raëlian movement branches (1990 modification); represents the temporal dimension of infinity through the cyclic-eternal principle"
post_1945_situation = "Nazi appropriation (1920-1945) produced substantial cultural-political complications in post-Holocaust European-North American contexts; legal restrictions vary across jurisdictions (Germany StGB §86 prohibits Nazi-specific usage; various other European countries have similar restrictions); various post-1945 reclamation efforts within Hindu-Buddhist diaspora communities have worked toward distinguishing the broader pre-Nazi religious-traditional usage from the specific Nazi appropriation"
distinguished_from = "The Star of David (the other principal component of the Raëlian Symbol of Infinity, treated under separate entry); the Raëlian Symbol of Infinity as composite emblem (treated under separate entry); the Nazi *Hakenkreuz* specifically (the tilted-clockwise form adopted as NSDAP symbol 1920); the broader cross-cultural sun-cross category (which includes various non-swastika cross-with-arms forms)"
status_in_source_material = "Substantially documented; the principal Yahweh-delivered passages establish both the symbol's specific Raëlian-framework semantic content and its identification with broader cross-cultural traditional usage"
...
**1. The "all the wisdom in the world" framing**. The combined symbol containing the swastika has unusually elevated framing as comprehensive iconographic compression of the broader cosmological framework. The detailed treatment lives in the [Raëlian Symbol of Infinity](../raelian-symbol-of-infinity/) entry.
...
**3. The modification's specific rationale**. The modification was made for two specific reasons: facilitating the Israeli embassy negotiations, and respecting Holocaust victims' sensitivities. The detailed treatment of the modification lives in the [Raëlian Symbol of Infinity](../raelian-symbol-of-infinity/) entry.
...
**The Cosmic Competition framework connection**. The broader Cosmic Competition framework's specific evaluation processes operate within the broader cosmic-cyclic context that the swastika partially represents. The detailed treatment lives in the [Cosmic Competition](../cosmic-competition/) entry.
...
The swastika operates as the central element of the original Raëlian Symbol of Infinity. The detailed treatment of the composite emblem lives in the [Raëlian Symbol of Infinity](../raelian-symbol-of-infinity/) entry; the Swastika entry's specific contribution is the broader cross-cultural and historical context within which the symbol operates as one specific instance of substantial cross-cultural traditional preservation.

### The Infinity entry

The swastika represents the temporal dimension of infinity within the broader Raëlian Symbol of Infinity, complementing the Star of David's representation of the spatial dimension. The detailed treatment of the broader Infinity framework lives in the [Infinity](../infinity/) entry.

### The Mass Effect entry

The swastika's specific cyclic-temporal content has substantial connection to the broader Mass Effect framework's specific time-scaling content. The detailed treatment lives in the [Mass Effect](../mass-effect/) entry.

### The Cosmic Chain entry

The swastika's specific cyclic-recursive content has substantial connection to the broader Cosmic Chain framework's specific recursive-creation cycle content. The detailed treatment lives in the [Cosmic Chain](../cosmic-chain/) entry.

### The Cosmic Competition entry

The swastika's specific progress-vs-regression content has substantial connection to the broader Cosmic Competition framework's specific evaluation-and-inheritance content. The detailed treatment lives in the [Cosmic Competition](../cosmic-competition/) entry.

### The Raëlism entry

The swastika operates as one specific institutional-iconographic element of the broader Raëlism movement. The detailed treatment of the broader institutional-doctrinal content lives in the [Raëlism](../raelism/) entry.
...
The relationship is one of **complementary-components-within-broader-emblem**. The detailed treatment of the Star of David lives in the [Star of David](../star-of-david/) entry when written; the entries register the complementary functions while preserving operational distinctness.
