...
description = "El encubrimiento militar de la exobiología es, en el marco Wheel of Heaven, la tesis de que las estructuras militares y de inteligencia avanzadas de las potencias mundiales centrales (EE. UU., Rusia, China, Reino Unido, Francia, Israel y el sistema de inteligencia aliado más estrecho) han retenido sistemáticamente, al menos desde el evento de Roswell de 1947, conocimiento sustancial sobre la realidad extraterrestre — vehículos recuperados, materiales biológicos, programas de ingeniería inversa tecnológica — frente al público. La tesis ha ganado plausibilidad sustancial en el período 2017–2024 a través de las revelaciones oficiales: el artículo del NYT sobre AATIP (diciembre de 2017); las publicaciones del Pentágono de videos UAP (abril de 2020); la Evaluación Preliminar de la ODNI sobre UAP (junio de 2021); las audiencias del Congreso con el testimonio de David Grusch sobre biológicos no humanos y programas de ingeniería inversa (julio de 2023); el informe final del Equipo Independiente de Estudio de UAP de la NASA (septiembre de 2023); y las audiencias subsiguientes de noviembre de 2024. El marco Wheel of Heaven lee la secuencia de revelaciones como transición sustancial controlada de las grandes potencias desde la fase de encubrimiento a la de revelación por etapas, anticipándose al regreso abierto venidero de la Alianza."
...
see_also = [
    { title = "Embajada", path = "wiki/embassy", description = "La resolución del canon a la cuestión de la divulgación mediante el reconocimiento diplomático formal." },
    { title = "PURSUE", path = "wiki/pursue", description = "El programa de publicación de 2026 cuyo archivo público por defecto incide sobre la tesis del secreto desde el lado oficial." },
]
...
principal_2017_2024_disclosure_events = "NYT December 16, 2017 article disclosing AATIP; April 27, 2020 Pentagon UAP video releases; June 25, 2021 ODNI Preliminary Assessment; July 26, 2023 congressional hearings with David Grusch testimony; September 14, 2023 NASA UAP Independent Study Team report; November 13, 2024 follow-up congressional hearings"
principal_whistleblowers = "David Grusch (2023 congressional testimony under oath; principal contemporary); Bob Lazar (1989-present; S-4 reverse-engineering claims); Robert Salas (1967 Malmstrom case); Phil Schneider (1995 lectures); Clifford Stone; Steven Greer (Disclosure Project 1993-present)"
principal_historical_scholarship = "Richard Dolan, *UFOs and the National Security State* (2 vols., 2000, 2009); Leslie Kean, *UFOs: Generals, Pilots, and Government Officials Go on the Record* (2010); Luis Elizondo, *Imminent* (2024)"
contested_document_tradition = "Majestic 12 documents (substantial authenticity disputes); substantial subsequent leaked-document tradition; the substantial CIA-MK-ULTRA-related psychological-operations engagement"
principal_nuclear_facility_cases = "1967 Robert Salas Malmstrom AFB Minuteman missile shutdown; substantial Robert Hastings *UFOs and Nukes* documentation including approximately 150 documented multi-witness cases; 2010 National Press Club briefing"
corpus_position = "Governmental cover-up substantively real across 1947-2017 period through demonstrated classified programs; 2017-2024 disclosure has substantially shifted question into mainstream-policy domain; substantive Vorilhon-source resolution operates through Embassy framework requiring international diplomatic recognition"
distinguished_from = "General governmental secrecy (broader category); conspiracy theories without empirical foundation (substantively different evidential register); the broader Ufology field (cover-up question as one component); Astrobiology (the broader scientific field engaging extraterrestrial-life question)"
status_in_framework = "Methodologically complex question engaged with substantive epistemic discipline; corpus position threads documented programs and contested allegations with substantial care"
+++
...
- **The broader Ufology field.** Treated in the [Ufology](../ufology/) entry; the cover-up question operates as one substantive component of broader ufology
- **Astrobiology.** The broader scientific field engaging the extraterrestrial-life question generally; treated in the [Astrobiology](../astrobiology/) entry
...
- **Substantial referral practices.** UFO reports made to military and civilian authorities were principally referred to civilian organizations (NICAP, APRO, CUFOS, MUFON; treated in the [Ufology](../ufology/) entry) or dismissed.
...
- **The substantial subsequent documentary work** — *UFOs and Nukes* documentary (2016) and substantial subsequent engagement
...
### The substantial CIA-MK-ULTRA-related psychological-operations engagement
