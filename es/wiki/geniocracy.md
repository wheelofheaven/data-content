+++
title = "Geniocracia"
description = "Geniocracia es el modelo político que Raël propuso en *Geniocracy* (original francés *La Géniocratie*, 1977) como forma de gobierno alternativa a la democracia contemporánea — un modelo en el que el derecho activo y pasivo al voto está vinculado a la capacidad cognitiva. El modelo propone que solo los ciudadanos cuya capacidad cognitiva esté sustancialmente por encima de la media (percentil 50 o superior) puedan tomar decisiones electorales, y que solo aquellos cuya capacidad cognitiva sea sustancialmente mayor (percentil 90 o superior) puedan presentarse como candidatos. La posición se motiva en el corpus por la observación de que la práctica electoral democrática contemporánea (en la que cada voto se pondera por igual sin atender al grado de comprensión de las políticas elegidas) resulta especialmente vulnerable a la demagogia, la manipulación populista y la incompetencia gubernamental, y que una base electoral con cualificación cognitiva tomaría decisiones políticas sustancialmente mejores a largo plazo. El modelo es sustancialmente controvertido y ha sido criticado tanto por sectores políticos de izquierda como de derecha como antidemocrático y eugenésico. El marco Wheel of Heaven trata la geniocracia como forma de gobierno de transición para la fase temprana de la era de Acuario, hasta que el orden económico paradista y la infraestructura cultural y educativa renovada asociadas hagan posible una maduración cognitiva más amplia de toda la población."
...
core_articulation = "'Selective democracy' restricting political eligibility to those whose measured intelligence exceeds specified thresholds — voting reserved for those at least 10% above population average, eligibility for public office reserved for those at least 50% above"
position_within_seven_commandments = "First New Commandment; the political-governance dimension complementing Humanitarianism, World Government, Demilitarization, Science as Religion, Telepathic Cultivation, and the Metaphysical Clarifications"
principal_argument_structure = "Universal-suffrage democracy weighs votes equally regardless of capacity to understand issues; majority-rule frequently contradicts expert knowledge (Copernicus example); cells-of-the-body metaphor articulates that specialized capacities should make decisions for the broader system; psychometric measurement provides technical basis for eligibility restriction"
distinguished_from = "Universal-suffrage democracy (which weighs all votes equally); aristocracy (hereditary-based political authority); plutocracy (wealth-based political authority); monarchy (single-individual hereditary political authority); theocracy (religious-authority-based political authority); technocracy (technical-expertise-based political authority operating substantively differently from intelligence-based selection)"
parallel_contemporary_articulations = "Plato's philosopher-kings (*Republic*); Confucian meritocratic civil-service tradition; twentieth-century technocracy movement (Howard Scott); Bertrand Russell's scientific-oligarchy engagement; epistocracy tradition (Jason Brennan, David Estlund); John Stuart Mill's plural-voting proposal; Robert Heinlein's political articulations; Singapore meritocratic-governance experiment"
mainstream_critical_engagement = "Measurement-validity concerns (Stephen Jay Gould's *The Mismeasure of Man*, the substantial broader critical-psychometric tradition); historical-eugenic associations (the substantial twentieth-century historical experience); democratic-egalitarian concerns (the substantial mainstream democratic-political-philosophy tradition); practical-implementation concerns (the substantial broader concerns about implementation integrity)"
status_in_framework = "Foundational Raëlian political-governance doctrine; the first of the seven New Commandments constituting the Aquarian-age program; directional orientation rather than immediate institutional change"
principal_corpus_treatment = "*The Book Which Tells the Truth* (Vorilhon, 1974), Sixth Chapter — principal source articulation; *Géniocratie* (Vorilhon, 1977) — the dedicated systematic articulation; *timeline.epub* — substantial subsequent corpus contextualization within the broader New Commandments framework"
+++
...
**2. Humanitarianism**. Abolition of property ownership in favor of forty-nine-year rental tenures; elimination of inheritance beyond the family home. The property-and-inheritance dimension. The detailed treatment lives in the [Humanitarianism](../humanitarianism/) entry.

**3. World Government**. Unified planetary political authority, with single global currency, common second language alongside local mother tongues, and single coordinating framework for planetary-scale issues. The political-coordination dimension. The detailed treatment lives in the [World Government](../world-government/) entry when written.

**4. Demilitarization**. Abolition of national-level military service, dismantling of national armed forces, repurposing of career soldiers as global peacekeeping force. The peace dimension. The detailed treatment lives in the [Demilitarization](../demilitarization/) entry when written.

**5. Science as Religion**. Reorientation of religious commitment toward scientific inquiry as substantive religious activity. The religious-cultural dimension. The detailed treatment lives in the [Science as Religion](../science-as-religion/) entry when written.

**6. Telepathic Cultivation**. Systematic development of latent telepathic capacities. The cognitive-developmental dimension. The detailed treatment lives in the [Telepathy](../telepathy/) entry when written.

**7. Metaphysical Clarifications**. Doctrinal-cosmological clarifications regarding soul, original sin, and broader inherited religious cosmology. The doctrinal-cosmological dimension. The detailed treatment lives in the [Metaphysical Clarifications](../metaphysical-clarifications/) entry when written.
...
The Geniocracy entry operates as one of seven New Commandments dedicated entries that together articulate the substantive Aquarian-age program. The detailed treatment of the broader umbrella concept lives in the [New Commandments](../new-commandments/) entry when written.

### The Humanitarianism complement

The doctrine operates substantively as principal foundational complement to Humanitarianism — Geniocracy on the political-governance dimension, Humanitarianism on the property-and-inheritance dimension. The detailed treatment of Humanitarianism lives in the [Humanitarianism](../humanitarianism/) entry; the present entry articulates the political-governance complement substantively.

### The Aquarian-age program

The Aquarian-age program articulation operates across multiple corpus entries. The detailed treatment of the broader Aquarian-age content lives in the [Age of Aquarius](../age-of-aquarius/) entry when written; the present entry articulates the political-governance dimension specifically.

### The Yahweh figure engagement

The doctrine is articulated principally by Yahweh as one of the New Commandments delivered to Vorilhon. The detailed treatment of the Yahweh figure lives in the [Yahweh](../yahweh/) entry when written.

### The Raëlism institutional framework

The doctrine operates substantively within the broader Raëlian Movement institutional framework, with substantive editorial separation between Raëlian Movement institutional engagement and Geniocratic political-movement engagement. The detailed treatment lives in the [Raëlism](../raelism/) entry.

### The Vorilhon source-textual material

The doctrine is articulated principally in *The Book Which Tells the Truth* (1974) and the dedicated *Géniocratie* (1977). The detailed treatment of the broader Vorilhon source material lives in the [Raël](../rael/) and [Message from the Designers](../message-from-the-designers/) entries.

### The Movement for Worldwide Geniocracy

The substantive Movement for Worldwide Geniocracy operates substantively as the political-institutional articulation of the doctrine. The detailed treatment lives in the [Movement for Worldwide Geniocracy](../movement-for-worldwide-geniocracy/) entry when written.
...
The detailed treatment of the imperial examination system lives in the [Chinese Imperial Examination System](../chinese-imperial-examination/) entry when written.
