+++
title = "Zodíaco"
description = "El Zodíaco (griego <span class=\"greek\">ζῳδιακὸς κύκλος</span> *zōidiakòs kýklos*, \"círculo de los animales\") es la configuración circular eclíptica de las doce constelaciones por las que el Sol transita a lo largo de un año trópico: Aries, Tauro, Géminis, Cáncer, Leo, Virgo, Libra, Escorpio, Sagitario, Capricornio, Acuario, Piscis. La convención de dividir la eclíptica en doce segmentos zodiacales iguales se remonta principalmente a la tradición astronómica babilonio-mesopotámica (siglo V a. e. c. aproximadamente), con la extensión sustancial a través de la tradición astronómica helenística y árabe. En el marco Wheel of Heaven, el zodíaco es el fundamento geométrico del cómputo precesional: los doce segmentos zodiacales corresponden a las doce eras precesionales de un Gran Año, y los símbolos conservados en la tradición religioso-iconográfica de cada era (Apis-toro y sandalias-escorpión de la tradición egipcia; cordero-Pésaj y símbolo-balanza de la tradición profética hebrea; símbolo-Cristo de pez y símbolo-Virgen-María de la tradición cristiana) se leen como configuraciones de signatura doble de las eras correspondientes."
...
constellational_basis = "The twelve constellations occupy varying angular extents along the ecliptic (modern IAU boundaries; idealized 30°-per-sign in classical astrological usage); the constellations are not equal in size — Virgo is the largest, Capricorn among the smallest"
...
framework_reading = "The zodiac as the alliance's engineering tool — the long-duration calendrical framework devised by the Elohim for their interstellar biotech program, with the zodiacal names and the paired-opposition structure operating as functional engineering features rather than mystical-aesthetic conventions"
zodiacal_names_origin = "On the corpus's reading: the Elohim's own conceptual shorthand for the twelve ecliptic segments, inherited by human civilizations through cultural transmission across the post-flood ages; later human civilizations modified the figures while preserving the underlying twelve-fold structure"
distinguished_from = "Mainstream astrology's tropical zodiac (signs tied to seasonal positions rather than actual constellational positions, decoupled from precessional motion); the various cross-cultural zodiacal-equivalent traditions (Chinese twelve-animal cycle, Indian nakshatra system, Mesoamerican calendrical traditions) which preserve substantive parallel content within distinctive cultural framings; the broader astronomical constellational framework (the 88 IAU-defined constellations of which the twelve zodiacal constellations are a subset)"
status_in_framework = "Foundational; the zodiac operates as the principal observational-symbolic complement to the World Age temporal framework, with the two together constituting the corpus's principal cosmic-chronological architecture"
principal_corpus_treatment = "*timeline.epub*, particularly the Libra chapter's Section VI.2 ('The Zodiacal Framework as Engineering Tool'); Jean Sendy, *L'ère du Verseau* (1970), with substantial systematic engagement with Moses's use of zodiacal symbolism (the *religion zodiacale* framework)"
+++
...
The zodiac operates as the principal observational-symbolic framework underlying the precessional age system: the constellational regions through which the **vernal equinox** precesses across the ~25,920-year Great Year cycle, with each constellation occupied for approximately 2,160 years per age. The current present marks the precessional transition from Pisces (the past two millennia) toward Aquarius (the present and coming age) — the underlying astronomical fact that the broader cultural engagement with "the Age of Aquarius" registers. The detailed treatment of the precessional age system itself lives in the [World Age](../world-age/) entry; the Zodiac entry's contribution is registering the constellational-symbolic framework through which that temporal system is articulated.
...
> *Hatotzi mazzarot be'ito ve-ayish al-baneha tanchem*
> "Can you bring forth Mazzaroth in its season? Or can you guide the Bear with her sons?"
...
- **Persian**: منطقه‌البروج (*Mantaqat al-Burūj*); the substantial Persian astronomical tradition's principal designation
...
The framework operates principally through the sidereal-zodiac engagement, since the precessional age system requires actual constellational tracking. The detailed treatment of the tropical-vs-sidereal distinction lives in the [World Age](../world-age/) entry.
...
The articulation registers the paired-opposition structure as foundational to the doubled-signature principle. The detailed treatment of the doubled-signature principle lives in the [Doubled Signature](../doubled-signature/) entry; the Zodiac entry's contribution is registering the underlying paired-opposition geometry.
...
> הֲתֹצִיא מַזָּרוֹת בְּעִתּוֹ וְעַיִשׁ עַל־בָּנֶיהָ תַנְחֵם
> *Hatekashshēr ma'adanot kimah o-moshkot kesil tefatēach*
> *Hatotzi mazzarot be'ito ve-ayish al-baneha tanchem*
> "Can you bind the chains of the Pleiades, or loose the cords of Orion? Can you bring forth Mazzaroth in its season, or guide the Bear with her sons?"
...
1. **Aries ↔ Libra** (Ram ↔ Scales): impulse and balance; the assertive principle and the relational principle
2. **Taurus ↔ Scorpio** (Bull ↔ Scorpion): generative and regenerative; life-power and death-power
3. **Gemini ↔ Sagittarius** (Twins ↔ Archer): communication and aspiration; the local mind and the cosmic mind
4. **Cancer ↔ Capricorn** (Crab ↔ Sea-Goat): emotional home and structured summit; nurturance and authority
5. **Leo ↔ Aquarius** (Lion ↔ Water-Bearer): individual sovereignty and collective participation; royal consciousness and humanitarian consciousness
6. **Virgo ↔ Pisces** (Virgin ↔ Fishes): analytical precision and dissolutive unity; the discerning intellect and the synthetic intuition

The paired oppositions operate substantively within the broader doubled-signature principle. The detailed treatment lives in the [Doubled Signature](../doubled-signature/) entry.
...
The detailed treatment of the precessional age system lives in the [World Age](../world-age/) entry. The Zodiac entry's contribution is registering the constellational-symbolic framework through which that temporal system is articulated.

### The Doubled Signature concept

The detailed treatment of the doubled-signature principle lives in the [Doubled Signature](../doubled-signature/) entry. The Zodiac entry's contribution is registering the paired-opposition geometric structure that underlies the principle.
...
- [Age of Capricorn](../age-of-capricorn/), [Age of Sagittarius](../age-of-sagittarius/), [Age of Scorpio](../age-of-scorpio/), [Age of Libra](../age-of-libra/), [Age of Virgo](../age-of-virgo/), [Age of Leo](../age-of-leo/), [Age of Cancer](../age-of-cancer/), [Age of Gemini](../age-of-gemini/), [Age of Taurus](../age-of-taurus/), [Age of Aries](../age-of-aries/), [Age of Pisces](../age-of-pisces/), [Age of Aquarius](../age-of-aquarius/)
...
The detailed treatment of *Hamlet's Mill* as foundational scholarly anchor lives in the [Hamlet's Mill](../hamlets-mill/) entry when written. The substantial Santillana / von Dechend reconstruction of cross-cultural zodiacal-precessional encoding operates substantively within the broader framework.

### The Hebrew Bible engagement

The Hebrew Bible engagement with zodiacal content lives principally in the [Hebrew Bible](../hebrew-bible/) entry. The substantial Sendy engagement with Moses's zodiacal-symbolism use, the Mazzaroth reference in Job, the various other Hebrew Bible zodiacal allusions are treated within that broader engagement.
...
**The Long Count**. The Mayan Long Count (treated principally in the [World Age](../world-age/) entry) operates with substantive cyclical-temporal architecture.
