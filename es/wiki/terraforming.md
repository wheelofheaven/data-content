...
description = "Terraformación (inglés *terraforming*, \"formar tierra\") es el concepto central en la tradición de la ciencia ficción y la ciencia planetaria de modificación dirigida de un entorno planetario para hacerlo habitable para la vida terrestre — concepto que Jack Williamson articuló sistemáticamente por primera vez en *Collision Orbit* (1942) y que ocupa lugar central en la tradición posterior de ciencia ficción (la trilogía de *Marte* de Kim Stanley Robinson, 1992–1996; *Man Plus* de Frederik Pohl, 1976), en la investigación científica sobre terraformación de Marte (Christopher McKay, Robert Zubrin) y en la discusión contemporánea de astrobiología y colonización de Marte de SpaceX/Tesla. El marco Wheel of Heaven lee la terraformación como el método operativo aplicado por la Alianza Elohim en la Tierra durante las eras de pre-creación (de Capricornio a Cáncer según el cómputo precesional del corpus) — la modificación sustancial de la configuración terrestre pre-Elohim a un entorno mundial óptimo para la fase subsiguiente de síntesis humana. El concepto humano contemporáneo de terraformación opera así en convergencia funcional con el método operativo Elohim original."
...
adjacent_fields = "Astrobiology; planetary science; xenobiology; synthetic biology; geoengineering; climate science"
term_coined = "Jack Williamson, *Collision Orbit*, 1942 (science-fiction context); Carl Sagan, *Science*, 1961 (scientific context)"
principal_targets = "Mars (most studied); Venus (more speculative); Moon, Mercury, Jovian and Saturnian moons (variously discussed); free-floating habitats and shell worlds (alternative paraterraforming concepts)"
foundational_milestones = "Coining of the term (Williamson, 1942); first scientific proposal (Sagan, Venus terraforming via algae, 1961); first Mars terraforming proposal (Sagan, polar-cap vaporisation, 1971); foundational scientific treatments (McKay, 1982 onward; Fogg, *Terraforming*, 1995); CO2-inventory analysis (Jakosky and Edwards, 2018); silica-aerogel paraterraforming (Wordsworth et al., 2019)"
current_status = "Active research field; no terraforming has been attempted at any scale; full-scale Mars terraforming assessed as infeasible with present technology; localised paraterraforming concepts under active study"
framework_significance = "The planetary-engineering operations of the first four ages of Genesis 1 — atmospheric separation, water-cycle establishment, continental work, astronomical calibration — are read on the framework as the Elohim's terraforming of Earth during the preparation phase of the Earth project, prior to biological synthesis"
+++
...
The biological approach is more naturally combined with paraterraforming or pan-tropic approaches than with classical global terraforming. The synthetic-biology and synthetic-genomics methods now available (treated in the [synthetic biology](../synthetic-biology/) and [synthetic genomics](../synthetic-genomics/) entries) provide the engineering capability for designing organisms suited to specific extraterrestrial environments — the pan-tropic approach.
...
The pan-tropic literature has developed in parallel with the broader synthetic-biology literature and is treated more fully in the [xenobiology](../xenobiology/) entry, where the relationship between synthetic-biology methods and the design of organisms for non-terrestrial environments is developed in detail.
...
The framework's interest in terraforming engages a different aspect of the source material's account than the previous life-engineering entries do. Where [life engineering](../life-engineering/), [synthetic biology](../synthetic-biology/), and [synthetic genomics](../synthetic-genomics/) engage the framework through the *biological-synthesis* convergence — the contemporary terrestrial development of the capability to design and construct living organisms — terraforming engages the framework through the *planetary-engineering* convergence: the contemporary development of the capability to modify planetary environments to support biological life.

### The first four *yamim* as terraforming operations

The source material's account of the Elohim's work on Earth — developed in the [Genesis](../genesis/) entry and the dedicated entries on the early precessional ages — places the biological synthesis of terrestrial life in the latter half of the seven-*yom* creation sequence. The first four *yamim* are not described as biological-synthesis operations; they are described as operations on the planet itself, in preparation for the biological work that follows.
...
The convergence reading that the [life engineering](../life-engineering/) entry develops for the biological side of the source material's account is partially applicable to the terraforming side, but with substantial differences in current state.
...
The pan-tropic alternative to classical terraforming — designing the organisms to suit the environment rather than the environment to suit the organisms — has specific relevance to the framework's broader reading. The cosmic-chain account, developed in the [Cosmic Chain](../cosmic-chain/) entry, treats the Elohim civilisation as one link in a chain of creator civilisations, each of which has at some point developed the capability to create life on other worlds. If the chain extends backward indefinitely through deep time, with each civilisation creating new humanities on suitable worlds, the question of *how* each civilisation conducts its creation work is significant.
