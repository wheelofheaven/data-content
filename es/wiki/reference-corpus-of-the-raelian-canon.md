...
timeline = ["pisces"]
lead = "A lo largo de los tres libros canónicos del corpus raeliano, Claude Vorilhon (Raël) construye su exposición citando, parafraseando y aludiendo a un amplio repertorio de textos, tradiciones y figuras preexistentes. Esta entrada cataloga ese campo intertextual en dos niveles: un nivel primario de obras que el canon nombra o cita expresamente, y un nivel secundario de tradiciones, lenguas y motivos con los que el canon dialoga sin citar formalmente."
reading = "interpretive"

see_also = [
    { title = "Biblia", path = "/wiki/bible/", description = "La tradición textual más amplia en la que se inscriben la Biblia hebrea y el Nuevo Testamento." },
    { title = "Biblia Hebrea", path = "/wiki/hebrew-bible/", description = "El cuerpo de referencia más extenso y citado con mayor precisión por el canon." },
    { title = "Génesis", path = "/wiki/genesis/", description = "El libro más citado en la exégesis de la historia primigenia que recorre el canon." },
    { title = "Cábala", path = "/wiki/kabbalah/", description = "Nombrada en El fin del mundo como «el libro más cercano a la verdad»; el pasaje de los parasangas apunta al Shi'ur Qomah." },
    { title = "Raelismo", path = "/wiki/raelism/", description = "El movimiento constituido por los tres libros canónicos aquí catalogados." },
    { title = "Raël", path = "/wiki/rael/", description = "Claude Vorilhon, autor de los tres libros canónicos." },
    { title = "Elohim", path = "/wiki/elohim/", description = "La denominación civilizacional que el canon descifra a partir del plural hebreo." },
    { title = "Yahvé", path = "/wiki/yahweh/", description = "El líder del Consejo que el canon restituye al texto bíblico." },
...
footnotes = [
    ...
    { content = "La lista de «vestigios» (Kojiki, Popol Vuh, Crónica de Akakor, Epopeya de Gilgamesh, Mahābhārata) que aparece en el comentario *Sí... soy raeliano* figura en una contribución de un seguidor a *Acojamos a los extraterrestres* y no en la propia voz de Raël. Ha sido canonizada por su preservación a lo largo de las ediciones, pero se trata de una síntesis de un seguidor. Si conviene ponderarla en pie de igualdad con las citas del nivel primario es una cuestión editorial abierta —y la *Crónica de Akakor* en particular encaja con dificultad con el resto del catálogo, ya que la obra de Brugger de 1976 ha sido tratada ampliamente por la investigación posterior como un fraude literario." },
    { content = "El pasaje cosmológico que el canon atribuye a «la Cábala» en *El fin del mundo* —la «altura del creador» y la «altura de sus talones» medidas en *parasangas*— coincide con motivos de la tradición *Shi'ur Qomah* de especulación esotérica sobre el cuerpo de Dios (c. siglos II-IV d. C.) y no con el corpus del *Zohar* que el término «Cábala» suele designar hoy de manera más convencional. El canon nombra la Cábala de forma genérica; una lectura filológica más estricta glosaría la referencia como Shi'ur Qomah específicamente." },
    { content = "El trabajo etimológico-filológico del canon —*Elohim* como «los que vinieron del cielo», *angelos* como «mensajero», *apocalypsis* como «revelación», *diabolos* como «calumniador», *euagelion* como «buena nueva», etc.— trata las historias de las palabras como testimonios por derecho propio. La exactitud de cada etimología es desigual (algunas son consenso académico mayoritario, otras son especulativas o discutidas), pero el movimiento estructural es coherente: el canon lee la etimología como conservadora de contenido histórico que el vocabulario teológico convencional ha oscurecido. Esta es una de las operaciones interpretativas recurrentes del canon." },
    { content = "El canon excluye explícitamente de su ámbito la tradición interpretativa más amplia de los antiguos astronautas (Sendy, Sitchin, von Däniken, Wallis, Biglino) como *contexto aportado por el lector* y no como corpus de referencia propio del canon. El canon raeliano reivindica revelación, no derivación, y trata la literatura religiosa previa como registros imperfectos de contactos anteriores con los Elohim, no como sus propias fuentes intelectuales. El marco del corpus distingue estas capas cuidadosamente: esta entrada cataloga únicamente lo que el canon mismo nombra y aborda." },
]

[[extra.references]]
id = "the-book-which-tells-the-truth"
note = "Vorilhon (Raël, 1974); el libro canónico fundacional y el principal lugar de la exégesis bíblica del canon (Génesis 1-11 capítulo por capítulo)."

[[extra.references]]
id = "extraterrestrials-took-me-to-their-planet"
note = "Vorilhon (Raël, 1975); contiene el capítulo Budismo, las citas directas del Corán y la lectura de Ezequiel 37 sobre los huesos secos."

[[extra.references]]
id = "lets-welcome-the-extraterrestrials"
note = "Vorilhon (Raël, 1979); contiene el capítulo Las nuevas revelaciones sobre el Apocalipsis y el comentario Sí... soy raeliano que enumera vestigios supervivientes."

[[extra.references]]
id = "intelligent-design-message-from-the-designers"
note = "El compendio inglés de 2005 que reúne los tres libros canónicos; la base textual principal de este catálogo."

[[extra.references]]
id = "dhorme-bible"
note = "La principal Biblia francesa utilizada por Raël durante el contacto de 1973 y citada en los volúmenes canónicos franceses."

[[extra.references]]
id = "rnkjv"
note = "Restored Name King James Version; la principal Biblia en inglés utilizada en el compendio de 2005, que restituye Elohim y Yahvé al texto."

[[extra.references]]
id = "the-qur-an"
locator = "Sura 21:1-5; 54:1; 56:15-24"
note = "Citada directamente en Los extraterrestres me llevaron a su planeta con precisión de capítulo y versículo."

[[extra.references]]
id = "book-of-enoch"
note = "Nombrado en el comentario Sí... soy raeliano como uno de los textos más próximos a la verdad del canon."

[[extra.references]]
id = "shiur-qomah"
note = "La temprana tradición mística judía cuyo motivo antropomórfico-cósmico de medida del cuerpo coincide con la cita del canon sobre los parasangas / altura del creador atribuida a la Cábala."

[[extra.references]]
id = "epic-of-gilgamesh"
note = "Enumerada en el comentario Sí... soy raeliano entre los vestigios supervivientes (identificada como «sumerio-babilónica»)."

[[extra.references]]
id = "mahabharata"
note = "Nombrada en el comentario Sí... soy raeliano; los Vedas y el Rāmāyaṇa figuran como partes del corpus más amplio."

[[extra.references]]
id = "ramayana"
note = "Enumerado junto al Mahābhārata en el comentario Sí... soy raeliano."

[[extra.references]]
id = "vedas"
note = "Nombrados dentro del corpus del Mahābhārata en el comentario Sí... soy raeliano."

[[extra.references]]
id = "kojiki"
note = "La crónica japonesa del año 712 d. C., nombrada en el comentario Sí... soy raeliano entre los vestigios supervivientes."

[[extra.references]]
id = "popol-vuh"
note = "La epopeya de creación maya k'iche', nombrada en el comentario Sí... soy raeliano, junto a la Crónica de Akakor como testimonio latinoamericano."

[[extra.references]]
id = "chronicle-of-akakor"
note = "Brugger (1976); aparece en la lista de vestigios de Sí... soy raeliano. La investigación posterior trata ampliamente la obra de Brugger como un fraude literario —una tensión no resuelta dentro del horizonte de referencias del canon."
+++
...
3. **Contexto aportado por el lector.** Material que un lector o comentarista pudiera aportar al canon desde fuera (Sendy, Sitchin, Biglino, literatura sobre antiguos astronautas en general). Esta tercera categoría **queda fuera del alcance** de este artículo{{ footnote(id="6") }}. Se cataloga en otro lugar dentro de la taxonomía de fuentes del proyecto.
...
La base textual de este catálogo es la edición compendio en lengua inglesa de 2005 *Intelligent Design — Message From the Designers*{{ cite(id="intelligent-design-message-from-the-designers", text="[1]", title="El compendio inglés de 2005 que reúne los tres libros canónicos") }}{{ footnote(id="1") }}, que reúne los tres libros canónicos. Cuando las ediciones francesas originales difieren de la traducción inglesa en su tratamiento de las citas bíblicas, el propio canon señala la divergencia: los volúmenes franceses se basan principalmente en la traducción de la Biblia de **Édouard Dhorme**{{ cite(id="dhorme-bible", text="[2]", title="Dhorme (1956-1959); la traducción francesa de la Biblia que Raël consultó") }}{{ footnote(id="2") }}, mientras que el compendio inglés utiliza la **Restored Name King James Version** (RNKJV){{ cite(id="rnkjv", text="[3]", title="Restored Name King James Version; restituye Elohim y Yahvé al texto") }} para la mayoría de las citas, con uso ocasional de la **New King James Version**, la **American Standard Version**, la **Webster Bible**, la **Hebrew Names Version** y la **Darby Translation**. Estas decisiones editoriales son en sí mismas referencias directas a tradiciones textuales específicas y se catalogan más abajo.
...
- **La Cábala** — nombrada en *El fin del mundo*, capítulo *En la raíz de todas las religiones*, como «el libro más cercano a la verdad». El canon le atribuye un pasaje cosmológico específico sobre la «altura del creador» y la distancia entre la Tierra y el planeta de origen de los Elohim, medida en *parasangas*. (La referencia a un pasaje del *Cántico de los Cánticos* dentro de la Cábala apunta aquí a la tradición *Shi'ur Qomah* de especulación esotérica sobre el cuerpo de Dios{{ cite(id="shiur-qomah", text="[4]", title="Shi'ur Qomah; la temprana tradición mística judía sobre el cuerpo de Dios") }}{{ footnote(id="4") }}.)
...
La lista *Sí... soy raeliano* es un comentario de un seguidor y no una declaración de Raël, pero aparece dentro del compendio canónico y articula la misma lectura que el canon establece en *En la raíz de todas las religiones*{{ footnote(id="3") }}.

### Lenguas abordadas filológicamente

El canon realiza lecturas etimológicas sostenidas, tratando las historias de las palabras como testimonios por derecho propio{{ footnote(id="5") }}. Las lenguas en las que se apoya explícitamente incluyen:
...
- **Latín** — *senior* (el mayor / señor), *pontifex* (constructor de puentes), *cultus* (tributo), *religio* (lo que vincula).
