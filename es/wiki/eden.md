...
see_also = [
    ...
    { title = "Árbol de la Vida", path = "/wiki/tree-of-life/", description = "Uno de los dos árboles nombrados en el centro del jardín." },
    { title = "Árbol del Conocimiento del Bien y del Mal", path = "/wiki/tree-of-the-knowledge-of-good-and-evil/", description = "El otro árbol nombrado — el que conlleva la prohibición." },
    { title = "Serpiente", path = "/wiki/serpent/", description = "La figura que inicia la ruptura del estado del jardín." },
    { title = "Génesis", path = "/wiki/genesis/", description = "El texto en el que se enmarca la narrativa del jardín." },
    { title = "Elohim", path = "/wiki/elohim/", description = "La denominación civilizacional de la alianza cuyo equipo Israel operó en la región del Edén." },
    { title = "Yahvé", path = "/wiki/yahweh/", description = "La figura del líder del Consejo cuya política estructuró el asentamiento post-edénico." },
    { title = "Lucifer", path = "/wiki/lucifer/", description = "El líder de la facción disidente cuya divulgación produjo el episodio de Génesis 3." },
    { title = "Antediluviano", path = "/wiki/antediluvian/", description = "El período prediluviano durante el cual se desarrolló la civilización edénica más amplia." },
    { title = "Pangea", path = "/wiki/pangaea/", description = "El supercontinente antediluviano en el que se encontraba el Edén." },
    { title = "Gran Diluvio", path = "/wiki/great-flood/", description = "El evento de la Era de Géminis que cerró el período operativo del Edén." },
...
[[extra.references]]
id = "cassuto-genesis"
note = "Cassuto (1961); comentario erudito judío que se opone a la fragmentación documentaria-hipotética de la narrativa del Edén."

[[extra.references]]
id = "halloran-sumerian-lexicon"
note = "Halloran (2006); referencia accesible sobre el trasfondo etimológico del sumerio EDEN / edinu."

[[extra.references]]
id = "rohl-legend-genesis"
note = "Rohl (1998); articulación de la hipótesis del Lago Urmia; una de las principales propuestas modernas sobre la ubicación del Edén."

[[extra.references]]
id = "oppenheimer-eden-east"
note = "Oppenheimer (1998); hipótesis del Edén en Sundaland; sitúa la fuente cultural originaria en el sudeste asiático sumergido."

[[extra.references]]
id = "kramer-enki-myths"
note = "Kramer y Maier (1989); el corpus mitológico de Enki incluyendo el material de Dilmun y Enki-Ninhursag estructuralmente paralelo a la tradición edénica."

[[extra.references]]
id = "atra-hasis-lambert-millard"
note = "Lambert y Millard (1969); edición crítica de la narrativa babilónica del diluvio; contexto del antiguo Próximo Oriente para la tradición del Edén-y-Diluvio."

[[extra.references]]
id = "boyce-zoroastrians"
note = "Boyce (ed. rev. 2001); la Vara-de-Yima persa-zoroastriana y la tradición más amplia del paraíso-y-diluvio estrechamente paralela al Edén."

[[extra.references]]
id = "sitchin-12th-planet"
note = "Sitchin (1976); la lectura sumeria E.DIN; principal ancla popular del astronauta antiguo para la tradición interpretativa edénica más amplia."

[extra.infobox]
hebrew_name = "עֵדֶן (región); גַּן־עֵדֶן (el jardín en Edén)"
...
La palabra hebrea *gan*, traducida convencionalmente como «jardín», deriva de la raíz *g-n-n*, «encerrar, proteger, defender» — la misma raíz que está detrás de *ginah* («jardín, recinto») y *meginah* («escudo, protección»). El sentido fuerte de *gan* es, por tanto, el de un espacio cerrado, protegido y controlado, con el límite no meramente ornamental sino funcional{{ footnote(id="1") }}. Este sentido de *gan* cobrará importancia en la sección Reinterpretaciones modernas más adelante.

## En las fuentes primarias

El Edén aparece principalmente en Génesis 2–3, con referencias secundarias dispersas por el resto de la {% wiki(slug="bible") %}Biblia{% end %} hebrea y en la literatura más amplia del antiguo Próximo Oriente.
...
Durante esta fase operativa inicial, el jardín fue el emplazamiento de la síntesis biológica activa{{ cite(id="the-book-which-tells-the-truth", text="[1]", title="Vorilhon (Raël), *El Libro que Dice la Verdad* (1974), capítulo 2 «La Verdad» — la principal fuente raeliana para la lectura del marco del Edén") }}. Los laboratorios del equipo produjeron a los primeros humanos mediante las técnicas de diseño genético y síntesis de laboratorio que la civilización Elohim poseía; los individuos resultantes fueron colocados en el entorno preparado del jardín e instruidos en los idiomas, las ciencias y las artes que el equipo juzgó apropiados para ellos. La instrucción estaba deliberadamente acotada: a los humanos se les concedió el libre uso de los recursos educativos y biológicos del jardín, pero la prohibición relativa al Árbol del Conocimiento del Bien y del Mal correspondía a una restricción específica del acceso a los archivos científicos y tecnológicos del equipo — los materiales cuyo uso habría dado a los humanos capacidades que las autoridades del equipo, en el mundo de origen, no querían que adquirieran{{ footnote(id="4") }}.
...
El tratamiento detallado del evento del Diluvio vive en la entrada {% wiki(slug="great-flood") %}Gran Diluvio{% end %}. Lo que importa para la entrada del Edén es que el Diluvio es el evento que cierra el período operativo del Edén: tras el Diluvio, el Edén es una memoria más que un lugar.
...
El tratamiento del Edén por **Jean Sendy** está desarrollado a lo largo de su obra pero se concentra particularmente en *Ces dieux qui firent le ciel et la terre* (1969){{ cite(id="sendy-ces-dieux", text="[2]", title="Sendy (1969); articulación fundacional en francés; principal antecedente académico de la lectura del Edén del corpus") }} y *Les cahiers de cours de Moïse* (1974){{ cite(id="sendy-cahiers-moise", text="[3]", title="Sendy (1974); desarrolla el marco del período mosaico con sustancial trasfondo del período del Edén") }}. Sendy lee la narrativa del Edén como un registro de eventos operativos en un emplazamiento específico de creadores extraterrestres, con la extrañeza de la narrativa (la serpiente parlante, los árboles con funciones teológicas, los querubines con espadas flamígeras) desapareciendo cuando los referentes subyacentes se toman en serio en lugar de alegorizarlos. Las contribuciones específicas de Sendy a la interpretación del Edén incluyen la lectura de los cuatro ríos como una hidrografía antediluviana, la identificación de los querubines con controles tecnológicos de acceso, la lectura del Árbol de la Vida como un recurso biotécnico más que como una especie botánica, y la lectura política-en-lugar-de-moral de la expulsión. El enfoque de Sendy es filológico e historiográfico más que revelatorio; alcanza la lectura del marco a partir del sentido llano del texto hebreo, trabajando desde la evidencia comparativa-mitológica y el análisis textual interno. Su tratamiento del Edén es el principal antecedente académico de la lectura adoptada por el corpus.
...
Biglino propone adicionalmente una etimología no estándar del sumerio-acadio *E-Din* como «casa de los justos», leyendo «los justos» como miembros del linaje Elohim{{ footnote(id="5") }}. Esta glosa es distintivamente de Biglino y no es la lectura asiriológica estándar; la lectura consensuada sigue siendo «llanura» o «estepa». El corpus adopta la lectura estándar en lugar de la de Biglino, ya que la argumentación interpretativa del marco no depende de la glosa no estándar y está en terreno más sólido sin ella.
...
La tradición egipcia *zep tepi* («el primer tiempo»), referenciada brevemente en la entrada {% wiki(slug="antediluvian") %}Antediluviano{% end %}, es un paralelo más cercano a la tradición edénica-de-origen de lo que es el Campo de Juncos. *Zep tepi* se refiere a un período primordial cuando los dioses caminaban entre los hombres y establecieron el orden cósmico; el paralelo estructural con el período del Edén (cuando la alianza estaba directamente presente en la Tierra, antes de la retirada post-Edén) es evidente.
