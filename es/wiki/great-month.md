+++
title = "Gran Mes"
description = "El Gran Mes es, en el marco Wheel of Heaven, sinónimo de era precesional — una doceava parte del Gran Año, es decir, alrededor de 2.160 años (o, más precisamente, 25.920 / 12 = 2.160 años según la tradición astrológica; o 25.772 / 12 ≈ 2.147,7 años según la medición astronómica contemporánea). La denominación de \"Mes\" proviene de la expansión analógica de la organización mensual del año a la escala cósmica — así como el año solar normal se divide en doce meses (~30 días cada uno), el Gran Año se divide en doce Grandes Meses (~2.160 años cada uno). El término se utiliza en el corpus sobre todo en las capas más antiguas del material (lecturas de Génesis en las que los siete \"días\" de la creación se interpretan como siete eras precesionales); contemporáneamente predomina la designación \"era precesional\" o \"Era del Mundo\"."
...
entry_type = "concept"
claim_type = "inferred"
alternative_names = ["Astrological age", "Precessional month", "World Age", "Aeon (in some Greek-derived usages)", "Platonic Month (in some Renaissance-tradition usages)"]

[extra.infobox]
type = "Unit of chronological measurement; one-twelfth of the precessional Great Year"
duration_modern = "Approximately 2,147.6 years (25,771.5 years ÷ 12, based on the modern astronomical precessional rate of ~50.29 arcseconds/year)"
duration_traditional = "Exactly 2,160 years (25,920 years ÷ 12, based on the astrological-tradition Great Year)"
component_units = "1 Great Month = 30° of ecliptic precession; 12 Great Months = 1 Great Year (full precessional cycle); 30 Great Days = 1 Great Month (where 1 Great Day = 72 years ≈ one human lifespan)"
zodiacal_correspondence = "Each Great Month corresponds to the period during which the vernal equinox point lies within one of the twelve zodiacal signs; the current Age is in transition between Pisces and Aquarius"
mathematical_properties = "The traditional figure 25,920 factors as 2⁶ × 3⁴ × 5 = 64 × 405 = 60 × 432 = 360 × 72; the Great Month figure 2,160 factors as 2⁴ × 3³ × 5; both numbers have substantial divisibility properties that account for their prominence in cross-cultural cosmological tradition"
cross_cultural_preservation = "The 25,920 / 2,160 / 432 numerical structure appears in Hindu *yuga* arithmetic (Kali Yuga = 432,000 years = 1/3 of the precessional Great Year measured in arcseconds), Babylonian sexagesimal numerology, the Platonic-tradition Magnus Annus, and other cross-cultural cosmological systems"
framework_significance = "Principal chronological unit for the corpus; the precessional Great Months provide the structured temporal framework within which the Elohim project and the broader prophetic record are dated"
+++
...
The Great Month's duration depends on the choice of precessional rate. The two principal reckonings produce different numerical values, both of which are used in different contexts within the corpus's broader work.

### Modern astronomical reckoning
...
The precessional rate itself is not perfectly constant — it varies slowly across geological timescales due to the broader Earth-Moon system dynamics and the influence of the other planets. The contemporary rate is the value applicable to the present epoch; over substantially longer periods (millions of years), the rate varies by a few percent. For the corpus's chronological purposes — which span approximately one full precessional cycle from the Adamite synthesis (~13,000 BCE) through the contemporary period — the variation is negligible and the contemporary rate is adequate.

### Astrological-tradition reckoning
...
$$
25,920 = 2^6 \times 3^4 \times 5 = 64 \times 405 = 60 \times 432 = 360 \times 72
$$

The number is divisible by:
- **360** (the number of degrees in a circle), giving 72 years per degree of ecliptic precession
- **60** (the base of Babylonian sexagesimal numeration), giving 432 years per sexagesimal unit
- **12** (the number of zodiacal signs), giving 2,160 years per sign — the Great Month
- **24** (the hours of the day or the doubled signs), giving 1,080 years per half-sign
- **36** (the decans of classical astrology), giving 720 years per decan
- **72** (the doubled half-sign, also the Great Day in the unit-system developed below)

The number 2,160 = 2⁴ × 3³ × 5 retains many of these divisibility properties:
...
- **One Great Year (25,920 years) ≈ 360 human lifespans** — substantially exceeding the temporal scope of any continuous cultural memory

The framework's broader reading treats this correspondence as one of several structural patterns connecting human and cosmic scales that the corpus engages. The dedicated [Anthropic principle](../anthropic-principle/) and related entries develop the broader pattern. The 72-year Great Day also connects to substantial source-tradition material on the number 72, developed in the framework section below.
...
The Hindu cosmological tradition preserves the most substantial numerical correspondences with the precessional cycle. The standard *yuga* periods (in human years, after the conversion factor of 360 human years per divine year is applied):

| Yuga | Duration in human years | Relationship to 432 |
|---|---|---|
| **Satya Yuga (Krita Yuga)** | 1,728,000 | 4 × 432,000 |
| **Treta Yuga** | 1,296,000 | 3 × 432,000 |
| **Dvapara Yuga** | 864,000 | 2 × 432,000 |
| **Kali Yuga** | 432,000 | 1 × 432,000 |
| **Mahayuga (sum of all four)** | 4,320,000 | 10 × 432,000 |
| **Kalpa (1,000 Mahayugas)** | 4,320,000,000 | 10,000 × 432,000 |

The number **432,000** is the basic unit of the entire Hindu cosmological time-system. The number relates to the precessional Great Year through several connections:
...
### The Platonic Magnus Annus tradition

The Greek philosophical tradition includes substantial engagement with the concept of a cosmic "Great Year" predating Hipparchus's discovery of precession. **Plato**'s *Timaeus* (c. 360 BCE, Timaeus 39d) introduces the **Perfect Year** (*teleios eniautos*) or **Magnus Annus** (in the later Latin tradition) — the period required for all the celestial bodies (Sun, Moon, and the five visible planets) to return to their initial configuration:
...
The Babylonian astronomical tradition's sexagesimal (base-60) numeration produces several numerical correspondences with the precessional cycle:

- **The *sar* of 3,600 years** (60²) — a basic unit of long-period Babylonian chronology; 25,920 = 7.2 × 3,600
- **The *ner* of 600 years** (60 × 10) — 25,920 = 43.2 × 600
- **The *sussu* of 60 years** — 25,920 = 432 × 60
- **The 360-day year** (the standard Babylonian schematic year) — 25,920 = 72 × 360, with 72 as the Great Day

The Babylonian astronomical tradition did not explicitly identify precession (as discussed in the [Precession](../precession/) entry), but the numerical infrastructure of Babylonian astronomy substantially aligns with the precessional cycle. The framework reads this as evidence that the underlying numerical structure was preserved in the Babylonian tradition through symbolic-numerological transmission, even if the explicit astronomical identification of precession was not present.

### The Mesoamerican Long Count

The Mesoamerican Long Count calendar (developed by the Olmec and Maya civilisations) uses a base-20 (vigesimal) system with some base-18 modifications. The principal Long Count units:

- **K'in** = 1 day
- **Winal** = 20 k'in = 20 days
- **Tun** = 18 winal = 360 days (note the base-18 modification, producing a 360-day "year" comparable to the Babylonian schematic year)
- **K'atun** = 20 tun = 7,200 days ≈ 19.7 years
...
The framework's adopted reckoning produces Great Month boundary dates with approximately ±200-year uncertainty due to several methodological choices:

- **Which precessional rate to use** — the modern astronomical 25,771.5-year cycle vs. the traditional 25,920-year cycle produces approximately 12 years of difference per Great Month, accumulating to approximately 150 years across the full cycle
...
### The symbolic-numerological significance of 72

The number 72 — the Great Day in years — has substantial significance across multiple source-tradition contexts that the framework's broader work engages:

- **The 72 disciples of Luke 10:1** — the secondary group of disciples sent out by Jesus, distinguished from the principal twelve. The number 72 in some manuscript traditions; 70 in others (the textual variant is well-attested and longstanding). The framework reads the 72/70 variation as reflecting the underlying symbolic-numerological pattern.
- **The 70 (or 72) nations of the Table of Nations** — Genesis 10's enumeration of the post-deluge nations descended from Noah's three sons. The Masoretic Hebrew text gives 70; the Septuagint Greek translation gives 72. The same 70/72 variation pattern appears here as in Luke 10:1, consistent with a shared underlying symbolic structure.
- **The 70 elders of Israel** — Numbers 11:16-25, the seventy elders given a portion of Moses's spirit at the Tabernacle. The number connects to the broader pattern of 70/72 as a representative-completion number in the Hebrew tradition.
- **The 72 names of God in Kabbalah** — the *Shemhamphorash*, the 72-letter Name of God derived from Exodus 14:19-21 (each verse containing 72 Hebrew letters; combined, they produce a 72 × 3 = 216 letter sequence that is divided into 72 three-letter Names). The Kabbalistic tradition is substantially developed in *Sefer Yetzirah* (c. 200-900 CE) and subsequent medieval Jewish mystical literature.
...
### Connection to the source-tradition chronological content

The framework's broader reading uses the Great Month framework to interpret several specific source-tradition chronological passages:

- **The Genesis 5 antediluvian genealogy** — the long-lived patriarchs (Methuselah at 969 years, the others at comparably long ages) preserve content that the framework reads through the Great Day pattern: the 900-1,000 year lifespans approximate **12-14 Great Days** (12 × 72 = 864 years; 14 × 72 = 1,008 years), suggesting that the antediluvian lifespans may preserve content about a different chronological relationship between human and cosmic scales in the immediate post-synthesis Adamite population.
- **The 70-year span of Psalm 90:10** — "the years of our life are seventy" — connects directly to the standard 70-year human lifespan that approximates the 72-year Great Day
- **The 70 years of the Babylonian exile (Jeremiah 25:11-12; 29:10)** — the standard biblical figure for the duration of the exile, again approximating the 72-year Great Day
- **The "year of years" or jubilee pattern** — the 49-year (7 × 7) jubilee cycle of Leviticus 25, while not directly precessional, reflects the broader pattern of structured time-cycles in the biblical chronological vocabulary

The framework's reading is that the source-tradition chronological vocabulary substantially incorporates the broader precessional numerical structure — both directly (through the 72-year Great Day approximating the prophetic lifespan and the 2,160-year Great Month framing the major religious-historical periods) and indirectly (through the broader cross-cultural symbolic-numerological vocabulary of 72, 360, 432, and related numbers).

## Connections to the broader framework

The Great Month entry connects to several specific corpus entries.

**The Precession entry.** The dedicated [Precession](../precession/) entry treats the astronomical phenomenon itself; the Great Month is the principal chronological unit derived from precession.

**The Great Year entry.** The dedicated [Great Year](../great-year/) entry treats the full precessional cycle (12 Great Months); the Great Month is its principal subdivision.

**The World Age entry.** The dedicated [World Age](../world-age/) entry treats the broader cross-cultural doctrine of cosmic ages; the Great Month is one specific articulation of this broader doctrine.

**The individual Age entries.** The dedicated entries on each Great Month — [Age of Virgo](../timeline/age-of-virgo/), [Age of Leo](../timeline/age-of-leo/), [Age of Cancer](../timeline/age-of-cancer/), [Age of Gemini](../timeline/age-of-gemini/), [Age of Taurus](../timeline/age-of-taurus/), [Age of Aries](../timeline/age-of-aries/), [Age of Pisces](../timeline/age-of-pisces/), [Age of Aquarius](../timeline/age-of-aquarius/), and the [Age of Apocalypse](../age-of-apocalypse/) — develop the specific content of each Great Month within the framework that the present entry establishes.

