...
description = "La Estrella de David (hebreo <span class=\"hebrew\">מָגֵן דָּוִד</span> *Magen Dawid*, \"escudo de David\") es el emblema visual principal de la tradición religioso-cultural judía — la configuración hexagrámica de dos triángulos equiláteros entrelazados, cuya configuración simétrica de seis puntas porta significado cosmológico-religioso sustancial. El uso del símbolo está sustancialmente arraigado en el judaísmo rabínico-medieval (Estrella de la sinagoga de Praga del s. XVII; el subsiguiente emblema estatal sionista de la Estrella) y se sitúa contemporáneamente en el centro de la tradición de identidad y antidiscriminación judía (Estrella de David de la Shoá como símbolo de estigmatización; revalorización post-Shoá posterior). El marco Wheel of Heaven lee la Estrella de David como marca simbólica de la realidad Elohim-Alianza en la tradición hebrea: la configuración hexagrámica representa la infinitud del espacio (una de las dos doctrinas cosmológicas centrales del corpus), y la configuración entrelazada de triángulos simboliza la relación operativa de la Alianza entre el mundo natal Elohim y la Tierra."
...
basic_form = "Two intertwined equilateral triangles, one pointing upward and one pointing downward, forming a six-pointed star (hexagram); the geometric structure produces six points and twelve outer line-segments forming the principal hexagonal outline"
hebrew_designation = "*Magen David* (מָגֵן דָּוִד, 'Shield of David'); the Hebrew designation became the principal Jewish-cultural designation across the medieval and modern periods"
oldest_known_usage = "Substantial pre-Jewish-symbol cross-cultural usage extending back at least 4,000-5,000 years across Mesopotamian, Mediterranean, and South Asian traditions; the specific Jewish-symbol identification is principally modern (17th century onward)"
principal_traditional_meanings = "Cosmic correspondence (Hermetic 'as above, so below'); union of male and female divine principles (Hindu Shatkona); union of opposites and four-elements integration (Hermetic-alchemical); magical-protective seal (Solomon's Seal traditions); Jewish-cultural identification (modern Jewish-symbol usage); the alliance covenant between creators and human creation (Sendy interpretive contribution); the spatial dimension of infinity (Raëlian framework)"
principal_cross_cultural_traditions = "Hindu (Shatkona, principally Tantric-yantra usage); Hermetic-alchemical (the four-elements-integration framework); Solomon's Seal traditions (magical-protective contexts across medieval Jewish, Christian, and Islamic traditions); Mesopotamian and ancient Mediterranean hexagram usage; medieval Christian and Islamic religious-architectural usage; modern Jewish-cultural and Zionist-political usage; Raëlian-framework iconographic correlate of the spatial dimension of infinity"
position_in_raelian_framework = "Outer component of the Raëlian Symbol of Infinity (the composite emblem with central swastika or galaxy-spiral); represents the spatial dimension of infinity through the Hermetic 'as above, so below' principle; in Sendy's distinctive interpretive contribution, additionally represents the alliance covenant between the creators (upward triangle) and the human creation (downward triangle)"
modern_jewish_symbol_status = "Principal Jewish-cultural symbol since approximately the late nineteenth century; adopted by the Zionist movement at the First Zionist Congress (1897); substantial Holocaust-period usage as the yellow-badge identification; adopted on the Israeli national flag (1948); continues as the principal Jewish-cultural-religious symbol in contemporary contexts"
distinguished_from = "The Swastika (the other principal component of the Raëlian Symbol of Infinity, with its own substantial pre-Nazi religious-traditional history); the Raëlian Symbol of Infinity as composite emblem (treated under separate entry); the broader cross-cultural pentagram and other star-iconographic forms (which operate within distinct iconographic categories); the various national-flag and political-symbol usages (which operate within specific contemporary political contexts)"
status_in_source_material = "Substantially documented; the principal Yahweh-delivered passages establish both the symbol's specific Raëlian-framework semantic content and its identification with the Hermetic 'as above, so below' principle; Sendy's distinctive interpretive contribution provides substantial additional doctrinal content"
principal_text = "*The Book Which Tells the Truth* (1974), 'Watching Over the Chosen People' content (the principal Yahweh passage on the emblem); *Extra-Terrestrials Took Me to Their Planet* (1975), 'Neither God nor Soul' section (the 'as above, so below' explicit articulation and the Bardo Thodol cross-reference); Jean Sendy, *L'ère du Verseau* (1970), the seal-of-Solomon-as-alliance-covenant interpretive contribution"
+++
...
**4. The integration with the broader emblem**. The Star of David is integrated with the central swastika (or, in the 1990 Western-modified form, the central galaxy-spiral) to form the broader composite emblem. The detailed treatment of the composite emblem lives in the [Raëlian Symbol of Infinity](../raelian-symbol-of-infinity/) entry.
...
**3. The "all the wisdom in the world" framing**. The combined symbol containing the Star of David has unusually elevated framing as comprehensive iconographic compression of the broader cosmological framework. The detailed treatment lives in the [Raëlian Symbol of Infinity](../raelian-symbol-of-infinity/) entry.
...
- The Raëlian Symbol of Infinity (the composite emblem within which the Star of David operates as outer component) is treated more fully in the [Raëlian Symbol of Infinity](../raelian-symbol-of-infinity/) entry
- The Infinity framework (the broader cosmological framework within which the Star of David operates as iconographic representation of the spatial dimension) is treated in the [Infinity](../infinity/) entry
- The Fractal Cosmology framework (the spatial-self-similar content the Star of David represents) is treated in the [Fractal Cosmology](../fractal-cosmology/) entry
- The Alliance framework (the covenant-relational content that Sendy's reading articulates) is treated in the [The Alliance](../the-alliance/) entry
- The Doubled Signature framework (the related "as above, so below" cosmic-correspondence content operating across precessional ages) is treated in the [Doubled Signature](../doubled-signature/) entry
...
**The covenant-relational content**. The covenant between the creators and the human creation operates as the principal political-relational framework within which the broader corpus-narrative operates. The covenant's specific content (treated more fully in the [The Alliance](../the-alliance/) entry):
...
The Star of David operates as the outer component of the Raëlian Symbol of Infinity. The detailed treatment of the composite emblem lives in the [Raëlian Symbol of Infinity](../raelian-symbol-of-infinity/) entry; the Star of David entry's specific contribution is the broader cross-cultural and historical context within which the symbol operates as one specific instance of substantial cross-cultural traditional preservation, with substantial development of the Sendy covenant-reading.

### The Infinity entry

The Star of David represents the spatial dimension of infinity within the broader Raëlian Symbol of Infinity, complementing the swastika's representation of the temporal dimension. The detailed treatment of the broader Infinity framework lives in the [Infinity](../infinity/) entry.

### The Fractal Cosmology entry

The Star of David's specific "as above, so below" content has substantial connection to the broader Fractal Cosmology framework's specific spatial-self-similar content. The detailed treatment lives in the [Fractal Cosmology](../fractal-cosmology/) entry.

### The Doubled Signature entry

The Star of David's specific "as above, so below" content has substantial connection to the broader Doubled Signature framework's specific opposite-sign-correspondence content (each precessional age encodes signature in current sign + opposite). The detailed treatment lives in the [Doubled Signature](../doubled-signature/) entry.

### The Alliance entry

The Star of David's Sendy-grounded covenant-reading has substantial connection to the broader [The Alliance](../the-alliance/) entry. The detailed treatment of the alliance's institutional development lives in that entry; the Star of David entry's specific contribution is registering the iconographic-articulation of the covenant-relational content.

### The Swastika entry

The Star of David's specific complementary relationship with the swastika (the two principal components of the Raëlian Symbol of Infinity) connects substantially to the broader [Swastika](../swastika/) entry. The two entries are complementary, registering each component's specific content while preserving the broader composite-emblem treatment in the [Raëlian Symbol of Infinity](../raelian-symbol-of-infinity/) entry.

### The Raëlism entry

The Star of David operates as one specific institutional-iconographic element of the broader [Raëlism](../raelism/) movement. The detailed treatment of the broader institutional-doctrinal content lives in that entry.

### The Embassy entry

The Star of David is registered within the broader Embassy framework, with the Israeli political-cultural context being substantively relevant to the projected Embassy site. The detailed treatment lives in the [Embassy](../embassy/) entry.
...
The relationship is one of **complementary-components-within-broader-emblem**. The detailed treatment of the Swastika lives in the [Swastika](../swastika/) entry; the entries register the complementary functions while preserving operational distinctness.
