+++
title = "Tercer Templo"
description = "El Tercer Templo (hebreo <span class=\"hebrew\">בֵּית הַמִּקְדָּשׁ הַשְּׁלִישִׁי</span> *Beit Hamiqdash HaShlishi*) es, en la tradición mesiánica judía, el sucesor del Templo de Salomón (957 a. e. c.) y del Segundo Templo ampliado por Herodes (destruido en 70 e. c. por la destrucción bélica romana) que ha de erigirse, según la expectativa profética, en el monte del Templo en Jerusalén en el fin escatológico de los tiempos. La expectativa de restauración del Templo está en el centro de la tradición mesiánica judía (especialmente la tradición ortodoxa y ultraortodoxa; la iniciativa del Temple Institute en Jerusalén con la preparación material sustancial de los utensilios del culto, las vestiduras sacerdotales y los procedimientos del sacrificio animal) y en la tradición cristiana dispensacionalista asociada (con la edificación del Templo como signo de fases escatológicas subsiguientes). El marco Wheel of Heaven lee el discurso del Tercer Templo a través del material del corpus sobre la Embajada que ha de erigirse: la expectativa mesiánica judía de restauración del Templo se lee como anticipo cultural religioso resonante a la erección operativa de la Embajada, que representa en la fase contemporánea de la era de Acuario el punto institucional formal de recepción para el regreso abierto de la Alianza."
...
jewish_preparation_organizations = "The Temple Institute (Machon HaMikdash, founded 1987 by Rabbi Yisrael Ariel); the Sanhedrin Initiative; the various red heifer breeding programs; the broader Religious Zionist Temple-preparation tradition"
christian_engagement = "Dispensationalist eschatology (Darby 19th century, Scofield Reference Bible 1909, the Left Behind series 1995-2007); substantively contested by amillennial, postmillennial, and preterist Christian positions"
...
- **<span class="hebrew">בַּיִת</span>** (*bayit*) — "house," the basic Hebrew architectural-domestic term
- **<span class="hebrew">מִקְדָּשׁ</span>** (*mikdash*) — "holy [place], sanctuary," from the root **<span class="hebrew">קדשׁ</span>** (*q-d-sh*, "to be holy, consecrated, set apart")

The full standard designation **<span class="hebrew">בֵּית הַמִּקְדָּשׁ הַשְּׁלִישִׁי</span>** (*Beit ha-Mikdash ha-Shlishi*) adds the ordinal **<span class="hebrew">הַשְּׁלִישִׁי</span>** (*ha-Shlishi*, "the Third") to distinguish it from the historical First and Second Temples.

Alternative designations include:

- **<span class="hebrew">בֵּית יְהוָה</span>** (*Beit YHWH*, "House of YHWH") — the older biblical designation, common in the historical books and the prophets
- **<span class="hebrew">הַהֵיכָל</span>** (*ha-Heikhal*, "the Sanctuary/Palace") — used particularly for the inner sanctuary
...
The Greek term **<span class="greek">ναός</span>** (*naos*, "temple, shrine") is used in the New Testament for both the historical Jewish Temple and for anticipated future structures; the Greek **<span class="greek">ἱερόν</span>** (*hieron*, "sacred place") refers to the broader Temple complex including the courts. The Latin tradition uses **templum** (whence English "Temple").
...
The framework reads the Second Temple as the principal **early Age of Pisces** installation, with the transition from the Hebrew biblical Temple period to the post-Temple rabbinic period substantially coinciding with the broader Age of Aries-to-Age of Pisces precessional transition (treated in the [Precession](../precession/) and [Great Month](../great-month/) entries).
...
- **Chapter 48** — the **tribal allotments** of the surrounding land; the prophecy concludes with the city's name: **"The LORD is There"** (Hebrew **<span class="hebrew">יְהוָה שָׁמָּה</span>** *YHWH Shammah*, Ezekiel 48:35)
...
The substantive interpretive question concerns the identification of "The BRANCH" (Hebrew **<span class="hebrew">צֶמַח</span>** *Tzemah*), who is to build the Temple:
...
The dedicated [List of exegetic readings](../list-of-exegetic-readings/) entry treats the broader interpretive tradition; the present entry focuses specifically on the principal Third Temple sources.
...
The **Temple Institute** (Hebrew **<span class="hebrew">מָכוֹן הַמִּקְדָּשׁ</span>** *Machon HaMikdash*) was founded in 1987 by **Rabbi Yisrael Ariel** (b. 1939) and is the principal contemporary Jewish organization dedicated to substantively preparing for the rebuilding of the Third Temple. The Institute's principal activities:
...
The substantive contemporary obstacle to Third Temple construction is the political and religious status of the **Temple Mount** (Hebrew **<span class="hebrew">הַר הַבַּיִת</span>** *Har ha-Bayit*; Arabic **<span class="arabic">الحرم الشريف</span>** *al-Ḥaram al-Sharīf*, "The Noble Sanctuary"), the Jerusalem site of the First and Second Temples.
...
- **The Dome of the Rock** (Arabic **<span class="arabic">قبة الصخرة</span>** *Qubbat aṣ-Ṣakhrah*) — built 691-692 CE under the Umayyad Caliph Abd al-Malik ibn Marwan; one of the oldest extant Islamic monuments; covers the **Foundation Stone** (Hebrew *Even ha-Shtiyah*; Arabic *aṣ-Ṣakhrah*) traditionally identified as the site of the Holy of Holies of the historical Temples and as the site of Muhammad's Night Journey (the *Isra and Mi'raj*) to the heavens
- **The al-Aqsa Mosque** (Arabic **<span class="arabic">المسجد الأقصى</span>** *al-Masjid al-Aqṣā*, "the Furthest Mosque") — built 705-715 CE under the Umayyad Caliph al-Walid I; rebuilt several times following earthquakes and other damage; the third-holiest site in Islam (after Mecca's Masjid al-Haram and Medina's Masjid an-Nabawi)
...
The substantive engagement with the seven-denial pattern is developed more fully in the [Great Return](../great-return/) entry's section on the Embassy operational history; the present entry registers the pattern as part of the Third Temple location question.
...
The framework reads the contemporary substantive engagement with the Third Temple expectation as part of the broader contemporary recognition pattern (treated in the [Age of Apocalypse](../age-of-apocalypse/) and [Great Return](../great-return/) entries). The principal observations:
...
**The Embassy.** The dedicated [Embassy](../embassy/) entry treats the operational installation; the present entry treats the Hebrew biblical Third Temple identification.

**The Great Return.** The dedicated [Great Return](../great-return/) entry treats the broader anticipated event for which the Third Temple is the reception site; the present entry treats the specific reception-site question.
...
**The Elohim entry.** The dedicated [Elohim](../elohim/) entry treats the civilization whose anticipated terrestrial reception the Third Temple is being prepared for.

**The Yahweh entry.** The dedicated [Yahweh](../yahweh/) entry treats the principal Elohim figure who provides the Embassy specifications in the source material.
...
**The cosmic pluralism entry.** The dedicated [Cosmic pluralism](../cosmic-pluralism/) entry treats the broader metaphysical framework within which the Third Temple/Embassy is established.

**The List of prophets and religions.** The dedicated [List of prophets and religions](../list-of-prophets-and-religions/) entry treats the broader cross-cultural eschatological tradition that the Third Temple expectation is part of.
