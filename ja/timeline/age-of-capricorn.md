...
{{ figure(src="timeline/equinox_bc21810", caption="図1 - 地球表面から見た紀元前21'810年の春分") }}
...
{{ figure(src="wiki/interstellar-space-travel", caption="Ill. 1 - 星間の宇宙旅行") }}
...
{{ figure(src="wiki/blue-planet-afar", caption="Ill. 2 - 青い惑星の表面") }}
...
{{ figure(src="wiki/spacecraft-orbiting-earth-sunrise", caption="Ill. 3 - 軌道上のアウトポスト") }}
