...
{{ figure(src="wiki/saurian-experiments", caption="図1 - 遺伝子実験の失敗") }}
...
{{ figure(src="wiki/archaic-blue-planet", caption="Ill. 2 - 古代の青い惑星") }}
...
{{ figure(src="wiki/futuristic-city-with-tower", caption="図 3 - 先進的な都市景観") }}
