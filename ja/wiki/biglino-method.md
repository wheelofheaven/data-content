+++
title = "ビリーノの方法"
description = "ビリーノの方法は、イタリアの翻訳者マウロ・ビリーノにちなんで命名され、蓄積された神学的前提を取り去ってヘブライ語聖書を読み、その文字通りかつ技術的な射程を復元することを旨とする。Wheel of Heaven は資料再読の道具として広くこれを参照するが、その全ての主張に同一化するわけではない。"
