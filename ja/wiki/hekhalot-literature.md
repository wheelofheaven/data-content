...
description = "ヘカロート文献(ヘブライ語 הֵיכָלוֹת、「宮殿群」)は、七つの天の宮殿を通って神の玉座の戦車(merkavah)へと魂が上昇する様を描く、古代末期ユダヤ神秘主義の著作群である。ユダヤ神秘主義におけるカバラ以前の層をなし、シウル・コマー(Shi'ur Qomah)が伝承される文献集でもある。"
...
entry_type = "text"
claim_type = "direct"
alternative_names = ["Hekhalot / Heikhalot 文献(הֵיכָלוֹת)", "Merkavah 神秘主義", "Merkabah 神秘主義", "「宮殿」文献", "*ma'aseh merkavah*(「戦車の業」)"]
timeline = ["multi-age"]

[extra.infobox]
type = "古代末期から中世初期のユダヤ神秘主義テクスト群(カバラ以前)"
literal_meaning = "ヘブライ語 הֵיכָלוֹת (*hekhalot*)、הֵיכָל (*hekhal*) の複数形で「宮殿」または「広間」の意 ― 上昇の際に通る七つの天の宮殿"
also_called = "Merkavah(戦車)神秘主義。Ezekiel の玉座幻視(*ma'aseh merkavah*、「戦車の業」)に由来する"
principal_works = "*Hekhalot Rabbati*(「大宮殿書」)、*Hekhalot Zutarti*(「小宮殿書」)、*Ma'aseh Merkavah*、*Merkavah Rabbah*、*3 Enoch*(ヘブライ語エノク書);*Shi'ur Qomah* はこの文献集の内に埋め込まれている"
practitioner = "*yored merkavah*(「戦車への降下者」)。讃歌、天使の名、印章を携えて宮殿群を上昇する者"
dating = "諸説あり:成立/編纂はおおむね 3rd–8th centuries CE の間(Scholem はより早く、Schäfer はより遅く、ガオン期のバビロニアと論じた)"
key_figure = "天使 Metatron ― 「臨在の君」、天の書記であり、(3 Enoch においては)変容した族長 Enoch"
+++
