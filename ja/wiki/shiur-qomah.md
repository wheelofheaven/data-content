...
title = "シウル・コマー"
slug = "shiur-qomah"
description = "シウル・コマー(ヘブライ語 שִׁעוּר קוֹמָה、「身丈の寸法」)は、カバラ以前のヘカロート/メルカバー文献に属するテクストであり、天使 Metatron が神の身体の宇宙的な寸法を四肢ごとに口述し、各部位がパラサング(parasang)で測られ、秘密の名を付されていく。ラエル文献資料が「カバラ」に帰しているパラサングの数値の背後にある、まさにそのテクストである。"
...
entry_type = "text"
claim_type = "direct"
alternative_names = ["*Shiʿur Qomah* (שִׁעוּר קוֹמָה)", "Sefer Haqqomah(『[神の]身体の書』)", "身丈の寸法", "身体の寸法", "Ma'amar Rabbi Yishmael"]
timeline = ["multi-age"]

[extra.infobox]
type = "ヘカロート/メルカバー神秘主義文献に属するテクスト。神の身体を擬人的に捉えた「神の身体の寸法」"
literal_meaning = "ヘブライ語 שִׁעוּר (*shiʿur*、「寸法・量」) + קוֹמָה (*qomah*、「身丈・高さ」。アラム語では「身体」):「身丈の寸法」"
corpus = "ヘカロート/メルカバー文献(カバラ以前のユダヤ神秘主義)"
dating = "諸説あり:Scholem ― 2nd c. CE;Cohen ― ガオン期の 6th–7th c. CE;Schäfer ― 年代を特定できる単一の「テクスト」は存在しない(「単一のテクストは幻想である」)"
attributed_to = "偽名的に、タンナイームである R. Ishmael と R. Akiva に帰され、天使 Metatron からの啓示を報告する形をとる"
key_figure = "236(万×千)パラサング ― 造物主の身丈。詩篇147:5からゲマトリア(gematria)によって導かれる"
printed_in = "*Sefer Raziel ha-Mal'akh*(アムステルダム、1701、fol. 37b);*Merkavah Shelemah*(エルサレム、1921);校訂版:M. S. Cohen(TSAJ 9、1985)"
wheel_of_heaven_reading = "*parasang* を1光秒と解すると、パラサングの数値は二つの実在する天文学的距離が混乱して伝わった記録として読める"
+++
