...
footnotes = [
    { content = "*Emic* and *etic* are anthropology's terms for the two vantage points on a culture: emic description works with the categories the insiders themselves use; etic description works with the observer's comparative categories. A Raëlian saying 'we are an atheistic religion' is emic; a scholar filing the movement under 'UFO religions' is etic. Chryssides makes the distinction explicitly when defending the etic label against the movement's objection." },
    { content = "*Laïcité* is the French constitutional doctrine of state secularism, descended from the 1905 law separating church and state. It shapes both sides of this story: Vorilhon was raised, by his own account and Palmer's, in 'the antireligious culture of la laïcité' — and the same tradition later produced the state anticult apparatus that classified his movement a *secte*." },
    { content = "The report — *Les sectes en France*, Assemblée nationale no. 2468, December 1995, known by its rapporteur as the Guyard report — listed 173 movements on criteria supplied by the Renseignements généraux, including 'excessive financial demands' and 'antisocial discourse.' It had no legal force, but in practice functioned as a blacklist; the European Court of Human Rights would later quote its Raëlian entry verbatim. A Belgian parliamentary inquiry produced a similar classification in 1997." },
    { content = "Maitreya is the future Buddha of Buddhist eschatology — the successor the historical Buddha is said to have announced, expected when the dharma has decayed. Japanese tradition renders the name Miroku. Onisaburō's 1928 festival turned on a numerological reading: he was then aged fifty-six years and seven months, and the digits 5-6-7 can be read in Japanese as *mi-ro-ku*." },
    { content = "The canonical date of the second encounter is 7 October 1975, and the movement's festival calendar keeps it there. The scholarly literature handles the date carelessly: Palmer's monograph prints '1976' on one page and 1975 elsewhere; Chryssides's 2000 article prints '7 November 1975.' Small errors of this kind are useful — they show which authors worked from the sources and which from each other." },
    { content = "The movement's own running totals are 65,000 baptized members in 86 countries (2006), 85,000 in 90 (2011), 90,000 (2013). Palmer relays the official numbers with the caveat that they count everyone ever baptized, including teenagers 'on a dare.' Introvigne's 2003 estimate distinguished ~1,500 committed members of the Structure from ~50,000 nominal adherents. Leaked internal databases — reported at 14,192 verified members in 2010 and 18,111 in 2017, though the leak is a single source — sit between the two. Every figure in this range makes Raëlism one of the smallest bodies ever to sustain a fifty-year global religious institution." },
    { content = "The 'transmission of the cellular plan' is the Raëlian initiation: on one of the four festival days, a guide dips his hands in water and holds the initiate's head, transmitting — the movement says telepathically, to the Elohim's computers — the new member's genetic identity, for the record against which the last judgment will be run. It is baptism, relocated from the soul to the genome. A companion funeral rite removes one square centimeter of the frontal bone for storage in Geneva, awaiting collection." },
    { content = "The auxiliary-language commitments are specific, and they connect. 'Abdu'l-Bahá praised Esperanto as a candidate for the Bahá'í principle of a universal auxiliary language, and Lidia Zamenhof — youngest daughter of Esperanto's inventor — became a Bahá'í in 1925 and translated its literature. Oomoto adopted Esperanto from the early 1920s (one account traces the decision to interfaith contact with Bahá'ís in 1921) and still publishes in it; the motto over its Kameoka center reads Unu Dio, Unu Mondo, Unu Interlingvo — one God, one world, one interlanguage. The Raëlian canon, without naming Esperanto, orders 'a new language, inspired by all of them,' compulsory in every school on Earth (TBWTT 6:16)." },
    { content = "Tam Kỳ Phổ Độ — 'the Third Great Universal Amnesty' (or Salvation) — is Caodaism's periodization of revelation: two prior amnesties delivered the founders of the world's religions; their messages decayed in transmission; the third and final amnesty dispenses with human intermediaries, God dictating directly through the séance basket. The full official name of the religion, Đại Đạo Tam Kỳ Phổ Độ, carries the doctrine in its title." },
    { content = "The Caodaist founding declaration (the Khai Đạo petition to the French colonial administration) is dated 7 October 1926 — the same calendar date the Raëlian canon gives, forty-nine years later, for the second encounter. Nothing is claimed for the coincidence here; it is recorded because the corpus's readers notice such things, and it is better recorded with its weight stated: none." },
    { content = "The phrase 'forty prophets' does not occur verbatim in the three founding books. The number enters the canon at the 1975 meal scene — 'The forty men and women present at this meal are all beings representative of the religions created following our contacts on the Earth' (ETTMTTP 2:64) — and the movement's later usage ('the last of forty prophets') is an articulation of that sentence. No complete list of the forty exists anywhere in the canon or the movement's literature; the corpus's own catalog marks the enumeration as reconstruction." },
    { content = "Geniocracy, the 1977 program: intelligence measured by 'sophisticated scientific tests'; the franchise restricted to those 10 percent above the mean, eligibility for office to those 50 percent above it — by the book's own arithmetic, an electorate of 27.5 percent of the population. The book packages itself as secular political philosophy; the Elohim appear in the main text essentially not at all, and the disclosure that geniocracy is 'practiced by the Elohim on their own planet' sits in the advertising back matter. The proposal's vocabulary for the excluded is of its era and reads accordingly today; the movement itself has treated the program as aspirational rather than operative." }
]
+++

On 13 December 1973 a twenty-seven-year-old motor-racing journalist walked
into the crater of an extinct volcano above Clermont-Ferrand and came back
down saying a small bearded man in a green one-piece suit had stepped out
of a landed craft, addressed him by name, and asked him to return the next
morning — with a Bible. For six consecutive days, by his account, the
visitor worked through that Bible with him, verse by verse, correcting the
translation errors of thirty centuries. The book Claude Vorilhon published
...
movement itself), "the most thoroughly secular of all the UFO religions"
(James R. Lewis), a "scientific creationism" (Chryssides again), a
postmodern "religion of science" (Bryan Sentes and Susan Palmer), a
...
claim about the human institution and its texts — the kind of claim a
scholar of religion could assess without granting the canon anything —
and the article stays on that level throughout. Palmer, who spent fifteen
years inside the movement's meetings, put the ground rule best: "It is not
the job of a sociologist to meddle in theology." The same restraint,
pointed the other way, governs here.

## The unlikeliest man in France

Claude Vorilhon was born on 30 September 1946 in Ambert, in the Auvergne,
to an unmarried fifteen-year-old farm girl, and raised largely by a
grandmother Palmer describes as "a fervent atheist." His father was absent
and, it later emerged, not so very unknown: a married Jewish refugee named
Marcel who had fled Alsace during the German occupation and returned to
his family after the war. The child was not baptized. Sent at nine to a
Catholic boarding school, he took communion without having been baptized —
...
had a modest hit. The singing career ended when Morisse killed himself in
1970. Vorilhon married, moved to Clermont-Ferrand, and reinvented himself
a second time as a motor-racing journalist, founding a small magazine
called *Autopop* and test-driving on the hill-climb circuit. Then, on 30
November 1973, the French government — mid-oil-crisis — suspended all
...
are well received and it is possible to express them. France is the
country where democracy was born, and its image throughout the world is
that of the land of liberty. Next, we needed someone intelligent and open
to everything. Finally—and above all—we needed someone who is a
free-thinker without being anti-religious. With a Jewish father and a
Catholic mother, you happen to be the ideal link between two peoples very
important in the history of the world. Moreover, your occupation does not
predispose you in any way to revelations that most would find
unbelievable, which will make your words more credible. Not being a
scientist, you will not complicate matters and will explain them simply.
Not being a literary man, you will not write convoluted sentences that are
...
series](/articles/the-man-who-bet-the-bible-on-the-moon/). Palmer's
judgment on the relationship is careful and worth preserving in her
wording: these ideas were "already 'in the air,' so to speak," which "may
account for [the first book's] enthusiastic reception in France." She
stops short of a derivation claim, and so does this project, whose own
...
a Jamesian mystical experience — and declined to choose: "We will
probably never know what 'really happened.'" Her personal verdict on the
man is on the record too, and it is neither the believer's nor the
tabloid's: "Anticultists and journalists armed with a few superficial
facts try to stuff him into the pop-psychological profile of 'evil cult
leader'… I find this ludicrous… I approach Raël rather as a creative
artist, a kind of religious genius."
...
argued against the standard genealogy, do not float free of the great
traditions in some occult "cultic milieu"; they originate inside the
...
countries where the creators had bases: in the cordillera of the Andes, in
the Himalayas, in Greece where Mythology also contains great testimonies,
the Buddhist religion, the Islamic, the Mormons — it would take pages to
cite all the religions and sects that testify in a more or less obscure
way to our work.
{% end %}
...
You, Claude Vorilhon, you will spread the truth under your present name,
which you will progressively replace with the name that you bear for us,
«RAËL». Which means literally «light of God», and if one makes a more
precise translation, «light of the Elohim», or more exactly «he who brings
the light of the Elohim», or «Ambassador of the Elohim», for you will
indeed be our ambassador on the Earth, and we will officially land only in
your embassy. RAËL can be translated more simply as «messenger».
{% end %}

Chryssides noticed what kind of scene this is: "Vorilhon's first encounter
with the creator is a kind of inaugural vision, comparable to that of
Isaiah in the Jerusalem Temple… Like Isaiah, this inaugural vision is a
commissioning." A man is called, objects that he is nobody, is renamed,
and is sent — the form of Isaiah 6, Exodus 3, and Jeremiah 1, and the
tradition that owns that form is the one whose plural noun the visitor
uses for himself: {% libref(book="the-book-which-tells-the-truth", chapter=7, verse=33) %}"you can call us «Elohim», since we have «come from the sky»"{% end %}.
...
At his right is found Moses, at his left Elijah, at the left of Jesus is
seated the one whom, on Earth, one remembers under the name of Buddha. A
little further you can see Mohammed in whose writings I am called Allah
for he did not dare to name me out of respect. The forty men and women
present at this meal are all beings representative of the religions
...
You are the one who must assemble the men of all the religions. For the
movement you have created, the Raelian Movement, must be the religion of
religions. I insist, it is well and truly a religion, but an atheistic
religion as you had already understood.
{% end %}
...
The person whom you looked upon as your father was not your real father.
After the explosion at Hiroshima, we decided that the time had come for us
to send a new messenger on Earth. He would be the last prophet, but the
first one to address Mankind asking them to understand and not to believe.
We then selected a woman, as we had done in the time of Jesus. This woman
was taken aboard one of our ships and inseminated as we had done with the
mother of Jesus.
{% end %}

{% library(book="lets-welcome-the-extraterrestrials", chapter=2, verse=92) %}
Your real father is also the father of Jesus, and that makes you brothers.
You are presently looking at your father. Your foster-father was like
Joseph, he was to take care of you and your mother until such time as you
...
Buddhists ({% libref(book="extraterrestrials-took-me-to-their-planet", chapter=3, verse=228) %}"your writings indicate that the new Buddha must be born in the West; recognize the foreseen signs!"{% end %}),
and to Muslims — and its summary paragraph assigns Raël his place in the
line: {% libref(book="extraterrestrials-took-me-to-their-planet", chapter=3, verse=257) %}"he is the last of the line of the prophets, the prophet of the apocalypse, that is to say of the epoch when everything can be understood"{% end %}.
...
and obviously no soul. After death, there is nothing if science does
nothing so that there be something.
{% end %}

No god, because the universe is infinite and uncentered — the cosmology
...
creators of Humanity with their creation, even if it is in fact an atheist
religion, in the sense that it does not believe in the existence of a God
- atheist from the Greek atheos which means "denying the existence of any
form of divinity".
{% end %}
...
Raëlism removed; it cannot tell you what the religion is *made of* — and
...
Abrahamic religions," producing a religiosity "perfectly harmonious with
the ideology of technoscience that governs the world's advanced
...
from the omnipotent realm of glory, by the tongue of power and might, upon
the prophets of old. And We have taken the gems of its meaning and clothed
them in the garment of brevity, as a favour unto the learned, that they
may fulfil the covenant of God and render up His trusts within their own
souls.
{% end %}
...
religion — the precedent for classifying a new universalism by its
lineage rather than its size.

**Oomoto** (1892) begins with a possession. Deguchi Nao, an illiterate
widow in the Japanese town of Ayabe, was seized by a kami and began
producing — through automatic writing she herself could not read — the
oracles this project translates as the *Oomoto Shin'yu*. The opening
line announces a new age in eight words:

{% library(book="oomoto-shinyu-woh", chapter=1, verse=1) %}
Throughout the three-thousand worlds, all together, the plum blossom
...
Śākyamuni (Thích-Ca Mâu-Ni) is I;
Taishang, the Primordial Beginning (Thái-Thượng Ngươn-Thỉ), is I;
...
1 percent to Raël personally) that most members simply ignored: "Raël
claimed in an interview that more than 60 percent of Raelians do not
...
us, without religious mysticism, as responsible men but respecting their
creators, we will come in broad daylight and we will give the men of the
Earth our scientific inheritance.
{% end %}

## Further reading

- The {% wiki(slug="raelism") %}Raëlism{% end %} and
  {% wiki(slug="rael") %}Raël{% end %} entries, for the movement's
  institutional history and the founder's biography in reference form.
- The {% wiki(slug="list-of-prophets-and-religions") %}list of prophets
  and religions{% end %}, for the corpus's tiered catalog behind this
  article's comparative section.
- The {% wiki(slug="religion") %}religion{% end %} entry, for the
  *religare* etymology the canon's self-definition runs on.
- The {% wiki(slug="embassy") %}embassy{% end %} and
  {% wiki(slug="third-temple") %}Third Temple{% end %} entries, for the
  building project this article ends on.
- [*The Infinite in Both
  Directions*](/articles/the-infinite-in-both-directions/), for the
  cosmology summarized here in one paragraph.
- [*The Book Closest to the
  Truth*](/articles/the-book-closest-to-the-truth/) and [*The Man Who Bet
  the Bible on the Moon*](/articles/the-man-who-bet-the-bible-on-the-moon/),
  for the provenance audits of the canon's French sources.
- [*The Book Which Tells the
  Truth*](/library/the-book-which-tells-the-truth/) and
  [*Extraterrestrials Took Me to Their
  Planet*](/library/extraterrestrials-took-me-to-their-planet/), for the
  primary narratives read throughout — and the
  [*Hidden Words*](/library/hidden-words-woh/),
  [*Oomoto Shin'yu*](/library/oomoto-shinyu-woh/), and
  [*Thánh Ngôn Hiệp Tuyển*](/library/thanh-ngon-hiep-tuyen-woh/)
  translations, for the three sibling canons quoted beside it.
