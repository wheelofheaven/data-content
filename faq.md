...
description = "Substantive answers about the working hypothesis, the precessional framework, the sources, and how the project handles its claims."
template = "faq.html"
...
question = "What is Wheel of Heaven?"
answer = """
...
question = "What is the working hypothesis?"
answer = """
The hypothesis has five interconnected parts:

1. **The *Elohim* of Genesis are a literal plural.** The Hebrew word is grammatically a plural noun. The corpus reads it at face value — the figures who created humanity were a group of beings, not a single deity.
2. **The Elohim are an advanced human civilization, not supernatural beings.** They were biologically related to humanity, technologically far in advance, and engaged in a deliberate scientific project on Earth.
3. **What we have inherited as religion is the long memory of their work.** The religious traditions of humanity preserve, in compressed and often mystified form, an accurate historical record of the Elohim civilization's interventions across approximately twenty-two thousand years.
4. **The work was organized along the precessional cycle.** The slow ~25,920-year wobble of Earth's axis is the calendar that records the project. Twelve ages of approximately 2,160 years each subdivide the Great Year.
5. **The current age is the age of disclosure.** The Aquarian age, opening in 1950, is the age in which the long memory becomes legible to a humanity scientifically capable of evaluating it.
...
answer = """
The project is authored by Zara Zinsfuss, an independent reader and Raëlian who has spent fifteen years working out the framework the corpus presents. The project is written in the first-person singular voice of one author and is open to collaborators. Contributions are welcomed through [GitHub](https://github.com/wheelofheaven).
"""

[[extra.faq_groups.items]]
slug = "is-this-a-religion"
question = "Is this a religion?"
answer = """
...
question = "Is this peer-reviewed scholarship?"
answer = """
...
question = "How is this different from Raëlism?"
answer = """
...
question = "How is this different from ancient astronaut theory?"
answer = """
...
question = "How do you handle the question of evidence?"
answer = """
...
question = "What is the precessional cycle, in plain language?"
answer = """
...
[[extra.faq_groups.items]]
slug = "twelve-ages"
question = "What are the twelve ages, and where do they come from?"
answer = """
...
For more, see the [Elohim](/wiki/elohim/) wiki entry.
"""

[[extra.faq_groups.items]]
slug = "what-age-are-we-in"
question = "What age are we in now?"
answer = """
...
For the full treatment, see the [Age of Aquarius](/timeline/age-of-aquarius/) chapter.
"""

[[extra.faq_groups.items]]
slug = "position-on-evolution"
question = "What's the project's position on evolution?"
answer = """
...
For the longer treatment, see the [Age of Aries](/timeline/age-of-aries/) and [Age of Pisces](/timeline/age-of-pisces/) chapters.
"""

[[extra.faq_groups.items]]
slug = "position-on-other-religions"
question = "What's the project's position on other religions?"
answer = """
...
[[extra.faq_groups.items]]
slug = "predictions"
question = "Does the project predict anything about the future?"
answer = """
...
[[extra.faq_groups.items]]
slug = "what-sources"
question = "What sources does the project draw on?"
answer = """
...
question = "How does the project handle uncertainty and disagreement?"
answer = """
...
[[extra.faq_groups.items]]
slug = "translations"
question = "How are translations handled?"
answer = """
...
[[extra.faq_groups.items]]
slug = "how-to-start"
question = "How do I get started reading?"
answer = """
Three options, in increasing depth:

1. The [Read orientation](/read/) — a short overview of the project, with three reading paths.
2. The [Wiki](/wiki/) — start with key terms ([Elohim](/wiki/elohim/), [Precession](/wiki/precession/), [World Age](/wiki/world-age/)) and follow the cross-links.
3. The [Timeline](/timeline/) — the long-form book, beginning with the [Preamble](/timeline/preamble/) and walking through the twelve ages.
...
question = "Where do I read the source texts?"
answer = """
...
answer = """
Yes. All Wheel of Heaven content is released to the public domain under [Creative Commons Zero (CC0-1.0)](https://creativecommons.org/publicdomain/zero/1.0/). You can read, share, quote, translate, build on, or republish the content without restriction. Attribution is appreciated but not required.
"""
...
> Zinsfuss, Zara. *Wheel of Heaven*. wheelofheaven.io. Accessed [date].

For specific pages, append the page title and URL:

> Zinsfuss, Zara. "Age of Capricorn." *Wheel of Heaven*. https://www.wheelofheaven.io/timeline/age-of-capricorn/. Accessed [date].
"""
...
Help would be appreciated. Voluntary contributions through [Open Collective](https://opencollective.com/wheelofheaven) go toward hosting, infrastructure, and translation work — none of which is currently covered by anything other than the author's own time and money.
...
[[extra.faq_groups.items]]
slug = "how-to-report"
question = "Where do I report errors or disagreements?"
answer = """
Two channels, depending on what kind:

- **Factual errors, broken links, technical issues**: open an issue on the [GitHub repository](https://github.com/wheelofheaven).
- **Disagreements with interpretations, alternative readings, substantive challenges**: open a thread in the [GitHub Discussions](https://github.com/orgs/wheelofheaven/discussions).
...
answer = """
Yes — the project's community is hosted on [GitHub Discussions](https://github.com/orgs/wheelofheaven/discussions), which serves as the main public forum for questions, discussion, contributions, and substantive engagement with the corpus.
...
question = "What's the relationship to the institutional Raëlian movement?"
answer = """
...
For more on the institutional movement, the [Raëlism](/wiki/raelism/) wiki entry provides context.
"""

[[extra.faq_groups.items]]
slug = "contributor-expectations"
question = "What's expected of contributors?"
answer = """
Contributors are expected to engage in good faith, to read the [Code of Conduct](/code-of-conduct/), and to follow the [Contributing guidelines](/contributing/). The project welcomes substantive engagement — including disagreement — and asks that contributors maintain the editorial standards the corpus operates by: source-aware, clearly written, epistemically careful.
