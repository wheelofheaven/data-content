...
חומר המבול המסופוטמי מטופל באופן מלא יותר בערכים אטרא־חסיס ו־עלילות גלגמש (כשייכתבו).
