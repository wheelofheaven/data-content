...
title = "מיתמה"
slug = "mytheme"
description = "מיתמה היא מושג סטרוקטורליסטי שמקורו בקלוד לוי-שטראוס, המציין את יחידת המשמעות המזערית בנרטיב המיתי. במסגרת Wheel of Heaven היא משמשת כלי לפירוק השוואתי של כתבי הקודש המרכזיים."
