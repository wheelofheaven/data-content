+++
title = "סמל האינסוף הראליאני"
slug = "raelian-symbol-of-infinity"
description = "סמל האינסוף הראליאני משלב מגן דוד עם צלב-קרס (סווסטיקה), שילוב הדוחס את רעיון המחזוריות האינסופית הנטועה בזיכרון האלוהים. במסגרת Wheel of Heaven נדונה הסמיוטיקה שלו על רקע ההיסטוריה ההשוואתית של שני הסמלים."
