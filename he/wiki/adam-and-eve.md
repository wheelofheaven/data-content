...
footnotes = [
    ...
    { content = "התאריך שהקורפוס מקצה לאדם ולחוה — עידן האריה המאוחר, בסביבות 8,850 לפנה״ס, בגבול האריה–סרטן — הוא פנים-מסגרתי. הוא מובחן מסינתזת המין האדמי הראשון בפתיחת האריה (בסביבות 11,375 לפנה״ס), שאותה מעגן חישוב 666 הדורות בני 20 השנים הנקרא מתוך חזון יוחנן יג:18; אדם וחוה הם דמויות מייסדות בשלב עדן המאוחר, לא בני האדם האדמיים הראשונים. עידני הנקיפה הם תופעות אסטרונומיות אמיתיות; שנות הגבול הספציפיות הן מוסכמות מסגרת. ראו את הערכים בראשית, טרום-מבולי, ומספר האדם לגזירת הכרונולוגיה." },
...
title = "הזוג האנושי המייסד של שושלת עדן של צוות ישראל"
type = "בני אדם סינתטיים שנוצרו על ידי צוות ישראל של בוראי האלוהים; זוג ביולוגי"
created = "עידן האריה המאוחר, בסביבות 8,850 לפנה״ס על פי חישוב הקורפוס (סגירת שלב עדן, בגבול האריה–סרטן); המין האדמי הראשון סונתז מוקדם יותר, בפתיחת האריה בסביבות 11,375 לפנה״ס, על פי קריאת 666 הדורות בני 20 השנים של חזון יוחנן יג:18"
