+++
title = "רשימת אתרים מגליתיים"
slug = "list-of-megalithic-sites"
description = "רשימת אתרים מגליתיים שקורפוס Wheel of Heaven מתעניין בהם בשל דיוקם האסטרונומי, קדמותם, או הישנותם במסורות המסירה שלאחר האסון הגדול."
