...
title = "בראשית"
slug = "genesis"
description = "בראשית (בְּרֵאשִׁית) הוא הספר הראשון של התורה והמקרא, ובו סיפורי הבריאה, גן עדן, המבול והאבות. במסגרת Wheel of Heaven הוא טקסט המקור הראשון במעלה שיש לקרוא מחדש דרך עדשת האלוהים."
