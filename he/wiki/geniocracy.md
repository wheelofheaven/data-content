...
title = "גניוקרטיה"
slug = "geniocracy"
description = "גניוקרטיה היא בקורפוס הראליאני שיטת ממשל הבוחרת מנהיגים על בסיס יכולת קוגניטיבית נמדדת. קורפוס Wheel of Heaven מזכיר אותה כאחד המבנים המוסדיים שמציעה תנועת ראל."
