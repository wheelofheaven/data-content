...
operational_period = "עידן האריה עד עידן הסרטן, בסביבות 11,375 – 6,690 לפנה»ס"
...
### תקופת הפעולה של צוות ישראל: עידן האריה
...
חשיבותה של עדן במסגרת Wheel of Heaven מובנית על ידי שלוש פונקציות מובחנות, שכל אחת מהן פותחה בסעיפים הקודמים של הערך. הן ראויות לסינתזה מפורשת.
