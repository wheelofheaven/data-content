...
title = "המסורת"
slug = "the-tradition"
description = "המסורת, במסגרת Wheel of Heaven, היא המכלול המצטבר של מסירת האלוהים שנשתמר דרך הדת, אסכולות אזוטריות וכתבים פילוסופיים מסוימים — הנבדל מכל מסורת כיתתית מסוימת."
