...
title = "מנורה"
slug = "menorah"
description = "המנורה (מְנוֹרָה) היא פמוט שבעת הקנים של מקדש ירושלים, שמבנהו משלב סמליות קוסמולוגית ותפקוד פולחני. קורפוס Wheel of Heaven דן ברובדי הקריאה הטכני, האסטרונומי והליטורגי שלה."
