...
footnotes = [
    ...
    { content = "התאריכים שהקורפוס מקצה לקריירה של לוציפר — גלות עדן בערך ב-8,850 לפנה״ס, תפקיד ההוראה הטרום-מבולי לאורך עידן הסרטן (בערך 8,850 – 6,690 לפנה״ס) — הם פנים-מסגרתיים, נגזרים מכרונולוגיית עידני הנקיפה ומחישוב 666 הדורות המעגן את תאריך בריאת האדם. עידני הנקיפה הם תופעות אסטרונומיות אמיתיות; שנות הגבול שהקורפוס ממקם אותם בהן הן מוסכמות מסגרת. ראו את הערך הטרום-מבולי לגזירת הכרונולוגיה." },
...
operational_period = "עידן האריה המאוחר עד ההווה (נוכחותו המתמשכת של לוציפר על כדור הארץ מתחילה בגלות עדן, בערך 8,850 לפנה״ס על פי חישוב הקורפוס, ונמשכת לאורך התקופה הטרום-מבולית ומעבר לה)"
...
לאורך עידן האריה, לוציפר שימש כאחד ממחנכי בני האדם הסינתטיים במהלך תקופתם שלאחר הבריאה במתקן עדן. עבודת החינוך הייתה מהותית: בני האדם הסינתטיים נוצרו בבגרות תפקודית עם יכולת קוגניטיבית מהותית, אך הם נדרשו להוראה בשפה, ביכולת טכנולוגית בסיסית, בדפוסים התרבותיים-חברתיים שיהוו את אנושיותם המפותחת. לוציפר וחברי צוות ישראל אחרים סיפקו הוראה זו לאורך תקופה ממושכת.
