...
operational_phases = "1) מאפיין מתקן עדן המקורי (מוגבל לאנשי הברית); 2) שלב המענק הפטריארכלי שלאחר עדן (אריכות חיים מוגבלת למנהיגים ספציפיים, בסביבות 8,850–6,690 לפנה״ס); 3) שלב מוגבל שלאחר המבול (גישה אנושית מצומצמת בהדרגה); 4) שלב אריכות החיים הבסיסי של האלוהה (700–1,200 שנה לגוף, סטנדרטי לציוויליזציית האלוהים); 5) שלב השכפול והעברת הזיכרון של הנצחיים (אלמוות מעשי, מועצת הנצחיים)"
recipients_in_framework = "מנהיגים פטריארכליים משושלת עדן באמצעות מענק אריכות החיים שלאחר עדן (אדם, שת, אנוש, קינן, מהללאל, ירד, מתושלח, למך, נח, ואחרים); ציוויליזציית האלוהים הרחבה (~7 מיליארד פרטים עם אריכות חיים טבעית מוארכת); הנצחיים על כוכב הנצחיים (~700 חברי מועצה בתוספת ~8,400 בני אדם שתחיו, לרבות דמויות טרום-מבוליות שחולצו לפני מותן הטבעי כגון חנוך)"
...
**מנגנון העברת התאים** (מתוך *החייזרים לקחו אותי לכוכב שלהם* (1975), הדיווח על כוכב הנצחיים):
...
**המצב הנוכחי של המחקר.** תחזיות אופטימיות בתחום אריכות החיים חוזות אריכויות חיים אנושיות של 150–200 שנים באמצעות שילובים של התערבויות אלו; מדע ההזדקנות המיינסטרימי מתייחס לנתונים אלו כספקולטיביים. אריכויות חיים של 500–1,000 שנים יחייבו או פריצות דרך מהותיות מעבר למסלול הנוכחי או גישות שונות לחלוטין (כגון טכנולוגיית העברת התאים שחומר המקור מתאר).
...
מעורבותו של **פול אנתוני ווליס** עם חומר עץ החיים בקורפוס הרחב יותר שלו מפתחת טיפול מהותי בביוטכנולוגיה הבסיסית ובהיסטוריה הפעולתית שלה.{{ cite(id="wallis-eden-conspiracy", text="[20]", title="ווליס, *קונספירציית עדן* (2024)") }} תרומותיו הספציפיות של ווליס כוללות את הקריאה המבנית של התשתית הספציפית של מתקן עדן (לרבות עץ החיים כרכיב מרכזי), את הטיפול הקפדני במענקים הפטריארכליים שלאחר עדן כאירועים היסטוריים-פעולתיים, ואת המעורבות ההשוואתית עם התייחסויות ביוטכנולוגיה עתיקות מקבילות.
