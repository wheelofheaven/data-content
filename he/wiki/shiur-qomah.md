...
title = "שיעור קומה"
slug = "shiur-qomah"
description = "שיעור קומה (עברית שִׁעוּר קוֹמָה, 'מידת הקומה') הוא חיבור מספרות ההיכלות / המרכבה הקדם-קבלית, שבו המלאך Metatron מכתיב את ממדיו הקוסמיים של הגוף האלוהי, אבר אחר אבר, כשכל אחד נמדד בפרסאות ומכונה בשם סודי. זהו החיבור הספציפי שמאחורי מספרי הפרסאות שהקאנון הראליאני מייחס ל'קבלה'."
...
entry_type = "text"
claim_type = "direct"
alternative_names = ["*Shiʿur Qomah* (שִׁעוּר קוֹמָה)", "Sefer Haqqomah ('ספר הגוף [האלוהי]')", "מידת הקומה", "מידת הגוף", "Ma'amar Rabbi Yishmael"]
timeline = ["multi-age"]

[extra.infobox]
type = "חיבור מתוך הקורפוס המיסטי של ההיכלות / המרכבה; 'מידת הגוף האלוהי' האנתרופומורפית"
literal_meaning = "עברית שִׁעוּר (*shiʿur*, 'מידה, כמות') + קוֹמָה (*qomah*, 'קומה, גובה'; בארמית 'גוף'): 'מידת הקומה'"
corpus = "ספרות ההיכלות / המרכבה (מיסטיקה יהודית קדם-קבלית)"
dating = "שנוי במחלוקת: Scholem — המאה ה-2 לספירה; Cohen — תקופת הגאונים, המאה ה-6–7 לספירה; Schäfer — אין 'חיבור' יחיד הניתן לתיארוך ('החיבור האחד הוא אשליה')"
attributed_to = "בדרך פסאודו-אפיגרפית לתנאים ר' Ishmael ור' Akiva, המדווחים על התגלות מן המלאך Metatron"
key_figure = "236 (רבבות אלפי) פרסאות — גובהו של הבורא, הנגזר בגימטרייה מתהלים 147:5"
printed_in = "*Sefer Raziel ha-Mal'akh* (אמסטרדם, 1701, fol. 37b); *Merkavah Shelemah* (ירושלים, 1921); מהדורה ביקורתית: M. S. Cohen (TSAJ 9, 1985)"
wheel_of_heaven_reading = "מספרי הפרסאות נקראים כרישום משובש של שני מרחקים אסטרונומיים ממשיים, ברגע שה-*parasang* מובנת כשניית אור"
+++
