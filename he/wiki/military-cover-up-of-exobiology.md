+++
title = "הטיוח הצבאי של אקסוביולוגיה"
slug = "military-cover-up-of-exobiology"
description = "הטיוח הצבאי של אקסוביולוגיה מציין את מכלול המנגנונים הממלכתיים, בעיקר אמריקניים, המסווגים מידע על נוכחות ישויות לא-אנושיות על פני כדור הארץ; במסגרת Wheel of Heaven הוא נרשם כמכשול מוסדי החוסם את השיבה הגדולה."
...
see_also = [
    { title = "PURSUE", path = "wiki/pursue", description = "תוכנית הפרסום הפומבי מ-2026, שהארכיון הפומבי-כברירת-מחדל שלה נוגע בטענת הסודיות מן הצד הרשמי." },
]
