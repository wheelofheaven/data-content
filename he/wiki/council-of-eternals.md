...
aliases = ["/he/wiki/council-of-eternals/"]
description = "מועצת הנצחיים היא, בקורפוס הראליאני, גוף השלטון של האלוהים, המורכב ממדעני הציוויליזציה הוותיקים ביותר ובראשותו של יהוה; במסגרת Wheel of Heaven היא ניצבת בראש היררכיית ההכרעה של האלוהים בכל הנוגע לכדור הארץ."
