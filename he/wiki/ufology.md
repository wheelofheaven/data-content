...
title = "אופולוגיה"
slug = "ufology"
description = "אופולוגיה היא חקר העצמים המעופפים הבלתי מזוהים ותופעות המפגש הקשורות בהם. במסגרת Wheel of Heaven נדון ערכם התיעודי, תוך הבחנה בין מקרים שמישים למקרים חסרי הכרעה, ובלי להזדהות עם התחום בכללותו."
...
see_also = [
    { title = "PURSUE", path = "wiki/pursue", description = "תוכנית ממשלת ארה״ב מ-2026 המשחררת רישומי UAP בלתי-פתורים בכתובת war.gov/UFO — ההתפתחות המוסדית העדכנית של התחום." },
]
