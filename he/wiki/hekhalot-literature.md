...
description = "ספרות ההיכלות (עברית הֵיכָלוֹת, 'היכלות') היא גוף הכתבים המיסטיים היהודיים משלהי העת העתיקה, המתארים את עליית הנשמה דרך שבעה היכלות שמימיים אל מרכבת הכיסא האלוהית (merkavah). זהו הרובד הקדם-קבלי של המיסטיקה היהודית, והקורפוס שבו נמסר שיעור קומה."
...
entry_type = "text"
claim_type = "direct"
alternative_names = ["ספרות Hekhalot / Heikhalot (הֵיכָלוֹת)", "מיסטיקת המרכבה", "מיסטיקת Merkabah", "ספרות 'ההיכלות'", "*ma'aseh merkavah* ('מעשה מרכבה')"]
timeline = ["multi-age"]

[extra.infobox]
type = "קורפוס של חיבורים מיסטיים יהודיים משלהי העת העתיקה / ראשית ימי הביניים (קדם-קבלי)"
literal_meaning = "עברית הֵיכָלוֹת (*hekhalot*), רבים של הֵיכָל (*hekhal*), 'היכל' או 'אולם' — שבעת ההיכלות השמימיים של העלייה"
also_called = "מיסטיקת המרכבה (merkavah), על שם חזון הכיסא של יחזקאל (*ma'aseh merkavah*, 'מעשה מרכבה')"
principal_works = "*Hekhalot Rabbati* ('ההיכלות הגדולים'), *Hekhalot Zutarti* ('ההיכלות הקטנים'), *Ma'aseh Merkavah*, *Merkavah Rabbah*, *3 Enoch* (ספר חנוך העברי); ה-*Shi'ur Qomah* משוקע בתוך הקורפוס"
practitioner = "ה-*yored merkavah* ('יורד המרכבה'), העולה דרך ההיכלות חמוש במזמורים, בשמות מלאכים ובחותמות"
dating = "שנוי במחלוקת: חיבור / עריכה בין המאה ה-3 לערך למאה ה-8 לספירה (Scholem טען למוקדם יותר, Schäfer למאוחר יותר ולתקופה גאונית-בבלית)"
key_figure = "המלאך Metatron — 'שר הפנים', סופר שמימי, ו(ב-3 Enoch) האב הקדמון חנוך שעבר שינוי צורה"
+++
