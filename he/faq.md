...
המשמעת האפיסטמית של הפרויקט היא פנימית ולא מוסדית: כל ערך ויקי, כל מאמר וכל ספר בספרייה — ורוב העמודים האחרים — מתייגים את טענתם המרכזית כ**ישירה** (מה שמקור טוען ושהמחקר המקובל אינו חולק עליו), **מסגרת** (הנחת יסוד של הקאנון הראלי שהמחקר המקובל אינו מאמץ), **מוסקת** (קריאה סבירה של מקור), או **ספקולטיבית** (מה שהפרויקט מציע כסינתזה פרשנית). הקוראים מוזמנים להעריך את הטענות הספציפיות של הפרויקט מול החלופות.
"""
...
התוצאה המעשית היא שהקבוצה העולה מאחורי השמש בשוויון האביב מתחלפת לאט מערבה דרך גלגל המזלות. עד בערך 210 לפנה"ס זה היה טלה; באלפיים השנים שלאחר מכן — דגים; מאז 1950, לפי הכרונולוגיה של הקורפוס, זה דלי. המחזור חוזר על עצמו כל כ-26,000 שנה.

מחולק בשנים-עשר הקבוצות של גלגל המזלות, מחזור זה מניב *עידנים קדמיים* של כ-2,160 שנה כל אחד. הקורפוס משתמש בעידנים אלה כמסגרת הכרונולוגית שלו. למידע נוסף, ראו את ערך הוויקי [נסיגה](/he/wiki/precession/).
"""
...
answer = """
*אלוהים* (אֱלֹהִים) היא המילה העברית שתנ"כים מקובלים מתרגמים כ"אל". דקדוקית, זהו שם עצם ברבים — סיומת ה-*-ים* היא סמן הרבים העברי הסטנדרטי, אותו אחד שמרבה שמות עצם זכריים אחרים (*כרוב* / *כרובים*, *שרף* / *שרפים*).
...
למידע נוסף, ראו את ערך הוויקי [אלוהים](/he/wiki/elohim/).
"""
...
לטיפול המלא, ראו את פרק [עידן הדלי](/he/timeline/age-of-aquarius/).
"""
...
הפרויקט מקבל את התיארוך הגיאולוגי של כדור הארץ לכ-4.5 מיליארד שנה ואינו מסגרת של ארץ צעירה. פרויקט האלוהים מתוארך מהגעת עידן הגדי בסביבות 21,810 לפנה"ס, לא מהיווצרות הגיאולוגית של כדור הארץ.
"""
...
answer = """
הקורפוס מתייחס לישוע כדמות היסטורית שמשירותו מתאימה למעבר הקדמי מטלה לדגים. המקור הראלי כולל טענות ספציפיות על טבעו ומקורו של ישוע (כבנה של אישה אנושית ושל אלוהה — יהוה, לפי קריאת הקורפוס — בהמשכיות עם דפוס *בני האלוהים* של בראשית ו); הקורפוס מתעמק בטענות אלה כחלק מתוכן משפחת המקורות.
...
לטיפול הארוך יותר, ראו את פרקי [עידן הטלה](/he/timeline/age-of-aries/) ו[עידן הדגים](/he/timeline/age-of-pisces/).
"""
...
**שלישוני**: הפרשנויות מחדש של ז'אן סנדי משנים 1966–1970 של חומר מקראי כתיעודים של פעילות חוץ-יבשתית (*האלים נולדו לנו*, 1966; *הירח, מפתח התנ"ך*, 1968; *האלים שעשו את השמיים ואת הארץ*, 1969; *עידן הדלי*, 1970).
...
לנוף המקור המלא, ראו את חלקי [הספרייה](/he/library/) ו[מקורות](/he/sources/).
"""
...
[[extra.faq_groups.items]]
slug = "claim-badges"
question = "מה משמעות »ישירה«, »מסגרת«, »מוסקת« ו»ספקולטיבית« על תווי העמוד?"
answer = """
לרוב העמודים בקורפוס יש תו קטן המציין את הסטטוס האפיסטמי של הטענה המרכזית של העמוד. יש ארבעה ערכים:

**טענה ישירה** — מה שטקסט המקור עצמו טוען, ומה שהמחקר המקובל אינו חולק עליו. »בראשית א:כ"ו אומר 'נעשה אדם בצלמנו'.« אלה הן הטענות המהימנות ביותר; אימות הוא עניין של בדיקת המקור.

**טענת מסגרת** — הנחת יסוד של הקריאה של Wheel of Heaven, המפורשת בקאנון הראלי אך אינה מאומצת על ידי המחקר המקובל. »אלוהים הרבים של בראשית הם הציוויליזציה הקטנה שהמקור הראלי מתאר.« טענות אלה מנוסחות במישרין משום שהקאנון מנסח אותן במישרין; התו מסמן שהקונצנזוס האקדמי הרחב אינו שותף להן.

**טענה מוסקת** — קריאה סבירה של מקור, שאינה כתובה בו במפורש אך עולה בקנה אחד איתו. »צורת פועל הרבים מצביעה על סוכנים מרובים.« טענות אלה כוללות עבודה פרשנית אך נשארות קרוב לראיות.

**טענה ספקולטיבית** — סינתזה פרשנית החורגת ממה שכל מקור יחיד אומר. »סיפורי מלחמת השמיים של מסורות בלתי תלויות מתכנסים לאירוע זכור אחד.« טענות אלה הן התרומה הייחודית של הפרויקט וכפופות הכי הרבה לעדכון.
...
האתר עצמו מתפרסם בעשר שפות, כאשר אנגלית היא המקור לתרגומים. במקומות בהם בחירות תרגום משפיעות מהותית על הפרשנות, האנגלית המקורית מקבלת עדיפות.
"""
...
1. [הכוונה לקריאה](/he/read/) — סקירה קצרה של הפרויקט, עם שלושה מסלולי קריאה.
2. [הוויקי](/he/wiki/) — התחילו עם מונחי מפתח ([אלוהים](/he/wiki/elohim/), [נסיגה](/he/wiki/precession/), [עידן עולמי](/he/wiki/world-age/)) ועקבו אחר הקישורים הצולבים.
3. [ציר הזמן](/he/timeline/) — הספר ארוך-הצורה, מתחיל ב[פתיחה](/he/timeline/preamble/) והולך דרך שנים-עשר העידנים.
...
answer = """
חלק [הספרייה](/he/library/) מארח את טקסטי המקור הראשיים שמהם הקורפוס קורא, עם פרשנות והקשר. זה כולל:

- *הספר שאומר את האמת* (וורילון, 1974) — הטקסט הראלי המייסד — יחד עם ספרי ההמשך שלו *Extraterrestrials Took Me to Their Planet* ו*Let's Welcome the Extraterrestrials*.
- בראשית (הטקסט העברי המנוקד עם תרגום הפרויקט במקביל, בתוספת מהדורה אנגלית סטנדרטית).
- ספר חנוך.
- אנומה אליש.
- מקורות ראשיים אחרים כפי שהקורפוס מתבסס עליהם.

לחומר מקור חיצוני שהקורפוס מתבסס עליו אך אינו מארח, ראו את חלק [מקורות](/he/sources/).
"""
...
- **תרגום** — האתר מתפרסם בעשר שפות ומקבל בברכה עזרת תרגום נוספת. ראו [תרומה](/he/contributing/), ואת [מדריך התרגומים](https://docs.wheelofheaven.world/contributing/content/translations/) לזרימת העבודה ולמוסכמות לפי שפה.
...
answer = """
עשר: אנגלית (ראשית), Deutsch, Français, Español, Русский, 日本語, 简体中文, 繁體中文, 한국어, עברית. תרגומים נגזרים מהמקור האנגלי. שפות נוספות מתקבלות בברכה; ראו [תרומה](/he/contributing/).
"""
...
למידע נוסף על התנועה המוסדית, ערך הוויקי [ראליזם](/he/wiki/raelism/) מספק הקשר.
"""
...
answer = """
מתורמים מצופה לפעול בתום לב, לקרוא את [קוד ההתנהגות](/he/code-of-conduct/), ולעקוב אחר [הנחיות התרומה](/he/contributing/). הפרויקט מקבל בברכה התעסקות מהותית — כולל חילוקי דעות — ומבקש שתורמים ישמרו על הסטנדרטים העריכתיים שהקורפוס פועל לפיהם: מודעי-מקור, כתובים בבירור, אפיסטמית זהירים.
