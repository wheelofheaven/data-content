...
description = "החל מ־7 ביוני 2026, כל ספר תנ\"ך בספריית Wheel of Heaven נושא טקסט בתשע שפות — ASV באנגלית בתוספת שמונה תרגומי PD מיובאים."
date = 2026-06-07
...
sources = [
    { title = "תרגומים מיובאים: תוכנית המקורות לכל שפה", url = "https://docs.wheelofheaven.world/contributing/content/imported-translations/", outlet = "תיעוד Wheel of Heaven", date = "2026-06-07" },
    { title = "קטלוג data-library וקבצי הפרקים", url = "https://github.com/wheelofheaven/data-library", outlet = "Wheel of Heaven data-library", date = "2026-06-07" }
]
+++

## מה הושק

החל מ־7 ביוני 2026, ספריית Wheel of Heaven מארחת את התנ"ך המלא — מבראשית ועד צפניה, שלושים ושישה ספרים — בתשע שפות. כל פרק מציג את קו הבסיס של ASV האנגלי משנת 1901 לצד מהדורות מיובאות בנחלת הכלל בגרמנית, ספרדית, צרפתית, יפנית, קוריאנית, רוסית, סינית מפושטת וסינית מסורתית. קוראים המעיינים בספרייה בכל אחת מתשע שפות האתר רואים כעת את הטקסט בשפת הקריאה שלהם בלי שיצטרכו לעבור דרך אנגלית.
...
*— תוייק 7 ביוני 2026, מערכת Wheel of Heaven.*
