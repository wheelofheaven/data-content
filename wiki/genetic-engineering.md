...
description = "Genetic engineering is the scientific discipline concerned with the deliberate modification of an organism's genetic material — typically its DNA — to introduce new traits, alter existing traits, or transfer specific genetic content between organisms. The discipline emerged in its contemporary form in the early 1970s, with the foundational work of Paul Berg, Stanley Cohen, and Herbert Boyer establishing recombinant DNA technology, and the Asilomar Conference of February 1975 establishing the initial regulatory framework that has substantively shaped subsequent biotechnology development. The foundational techniques include the use of restriction enzymes (Werner Arber, Daniel Nathans, Hamilton Smith, Nobel Prize 1978) to cut DNA at specific sequences, DNA ligase to join DNA fragments, plasmids as vectors for foreign DNA, bacterial transformation to introduce engineered constructs into living cells, the polymerase chain reaction (PCR; Kary Mullis, 1983, Nobel Prize 1993) for DNA amplification, and DNA sequencing methods (Frederick Sanger, 1977, Nobel Prize 1980). The contemporary period has seen the development of CRISPR-Cas9 (Jennifer Doudna and Emmanuelle Charpentier, 2012, Nobel Prize 2020) as a substantively more accessible and precise genome-editing technology that has substantially expanded the discipline's reach. The discipline has spawned related fields including synthetic biology (the engineering of biological systems), synthetic genomics (the genome-scale design and synthesis of organisms), and pantropy (the engineering of organisms for non-terrestrial environments), each treated in dedicated entries. The Wheel of Heaven framework reads contemporary genetic engineering as the substantive recovery by humanity of the engineering capabilities that the Elohim used in the original synthesis approximately 25,000 years ago — a recovery whose contemporary acceleration corresponds substantively to the framework's reading of the contemporary transitional period and the broader anticipated knowledge transfer at the Great Return."
...
foundational_period = "Early 1970s — Paul Berg's first recombinant DNA molecule (1972); Stanley Cohen and Herbert Boyer's first successful bacterial transformation with recombinant DNA (1973); the Asilomar Conference (February 1975)"
foundational_figures = "Paul Berg (Stanford, recombinant DNA, Nobel Prize 1980); Stanley Cohen (Stanford) and Herbert Boyer (UCSF) (Cohen-Boyer technique, 1973); Werner Arber, Daniel Nathans, Hamilton Smith (restriction enzymes, Nobel Prize 1978); Frederick Sanger (DNA sequencing, second Nobel Prize 1980); Kary Mullis (PCR, Nobel Prize 1993); Jennifer Doudna and Emmanuelle Charpentier (CRISPR-Cas9, Nobel Prize 2020)"
foundational_techniques = "Restriction enzymes; DNA ligase; plasmids as vectors; bacterial transformation; polymerase chain reaction (PCR); DNA sequencing (Sanger method, subsequent next-generation sequencing); gel electrophoresis"
contemporary_techniques = "CRISPR-Cas9 (genome editing, 2012 onward); CRISPR-Cas12, CRISPR-Cas13 (variant systems); base editing; prime editing; TALENs (transcription activator-like effector nucleases); zinc finger nucleases; gene drives; mRNA technology (substantively developed during the COVID-19 vaccine response)"
regulatory_framework = "NIH Guidelines for Research Involving Recombinant DNA Molecules (1976, regularly updated); USDA, FDA, EPA regulatory authority (US); the substantially more restrictive EU regulatory framework; Cartagena Protocol on Biosafety (2003); national variations across most jurisdictions; the contemporary contested status of heritable human genome editing"
major_applications = "Medical (recombinant insulin from 1978, recombinant therapeutic proteins, gene therapy, CAR-T cell therapy, mRNA vaccines); agricultural (Bt crops, Roundup-Ready crops, Golden Rice, the broader GMO industry); industrial (bioplastics, biofuels, recombinant enzymes); research (model organisms, knockout/knock-in studies, cellular reprogramming)"
related_disciplines = "Synthetic biology; synthetic genomics; pantropy; life engineering (the broader umbrella concept); cell biology; molecular biology; biochemistry; bioinformatics; structural biology"
framework_significance = "Read by the framework as the substantive recovery by humanity of the engineering capabilities the Elohim used in the original synthesis approximately 25,000 years ago; the contemporary acceleration of genetic-engineering capability corresponds substantively to the framework's reading of the contemporary Age-of-Apocalypse transitional period"
+++

**Genetic engineering** is the scientific discipline concerned with the **deliberate modification of an organism's genetic material** — typically its DNA — to introduce new traits, alter existing traits, or transfer specific genetic content between organisms. The discipline emerged in its contemporary form in the early 1970s, with the foundational work of Paul Berg, Stanley Cohen, and Herbert Boyer establishing **recombinant DNA technology**, and the **Asilomar Conference** of February 1975 establishing the initial regulatory framework that has substantively shaped subsequent biotechnology development. The discipline has subsequently spawned several related fields, including **synthetic biology** (treated in the dedicated [Synthetic biology](../synthetic-biology/) entry), **synthetic genomics** (treated in the dedicated [Synthetic genomics](../synthetic-genomics/) entry), and **pantropy** (treated in the dedicated [Pantropy](../pantropy/) entry); the broader [Life engineering](../life-engineering/) entry treats the umbrella concept that organizes these related disciplines within the framework's broader interpretive position.
...
The Wheel of Heaven framework reads contemporary genetic engineering as the **substantive recovery by humanity** of the engineering capabilities that the Elohim used in the original synthesis approximately 25,000 years ago. The framework's adopted position is that the contemporary acceleration of genetic-engineering capability — particularly the post-CRISPR period from 2012 onward — corresponds substantively to the framework's reading of the contemporary [Age of Apocalypse](../age-of-apocalypse/) transitional period, and that the broader Vorilhon source-material anticipation of humanity's eventual independent creation of life through engineering substantively anticipates the contemporary developments. The relationship to the broader anticipated **Great Return** (treated in the dedicated [Great Return](../great-return/) entry) is read by the framework as substantively important: contemporary genetic-engineering capability provides the substrate onto which the Elohim's anticipated 25,000-year knowledge transfer would build.

The present entry focuses specifically on genetic engineering as a scientific discipline — the foundational history, the principal techniques, the regulatory framework, the major applications, the substantive controversies, and the framework's reading. The broader life-engineering interpretive context is treated in the [Life engineering](../life-engineering/) entry; the specifically-engineered-organism-design dimension is treated in [Synthetic biology](../synthetic-biology/); the genome-scale work is treated in [Synthetic genomics](../synthetic-genomics/); the non-terrestrial-environment application is treated in [Pantropy](../pantropy/).
...
- **Genetic** — from the Latin *geneticus*, from the Greek *<span class="greek">γενετικός</span>* (*genetikos*, "concerning origin or generation"), itself from *<span class="greek">γένεσις</span>* (*genesis*, "origin, generation, creation"). The English "gene" was coined by the Danish botanist Wilhelm Johannsen in 1909, from the same Greek root.
...
- **The anticipated Great Return** (in the broader Age of Aquarius / Age of Apocalypse framework, treated in the [Age of Apocalypse](../age-of-apocalypse/) and [Great Return](../great-return/) entries) would substantively continue from the contemporary recovery point
...
**The related life-engineering entries.** The dedicated [Life engineering](../life-engineering/) entry treats the umbrella concept; [Synthetic biology](../synthetic-biology/) treats the engineering of biological systems; [Synthetic genomics](../synthetic-genomics/) treats the genome-scale design and synthesis; [Pantropy](../pantropy/) treats the engineering of organisms for non-terrestrial environments. The present entry's substantive contribution is the focus on genetic engineering as the historical foundation that subsequently spawned these related disciplines.

**The Genesis entry.** The dedicated [Genesis](../genesis/) entry treats the source-tradition account of the Elohim's original engineering work; the present entry treats the contemporary scientific recovery of substantially the same capabilities.

**The Elohim entry.** The dedicated [Elohim](../elohim/) entry treats the civilization whose engineering capabilities are being recovered.

**The Great Return entry.** The dedicated [Great Return](../great-return/) entry treats the anticipated 25,000-year knowledge transfer that would substantively continue from the contemporary recovery point.

**The Age of Apocalypse entry.** The dedicated [Age of Apocalypse](../age-of-apocalypse/) entry treats the post-1945 transitional period during which the substantive contemporary recovery has occurred.

**The List of etymological readings entry.** The dedicated [List of etymological readings](../list-of-etymological-readings/) entry treats the etymological connections, including *genesis* / genetic engineering.

**The Intelligent design entry.** The dedicated [Intelligent design](../intelligent-design/) entry treats the broader philosophical question of designed-versus-undesigned life that contemporary genetic engineering substantively engages.

**The Cosmic pluralism entry.** The dedicated [Cosmic pluralism](../cosmic-pluralism/) entry treats the broader cosmological framework within which the chain-of-life propagation pattern operates.

**The Adamites entry.** The dedicated [Adamites](../adamites/) entry treats the engineered original human population on the framework's reading.
...
- [Gene therapy | Wikipedia](https://en.wikipedia.org/wiki/Gene_therapy)
