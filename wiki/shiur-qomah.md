...
title = "Shi'ur Qomah"
slug = "shiur-qomah"
description = "The Shi'ur Qomah (Hebrew שִׁעוּר קוֹמָה, 'the Measure of the Stature') is a text of the pre-Kabbalistic Hekhalot / Merkavah literature in which the angel Metatron dictates the cosmic dimensions of the divine body, limb by limb, each measured in parasangs and named with a secret name. It is the specific text behind the parasang figures the Raëlian canon attributes to 'the Kabbalah.'"
...
literal_meaning = "Hebrew שִׁעוּר (*shiʿur*, 'measure, quantity') + קוֹמָה (*qomah*, 'stature, height'; in Aramaic 'body'): 'the Measure of the Stature'"
corpus = "Hekhalot / Merkavah literature (pre-Kabbalistic Jewish mysticism)"
dating = "Contested: Scholem — 2nd c. CE; Cohen — geonic 6th–7th c. CE; Schäfer — no single datable 'text' ('the one text is an illusion')"
attributed_to = "Pseudepigraphically to the tannaim R. Ishmael and R. Akiva, reporting a revelation from the angel Metatron"
key_figure = "236 (myriads of thousands of) parasangs — the height of the Creator, derived by gematria from Psalm 147:5"
printed_in = "*Sefer Raziel ha-Mal'akh* (Amsterdam, 1701, fol. 37b); *Merkavah Shelemah* (Jerusalem, 1921); critical edition: M. S. Cohen (TSAJ 9, 1985)"
wheel_of_heaven_reading = "The parasang figures read as a garbled record of two real astronomical distances once the *parasang* is taken as a light-second"
+++
