...
core_claim_ids = ["woh-claim-0001", "woh-claim-0009", "woh-claim-0030"]
core_versions = { woh-claim-0001 = "0.2.0", woh-claim-0009 = "0.1.0", woh-claim-0030 = "0.1.0" }
...
see_also = [
    ...
    { title = "The Rain Over Helicon", path = "/articles/the-rain-over-helicon/", description = "The third Greek Explainer, weighing what documented literary transmission can and cannot establish about a shared referent behind the divine-combat traditions." },
...
footnotes = [
    { content = "The semantic convergence of *sky*, *star*, and *divine* in the cuneiform sign 𒀭 is treated in mainstream Assyriology as a normal feature of ancient Near Eastern religious cosmology: in cosmologies that place the divine in the heavens, the sign for *sky* naturally acquires the determinative function *divine* and takes the pictographic form of a star. On that reading the convergence is a semantic-religious fact about the language, not evidence about the literal location or origin of the beings the sign names. The corpus's reading proposes the inverse mapping — that the cosmological vocabulary is downstream of literal observation — without claiming the standard reading is wrong about the semantics themselves." },
    { content = "The Elohim count of approximately 2,600 and the Tetragrammaton count of approximately 6,800 are widely-cited concordance figures derived from work on the Masoretic Text. Exact figures vary by edition (the Leningrad Codex, BHS, and BHQ differ by small margins) and by whether occurrences in proper names with the *-el* / *-yah* endings are counted as instances of the root. Brown–Driver–Briggs and Strong's concordance (entries 430 and 3068) remain the standard reference points." },
    { content = "The source material's *small surgical intervention* phrasing for the lifespan extension is under-specified by design. Vorilhon's transcripts do not describe the procedure mechanically, and the corpus does not extrapolate beyond the source — both because the source's own restraint suggests the explanation would not be useful at the receiving party's technical level, and because committing to a specific mechanism would invent a claim the source itself does not make. The corpus treats the figure as a source-internal assertion rather than as a falsifiable engineering specification." },
    { content = "The seven-billion population figure was given to Vorilhon in 1973, when Earth's population stood at approximately 4 billion. By 2024 Earth's population was approximately 8.1 billion. The Elohim figure has remained constant across the Raëlian material's subsequent editions, and the temporal congruence is, on the corpus's reading, suggestive — the source produced a figure that has held up against Earth's actual population trajectory across more than fifty years — but the figure remains a source-internal datum and is not independently verifiable." },
    { content = "The corpus's specific dates for the precessional ages derive from anchoring the cycle's twelve ages, each approximately 2,160 years, to the present age opening at approximately 1950 CE — the threshold the source identifies. The deep-time chronology that follows (Capricorn beginning c. 21,810 BCE, Leo ending c. 8,850 BCE, and so on) is therefore framework-internal: the precessional ages are real astronomical phenomena, but the boundary years the corpus places them at are framework conventions for organising the material. Other precessional-age systems anchor the cycle at different threshold points and arrive at correspondingly different dates." },
    { content = "The Latin Vulgate translated the Hebrew הֵילֵל (*helel*) of Isaiah 14:12 — a poetic epithet meaning *shining one* or *morning star*, applied in context to the king of Babylon — as *Lucifer*. Patristic interpreters (Tertullian, Origen, and successors) read the Isaiah passage as referring to the fall of the angel who would later be identified with Satan. The conflation was codified in medieval Latin theology (Aquinas treats Lucifer–Satan as a single figure) and passed through to early modern translations and to *Paradise Lost*. The Hebrew text itself, by contrast, distinguishes the political-prosecutorial *ha-satan* of Job 1–2 from *helel ben shahar* of Isaiah 14, and the Hebrew Bible nowhere identifies the two." },
]
...
[[extra.references]]
id = "the-naked-bible"
note = "Biglino's 2022 collaboration with Giorgio Cattaneo, extending the strict-literal-translation method to a broader Hebrew Bible survey."

[[extra.references]]
id = "extraterrestrials-took-me-to-their-planet"
note = "Vorilhon's second Raëlian work (1976), the Périgord visit and Yahweh's exposition of the home world."
...
Mauro Biglino (b. 1950) is an Italian translator who worked for over a decade on Hebrew and Greek biblical texts for Edizioni San Paolo, a Catholic publishing house associated with the Vatican. His books, beginning with *Il Libro che cambierà per sempre le nostre idee sulla Bibbia* (2010, *The Book That Will Forever Change Our Ideas About the Bible*){{ cite(id="the-bible-is-not-a-sacred-book", text="[7]", title="Biglino, strict-literal Hebrew Bible series (2010 onward) — *Elohim* as plurality of physical beings") }} and continuing through *La Bibbia non parla di Dio* (2015) and *The Naked Bible* (2022, with Giorgio Cattaneo),{{ cite(id="the-naked-bible", text="[8]", title="Biglino & Cattaneo, *The Naked Bible* (2022) — strict-literal Hebrew Bible survey") }} argue from a strict literal translation of the Hebrew that *Elohim* designates a plurality of physical beings — *the lords from above* — whose works are described in concrete, non-metaphorical terms in the Hebrew text.
...
Paul Anthony Wallis is an Australian biblical scholar and former Anglican archdeacon whose books beginning with *Escaping from Eden* (2020){{ cite(id="escaping-from-eden", text="[9]", title="Wallis, *Escaping from Eden* (2020) — comparative reading of the Hebrew Bible's *Elohim* as the Sumerian Sky People") }} and continuing through *The Scars of Eden* (2021), *Echoes of Eden* (2021), and *The Eden Conspiracy* (2024) propose translating *Elohim* as *the Powerful Ones*, taking the plural as literal. Wallis's distinctive contribution is the comparative argument that the Powerful Ones of the Hebrew Bible are the same referent as the *Sky People* of the Sumerian cuneiform tradition — the figures known in Akkadian as the Anunnaki. He points to passages such as {% libref(book="joshua", chapter=24, verse=14) %}Joshua 24:14{% end %}, where Joshua exhorts the Israelites to abandon the *elohim* their ancestors served beyond the river, as cases where the term cannot be a singular plural-of-majesty without the passage becoming incoherent.
...
The Elohim civilization is internally differentiated. It is not a monoculture; it contains political factions with sharply different positions on the major policy questions the civilization has faced, particularly concerning the Earth creation project and its consequences. Three factional positions are load-bearing for the corpus's reading of the post-creation history.
