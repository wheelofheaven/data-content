...
see_also = [
    ...
    { title = "Age of Aquarius", path = "/wiki/age-of-aquarius/", description = "The inheritance-threshold age within which Cyberparadism emerges as Aquarian-age cultural articulation." },
    { title = "Age of Cancer", path = "/wiki/age-of-cancer/", description = "The originary alliance-project age, within which Eden as Cyberparadism is situated." },
