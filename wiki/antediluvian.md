...
timeline = ["leo", "cancer"]
see_also = [
    { title = "Eden", path = "wiki/eden", description = "The post-creation Lucifer-faction disclosure that opens the antediluvian period." },
    { title = "Great Flood", path = "wiki/great-flood", description = "The catastrophic event that closes the antediluvian world." },
...
footnotes = [
    { content = "The specific dates the corpus assigns to the antediluvian bracket — c. 11,375 BCE for the synthesis of the first humans at the opening of Leo and c. 6,690 BCE for the Flood of Gemini — are framework-internal. The precession of the equinoxes is a real astronomical phenomenon, and the corpus's twelve-age cycle of approximately 2,160 years per age is consistent with the standard astronomical figure. The anchoring of the cycle to the present Aquarian opening at approximately 1950 CE, however, and the human-creation date derived from the 666-generation calculation, are framework conventions for organising the material. Other precessional-age systems anchor the cycle at different threshold points and arrive at correspondingly different dates for the deep-time chronology." },
    { content = "The corpus's supercontinent reading conflicts directly with the mainstream geological account of Pangaea. Mainstream geology dates Pangaea's assembly to approximately 335 million years ago and its breakup to approximately 175 million years ago, with continental drift unfolding over hundreds of millions of years through mantle convection. The corpus reads continental consolidation as antediluvian and the breakup as the catastrophic Flood event of c. 6,690 BCE, with the observed continental drift since then as the residual momentum of that event. The disagreement is substantial; the corpus does not soften it. The mainstream account remains the dominant scientific position. See the [Pangaea](../pangaea/) and [Great Flood](../great-flood/) entries for fuller treatment." },
    { content = "The Genesis 5 patriarchal longevities — Adam at 930 years, Methuselah at 969 years, and so on — are read literally on the corpus's account as the consequence of the Tree of Life cell-transfer technology granted by the Lucifer faction to the Eden lineage's leadership. The standard alternative readings in mainstream biblical scholarship — that the numbers are numerological constructions, that they reflect a mistranslation of an underlying numerical system perhaps tracking months rather than years, or that they are theological devices marking the patriarchs as figures of special status — are noted and not adopted. The corpus treats these alternatives as the natural readings when the underlying technological referent is unknown, and as superseded once the technological referent is recovered from the Raëlian source material." },
    { content = "Plato's chronology in the *Timaeus* and *Critias* places the destruction of Atlantis approximately 9,000 years before Solon, which the calculation conventionally lands in the late tenth millennium BCE — within the early Cancer age on the corpus's reckoning. The temporal congruence is suggestive: a Greek tradition received through Egyptian priestly sources, dated to a period the corpus reads as the early antediluvian, describing a lost advanced civilization. The figure remains source-internal and is not independently verifiable; Plato's chronology depends on the accuracy of the chain of transmission (Egyptian priests → Solon → Critias the elder → Critias the younger → Plato) and on the precision of the original Egyptian record. The corpus registers the congruence without claiming Plato had access to a precise pre-Flood chronology." },
    { content = "The Richat Structure identification of Atlantis — a circular geological formation about 40 kilometers in diameter in Mauritania, also called the Eye of Africa — is registered by the corpus as a candidate consistent with the corpus's chronology in ways the conventional mid-Atlantic location is not. The corpus does not insist on the Richat identification. The mainstream geological reading of the structure as a deeply eroded dome remains the dominant academic position; the Richat-as-Atlantis reading is alternative-archaeology speculation that has emerged principally since 2018. What the corpus registers is that the structural features (concentric rings, scale matching Plato's stadia, location in northwest Africa, surrounding plain) deserve more serious investigation than mainstream archaeology has typically given them." },
    { content = "The Younger Dryas Impact Hypothesis — that a comet-fragment impact at approximately 12,800 years before present produced the Younger Dryas climate event and destroyed an advanced civilization — is the principal contemporary catastrophist proposal for the mechanism of the Flood. The corpus shares the broad direction (an advanced pre-Flood civilization existed, was destroyed in a catastrophic event, and its memory survives in fragmentary form across the post-Flood world) without endorsing the comet-impact mechanism as the Flood event itself. The corpus's reading places the Flood at c. 6,690 BCE rather than at the Younger Dryas boundary, and the source material's mechanism is not the cosmic-impact mechanism. The two reconstructions converge on the existence of a pre-Flood high civilization and diverge on the timing and the mechanism of its destruction." },
]

[[extra.references]]
id = "the-book-which-tells-the-truth"
locator = "Chapter 2"
note = "Foundational Raelian source for the antediluvian period — the seven creator teams, the Eden lineage's compounding advantages, the *benei ha-Elohim* unions, and the Flood decision."

[[extra.references]]
id = "those-gods-who-made-heaven-and-earth"
note = "Jean Sendy's philological-historiographic treatment of the Genesis 5 longevities and the Genesis 6 *benei ha-Elohim* / *Nephilim* material — reaches a substantially convergent reading without reliance on revelatory testimony."

[[extra.references]]
id = "pseudodoxia-epidemica"
locator = "Book VI"
note = "Sir Thomas Browne's 1646 work — the citation point for the technical use of *antediluvian* as the designation for the pre-Flood period in scholarly English."

[[extra.references]]
id = "telluris-theoria-sacra"
note = "Thomas Burnet's 1681 *Sacred Theory of the Earth* — the most influential late-seventeenth-century attempt to give a unified natural-philosophical account of the Genesis cosmology and the pre-Flood world."

[[extra.references]]
id = "annales-veteris-testamenti"
note = "Archbishop Ussher's 1650 chronology — the principal reference point for the early-modern Christian dating of the antediluvian period at approximately 1,656 years."

[[extra.references]]
id = "theory-of-the-earth"
note = "James Hutton's 1788 foundational paper on geological uniformitarianism — the conceptual displacement of the Ussher chronology by deep-time geology."

[[extra.references]]
id = "principles-of-geology"
note = "Charles Lyell's 1830–33 consolidation of uniformitarianism as the dominant nineteenth-century geological framework."

[[extra.references]]
id = "reliquiae-diluvianae"
note = "William Buckland's 1823 work — the major nineteenth-century articulation of diluvialism within mainstream geology."

[[extra.references]]
id = "mesopotamian-chronicles"
locator = "Sumerian King List (multiple recensions)"
note = "Jean-Jacques Glassner's critical edition of the Mesopotamian chronicle tradition, including the Sumerian King List with its antediluvian kings of vast lifespan."

[[extra.references]]
id = "atra-hasis-lambert-millard"
note = "Lambert and Millard's standard critical edition and translation of the *Atra-ḫasīs* Epic — the principal Old Babylonian narrative of the pre-Flood period."

[[extra.references]]
id = "before-the-muses"
locator = "Standard Babylonian *Gilgamesh*, Tablet XI"
note = "Foster's anthology of Akkadian literature — the principal scholarly access point for the Gilgamesh flood narrative whose dove-raven sequence parallels Genesis 8:6–12."

[[extra.references]]
id = "vidal-naquet-atlantis-story"
note = "Pierre Vidal-Naquet's standard contemporary scholarly treatment of the *Timaeus*/*Critias* Atlantis tradition — sceptical of any historical Atlantis; the principal mainstream source against which alternative-archaeological identifications are positioned."

[[extra.references]]
id = "gobekli-tepe-schmidt"
note = "Klaus Schmidt's foundational monograph on the Göbekli Tepe excavation — the site whose c. 9600 BCE construction has substantially overturned the previously dominant view of when complex human civilization began."

[[extra.references]]
id = "natufian-culture-in-the-levant"
note = "Bar-Yosef and Valla's standard scholarly treatment of the Natufian culture — the broader regional context within which Göbekli Tepe sits."

[[extra.references]]
id = "fingerprints-of-the-gods"
note = "Graham Hancock's 1995 foundational work in the contemporary catastrophist-civilization tradition."

[[extra.references]]
id = "magicians-of-the-gods"
note = "Hancock's 2015 work, converging on the Younger Dryas Impact Hypothesis as the proposed mechanism for the pre-Flood civilization's destruction."

[[extra.references]]
id = "america-before"
note = "Hancock's 2019 extension of the catastrophist hypothesis to the Americas."

[[extra.references]]
id = "voices-of-the-rocks"
note = "Robert Schoch's geological argument for the redating of the Great Sphinx of Giza on the basis of weathering patterns — contested in academic Egyptology, situated within the broader catastrophist-civilization tradition."

[[extra.references]]
id = "cataclysm-allan-delair"
note = "Allan and Delair's early articulation of the late-Pleistocene cosmic-catastrophe hypothesis on which subsequent catastrophist literature has built."

[[extra.references]]
id = "firestone-pnas-2007"
note = "The principal peer-reviewed scientific publication of the Younger Dryas Impact Hypothesis — geochemical and stratigraphic evidence for a substantial extraterrestrial impact event at approximately 12,900 years before present."

[[extra.references]]
id = "myth-of-the-eternal-return"
note = "Mircea Eliade's foundational work in the comparative phenomenology of religion — the global cyclical-destruction traditions read as expressions of a shared structural pattern."

[[extra.references]]
id = "origins-of-the-worlds-mythologies"
note = "E. J. Michael Witzel's broad comparative reconstruction of the structural parallels between the global flood, golden-age, and lost-civilization traditions."
...
**Antediluvian** (from Latin *ante*, "before," + *diluvium*, "flood") is the conventional English term for the period of human existence on Earth before the Great Flood narrated in {% libref(book="genesis-woh", chapter=6, verse=1) %}Genesis 6–9{% end %} and in parallel traditions preserved across multiple ancient cultures. The {% wiki(slug="hebrew-bible") %}Hebrew Bible{% end %} has no equivalent technical term, referring to the period descriptively as the days before the Flood or using more general terms such as *qedem* ("former times, antiquity"). The Greek Septuagint translation uses the phrase *πρὸ τοῦ κατακλυσμοῦ* (*pro tou kataklysmou*, "before the cataclysm"). The Latin construction enters English in the seventeenth century through the work of biblical chronologists and early geologists,{{ footnote(id="1") }} and becomes standard in the geological and theological literature of the eighteenth century, when the dating and historicity of the antediluvian world were live questions for both natural science and biblical interpretation.

On the reading developed in the Raëlian source material and adopted by the Wheel of Heaven corpus, the antediluvian world is the post-creation pre-Flood span: from the synthesis of the first humans at the opening of the Age of Leo (c. 11,375 BCE) through the catastrophic {% wiki(slug="great-flood") %}Flood{% end %} event at the close of the Age of Cancer (c. 6,690 BCE), a span of approximately five millennia. This is the world in which the seven regional human lineages produced by the {% wiki(slug="elohim") %}Elohim{% end %} creator teams developed substantial civilizations on a single supercontinent, in continuous trade and conflict with one another, with the {% wiki(slug="eden") %}Eden{% end %} lineage advancing — under the continuing tutelage of the exiled {% wiki(slug="lucifer") %}Lucifer{% end %} faction and through the longevity granted to its patriarchal leadership — to a level of technological and scientific sophistication that the home-world Council ultimately judged unacceptable. The Flood was the home world's response. The antediluvian world is what the Flood ended.

The reading is contested. Within mainstream geology and archaeology, the historicity of any global Flood event is rejected: the geological record contains no evidence of a planet-wide inundation in the relevant period, and the various ancient flood traditions are conventionally explained as the cultural memory of regional flood events generalized into cosmic narratives. Within biblical scholarship, the antediluvian narrative is read variously as mythological composition, as theological commentary on the human condition, or as the redactional preservation of older Mesopotamian flood-and-creation traditions. The corpus's reading depends on the framework's broader account of the Elohim civilization and the Earth project, treats the Hebrew Bible's antediluvian narrative as preserving a accurate historical record in compressed form, and engages the modern archaeological developments — particularly the Pre-Pottery Neolithic discoveries of southeastern Anatolia — as material evidence consistent with the framework's reading.

## Etymology

The English word *antediluvian* is a Latinate compound: *ante-* (before) + *diluvium* (flood) + the adjectival suffix *-an*. *Diluvium* in Latin is the standard term for a flood or inundation, used in classical Latin for the destructive overflow of rivers and adopted by ecclesiastical Latin specifically for the biblical Flood narrated in {% libref(book="genesis-woh", chapter=6, verse=1) %}Genesis 6–9{% end %}. The Vulgate uses *diluvium* throughout the Genesis Flood narrative, and the term enters Christian Latin theological discourse as the standard designation for the event.

The English compound *antediluvian* enters the language in the early seventeenth century. Sir Thomas Browne uses the term in *Pseudodoxia Epidemica* (1646),{{ cite(id="pseudodoxia-epidemica", text="[1]", title="Browne, *Pseudodoxia Epidemica* (1646) — the citation point for the technical use of *antediluvian* in scholarly English") }} in the context of discussions of the longevity of the biblical patriarchs and the conditions of the world before the Flood. Browne's use is technical-theological: he is engaged with the genuinely contested early-modern question of how long humans lived before the Flood and what the physical conditions of the antediluvian world might have been. The term spreads across the seventeenth and eighteenth centuries as the standard designation for the period in biblical-chronological and natural-philosophical contexts, used by figures including Edward Stillingfleet, Thomas Burnet (in his influential *Telluris Theoria Sacra* of 1681){{ cite(id="telluris-theoria-sacra", text="[2]", title="Burnet, *Telluris Theoria Sacra* (1681) — the most influential late-seventeenth-century unified account of the Genesis cosmology") }}, and the early geological writers including James Hutton and Georges Cuvier.
...
The biblical narrative of the antediluvian period (Genesis 4–6:8) is treated within mainstream biblical scholarship as religious literature whose historical referents are mythological, theological, or — at most — distant cultural memory of regional flood events generalized into cosmic narrative. The very long patriarchal lifespans of {% libref(book="genesis-woh", chapter=5) %}Genesis 5{% end %} are read variously as numerological constructions, as mistranslations of an underlying numerical system (perhaps reflecting months rather than years), or as theological devices marking the patriarchs as figures of special status.{{ footnote(id="3") }} The historical-critical approach, dominant in academic biblical studies since Wellhausen, treats the antediluvian narrative as a redactional composition assembled from earlier sources rather than as a historical record of identifiable events.

## In the Hebrew Bible and other ancient sources

The Hebrew Bible covers the antediluvian period in {% libref(book="genesis-woh", chapter=4) %}Genesis 4–6:8{% end %}, beginning immediately after the expulsion from Eden in Genesis 3 and concluding with the divine decision to send the Flood. The narrative is unusually compressed: a few chapters carry events that on the corpus's reading occupy approximately five thousand years.

### The Genesis narrative

The principal content of {% libref(book="genesis-woh", chapter=4) %}Genesis 4–6:8{% end %} includes the conflict between Cain and Abel and Cain's subsequent exile and city-founding ({% libref(book="genesis-woh", chapter=4) %}Genesis 4{% end %}); the genealogies of Cain's line, naming Jabal as the founder of pastoral nomadism, Jubal as the founder of music, and Tubal-Cain as the founder of metallurgy ({% libref(book="genesis-woh", chapter=4, verse=17) %}Genesis 4:17–22{% end %}); the parallel genealogy of Seth's line, with the long lifespans of the patriarchs from {% wiki(slug="adam-and-eve") %}Adam{% end %} (930 years) through Methuselah (969 years) to {% wiki(slug="noah") %}Noah{% end %} ({% libref(book="genesis-woh", chapter=5) %}Genesis 5{% end %}); the introduction of the *benei ha-Elohim* ("sons of Elohim") who take human women as wives and produce the *Nephilim* ({% libref(book="genesis-woh", chapter=6, verse=1) %}Genesis 6:1–4{% end %}); and the divine assessment of human wickedness and the announcement of the coming Flood ({% libref(book="genesis-woh", chapter=6, verse=5) %}Genesis 6:5–8{% end %}).

The narrative is structurally bipartite. Genesis 4 traces the line of Cain from the expulsion to Lamech (the seventh generation from Adam through Cain), with cultural-technological founders at each generation. Genesis 5 traces the parallel line of Seth from Adam to Noah (the tenth generation), with the long lifespans recorded in formulaic detail. {% libref(book="genesis-woh", chapter=6, verse=1) %}Genesis 6:1–4{% end %} then introduces the *benei ha-Elohim* / *Nephilim* material as a brief but consequential interlude before the Flood announcement at 6:5–8. The narrative's brevity and density have made it a site of substantial interpretive elaboration across both Jewish and Christian traditions.
...
The **Sumerian King List**, in its various recensions, records a sequence of pre-Flood kings with reigns of extraordinary length — figures such as Alulim (28,800 years), Alalngar (36,000 years), and others, summing to total reign-lengths in the hundreds of thousands of years before the Flood interrupts the sequence and reign-lengths drop sharply afterward.{{ cite(id="mesopotamian-chronicles", text="[7]", title="Glassner, *Mesopotamian Chronicles* (2004) — standard critical edition of the Sumerian King List and the broader chronicle tradition") }} The structural parallel to Genesis 5 (ten antediluvian patriarchs with vast lifespans, ending with Noah and the Flood) is striking, though the specific Sumerian figures are far larger than the Genesis figures.
...
The corpus's antediluvian supercontinent is *not* the conventional Pangaea of mainstream geology.{{ footnote(id="2") }} The structural correspondence — a single consolidated continental mass surrounded by a single ocean — is shared, but the chronology is radically different: mainstream geology dates Pangaea's assembly to approximately 335 million years ago and its breakup to approximately 175 million years ago, with continental drift unfolding over hundreds of millions of years through mantle convection. The corpus reads the breakup as a catastrophic event during the Flood of the Age of Gemini at approximately 6,690 BCE,{{ footnote(id="1") }} with the observed continental drift since then as the residual momentum of that event. The conflict with mainstream geological dating is substantial and is treated openly in the {% wiki(slug="pangaea") %}Pangaea{% end %} and {% wiki(slug="great-flood") %}Great Flood{% end %} entries. The Hebrew text of {% libref(book="genesis-woh", chapter=1, verse=9) %}Genesis 1:9{% end %} preserves the configuration the corpus reads as the antediluvian setting: the dry land appears in *makom ehad*, "one place" — singular, not plural.
...
The corpus's reading of the antediluvian period is among the most operationally specific in the framework. The basis is the Raëlian source material — particularly *The Book Which Tells the Truth* (1974),{{ cite(id="the-book-which-tells-the-truth", text="[12]", title="Vorilhon (Raël), *The Book Which Tells the Truth* (1974), chapter 2 — the foundational Raelian source for the antediluvian period") }} with substantial elaboration through subsequent works — combined with the precessional chronology that maps Genesis 2:4–6:8 to the Age of Cancer. The Genesis text is treated as a literally accurate compressed account of real events, with the apparent cosmological strangeness (the longevity figures, the *benei ha-Elohim*, the *Nephilim*) read in the technical register the corpus develops.
...
**Third**, the longevity treatment granted to the Eden lineage's patriarchal leadership. The {% libref(book="genesis-woh", chapter=5) %}Genesis 5{% end %} genealogy records specific ages — Adam at 930 years, Seth at 912, Enosh at 905, Mahalalel at 895, Jared at 962, Methuselah at 969, Lamech at 777, and Noah at 950 — for the line descending from Adam through Seth to Noah.{{ footnote(id="3") }} These extended lifespans, on the corpus's reading, are the consequence of the {% wiki(slug="tree-of-life") %}Tree of Life{% end %} longevity technology that the Lucifer faction managed to obtain on a limited and case-by-case basis for the Eden civilization's leadership. The longevity was not hereditary in the broad sense; the general human population, including the descendants of Cain and the broader populations of the other six civilizations, lived ordinary human lifespans on the order of decades. The civilizational consequences of this asymmetry are substantial: a leader living nine hundred years can pursue research projects across multiple ordinary generations, integrate fields of expertise that in a short-lived civilization would be siloed across separate practitioners, and let personal memory function as institutional memory in ways no short-lived civilization can match.

**Fourth**, the hybrid offspring of the *benei ha-Elohim* — the "sons of Elohim" who took human women as wives — produced the *Nephilim*, the "men of renown" of {% libref(book="genesis-woh", chapter=6, verse=4) %}Genesis 6:4{% end %}. By mid-Cancer these hybrids were a substantial population within the Eden civilization, possessing capabilities approaching the Elohim's own. They became leaders, warriors, builders, and scientists, naturally rising to positions of substantial authority. The Eden civilization was therefore not only being taught by the exiled Elohim but was incorporating Elohim genetic material directly into its leadership population.
...
The biblical account in Genesis 4–5 names specific individuals as the founders of specific cultural and technological developments, in a genealogical structure the corpus treats as accurate. The line of Cain produces, within a few generations of the expulsion: pastoral nomadism (Jabal, {% libref(book="genesis-woh", chapter=4, verse=20) %}Genesis 4:20{% end %}), music (Jubal, {% libref(book="genesis-woh", chapter=4, verse=21) %}4:21{% end %}), and metallurgy (Tubal-Cain, {% libref(book="genesis-woh", chapter=4, verse=22) %}4:22{% end %}). These are not the inventions of vague primitive humans; they are specific cultural and technological developments attributed to specific named persons whose genealogies the text preserves. The line of Seth — the line through which the longevity treatment is transmitted, on the corpus's reading, by the exiled Elohim teachers — produces the patriarchal leadership that will carry the Eden civilization through to Noah.
...
{% libref(book="genesis-woh", chapter=6, verse=1) %}Genesis 6:1–4{% end %} introduces, in four compressed verses, one of the most consequential and most widely misread passages in the Hebrew Bible:
...
By late Cancer, on the corpus's reading, the conditions that would produce the Flood were converging. The home-world leadership had been observing the Earth project across the entire duration of the antediluvian period through the communications channels {% wiki(slug="yahweh") %}Yahweh{% end %} and the Council maintained. The original concerns of the home-world authorities — that fully enlightened humans might eventually pose a threat to the creator civilization — had originally been addressed through the policy of containment: the humans were to be kept in scientific ignorance, denied access to the longevity technology, restricted from acquiring capabilities approaching the makers' own.
...
Beyond Atlantis and the Anatolian archaeology, traditions of a lost pre-Flood high civilization survive across essentially every major cultural area: the Sumerian King List with its ten antediluvian kings of vast lifespan ending with the Flood and a reset; Hesiod's Golden Race in *Works and Days*; the Hindu *yuga* cycle; the Egyptian *zep tepi*; the Mesoamerican *Popol Vuh*'s prior attempts at humanity; Polynesian sunken-homeland traditions; Celtic submerged-city traditions.{{ cite(id="origins-of-the-worlds-mythologies", text="[14]", title="Witzel, *The Origins of the World's Mythologies* (2012) — broad comparative reconstruction of the structural parallels between the global flood, golden-age, and lost-civilization traditions") }} The pattern is global, treated in *In the Hebrew Bible and other ancient sources* above. The corpus's reading is that the pattern is global because the underlying historical event was global: a pre-Flood civilization existed across the supercontinent, was destroyed in a catastrophic event of which the various post-Flood populations preserved fragmentary memories, and the convergence of structurally similar stories across geographically disconnected cultures is precisely what such a global event would predict.
...
Related work includes **Trevor Watkins**'s broader analysis of the Pre-Pottery Neolithic transition, **Ian Hodder**'s excavation reports from Çatalhöyük (a slightly later but closely related site), and **Ofer Bar-Yosef**'s comparative work on the Natufian and PPN cultures.{{ cite(id="natufian-culture-in-the-levant", text="[15]", title="Bar-Yosef & Valla, *The Natufian Culture in the Levant* (1991) — standard scholarly treatment of the broader regional context within which Göbekli Tepe sits") }}
...
**Graham Hancock**, beginning with *Fingerprints of the Gods* (1995){{ cite(id="fingerprints-of-the-gods", text="[16]", title="Hancock, *Fingerprints of the Gods* (1995) — foundational work in the contemporary catastrophist-civilization tradition") }} and continuing through *Magicians of the Gods* (2015){{ cite(id="magicians-of-the-gods", text="[17]", title="Hancock, *Magicians of the Gods* (2015) — convergence on the Younger Dryas Impact Hypothesis") }} and *America Before* (2019),{{ cite(id="america-before", text="[18]", title="Hancock, *America Before* (2019) — extension of the catastrophist hypothesis to the Americas") }} has been the most widely-read figure in this tradition. Hancock's work develops the catastrophist hypothesis — that an advanced pre-Flood civilization existed, was destroyed in a catastrophic event, and left fragmentary archaeological traces and cultural memories across the post-disaster world. His specific reconstruction has shifted across his career; the recent work has converged on the Younger Dryas impact hypothesis (the proposal that a comet-fragment impact at approximately 12,800 years before present produced the Younger Dryas climate event and destroyed an advanced civilization that had existed during the preceding warm period).{{ footnote(id="6") }} The corpus's reading shares the broad direction of Hancock's argument — that there was an advanced pre-Flood civilization, and that its memory survives in fragmentary form across the post-Flood world — but does not endorse Hancock's specific reconstructions in detail. The Younger Dryas impact hypothesis, as a candidate mechanism for the Flood, is treated in the {% wiki(slug="great-flood") %}Great Flood{% end %} entry.

**Robert Schoch**, the geologist whose redating of the Great Sphinx of Giza on the basis of weathering patterns (proposing a substantially earlier date than the conventional Old Kingdom attribution) was developed in the early 1990s and presented in *Voices of the Rocks* (1999){{ cite(id="voices-of-the-rocks", text="[19]", title="Schoch, *Voices of the Rocks* (1999) — geological argument for the redating of the Great Sphinx") }} and subsequent works, is a separate but related figure. Schoch's specific claims about the Sphinx's age remain contested in academic Egyptology; his broader argument about pre-Flood civilization is in the same general region as Hancock's. The corpus treats the Sphinx redating as an open empirical question rather than as a settled fact.

The broader catastrophist-civilization literature — including **Allan and Delair**'s *Cataclysm!* (1995){{ cite(id="cataclysm-allan-delair", text="[20]", title="Allan & Delair, *Cataclysm!* (1995) — early articulation of the late-Pleistocene cosmic-catastrophe hypothesis") }} on the geological evidence for a catastrophic event in the early Holocene, the various **Younger Dryas Impact Hypothesis** publications by Richard Firestone, James Kennett, and others,{{ cite(id="firestone-pnas-2007", text="[21]", title="Firestone et al., *PNAS* 104:41 (2007) — principal peer-reviewed publication of the Younger Dryas Impact Hypothesis") }} and the substantial popular literature in the **lost-civilization** genre — is in this same broad space. The corpus's general position is that this literature is engaging real questions on a real evidence base, often producing observations and arguments that mainstream archaeology has not adequately addressed, but that the specific civilizational reconstructions vary in their evidentiary support and that the corpus does not endorse them in detail without case-by-case examination.

### The Sendy and Raëlian tradition

The corpus's own reinterpretive tradition — Jean Sendy's philological-historiographic work and the Raëlian source material — engages the antediluvian period as part of its broader treatment of the Hebrew Bible and the Elohim civilization. Sendy's specific treatment of the antediluvian narrative is found in *Ces dieux qui firent le ciel et la terre* (1969),{{ cite(id="those-gods-who-made-heaven-and-earth", text="[22]", title="Sendy, *Ces dieux qui firent le ciel et la terre* (1969) / *Those Gods Who Made Heaven and Earth* (1972) — philological-historiographic reading of the Genesis 5 longevities and the *benei ha-Elohim* / *Nephilim* material") }} where he reads the Genesis 5 longevities and the Genesis 6 *benei ha-Elohim* / *Nephilim* material in terms consistent with the corpus's later development. The Raëlian source material's treatment, in chapter 2 of *The Book Which Tells the Truth*, is the basis for the corpus's specific reading of the antediluvian period.
