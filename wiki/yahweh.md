...
[extra]
same_as = ["https://www.wikidata.org/wiki/Q766677", "https://en.wikipedia.org/wiki/Yahweh", "https://www.britannica.com/topic/Yahweh", "https://viaf.org/viaf/529159234869003372966"]
featured_order = 2
category = "Elohim"
...
footnotes = [
    { content = "The figure of approximately 6,800 occurrences of the Tetragrammaton in the Hebrew Bible is a widely-cited concordance number derived from work on the Masoretic Text. Precise counts vary by edition (the Leningrad Codex, BHS, and BHQ differ by small margins) and by whether instances within compound theophoric personal names (the *-yahu* and *-yah* endings) are counted as occurrences of the divine name itself. Strong's concordance entry 3068, BDB, and HALOT remain the standard reference points." },
    { content = "The reconstruction *Yahweh* as the historical pronunciation of the Tetragrammaton is the consensus of modern critical scholarship but was not arrived at internally to the Jewish liturgical tradition, which preserves the *qere perpetuum* substitution of *Adonai* and treats the consonantal name as unspoken. The reconstruction draws on patristic transcriptions (Clement of Alexandria's Ἰαουέ, Theodoret's Ἰαβέ), comparative West Semitic theophoric name elements (the *-yahu* and *-yah* endings of biblical personal names), and reconstructed vocalisation of the verbal root. The pronunciation is therefore a scholarly philological reconstruction, not a recovered or transmitted form." },
    { content = "The reference to *Yahu* / *Yhw* in late-Bronze-Age Egyptian sources concerns the topographical lists of Soleb (under Amenhotep III, fourteenth century BCE) and Amarah West (under Ramesses II, thirteenth century BCE), which mention a *Shasu yhw* — nomadic groups associated with a place or deity *yhw* located in the southern Levantine / Sinai region. The relationship between this Egyptian *yhw* and the later Israelite Yahweh is debated: the prevailing reading treats the Egyptian attestation as evidence of an early southern (Midianite / Edomite) origin for the deity, consistent with the biblical tradition of Sinai / Horeb as Yahweh's mountain, but the inference from a topographical list to a specific deity-figure is not philologically tight." },
    { content = "The form *Jehovah* — vowels of *Adonai* superimposed on the consonants YHWH — was popularised in Latin Christian use by Petrus Galatinus in *De arcanis catholicae veritatis* (1518), passed into the King James Version (1611) and the early modern European translations, and survived in liturgical use into the twentieth century. Modern philological consensus treats the form as a hybrid that was never pronounced as a unitary name in any historical Hebrew speech community; the Masoretic pointing was a reading-aid for substitution, not a record of pronunciation." },
    { content = "Wellhausen's classical formulation of the Documentary Hypothesis (J/E/D/P) has been substantially modified across subsequent scholarship. Rolf Rendtorff and Erhard Blum dispute the existence of continuous J and E sources, proposing instead a model of independent block-traditions later edited together. John Van Seters dates J to the exilic or post-exilic period rather than the tenth century BCE. The neo-documentarian school (Baruch Schwartz, Joel Baden) has defended a modified four-source model. The corpus's framework reads the historical referents preserved in the surviving text rather than committing to any specific compositional reconstruction." },
    { content = "The 25,000-year figure for Yahweh's continuous existence is source-internal to the Raëlian material: Vorilhon's transcripts give the period as approximately twenty-five thousand years, with Yahweh described as the first individual on whom the cell-transfer continuity technology was successfully applied. The figure has held constant across the Raëlian material's subsequent editions. The corpus treats it as a source-internal datum rather than as an independently verifiable chronological claim — neither the technology nor the individual's continuous existence is available to external corroboration." },
]
...
- The **Deuteronomist** (D), 7th century BCE and after, uses *YHWH* throughout and is associated with the book of Deuteronomy and the Deuteronomistic History.{{ footnote(id="5") }}
...
On the *rank* of Yahweh, however, Biglino and the corpus diverge sharply — and the divergence is worth stating plainly, because the two readings run in opposite directions from the same grammar. Reading the allotment of Deuteronomy 32:8–9, where the nations are divided among the sons of the Elohim and Jacob falls to Yahweh, Biglino infers from the *poverty* of that allotment that Yahweh is a minor figure — *"a small local lord,"* a tribal governor occupied with a single clan in a marginal territory, not the God of humanity. The corpus reads the same plurality and assigns Yahweh the opposite station: the president of the [Council of the Eternals](../council-of-the-eternals/), the senior authority who directed the Earth project. Both agree that Yahweh is one individual among a plurality of Elohim, with Jacob as his portion; they disagree about the org-chart above him — Biglino inferring downward from the allotment's modesty, the corpus reporting upward from the canon's testimony. Set beside the Wallis reading below, the three form a spectrum on a single question — Wallis pinning the dragon on Yahweh, Biglino reducing him to a lieutenant, the canon seating him at the head of the table — while agreeing on the grammar beneath. The full comparison is [The Translator's Wager](/articles/the-translators-wager/).
