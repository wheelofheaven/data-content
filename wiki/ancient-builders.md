...
footnotes = [
    { content = "The strong 'Ancient Builder race' framing — that the conventionally-credited civilizations could not have built their own monuments — has a substantially cultural-dismissive dimension that the corpus rejects on methodological as well as ethical grounds. The framing has, in its nineteenth- and twentieth-century articulations, often coincided with explicit racial-hierarchical assumptions about which populations were 'capable' of monumental construction. The corpus's commitment to respect for indigenous achievement is therefore not merely a methodological preference but a substantive ethical commitment: the Egyptians built the Egyptian pyramids; the Inca built Sacsayhuamán; the Rapa Nui built the moai; the Neolithic Maltese built the Maltese temples. The conventional attributions are substantively correct, and the experimental-archaeology record substantially documents the construction methods." },
    { content = "The Vorilhon-source content on alliance Earth-bases describes operational installations — laboratories, habitation, communications and energy infrastructure — rather than monumental constructions intended as visible symbols. This distinction is load-bearing for the corpus's position. The high-mountain bases the source identifies in the Himalayas, the Andes, Greece, and elsewhere are not the visible megalithic monuments the alternative-archaeology tradition typically points to (Giza, Stonehenge, Sacsayhuamán, the moai). The bases left fragmentary cultural traces — the substantial cross-cultural sacred-mountain pattern the corpus reads as preserving cultural memory of alliance presence — rather than surviving physical structures. The visible megalithic monuments are a separate phenomenon, substantively human accomplishment, and the corpus does not conflate the two." },
    { content = "Robert Schoch's geological argument for redating the Great Sphinx of Giza on the basis of water-erosion patterns proposes a substantially earlier date than the conventional Fourth-Dynasty attribution (c. 2500 BCE) — possibly to before the end of the last glacial period (c. 10,000 BCE or earlier). The mainstream Egyptological response has been substantially negative; the debate remains contested. The corpus treats the Sphinx-redating question as a substantively open empirical question rather than as a settled fact in either direction. If Schoch's redating were eventually confirmed, the implications for the corpus framework would be substantial; the corpus does not, however, build its reading on the assumption that the redating is correct." },
    { content = "The Younger Dryas Impact Hypothesis (YDIH) is engaged by the corpus at the descriptive level — the substantial evidence for a major catastrophic event at approximately 12,900 years before present warrants substantive engagement — without adopting Hancock's 'lost advanced civilization' framing as the inferred consequence. The substantial pre-Younger-Dryas human populations were substantially hunter-gatherer cultures with substantial cultural sophistication but not Atlantis-style advanced civilization. The YDIH event, if real, would have substantially disrupted these populations without requiring a lost super-civilization to explain. The relationship between the YDIH event and the corpus's framework-internal Cancer-Gemini boundary Flood at c. 6,690 BCE is substantively distinct: the YDIH event, if confirmed, would be a substantial earlier catastrophic episode rather than the principal Flood." },
    { content = "The Atlantis tradition is engaged by the corpus as a substantial interpretive tradition with substantive cultural-religious significance, without adopting the substantial specific claims that have accreted across the Donnelly-Cayce-Hancock lineage. The corpus does not require commitment to an Atlantic mid-ocean location, to the substantial Cayce-style 'crystal' technology content, or to the identification of Atlantis as the principal source of subsequent civilization. What the corpus does engage is the substantial possibility that the Plato account preserves cultural memory of a real pre-Flood civilization — either the Eden civilization itself or one of the other six lineages — with the geographic details reflecting post-Flood relocation of fragmentary memories. The dedicated treatment of Atlantis lives in its own entry when written." },
    { content = "Göbekli Tepe's c. 9600 BCE chronology places the site, on the corpus's reckoning, in the late Age of Leo / early Age of Cancer — substantially before the Cancer-Gemini boundary Flood event at c. 6,690 BCE. The site is therefore antediluvian on the corpus's reading. The substantial deliberate burial of the enclosures around 8000 BCE may preserve cultural memory of the approaching Flood. The site's hunter-gatherer builders, on the corpus's reading, were human populations under continuing alliance cultivation during the post-Eden / pre-Flood Cancer-age period, with the substantial monumental capability reflecting cultivated cultural development rather than independent emergence." },
]
...
note = "Vorilhon's second Raëlian work (1976) — the Périgord visit and the substantial alliance-history content bearing on Earth-base operations."

[[extra.references]]
id = "lets-welcome-the-extraterrestrials"
note = "Vorilhon's third Raëlian work (1979) — the embassy project and the substantial Aquarian-age content."
...
note = "West's alternative-Egyptology articulation of the substantially-older-Sphinx hypothesis and the Schwaller de Lubicz symbolist reading."
...
note = "Edgar Evans Cayce's compilation of the substantial Atlantis content from Edgar Cayce's 1920s–1940s trance readings."
...
note = "Dietrich et al.'s peer-reviewed cult-and-feasting interpretation of Göbekli Tepe and the substantial implications for the Neolithic-revolution sequence."
...
The Wheel of Heaven framework engages this proposition carefully. **The corpus does not adopt the broader "Ancient Builder race" framing in its strong form**, which treats the visible megalithic monuments as evidence that the human civilizations to whom they are attributed could not have built them. This strong framing is the von Däniken-style cultural-dismissive reading of indigenous achievement that the corpus has explicitly distanced itself from in the {% wiki(slug="ancient-astronaut-hypothesis") %}Ancient Astronaut Hypothesis{% end %} entry.{{ footnote(id="1") }}
...
- **The pre-flood alliance bases.** The Vorilhon source identifies the {% wiki(slug="elohim") %}Elohim{% end %} alliance as having maintained Earth-bases on high mountains and at submarine locations. The principal Vorilhon-source quotation: *"To avoid being disturbed by humans, the creators built their bases on high mountains, where we now find traces of great civilizations (in the Himalayas and Peru, for example), as well as at the bottom of the sea."*{{ cite(id="the-book-which-tells-the-truth", text="[1]", title="Vorilhon (Raël), *The Book Which Tells the Truth* (1974) — alliance Earth-bases content") }} This is genuine corpus content distinct from the broader "Ancient Builder race" claim.{{ footnote(id="2") }}
...
- **The Göbekli Tepe revolution.** The Turkish site dated to c. 9500 BCE has substantively changed the conventional chronology of monumental construction, demonstrating that pre-agricultural human populations were capable of major coordinated stone construction substantially earlier than the conventional view allowed.{{ cite(id="gobekli-tepe-schmidt", text="[2]", title="Schmidt, *Göbekli Tepe: A Stone Age Sanctuary in South-Eastern Anatolia* (2012)") }} Göbekli Tepe deserves its own dedicated entry; brief treatment here.
...
- **Ancient Astronaut tradition** (treated systematically in the {% wiki(slug="ancient-astronaut-hypothesis") %}Ancient Astronaut Hypothesis{% end %} entry) treats some monuments as candidate evidence for extraterrestrial influence in human construction.
...
- **Atlantis** — Plato's *Critias* and *Timaeus* describe a lost civilization beyond the Pillars of Hercules destroyed in a catastrophic flood;{{ cite(id="vidal-naquet-atlantis-story", text="[3]", title="Vidal-Naquet, *The Atlantis Story* (2007) — scholarly treatment of the Plato tradition") }} the subsequent Atlantis tradition (Donnelly's 1882 *Atlantis: The Antediluvian World*;{{ cite(id="atlantis-antediluvian-world", text="[4]", title="Donnelly, *Atlantis: The Antediluvian World* (1882) — the foundational nineteenth-century Atlantis revival") }} Cayce's 1920s-1940s readings;{{ cite(id="edgar-cayce-on-atlantis", text="[5]", title="Edgar Cayce on Atlantis (1968) — the 'sleeping prophet's' Atlantis readings") }} Hancock's contemporary work) substantially elaborates this
- **Lemuria / Mu** — the Pacific equivalent of Atlantis, popularized by Augustus Le Plongeon and James Churchward in the late 19th and early 20th centuries{{ cite(id="lost-continent-of-mu", text="[6]", title="Churchward, *The Lost Continent of Mu* (1926) — the foundational Mu / Pacific lost-civilization text") }}
...
- **The Sphinx** — Robert Schoch's water-erosion argument proposes that the Sphinx is substantially older than the conventional ~2500 BCE dating, possibly dating to before the end of the last glacial period (~10,000 BCE or earlier){{ cite(id="voices-of-the-rocks", text="[7]", title="Schoch, *Voices of the Rocks* (1999) — geological argument for the Sphinx redating") }}{{ footnote(id="3") }}
...
- **The Göbekli Tepe revolution is genuine.** The Turkish site dated to c. 9500 BCE substantially predates the conventional Neolithic-revolution chronology and demonstrates monumental construction capability substantially earlier than previously believed.{{ cite(id="dietrich-gobekli-antiquity-2012", text="[8]", title="Dietrich et al., 'The role of cult and feasting in the emergence of Neolithic communities' (Antiquity 2012)") }} Göbekli Tepe's implications for the broader pre-flood civilizational picture are substantial.{{ footnote(id="6") }}
- **The pre-flood civilizational catastrophe is plausible.** The Younger Dryas Impact Hypothesis (Firestone et al., 2007,{{ cite(id="firestone-pnas-2007", text="[9]", title="Firestone et al., 'Evidence for an extraterrestrial impact 12,900 years ago' (PNAS 2007)") }} and substantial subsequent development{{ cite(id="deadly-voyager", text="[10]", title="Powell, *Deadly Voyager* (2020) — synthesis of accumulated YDIH evidence") }}) has accumulated substantial evidence for a major cosmic impact or atmospheric airburst event ~12,900 BCE, with substantial implications for any pre-flood civilizations that may have existed.{{ footnote(id="4") }}
...
- **Engagement with mainstream archaeology.** Mark Lehner's work at Giza,{{ cite(id="the-complete-pyramids", text="[11]", title="Lehner, *The Complete Pyramids* (1997)") }} Mike Pitts's work at Stonehenge,{{ cite(id="hengeworld", text="[12]", title="Pitts, *Hengeworld* (2000)") }} the experimental-archaeology programs at multiple sites have substantially documented how specific monuments were constructed. The corpus engages this work at the descriptive level.
...
- **The Serpentine faction's submarine concealment.** The exiled {% wiki(slug="serpent") %}Serpentine faction{% end %} (treated systematically in the {% wiki(slug="theomachy") %}Theomachy{% end %} and Serpent entries) hid in oceanic locations after their banishment from the main alliance, with the submarine bases being principally their installations rather than the main alliance's.
...
> *"And the glory of {% wiki(slug="yahweh") %}Yahweh{% end %} went up from the midst of the city, and stood upon the mountain which is on the east side of the city. Afterwards the spirit took me up, and brought me in a vision by the Spirit of Elohim into Chaldea..."* (Ezekiel 11:23-24)
...
- **The Serpentine faction's submarine concealment.** The exiled Serpentine faction ({% wiki(slug="lucifer") %}Lucifer{% end %}'s group, banished from the main alliance after the disclosure event in {% wiki(slug="eden") %}Eden{% end %}) hid in oceanic locations. The substantial cross-cultural "serpent / dragon / sea-monster" traditions preserve cultural memory of this faction's submarine presence (treated in the Serpent and Theomachy entries).

The substantive contemporary engagement with submarine archaeology has produced substantial findings — the substantial submerged Neolithic sites in the Mediterranean and other regions; the substantial Yonaguni structures off Okinawa (substantively debated); the substantial Bimini Road off the Bahamas (substantively debated); the substantial submerged structures off the Gulf of Cambay (substantively debated).{{ cite(id="underworld-hancock", text="[13]", title="Hancock, *Underworld* (2002) — submerged archaeological sites globally") }} The corpus does not claim that any specific submerged site is provably an alliance submarine base. The claim is that the Vorilhon source's substantial submarine-base content registers a substantive corpus-content category distinct from the visible megalithic monuments.
...
The substantial documented record of Stonehenge construction is principally the work of multiple generations of British archaeologists, with contemporary engagement led by **Mike Parker Pearson** (University College London),{{ cite(id="stonehenge-parker-pearson", text="[16]", title="Parker Pearson, *Stonehenge: Exploring the Greatest Stone Age Mystery* (2012)") }} **Mike Pitts**, and others.
...
- **The sarsens.** The substantial sarsen stones (larger outer ring and trilithons) were quarried much closer — recent geochemical analysis (David Nash et al., 2020){{ cite(id="nash-sarsen-megaliths-2020", text="[17]", title="Nash et al., 'Origins of the sarsen megaliths at Stonehenge' (Science Advances 2020)") }} has substantially confirmed the West Woods, Marlborough Downs source ~25 km from the site. The transport involved substantial overland sledge-and-roller methods over relatively flat terrain.
...
- **Inca construction techniques.** The substantial Inca polygonal masonry was achieved through hammer-stone shaping (using harder andesite or basalt hammers to shape softer limestone or sandstone), with substantial test-fitting between adjacent stones until the polygonal interlock was achieved. The substantial experimental archaeology (Jean-Pierre Protzen's work at Ollantaytambo){{ cite(id="inca-architecture-ollantaytambo", text="[18]", title="Protzen, *Inca Architecture and Construction at Ollantaytambo* (1993)") }} has demonstrated the technique's feasibility within documented Inca tool capability.
...
- *Fingerprints of the Gods* (Crown, 1995){{ cite(id="fingerprints-of-the-gods", text="[20]", title="Hancock, *Fingerprints of the Gods* (1995)") }} — articulating the lost-civilization hypothesis through cross-cultural megalithic and mythological evidence
- *Magicians of the Gods* (Thomas Dunne, 2015){{ cite(id="magicians-of-the-gods", text="[21]", title="Hancock, *Magicians of the Gods* (2015) — Younger Dryas Impact Hypothesis convergence") }} — substantially updating the framework with the Younger Dryas Impact Hypothesis evidence
- *America Before* (St. Martin's, 2019){{ cite(id="america-before", text="[22]", title="Hancock, *America Before* (2019) — extension to pre-Columbian America") }} — extending the framework to pre-Columbian America
...
**John Anthony West** (1932-2018) was a substantial earlier proponent of the substantially-older-Sphinx hypothesis and the substantial broader alternative-Egyptology engagement.{{ cite(id="serpent-in-the-sky", text="[23]", title="West, *Serpent in the Sky* (1993) — alternative Egyptology and Schwaller de Lubicz symbolist reading") }}

**Christopher Dunn** has substantially engaged the substantial engineering questions about Egyptian pyramid construction, proposing substantial machining-and-power-tools hypotheses for specific features (the substantial granite boxes at the Serapeum at Saqqara; specific drilling marks in granite artifacts).{{ cite(id="giza-power-plant", text="[24]", title="Dunn, *The Giza Power Plant* (1998) — engineering-focused alternative Egyptology") }}
...
The substantial Ancient-Astronaut engagement with Ancient Builders content (treated systematically in the {% wiki(slug="ancient-astronaut-hypothesis") %}Ancient Astronaut Hypothesis{% end %} entry) operates principally through von Däniken, Sitchin, and the broader tradition.

**Erich von Däniken**'s *Chariots of the Gods?* (1968){{ cite(id="chariots-of-the-gods", text="[25]", title="Von Däniken, *Chariots of the Gods?* (1968) — the foundational popular ancient-astronaut text") }} substantially popularized the framing that specific monuments (Egyptian pyramids, Nazca lines, Easter Island moai, Sacsayhuamán, others) were built with extraterrestrial assistance or by extraterrestrial visitors directly. Von Däniken's methodology substantially relies on the cultural-dismissive framing (the conventionally-credited civilizations could not have built these monuments) that the corpus has explicitly distanced itself from.

**Zecharia Sitchin**'s substantial Anunnaki framework (treated in the Ancient Astronaut Hypothesis entry) substantially proposes that the Sumerian and broader Mesopotamian monumental construction was conducted with Anunnaki direction.{{ cite(id="the-12th-planet", text="[26]", title="Sitchin, *The 12th Planet* (1976) — the foundational Anunnaki-interpretation text") }} The Sitchin framework has substantial methodological problems (substantially contested Sumerian-language readings; substantial Nibiru claims unsupported by modern astronomy).
...
The ziggurat tradition's connection to the substantial Tower of Babel narrative is substantively engaged in the {% wiki(slug="babel") %}Babel{% end %} entry.
...
- **Precessional alignments** — the substantial *Hamlet's Mill* hypothesis (treated in the {% wiki(slug="comparative-mythology") %}Comparative Mythology{% end %} entry) that the substantial cross-cultural mythology encodes precessional content
...
The cross-cultural pattern of megalithic and monumental construction operates as one of the substantial broadest cross-cultural patterns the discipline of {% wiki(slug="comparative-mythology") %}Comparative Mythology{% end %} has identified. The pattern's distribution across virtually every major civilization warrants substantive engagement.
