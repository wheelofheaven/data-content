...
beginning = "Late Age of Cancer (c. 9,300-9,200 BCE on the corpus's compressed timeline); Lucifer's disclosure of forbidden knowledge to Adam and Eve in Eden; the political condemnation and exile to Earth"
open_military_phase = "Late Age of Gemini (c. 6,690 BCE forward); Council military action against the Serpentine faction in multiple theaters (orbital combat, surface engagements, possibly elsewhere in the solar system)"
resolution = "Early Age of Taurus; negotiated settlement and pardon of the original exiles; the alliance covenant with the human partners persists"
participants_council_side = "Yahweh (Council president), Satan (home-world abolitionist faction leader), various Council military forces from the home world"
participants_serpentine_side = "Lucifer (exiled-creator faction leader), the original exiled Eloha scientists, various subsequent adherents from the home-world dissenting tradition, the human alliance partners (with full participation in the post-flood phases)"
casualty_scope = "Substantial; the source registers the conflict as substantial in scope, duration, and destructive intensity, with the pre-flood civilization's destruction and substantial military engagement during the post-flood phase"
geographical_scope = "Multiple theaters: Earth surface engagements at Serpentine faction installation sites; orbital combat between Council spacecraft and Serpentine defensive systems; possibly engagements at locations elsewhere in the solar system"
political_settlement = "Pardon for the original exiles only; not a general amnesty for the broader Lucifer-faction movement; the hybrid Nephilim lineages and the post-flood human population not parties to the pardon; the covenant alliance with the human partners not unmade"
cultural_afterlife = "Preserved in virtually every major mythological tradition worldwide as the cross-cultural Theomachy pattern; preserved in the Hebrew Bible principally through the *liwyatan*/*nachash*/*tannin* vocabulary"
distinguished_from = "The Eden Expulsion (the specific late-Cancer event that initiates the broader conflict); the Great Flood (the specific Gemini-age destructive event that operates within the broader conflict); the Tower of Babel intervention (the specific Council intervention against the post-flood human technological project); the Sodom and Gomorrah strike (a chronologically later Taurus-age event with distinct operational character); the broader cross-cultural Theomachy pattern (which the corpus reads as cultural memory of this single historical event)"
status_in_source_material = "Substantially documented; the principal source-material passages establish both the conflict's specific narrative arc and its identification with the cross-cultural Theomachy pattern"
principal_text = "*The Book Which Tells the Truth* (1974), 'Eden,' 'The Flood,' 'Babel,' and broader narrative chapters; *timeline.epub* Age of Cancer chapter (Eden disclosure); *timeline.epub* Age of Gemini chapter (Sections X-XII, with substantial treatment of the open-military phase, the cross-cultural Theomachy convergence, and the political settlement); *timeline.epub* Age of Taurus chapter (the pardon)"
+++
...
**Zecharia Sitchin's broader engagement**. {% wiki(slug="zecharia-sitchin") %}**Zecharia Sitchin**{% end %} (1920-2010) produced substantial alternative-history work engaging Mesopotamian and Hebrew material as evidence of extra-terrestrial-civilization presence in human prehistory. Sitchin's specific framework (the "Anunnaki" reading of Mesopotamian texts) is broadly compatible with the corpus's framework at the structural level, while differing in specific details.
...
**2. The political condemnation**. The broader Council recognized the Lucifer faction's disclosure as substantial political defiance and responded with the Eden expulsion (treated more fully in the [Eden](../eden/) and [Adam and Eve](../adam-and-eve/) entries).
...
**1. The nuclear destruction mechanism**. The flood event was caused by Council nuclear weapons rather than natural meteorological phenomena. The detailed treatment of the flood mechanism lives in the [Great Flood](../great-flood/) entry.

**2. The Noah's-preservation operation**. The Lucifer faction's faction-internal "creator who was very fond of Noah" assisted Noah's preservation through the spacecraft-orbit operation. The detailed treatment lives in the [Great Flood](../great-flood/) entry.

**3. The covenant establishment**. The post-flood covenant was established between the Lucifer faction (the "creators" in this passage) and the surviving humans, formalized through the rainbow as the principal symbol of the new agreement. The detailed treatment lives in the [The Alliance](../the-alliance/) entry.
...
The principal subsequent source-material passages establishing the conflict's resolution appear at the opening of the Sodom and Gomorrah passage (which the Theomachy entry does not treat at length, but which provides the operational framing for the pardon):
...
The framework's reading: the three terms together identify the **Lucifer faction** — the same group that disclosed knowledge to Adam and Eve in Eden (the *nachash*), that the source's broader narrative identifies as the figures whose research program produced the dragons (the *tannin*-creators), and whose serpentine-twisting character the *liwyatan* designation registers. The detailed treatment of the *tannin* component lives in the [Dragons](../dragons/) entry; the detailed treatment of the *nachash* component lives in the [Serpent](../serpent/) entry; the detailed treatment of the broader Lucifer-faction identification lives in the [Lucifer](../lucifer/) entry.
...
- The Eden disclosure connects to the broader [Eden](../eden/), [Adam and Eve](../adam-and-eve/), [Lucifer](../lucifer/), and [Serpent](../serpent/) entries
- The antediluvian period connects to the broader [Antediluvian](../antediluvian/) entry
...
**The Eden expulsion**. The Council responded with the Eden expulsion — the formal removal of Adam and Eve from the creators' residence ("Eden") and the political condemnation of the Lucifer faction. The detailed treatment of the Eden expulsion lives in the [Eden](../eden/) and [Adam and Eve](../adam-and-eve/) entries.
...
The Theomachy's specific origin in Lucifer's Eden disclosure is one of the principal operational components of the broader [Eden](../eden/) entry. The detailed treatment of the Eden environment and the expulsion event lives in that entry; the Theomachy entry's specific contribution is the broader narrative-historical context within which the Eden disclosure operates.
...
The Theomachy's specific Council-side participation by Yahweh is one of the principal operational components of the broader [Yahweh](../yahweh/) entry. The detailed treatment of Yahweh as figure lives in that entry; the Theomachy entry's specific contribution is registering the broader narrative-political context within which Yahweh's specific actions operate.

### The Dragons entry

The Theomachy's specific connection to the Hebrew *tannin* vocabulary (Isaiah 27:1, Genesis 1:21, and various other passages) connects substantially to the [Dragons](../dragons/) entry. The detailed treatment of the *tannin* vocabulary lives in that entry; the Theomachy entry's specific contribution is registering the Isaiah 27:1 three-term identification within the broader narrative-historical context.
...
*The Poetic Edda*. Trans. Jackson Crawford. Hackett, 2015.
