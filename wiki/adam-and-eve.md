...
footnotes = [
    { content = "The corpus reads Genesis 1 and Genesis 2 as distinct in scope rather than as parallel-and-contradictory accounts of the same event. Genesis 1 is the summary account of the broader seven-team creation program (the sixth *yom* covering the human-creation work of all seven teams across the Age of Leo); Genesis 2 is the detailed narrative of one specific team's work — the Israel team's Eden installation. This partially aligns with the documentary hypothesis (the two accounts are genuinely textually distinct) while differing in interpretation: the corpus reads them as distinct in scope, not as contradictory parallel accounts. This has the methodological advantage of explaining why both are preserved together — they cover different scopes of the same broader operational reality." },
    { content = "The corpus reads the Genesis 2 creation language as stylized accounts of biological synthesis the original authors could not describe in technical vocabulary. The \"dust of the ground\" (*ʿāp̄ār min hā-ʾădāmâ*) formation is read as *de novo* synthesis using terrestrial materials as molecular substrate and Elohim genetic material as template; the \"breath of life\" (*nišmaṯ ḥayyîm*) as the activation of the synthesized organism; the \"rib\" (*ṣēlāʿ*, which can mean \"side,\" \"panel,\" or \"structural support\") as cellular or genetic material taken from Adam, giving Eve substantial genetic compatibility with him; the \"deep sleep\" (*tardēmâ*) as the medical-anesthetic state during the procedure. The corpus does not commit to the literal-anatomical specificity of the surface narrative." },
    { content = "The framework does not claim Adam and Eve are the first humans of all humanity. The seven-creator-team picture explicitly registers parallel first-human figures in the other six lineages — whose names are not preserved in the Hebrew Bible because the Hebrew Bible is the Israel-team lineage's specific cultural inheritance. Adam and Eve are the first humans of *one* lineage, whose subsequent history became the cultural-religious history of the Hebrews. The \"Fall\" is therefore not a universal human moral catastrophe but a specific operational event in one lineage's history, and the Augustinian original-sin doctrine that extends the narrative to all humanity does not have the universal scope its conventional theological framing claims." },
    { content = "The framework rejects the misogynistic interpretive tradition that places primary responsibility on Eve. The Raëlian source material is explicit that the disclosure was offered to both humans equally, the affection of the disclosing creators was for both, and the consequences fell equally on both. The 1 Timothy 2:13–14 \"the woman was deceived\" framing is the textual basis of the subsequent tradition the corpus rejects. On this specific point the corpus aligns with the Jewish and Christian feminist scholarship (Pagels, Trible, Meyers) without adopting the full feminist-theological apparatus." },
    { content = "The date the corpus assigns to Adam and Eve's synthesis — late Age of Leo, c. 11,400 BCE — is framework-internal, derived from the corpus's chronological calibration including the 666-generations-of-20-years calculation read out of Revelation 13:18. The precessional ages are real astronomical phenomena; the specific boundary years are framework conventions. See the Genesis and Antediluvian entries for the chronology's derivation." },
    { content = "The resurrection of Adam and Eve on the Planet of the Eternals is a source-internal claim of the Raëlian material — both are reported as currently living there in conditions of practical immortality maintained by the alliance's cloning and memory-transfer technology, awaiting the open return at the Aquarian-age embassy. The corpus reads Adam's resurrection in connection with his role as the first prophet (the first human recipient of direct alliance communication). The claim is not independently verifiable and the corpus treats it as the source's own assertion." },
]
...
note = "The medieval foundational text for the Lilith-as-Adam's-first-wife narrative the corpus registers but does not adopt."
...
note = "The Latter-day Saint source of the Adam-as-Michael doctrine the corpus registers but does not adopt."
...
The "dust of the ground" language of Genesis 2:7 is read as a stylized account of biological synthesis using terrestrial substrate.{{ footnote(id="2") }} The Eloha-side biological work was conducted with terrestrial materials providing the molecular building blocks and Elohim genetic material providing the design template. The "breath of life" (*nišmaṯ ḥayyîm*) breathed into the synthesized human's nostrils is read as the activation of the synthesized organism — the moment of biological initiation that completed the synthesis process.
...
**The documentary hypothesis** — the historical-critical scholarly position (developed by Wellhausen and successors across the late 19th and 20th centuries) treats the two accounts as compositions from distinct source documents (the Priestly source for Genesis 1 and the Yahwist source for Genesis 2) that have been juxtaposed by the Pentateuch's redactor without harmonization.{{ cite(id="skinner-genesis-icc", text="[3]", title="Skinner, *A Critical and Exegetical Commentary on Genesis* (ICC, 1910)") }}{{ cite(id="von-rad-genesis", text="[4]", title="von Rad, *Genesis: A Commentary* (1961)") }}{{ cite(id="westermann-genesis-1-11", text="[5]", title="Westermann, *Genesis 1–11: A Continental Commentary* (1994)") }}{{ cite(id="sarna-genesis-jps", text="[6]", title="Sarna, *Genesis: The JPS Torah Commentary* (1989)") }} The two accounts are recognized as genuinely distinct in vocabulary, theological emphasis, and creation sequence (Genesis 1 has plants → animals → humans; Genesis 2 has Adam → plants → animals → Eve), with the redactor leaving the discrepancies in the final form rather than smoothing them.

**The corpus's reading** — the framework reads Genesis 1 as the summary account of the broader seven-team creation program (the seven *yamim* as precessional ages, with the sixth *yom* covering the human-creation work of all seven teams across the Age of Leo) and Genesis 2 as the detailed narrative of one specific team's work — the Israel team's Eden installation.{{ footnote(id="1") }} The two accounts are thus genuinely distinct in scope (Genesis 1 covers the full program; Genesis 2 covers one team's portion of it) but complementary in their treatment of the same broader operational reality. This reading partially aligns with the documentary hypothesis (recognizing that the two accounts are textually and substantively distinct) while differing in interpretation (the corpus reads them as distinct in *scope* rather than as parallel-and-contradictory accounts of the same event).
...
The corpus reads Adam and Eve as the first humans of one specific creator team's work — the Israel team's work at the Eden installation — rather than as the first humans of all humanity.{{ footnote(id="3") }} This reading reframes the underlying ontology of their position. They are not the unique progenitors of all human beings (the seven-creator-team picture has parallel first-human figures in the other six lineages, whose names are not preserved in the Hebrew Bible because the Hebrew Bible is the Israel-team lineage's specific cultural inheritance). They are the first humans of *one* lineage — the lineage whose subsequent history became the cultural-religious history of the Hebrews and, through the Hebrew tradition's broader influence, of the developed Western religious traditions.
...
**Augustine of Hippo** (354–430 CE) developed the doctrine of original sin in *De Civitate Dei*, *De Peccatorum Meritis et Remissione*, and the various anti-Pelagian writings.{{ cite(id="city-of-god", text="[7]", title="Augustine, *The City of God* — the original-sin synthesis") }} The Augustinian doctrine holds that Adam's disobedience in Genesis 3 introduced sin and mortality into human nature, that this sinful condition is inherited by all subsequent humans through biological-spiritual descent from Adam, and that the resulting human condition requires divine grace (specifically through Christ's atoning sacrifice) for salvation.
...
**Phyllis Trible**'s *God and the Rhetoric of Sexuality* (1978) developed an influential close reading of Genesis 2–3 that argued for substantial gender equality in the original Hebrew text, with the patriarchal interpretation being a later imposition rather than the text's own framing.{{ cite(id="trible-rhetoric-sexuality", text="[9]", title="Trible, *God and the Rhetoric of Sexuality* (1978)") }} Trible's reading of the Hebrew *ʿēzer kə-negdô* ("a helper fit for him") of Genesis 2:18 emphasizes the *ʿēzer* term's broader meaning ("strength, support") rather than the subordinationist sense often imported in translation; her reading of the *ṣēlāʿ* ("rib" / "side") emphasizes the parallel-equal-side meaning rather than the subordinate-derivative meaning.

**Carol Meyers**'s *Discovering Eve* (1988) developed the historical-anthropological reading of Eve as representing the agricultural-laboring woman of the Iron Age Israelite household, with the Genesis narrative reflecting the actual social conditions of women in early Israelite society rather than imposing a theological-ideological framework on them.{{ cite(id="meyers-discovering-eve", text="[10]", title="Meyers, *Discovering Eve: Ancient Israelite Women in Context* (1988)") }} Meyers's reading reframes the "curses" of Genesis 3:16 as descriptive accounts of the difficult conditions of agricultural-household women rather than as prescriptive theological pronouncements about gender hierarchy.
...
The *Alphabet of Ben Sira* (c. 8th–10th century CE) is the foundational text for the Lilith narrative.{{ cite(id="alphabet-of-ben-sira", text="[11]", title="*The Alphabet of Ben Sira* (c. 8th–10th century CE) — the foundational Lilith-as-first-wife narrative") }} The text, a medieval Jewish satirical compilation, presents Lilith as Adam's first wife, created equally with him from the same earth, who refused to submit to Adam's sexual authority and pronounced the Tetragrammaton to escape from Eden. Lilith is subsequently associated with various demonic activities (particularly the killing of newborn infants) in subsequent Jewish folklore.

The *Zohar* and Lurianic Kabbalah develop Lilith as a demonic figure within the broader Kabbalistic cosmology, with Lilith as the consort of Samael and the leader of the demonic *sitra ahra* ("other side").{{ cite(id="zohar-pritzker", text="[12]", title="The Zohar, Pritzker Edition (Matt et al., 2003–2017)") }} The Kabbalistic Lilith is thoroughly incorporated into the broader medieval Jewish demonology.

Modern Jewish feminist writers (principally **Judith Plaskow**, in her 1972 essay "The Coming of Lilith") have reclaimed the Lilith figure as a positive symbol of feminine autonomy and resistance to patriarchy.{{ cite(id="plaskow-standing-again-sinai", text="[13]", title="Plaskow, *Standing Again at Sinai* (1990) and 'The Coming of Lilith' (1972)") }} The contemporary Jewish feminist Lilith is read as the figure who refused to submit to unjust authority and chose freedom over compliance — a reading substantially distinct from the medieval Jewish demonological figure.
...
**Mauro Biglino**'s strict-translational engagement with the Adam-and-Eve material is developed across his works,{{ cite(id="the-naked-bible", text="[14]", title="Biglino & Cattaneo, *The Naked Bible* (2022)") }} with the principal claims:
...
**Jean Sendy** and **Paul Anthony Wallis** both develop readings of Adam and Eve substantially aligned with the corpus's reading. Sendy's *Ces dieux qui firent le ciel et la terre* (1969) provides the principal scholarly antecedent of the corpus's reading, treating Adam and Eve as the first humans of the Israel-team lineage and reading the Genesis narrative as preserving substantive operational content.{{ cite(id="those-gods-who-made-heaven-and-earth", text="[15]", title="Sendy, *Ces dieux qui firent le ciel et la terre* (1969)") }} Wallis's *The Eden Conspiracy* (2024) provides accessible recent treatment, with detailed engagement with the Genesis 2–3 material from an Elohim-pluralist perspective broadly compatible with the corpus's reading.{{ cite(id="the-eden-conspiracy", text="[16]", title="Wallis, *The Eden Conspiracy* (2024)") }}
