...
description = "The Hekhalot literature (Hebrew הֵיכָלוֹת, 'palaces') is the body of late-antique Jewish mystical writings describing the soul's ascent through seven heavenly palaces to the divine throne-chariot (merkavah). It is the pre-Kabbalistic stratum of Jewish mysticism, and the corpus in which the Shi'ur Qomah is transmitted."
template = "wiki-page.html"
toc = true

[extra]
same_as = ["https://www.wikidata.org/wiki/Q2010619", "https://en.wikipedia.org/wiki/Hekhalot_literature", "https://www.britannica.com/topic/hekhalot", "https://viaf.org/viaf/174983753"]
...
literal_meaning = "Hebrew הֵיכָלוֹת (*hekhalot*), plural of הֵיכָל (*hekhal*), 'palace' or 'hall' — the seven heavenly palaces of the ascent"
also_called = "Merkavah (chariot) mysticism, after Ezekiel's throne-vision (*ma'aseh merkavah*, 'the work of the chariot')"
principal_works = "*Hekhalot Rabbati* ('the Greater Palaces'), *Hekhalot Zutarti* ('the Lesser Palaces'), *Ma'aseh Merkavah*, *Merkavah Rabbah*, *3 Enoch* (the Hebrew Book of Enoch); the *Shi'ur Qomah* is embedded within the corpus"
practitioner = "The *yored merkavah* ('descender to the chariot'), who ascends through the palaces armed with hymns, angelic names, and seals"
dating = "Contested: composition / redaction between roughly the 3rd and 8th centuries CE (Scholem argued earlier, Schäfer later and geonic-Babylonian)"
key_figure = "The angel Metatron — 'Prince of the Presence,' heavenly scribe, and (in 3 Enoch) the transfigured patriarch Enoch"
+++
