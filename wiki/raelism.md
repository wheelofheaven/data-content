...
footnotes = [
    ...
    { content = "The movement's teaching that sexual pleasure forges new neural pathways and raises intelligence is a doctrinal rather than an established scientific claim; mainstream neuroscience does not support the specific causal mechanism as stated. It is registered here as Raëlian doctrine, consistent with the corpus's general practice of distinguishing canon-internal claims from claims about the external scientific record." },
]
...
**1. Geniocracy** — selective democracy with intelligence-based eligibility for office (50% above mean) and voting (10% above mean); positioned as long-term developmental target rather than immediate institutional change{{ footnote(id="3") }}
...
The narrative arc of the movement's institutional development is treated above under *History*. Read as a sequence of organizational phases, it runs from the 1976–1990 founding and expansion (the IRM established, the foundational books completed, the 1990 symbol modification), through the 1991–2005 embassy-engagement period (the Israeli relocation requests, the 1997 Yahweh message, the Order of Angels, the Clonaid activity culminating in the 2002 announcement, and the 2005 *Message from the Designers*), into a 2006–2020 consolidation period and the post-2021 acceleration of the embassy project — the AEDC, the 2022 mayoral presentations, and the 2024 Memorandum of Collaboration — oriented toward the projected 2027–2030 construction window.

### The principal controversies

Several principal controversies warrant treatment:

**The 2002 Clonaid claim**. On December 27, 2002, Brigitte Boisselier (Clonaid president, Raëlian Bishop) announced at a press conference in Hollywood, Florida, that Clonaid had assisted the birth of the first cloned human baby, nicknamed "Eve." The claim has not been independently scientifically verified across the subsequent two decades, despite various Clonaid statements promising forthcoming verification.{{ footnote(id="5") }} The mainstream scientific community has substantially treated the announcement as unverified, with substantial subsequent skepticism. The announcement produced substantial international media attention and substantially elevated the Raëlian movement's broader public profile, though with substantially mixed outcomes for the movement's broader institutional reception.
...
The broader anti-cult organizational engagement (UNADFI, MIVILUDES, FECRIS, various international organizations) has produced substantial critical-hostile material across the past several decades. The mainstream NRM scholarship has generally engaged this material critically, with various scholars treating the anti-cult material as one specific perspective rather than as definitive scholarly treatment. The corpus's own position aligns with that scholarly engagement at the institutional-sociological level while extending beyond it on the content of the source-material teaching, and treats the anti-cult and ex-member accounts as evidence among many rather than as definitive.
